...
# %bb.2:                                # %.lr.ph92
	...
	vslt.du	$vr2, $vr8, $vr9
	vslt.du	$vr3, $vr7, $vr10
	vpickev.w	$vr2, $vr3, $vr2
	vslt.du	$vr3, $vr13, $vr11
	vslt.du	$vr0, $vr0, $vr5
...
# %bb.13:                               # %middle.block
	...
	move	$t3, $a2
	beq	$t6, $a2, .LBB12_16
.LBB12_14:                              # %"_Z6forallIZL16BM_PIC_1D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.preheader163"
                                        #   in Loop: Header=BB12_4 Depth=1
	alsl.d	$a4, $t3, $t7, 3
	alsl.d	$a5, $t3, $s0, 2
	alsl.d	$a6, $t3, $s7, 3
...
.Lfunc_end12:
	...
	.p2align	4, 0x0                          # -- Begin function _ZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateE
.LCPI13_0:
	.dword	8                               # 0x8
	.dword	0                               # 0x0
...
.LBB13_10:                              # %vector.memcheck420
	...
	vinsgr2vr.d	$vr9, $fp, 0
	vinsgr2vr.d	$vr9, $s1, 1
	vslt.du	$vr10, $vr1, $vr9
	vpickev.w	$vr5, $vr10, $vr5
	vslt.du	$vr10, $vr1, $vr8
	vslt.du	$vr11, $vr1, $vr7
	vpickev.w	$vr10, $vr11, $vr10
	vpickev.h	$vr5, $vr10, $vr5
	vslt.du	$vr3, $vr3, $vr6
	vslt.du	$vr6, $vr4, $vr9
	...
	vreplgr2vr.d	$vr9, $a0
	vreplgr2vr.d	$vr10, $a4
	vslt.du	$vr11, $vr5, $vr10
	vslt.du	$vr12, $vr6, $vr10
	vpickev.w	$vr11, $vr12, $vr11
	vslt.du	$vr10, $vr4, $vr10
	vslt.du	$vr2, $vr7, $vr2
	vpickev.w	$vr2, $vr10, $vr2
	vpickev.h	$vr2, $vr11, $vr2
	vslt.du	$vr5, $vr5, $vr9
	vslt.du	$vr6, $vr6, $vr9
...
# %bb.11:                               # %vector.memcheck420
	...
	ori	$a0, $zero, 1
	bnez	$a1, .LBB13_8
# %bb.12:                               # %vector.body506.preheader
                                        #   in Loop: Header=BB13_7 Depth=2
	addi.d	$a0, $s0, 8
	addi.d	$a4, $t3, 8
	move	$s3, $t7
...
# %bb.14:                               # %middle.block526
	...
	b	.LBB13_8
	.p2align	4, , 16
.LBB13_15:                              # %.preheader95.us.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	...
	b	.LBB13_17
	.p2align	4, , 16
.LBB13_16:                              # %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_1Ev9simd_execiiT_.exit_crit_edge.us"
...
.LBB13_17:                              # %.preheader95.us
	...
	ori	$a1, $zero, 4
	bgeu	$s8, $a1, .LBB13_20
.LBB13_18:                              # %scalar.ph388.preheader
                                        #   in Loop: Header=BB13_17 Depth=2
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$t2, $a1, $a0
	slli.d	$s3, $a0, 3
...
.LBB13_19:                              # %scalar.ph388
	...
	fld.d	$ft0, $a0, %pc_lo12(.LCPI13_1)
	fmadd.d	$fa2, $fa4, $fa3, $fa2
	fsub.d	$fa1, $fa1, $fa6
	fmadd.d	$fa1, $fa5, $fa1, $fa2
	fmadd.d	$fa1, $fa1, $ft0, $fa7
	fstx.d	$fa1, $s0, $s3
	add.d	$a0, $t5, $s3
	fldx.d	$fa1, $t5, $s3
	fld.d	$fa2, $a0, 8
...
.LBB13_20:                              # %vector.memcheck297
	...
	vori.b	$vr6, $vr1, 0
	vshuf4i.d	$vr6, $vr2, 6
	vpackev.d	$vr8, $vr1, $vr4
	vori.b	$vr9, $vr1, 0
	vshuf4i.d	$vr9, $vr2, 3
	vpackod.d	$vr10, $vr1, $vr5
	vori.b	$vr11, $vr1, 0
	vshuf4i.d	$vr11, $vr5, 6
	...
	vinsgr2vr.d	$vr14, $s8, 0
	ld.d	$s8, $sp, 112                   # 8-byte Folded Reload
	vinsgr2vr.d	$vr14, $s7, 1
	vreplgr2vr.d	$vr15, $s3
	vreplgr2vr.d	$vr16, $s7
	vslt.du	$vr2, $vr2, $vr16
	vpickev.w	$vr2, $vr2, $vr7
	vslt.du	$vr1, $vr1, $vr14
	vslt.du	$vr7, $vr9, $vr13
	vpickev.w	$vr1, $vr7, $vr1
	vpickev.h	$vr1, $vr1, $vr2
	vslt.du	$vr2, $vr5, $vr12
	vslt.du	$vr5, $vr8, $vr11
...
# %bb.23:                               # %vector.memcheck297
	...
	ori	$a0, $zero, 1
	bnez	$a1, .LBB13_18
# %bb.24:                               # %vector.body393.preheader
                                        #   in Loop: Header=BB13_17 Depth=2
	move	$a0, $zero
	addi.d	$a4, $t5, 8
	addi.d	$s1, $ra, 8
...
.LBB13_25:                              # %vector.body393
	...
	vldx	$vr5, $a5, $a0
	vfsub.d	$vr1, $vr7, $vr1
	vfmadd.d	$vr1, $vr4, $vr1, $vr2
	vldx	$vr2, $t2, $a0
	vfsub.d	$vr4, $vr7, $vr5
	vldx	$vr5, $s7, $a0
	vfmadd.d	$vr1, $vr3, $vr4, $vr1
	vfsub.d	$vr2, $vr7, $vr2
	vfmadd.d	$vr1, $vr8, $vr2, $vr1
	vfmadd.d	$vr1, $vr1, $vr6, $vr5
	vstx	$vr1, $s7, $a0
	addi.d	$a1, $a1, -2
	addi.d	$a0, $a0, 16
	bnez	$a1, .LBB13_25
# %bb.26:                               # %middle.block417
                                        #   in Loop: Header=BB13_17 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	...
	b	.LBB13_18
	.p2align	4, , 16
.LBB13_27:                              # %.preheader.us.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a3, $s2, 8
	...
	ld.d	$t2, $s4, 8
	ori	$a0, $zero, 1
	pcalau12i	$t5, %pc_hi20(.LCPI13_2)
	ori	$fp, $zero, 2
	bgeu	$s8, $fp, .LBB13_44
# %bb.28:                               #   in Loop: Header=BB13_4 Depth=1
	ld.d	$s7, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
.LBB13_29:                              # %scalar.ph281.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$t8, $sp, 16                    # 8-byte Folded Reload
.LBB13_30:                              # %scalar.ph281.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	alsl.d	$a1, $a0, $a3, 3
	alsl.d	$a3, $a0, $a6, 3
	alsl.d	$a4, $a0, $a7, 3
	...
	sub.d	$a0, $a2, $a0
	.p2align	4, , 16
.LBB13_31:                              # %scalar.ph281
                                        #   Parent Loop BB13_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa1, $a1, 0
	fld.d	$fa2, $a3, 0
	fld.d	$fa3, $t5, %pc_lo12(.LCPI13_2)
	fmadd.d	$fa1, $fa2, $fa3, $fa1
	fst.d	$fa1, $a4, 0
	fld.d	$fa1, $a5, 0
	fld.d	$fa2, $a6, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$a0, .LBB13_31
.LBB13_32:                              # %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_2Ev9simd_execiiT_.exit_crit_edge.us"
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a3, $s2, 16
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a6, $a0, 16
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_49
.LBB13_33:                              # %scalar.ph247.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_34:                              # %scalar.ph247
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB13_34
.LBB13_35:                              # %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_2Ev9simd_execiiT_.exit_crit_edge.us.1"
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a3, $s2, 24
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a6, $a0, 24
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_54
.LBB13_36:                              # %scalar.ph213.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_37:                              # %scalar.ph213
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB13_37
.LBB13_38:                              # %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_2Ev9simd_execiiT_.exit_crit_edge.us.2"
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a3, $s2, 32
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a6, $a0, 32
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_59
.LBB13_39:                              # %scalar.ph179.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_40:                              # %scalar.ph179
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB13_40
.LBB13_41:                              # %"._Z6forallIZL18BM_HYDRO_2D_LAMBDARN9benchmark5StateEE3$_2Ev9simd_execiiT_.exit_crit_edge.us.3"
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a3, $s2, 40
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a6, $a0, 40
...
.LBB13_44:                              # %vector.memcheck263
	...
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
	bnez	$a1, .LBB13_29
# %bb.45:                               # %vector.memcheck263
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ld.d	$t8, $sp, 16                    # 8-byte Folded Reload
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_30
# %bb.46:                               # %vector.body286.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
	...
	.p2align	4, , 16
.LBB13_47:                              # %vector.body286
                                        #   Parent Loop BB13_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $a0, 0
	vld	$vr2, $a1, 0
	vfmadd.d	$vr1, $vr2, $vr0, $vr1
	vst	$vr1, $a4, 0
	vld	$vr1, $a5, 0
	vld	$vr2, $t3, 0
	vfmadd.d	$vr1, $vr2, $vr0, $vr1
...
.LBB13_49:                              # %vector.memcheck229
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB13_33
# %bb.50:                               # %vector.memcheck229
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_33
# %bb.51:                               # %vector.body252.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
...
.LBB13_54:                              # %vector.memcheck195
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB13_36
# %bb.55:                               # %vector.memcheck195
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_36
# %bb.56:                               # %vector.body218.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
...
.LBB13_59:                              # %vector.memcheck161
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB13_39
# %bb.60:                               # %vector.memcheck161
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_39
# %bb.61:                               # %vector.body184.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
