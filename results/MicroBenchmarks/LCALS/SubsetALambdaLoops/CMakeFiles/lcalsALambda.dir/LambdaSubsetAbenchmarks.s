...
# %bb.6:                                #   in Loop: Header=BB0_5 Depth=1
	...
	b	.LBB0_10
	.p2align	4, , 16
.LBB0_7:                                # %vector.body100.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a7, $a5
	move	$t0, $a4
	move	$t1, $a2
	.p2align	4, , 16
.LBB0_8:                                # %vector.body100
...
.LBB0_18:                               # %pred.store.continue
	...
	andi	$t4, $t4, 1
	bnez	$t4, .LBB0_21
# %bb.19:                               # %pred.store.continue87
                                        #   in Loop: Header=BB0_16 Depth=2
	vpickve2gr.w	$t4, $vr10, 2
	andi	$t4, $t4, 1
	bnez	$t4, .LBB0_22
.LBB0_20:                               # %pred.store.continue89
                                        #   in Loop: Header=BB0_16 Depth=2
...
.LBB0_24:                               # %middle.block
	...
	move	$t3, $a3
	beq	$a0, $a3, .LBB0_4
.LBB0_25:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us.preheader108"
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
.LBB0_26:                               #   in Loop: Header=BB0_28 Depth=2
	...
	fsel	$ft0, $ft0, $ft6, $fcc0
	fst.d	$ft0, $t1, 0
.LBB0_27:                               # %"_Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us.us"
	...
	addi.d	$t2, $t2, 8
	beqz	$t3, .LBB0_4
.LBB0_28:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us"
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$ft0, $a7, 0
	fld.d	$ft1, $t0, 0
...
# %bb.6:                                #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_7:                                # %vector.body288.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
...
# %bb.21:                               #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_25
	.p2align	4, , 16
.LBB1_22:                               # %vector.body262.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
	move	$a1, $t6
	move	$a2, $t8
	move	$a3, $t1
...
.LBB1_23:                               # %vector.body262
	...
	addi.d	$a1, $a1, 32
	bnez	$a7, .LBB1_23
# %bb.24:                               # %middle.block271
                                        #   in Loop: Header=BB1_4 Depth=1
	ld.d	$a1, $sp, 464                   # 8-byte Folded Reload
	move	$a7, $a1
	beq	$s7, $a1, .LBB1_27
.LBB1_25:                               # %"_Z6forallIZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEE3$_1Ev9simd_execiiT_.exit.preheader305"
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a1, $a7, $t2, 3
...
# %bb.31:                               # %middle.block
	...
	move	$a2, $a0
	beq	$s7, $a0, .LBB1_34
.LBB1_32:                               # %"_ZZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEENK3$_3clEi.exit.preheader304"
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a0, $a2, $t6, 3
	alsl.d	$a1, $a2, $t4, 3
	sub.d	$a2, $s7, $a2
