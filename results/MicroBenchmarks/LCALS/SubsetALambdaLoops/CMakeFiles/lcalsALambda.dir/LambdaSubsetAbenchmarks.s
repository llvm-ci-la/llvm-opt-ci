...
# %bb.3:                                # %.lr.ph.us.us.preheader
	...
	b	.LBB0_5
	.p2align	4, , 16
.LBB0_4:                                # %"_Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit._Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_1Ev9simd_execiiT_.exit_crit_edge.us.us"
...
.LBB0_11:                               # %scalar.ph89
	...
	addi.d	$t0, $t0, 8
	bnez	$t1, .LBB0_11
.LBB0_12:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us.preheader"
                                        #   in Loop: Header=BB0_5 Depth=1
	beqz	$a6, .LBB0_14
...
.LBB0_20:                               # %middle.block
	...
	move	$t3, $a3
	beq	$a0, $a3, .LBB0_4
.LBB0_21:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us.preheader104"
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
.LBB0_22:                               #   in Loop: Header=BB0_24 Depth=2
	...
	fsel	$ft0, $ft0, $ft6, $fcc0
	fst.d	$ft0, $t1, 0
.LBB0_23:                               # %"_Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us.us"
	...
	addi.d	$t2, $t2, 8
	beqz	$t3, .LBB0_4
.LBB0_24:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us"
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$ft0, $a7, 0
	fld.d	$ft1, $t0, 0
	...
	fsel	$ft0, $ft0, $fa5, $fcc0
	bcnez	$fcc0, .LBB0_22
# %bb.25:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us"
                                        #   in Loop: Header=BB0_24 Depth=2
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	5                               # -- Begin function _ZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateE
...
.Lfunc_end1:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	5                               # -- Begin function _ZL20BM_VOL3D_CALC_LAMBDARN9benchmark5StateE
...
.LBB2_8:                                # %.lr.ph.preheader
	...
	b	.LBB2_10
	.p2align	4, , 16
.LBB2_9:                                # %"._Z6forallI9simd_execZL20BM_VOL3D_CALC_LAMBDARN9benchmark5StateEE3$_0EviiT0_.exit_crit_edge"
...
.LBB2_12:                               # %vector.body
	...
	vfsub.d	$vr12, $vr14, $vr12
	vldx	$vr13, $a5, $a4
	vldx	$vr14, $fp, $a4
	add.d	$t2, $a5, $a4
	vldx	$vr15, $t6, $a4
	add.d	$s3, $fp, $a4
	vfsub.d	$vr14, $vr13, $vr14
	add.d	$s7, $t6, $a4
	...
	vfadd.d	$vr20, $vr5, $vr12
	vfadd.d	$vr21, $vr14, $vr18
	vbitrevi.d	$vr22, $vr11, 63
	vfmul.d	$vr22, $vr15, $vr22
	vfmadd.d	$vr22, $vr10, $vr16, $vr22
	vbitrevi.d	$vr23, $vr16, 63
	vfmul.d	$vr23, $vr6, $vr23
	vfmadd.d	$vr23, $vr15, $vr4, $vr23
	vbitrevi.d	$vr24, $vr4, 63
	vfmul.d	$vr24, $vr10, $vr24
	vfmadd.d	$vr24, $vr6, $vr11, $vr24
	...
	vfmadd.d	$vr10, $vr14, $vr2, $vr10
	vbitrevi.d	$vr2, $vr2, 63
	vfmul.d	$vr2, $vr5, $vr2
	vfmadd.d	$vr1, $vr1, $vr7, $vr2
	vfmul.d	$vr2, $vr4, $vr10
	vfmadd.d	$vr2, $vr3, $vr9, $vr2
...
.Lcst_end1:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	5                               # -- Begin function _ZL16BM_COUPLE_LAMBDARN9benchmark5StateE
...
# %bb.6:                                # %.preheader.us.us.preheader
	...
	b	.LBB4_8
	.p2align	4, , 16
.LBB4_7:                                # %"._Z6forallI9simd_execZL16BM_COUPLE_LAMBDARN9benchmark5StateEE3$_0EviiT0_.exit_crit_edge.split.us.us.us"
                                        #   in Loop: Header=BB4_8 Depth=1
	ld.d	$s8, $sp, 168                   # 8-byte Folded Reload
	addi.d	$s8, $s8, -1
	beqz	$s8, .LBB4_47
.LBB4_8:                                # %.preheader.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB4_10
	.p2align	4, , 16
.LBB4_9:                                # %.noexc26.loopexit.us.us.us
	...
	beq	$a3, $a0, .LBB4_7
.LBB4_10:                               # %.lr.ph249.split.i.preheader.us.us.us
	...
	b	.LBB4_12
	.p2align	4, , 16
.LBB4_11:                               # %._crit_edge.i.loopexit.us.us.us
	...
	beq	$a0, $s7, .LBB4_9
.LBB4_12:                               # %.lr.ph249.split.i.us.us.us
                                        #   Parent Loop BB4_8 Depth=1
...
.LBB4_13:                               # %.lr.ph.i.us.us.us
	...
	fld.d	$fa2, $s4, -8
	fld.d	$fa3, $s4, 0
	fld.d	$fa4, $sp, 320                  # 8-byte Folded Reload
	fmul.d	$fs1, $fa0, $fa4
	fmul.d	$fs2, $fa1, $fa4
	fmul.d	$fs3, $fa2, $fa4
	fmul.d	$fs6, $fa3, $fa4
...
.LBB4_14:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit.i.us.us.us
	...
	fmov.d	$fa1, $fs3
	bceqz	$fcc2, .LBB4_27
.LBB4_15:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit68.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fadd.d	$fa2, $fs4, $fa2
	fadd.d	$fa1, $fs2, $fa1
	fld.d	$ft1, $sp, 328                  # 8-byte Folded Reload
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	movgr2fr.d	$fs2, $zero
	fmul.d	$fa1, $fa2, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_29
.LBB4_16:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit81.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $fa0, $ft2
	fmul.d	$fa3, $fa0, $ft3
	fsub.d	$fa2, $fa2, $fa4
	...
	fst.d	$fa1, $fp, 0
	bceqz	$fcc2, .LBB4_31
.LBB4_17:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit88.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fneg.d	$fa4, $fs7
	fmul.d	$fa1, $fs1, $fs6
	fmul.d	$fa2, $fs1, $fs3
	...
	fsub.d	$fa6, $fa2, $fa1
	bceqz	$fcc0, .LBB4_33
.LBB4_18:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit92.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa1, $ft2, $fs1
	fmul.d	$fa3, $ft3, $fs1
	fmul.d	$fa2, $ft3, $fs7
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_35
.LBB4_19:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit99.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_37
.LBB4_20:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit112.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $fs7, $fs7
	...
	fst.d	$fa1, $s3, 0
	bceqz	$fcc1, .LBB4_39
.LBB4_21:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit119.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fneg.d	$fs4, $fs0
	fmul.d	$fa1, $fs5, $ft4
	fmul.d	$fa2, $fs5, $ft5
	...
	fsub.d	$fs7, $fa2, $fa1
	bceqz	$fcc0, .LBB4_41
.LBB4_22:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit123.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa1, $ft2, $fs5
	fmul.d	$fa3, $ft3, $fs5
	fmul.d	$fa2, $ft3, $fs0
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_43
.LBB4_23:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit130.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_45
.LBB4_24:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit143.i.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
...
# %bb.28:                               #   in Loop: Header=BB4_13 Depth=4
	...
	fst.d	$ft4, $sp, 88                   # 8-byte Folded Spill
	fst.d	$ft5, $sp, 56                   # 8-byte Folded Spill
	fst.d	$ft6, $sp, 80                   # 8-byte Folded Spill
	fst.d	$ft7, $sp, 72                   # 8-byte Folded Spill
	movcf2gr	$a0, $fcc1
	st.d	$a0, $sp, 64
	...
	fld.d	$ft7, $sp, 72                   # 8-byte Folded Reload
	fld.d	$ft6, $sp, 80                   # 8-byte Folded Reload
	fld.d	$ft5, $sp, 56                   # 8-byte Folded Reload
	fld.d	$ft4, $sp, 88                   # 8-byte Folded Reload
...
# %bb.52:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_53:                               # %_ZN7ADomainD2Ev.exit29
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end4:
...
# %bb.3:                                # %.preheader.us.preheader
	...
	b	.LBB5_5
	.p2align	4, , 16
.LBB5_4:                                # %"._Z6forallIZL13BM_FIR_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit_crit_edge.us"
...
.Lfunc_end5:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function _ZN7ADomainC2Eii
.LCPI6_0:
	.word	2                               # 0x2
	.word	3                               # 0x3
	.word	4                               # 0x4
...
# %bb.28:                               # %.lr.ph72.us.preheader
	...
	addi.d	$a5, $s0, 16
	pcalau12i	$a6, %pc_hi20(.LCPI6_0)
	vld	$vr0, $a6, %pc_lo12(.LCPI6_0)
	ori	$a6, $zero, 6
	alsl.w	$a6, $s6, $a6, 1
	ori	$a7, $zero, 9
	b	.LBB6_30
	.p2align	4, , 16
.LBB6_29:                               # %._crit_edge73.us
...
.LBB6_33:                               # %vector.body112
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB6_33
# %bb.34:                               # %middle.block119
                                        #   in Loop: Header=BB6_30 Depth=1
	move	$t3, $a4
	beq	$a3, $a2, .LBB6_29
.LBB6_35:                               # %scalar.ph104.preheader
                                        #   in Loop: Header=BB6_30 Depth=1
	alsl.d	$t1, $a0, $s0, 2
	sub.d	$t2, $s3, $t3
	add.d	$t3, $t3, $a6
	.p2align	4, , 16
.LBB6_36:                               # %scalar.ph104
                                        #   Parent Loop BB6_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t3, $t1, 0
	addi.d	$a0, $a0, 1
...
# %bb.40:                               # %.lr.ph57.us.us.preheader
	...
	b	.LBB6_42
	.p2align	4, , 16
.LBB6_41:                               # %._crit_edge58.split.us.us.us
                                        #   in Loop: Header=BB6_42 Depth=1
	addi.w	$a1, $a1, 1
	add.d	$t0, $t0, $s5
	beq	$a1, $a2, .LBB6_51
.LBB6_42:                               # %.lr.ph57.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB6_44
	.p2align	4, , 16
.LBB6_43:                               # %._crit_edge50.us.us.us
                                        #   in Loop: Header=BB6_44 Depth=2
	addi.w	$t5, $t4, 1
	add.d	$t3, $t3, $s4
	beq	$t4, $a3, .LBB6_41
.LBB6_44:                               # %.lr.ph49.us.us.us
