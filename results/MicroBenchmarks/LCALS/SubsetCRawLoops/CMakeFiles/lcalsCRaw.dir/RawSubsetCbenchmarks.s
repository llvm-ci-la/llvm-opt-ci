...
.LBB13_31:                              # %._crit_edge.us213
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_48
.LBB13_32:                              # %scalar.ph353.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_34:                              # %._crit_edge.us213.1
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_53
.LBB13_35:                              # %scalar.ph319.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_37:                              # %._crit_edge.us213.2
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_58
.LBB13_38:                              # %scalar.ph285.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_43:                              # %vector.memcheck369
	...
	ld.d	$t8, $sp, 16                    # 8-byte Folded Reload
	bnez	$a1, .LBB13_29
# %bb.44:                               # %vector.memcheck369
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_29
# %bb.45:                               # %vector.body392.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
...
.LBB13_53:                              # %vector.memcheck301
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB13_35
# %bb.54:                               # %vector.memcheck301
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_35
# %bb.55:                               # %vector.body324.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
...
# %bb.59:                               # %vector.memcheck267
	...
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_38
# %bb.60:                               # %vector.body290.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
