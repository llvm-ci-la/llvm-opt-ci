...
.Lfunc_end12:
	...
	.p2align	4, 0x0                          # -- Begin function _ZL15BM_HYDRO_2D_RAWRN9benchmark5StateE
.LCPI13_0:
	.dword	8                               # 0x8
	.dword	0                               # 0x0
...
# %bb.11:                               # %vector.memcheck526
	...
	ori	$a0, $zero, 1
	bnez	$a1, .LBB13_8
# %bb.12:                               # %vector.body612.preheader
                                        #   in Loop: Header=BB13_7 Depth=2
	addi.d	$a0, $s0, 8
	addi.d	$a4, $t3, 8
	move	$s3, $t7
...
# %bb.14:                               # %middle.block632
	...
	b	.LBB13_8
	.p2align	4, , 16
.LBB13_15:                              # %.preheader199.us.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
...
.LBB13_17:                              # %.preheader199.us
	...
	ori	$a1, $zero, 4
	bgeu	$s8, $a1, .LBB13_20
.LBB13_18:                              # %scalar.ph494.preheader
                                        #   in Loop: Header=BB13_17 Depth=2
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$t2, $a1, $a0
	slli.d	$s3, $a0, 3
...
# %bb.23:                               # %vector.memcheck403
	...
	ori	$a0, $zero, 1
	bnez	$a1, .LBB13_18
# %bb.24:                               # %vector.body499.preheader
                                        #   in Loop: Header=BB13_17 Depth=2
	move	$a0, $zero
	addi.d	$a4, $t6, 8
	addi.d	$s1, $ra, 8
...
# %bb.28:                               #   in Loop: Header=BB13_4 Depth=1
	ld.d	$s7, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
.LBB13_29:                              # %scalar.ph387.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$t8, $sp, 16                    # 8-byte Folded Reload
.LBB13_30:                              # %scalar.ph387.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	alsl.d	$a1, $a0, $a3, 3
	alsl.d	$a3, $a0, $a6, 3
	alsl.d	$a4, $a0, $a7, 3
...
.LBB13_32:                              # %._crit_edge.us213
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_49
.LBB13_33:                              # %scalar.ph353.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_35:                              # %._crit_edge.us213.1
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_54
.LBB13_36:                              # %scalar.ph319.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_38:                              # %._crit_edge.us213.2
	...
	ori	$a0, $zero, 1
	bgeu	$s8, $fp, .LBB13_59
.LBB13_39:                              # %scalar.ph285.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	alsl.d	$a4, $a0, $t2, 3
...
.LBB13_44:                              # %vector.memcheck369
	...
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
	bnez	$a1, .LBB13_29
# %bb.45:                               # %vector.memcheck369
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ld.d	$t8, $sp, 16                    # 8-byte Folded Reload
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_30
# %bb.46:                               # %vector.body392.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
...
.LBB13_49:                              # %vector.memcheck335
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB13_33
# %bb.50:                               # %vector.memcheck335
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_33
# %bb.51:                               # %vector.body358.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
...
.LBB13_54:                              # %vector.memcheck301
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB13_36
# %bb.55:                               # %vector.memcheck301
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_36
# %bb.56:                               # %vector.body324.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
...
.LBB13_59:                              # %vector.memcheck267
	...
	andi	$a1, $a1, 255
	bnez	$a1, .LBB13_39
# %bb.60:                               # %vector.memcheck267
                                        #   in Loop: Header=BB13_4 Depth=1
	sub.d	$a1, $t2, $t1
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB13_39
# %bb.61:                               # %vector.body290.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	addi.d	$a0, $a3, 8
	addi.d	$a1, $a6, 8
	addi.d	$a4, $a7, 8
