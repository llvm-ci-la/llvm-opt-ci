...
# %bb.3:                                # %.lr.ph213
	...
	b	.LBB2_5
	.p2align	4, , 16
.LBB2_4:                                # %_ZN9benchmark5State3endEv.exit
...
.LBB3_6:                                # %.lr.ph
	...
	bnez	$t3, .LBB3_6
	b	.LBB3_4
.LBB3_7:                                # %_ZN9benchmark5State3endEv.exit._crit_edge
.Ltmp7:                                 # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN9benchmark5State17FinishKeepRunningEv)
	jirl	$ra, $ra, 0
.Ltmp8:                                 # EH_LABEL
# %bb.8:                                # %_ZNK9benchmark5State13StateIteratorneERKS1_.exit
	ld.d	$a0, $sp, 80
	beqz	$a0, .LBB3_10
# %bb.9:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_10:                               # %_ZN7ADomainD2Ev.exit
...
# %bb.12:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB3_13:                               # %_ZN7ADomainD2Ev.exit142
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end3:
...
# %bb.3:                                # %.preheader350.lr.ph
	...
	b	.LBB4_5
	.p2align	4, , 16
.LBB4_4:                                # %_ZN9benchmark5State3endEv.exit
...
.LBB4_10:                               # %.lr.ph
	...
	fmov.d	$fs2, $ft5
	bceqz	$fcc1, .LBB4_22
.LBB4_11:                               #   in Loop: Header=BB4_10 Depth=4
	fmul.d	$fs5, $fs3, $fs0
	fmul.d	$fs0, $fs6, $fs0
	fmul.d	$fa1, $fs5, $fa7
	fmul.d	$fa2, $fs0, $ft0
	...
	fmov.d	$fa1, $fs3
	bceqz	$fcc2, .LBB4_24
.LBB4_12:                               #   in Loop: Header=BB4_10 Depth=4
	fadd.d	$fa2, $fs4, $fa2
	fadd.d	$fa1, $fs2, $fa1
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_26
.LBB4_13:                               #   in Loop: Header=BB4_10 Depth=4
	fmul.d	$fa2, $fa0, $ft2
	fmul.d	$fa3, $fa0, $ft3
	fsub.d	$fa2, $fa2, $fa4
	fsub.d	$fa1, $fa3, $fa1
	...
	fst.d	$fa1, $s2, 0
	bceqz	$fcc2, .LBB4_28
.LBB4_14:                               #   in Loop: Header=BB4_10 Depth=4
	fneg.d	$fa4, $fs7
	fmul.d	$fa1, $fs1, $fs6
	fmul.d	$fa2, $fs1, $fs3
	fmul.d	$fa3, $fs7, $fs3
	...
	fsub.d	$fa6, $fa2, $fa1
	bceqz	$fcc0, .LBB4_30
.LBB4_15:                               #   in Loop: Header=BB4_10 Depth=4
	fmul.d	$fa1, $ft2, $fs1
	fmul.d	$fa3, $ft3, $fs1
	fmul.d	$fa2, $ft3, $fs7
	fadd.d	$fa2, $fa1, $fa2
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_32
.LBB4_16:                               #   in Loop: Header=BB4_10 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	fmul.d	$fa5, $fa3, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_34
.LBB4_17:                               #   in Loop: Header=BB4_10 Depth=4
	fmul.d	$fa2, $fs7, $fs7
	...
	fst.d	$fa1, $s4, 0
	bceqz	$fcc1, .LBB4_36
.LBB4_18:                               #   in Loop: Header=BB4_10 Depth=4
	fneg.d	$fs4, $fs0
	fmul.d	$fa1, $fs5, $ft4
	fmul.d	$fa2, $fs5, $ft5
	fmul.d	$fa3, $fs0, $ft5
	...
	fsub.d	$fs7, $fa2, $fa1
	bceqz	$fcc0, .LBB4_38
.LBB4_19:                               #   in Loop: Header=BB4_10 Depth=4
	fmul.d	$fa1, $ft2, $fs5
	fmul.d	$fa3, $ft3, $fs5
	fmul.d	$fa2, $ft3, $fs0
	fadd.d	$fa2, $fa1, $fa2
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_40
.LBB4_20:                               #   in Loop: Header=BB4_10 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	fmul.d	$fa5, $fa3, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_42
.LBB4_21:                               #   in Loop: Header=BB4_10 Depth=4
	...
	bnez	$s8, .LBB4_10
	b	.LBB4_8
.LBB4_22:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $ft5, $ft5
	fmov.d	$fs4, $ft4
	fmov.d	$fs2, $ft5
	bcnez	$fcc0, .LBB4_11
# %bb.23:                               #   in Loop: Header=BB4_10 Depth=4
	...
	fmov.d	$fs2, $fa1
	b	.LBB4_11
.LBB4_24:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fs3, $fs3
	fmov.d	$fa2, $fs6
	fmov.d	$fa1, $fs3
	bcnez	$fcc0, .LBB4_12
# %bb.25:                               #   in Loop: Header=BB4_10 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs0
	fmov.d	$fa2, $fa7
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_12
.LBB4_26:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_13
# %bb.27:                               #   in Loop: Header=BB4_10 Depth=4
	movgr2fr.d	$fa4, $zero
	vldi	$vr1, -912
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fa4
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_13
.LBB4_28:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fs3, $fs3
	bcnez	$fcc0, .LBB4_14
# %bb.29:                               #   in Loop: Header=BB4_10 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs0
	fmov.d	$fa2, $fa7
	...
	fmov.d	$fs3, $fa1
	b	.LBB4_14
.LBB4_30:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fa6, $fa6
	bcnez	$fcc0, .LBB4_15
# %bb.31:                               #   in Loop: Header=BB4_10 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs1
	fmov.d	$fa1, $fa4
	fmov.d	$fa2, $fs6
	...
	fmov.d	$fa6, $fa1
	b	.LBB4_15
.LBB4_32:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_16
# %bb.33:                               #   in Loop: Header=BB4_10 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs1
	fmov.d	$fa1, $fa4
	fmov.d	$fa2, $ft2
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_16
.LBB4_34:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_17
# %bb.35:                               #   in Loop: Header=BB4_10 Depth=4
	movgr2fr.d	$fa4, $zero
	vldi	$vr1, -912
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fa4
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_17
.LBB4_36:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $ft5, $ft5
	bcnez	$fcc0, .LBB4_18
# %bb.37:                               #   in Loop: Header=BB4_10 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs1
	fmov.d	$fa1, $fs7
	fmov.d	$fa2, $ft6
	...
	fmov.d	$ft5, $fa1
	b	.LBB4_18
.LBB4_38:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fs7, $fs7
	bcnez	$fcc0, .LBB4_19
# %bb.39:                               #   in Loop: Header=BB4_10 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs4
	fmov.d	$fa2, $ft4
	...
	fmov.d	$fs7, $fa1
	b	.LBB4_19
.LBB4_40:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_20
# %bb.41:                               #   in Loop: Header=BB4_10 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs4
	fmov.d	$fa2, $ft2
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_20
.LBB4_42:                               #   in Loop: Header=BB4_10 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_21
# %bb.43:                               #   in Loop: Header=BB4_10 Depth=4
	movgr2fr.d	$fa4, $zero
	vldi	$vr1, -912
	fmov.d	$fs0, $fa0
	fmov.d	$fa0, $fa4
	...
	fmov.d	$fa0, $fs0
	b	.LBB4_21
.LBB4_44:                               # %_ZN9benchmark5State3endEv.exit._crit_edge
.Ltmp12:                                # EH_LABEL
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZN9benchmark5State17FinishKeepRunningEv)
	jirl	$ra, $ra, 0
.Ltmp13:                                # EH_LABEL
# %bb.45:                               # %_ZNK9benchmark5State13StateIteratorneERKS1_.exit
	ld.d	$a0, $sp, 392
	beqz	$a0, .LBB4_47
# %bb.46:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_47:                               # %_ZN7ADomainD2Ev.exit
...
# %bb.49:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_50:                               # %_ZN7ADomainD2Ev.exit239
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end4:
...
.LBB7_65:
	...
	move	$s0, $a0
	bne	$a1, $s3, .LBB7_67
# %bb.66:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i7.i
	beqz	$s5, .LBB7_69
	b	.LBB7_68
.LBB7_67:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit8.i
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	beqz	$s5, .LBB7_69
.LBB7_68:                               # %common.resume.sink.split
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB7_69:                               # %common.resume
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end7:
