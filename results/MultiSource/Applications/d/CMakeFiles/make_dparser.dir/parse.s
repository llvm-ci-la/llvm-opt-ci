...
.LBB31_22:                              #   in Loop: Header=BB31_13 Depth=1
	...
	bnez	$a0, .LBB31_12
	b	.LBB31_15
.LBB31_23:                              # %._crit_edge.i
	ld.w	$a1, $sp, 32
	ori	$a0, $zero, 1
	bne	$a1, $a0, .LBB31_25
# %bb.24:                               # %._crit_edge.thread.i
	ld.d	$a1, $sp, 40
	ld.d	$s0, $a1, 0
	bnez	$a1, .LBB31_26
	b	.LBB31_28
...
# %bb.27:
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB31_28:                              # %resolve_ambiguities.exit
	addi.d	$s0, $s0, -152
.LBB31_29:
	ld.d	$a0, $fp, 144
	ld.w	$a1, $s0, 152
...
# %bb.30:                               # %.lr.ph
	...
	b	.LBB31_33
	.p2align	4, , 16
.LBB31_31:                              # %fixup_internal_symbol.exit
...
.LBB31_46:                              #   in Loop: Header=BB31_33 Depth=1
	...
	ori	$a0, $zero, 1
	bne	$s2, $a0, .LBB31_37
.LBB31_47:                              #   in Loop: Header=BB31_33 Depth=1
	ld.d	$a0, $s3, 48
	ld.d	$a0, $a0, 0
	ld.w	$a1, $a0, 32
	ld.d	$a2, $s0, 48
...
# %bb.49:                               # %.lr.ph68.i
	...
	b	.LBB31_52
	.p2align	4, , 16
.LBB31_50:                              #   in Loop: Header=BB31_52 Depth=2
	ld.wu	$a0, $s0, 40
	st.d	$s6, $s0, 48
	addi.d	$a1, $a0, 1
	st.w	$a1, $s0, 40
...
.LBB31_51:                              #   in Loop: Header=BB31_52 Depth=2
	addi.w	$s7, $s7, -1
	beqz	$s7, .LBB31_59
.LBB31_52:                              #   Parent Loop BB31_33 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s0, 48
	beqz	$a0, .LBB31_50
...
.LBB31_56:                              #   in Loop: Header=BB31_52 Depth=2
	ori	$a2, $zero, 2
	bltu	$a2, $a1, .LBB31_58
# %bb.57:                               #   in Loop: Header=BB31_52 Depth=2
	addi.d	$a2, $a1, 1
	st.w	$a2, $s1, 0
	slli.d	$a1, $a1, 3
	stx.d	$zero, $a0, $a1
	b	.LBB31_51
	.p2align	4, , 16
.LBB31_58:                              #   in Loop: Header=BB31_52 Depth=2
	move	$a0, $s1
	move	$a1, $zero
	pcaddu18i	$ra, %call36(vec_add_internal)
	jirl	$ra, $ra, 0
...
.LBB35_96:                              # =>This Inner Loop Header: Depth=1
	...
	ld.d	$a0, $s3, 0
	bne	$a1, $a0, .LBB35_96
.LBB35_97:                              # %get_unshared_priorities.exit.i
	ld.d	$a0, $sp, 80
	ld.d	$a1, $sp, 96
	sub.d	$a1, $a1, $a0
	srli.d	$a2, $a1, 2
	...
	ori	$a3, $zero, 2
	blt	$a1, $a3, .LBB35_105
# %bb.98:                               # %.lr.ph.preheader.i.i.preheader
	addi.d	$a2, $a2, -1
	bstrpick.d	$a2, $a2, 31, 0
	addi.d	$a4, $a0, 4
	b	.LBB35_100
	.p2align	4, , 16
.LBB35_99:                              # %.loopexit.i.i
                                        #   in Loop: Header=BB35_100 Depth=1
	beqz	$t0, .LBB35_105
.LBB35_100:                             # %.lr.ph.preheader.i.i
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB35_103
	.p2align	4, , 16
.LBB35_101:                             #   in Loop: Header=BB35_103 Depth=2
	st.w	$t1, $a7, -4
	st.w	$a5, $a7, 0
	ori	$t0, $zero, 1
.LBB35_102:                             #   in Loop: Header=BB35_103 Depth=2
	...
	addi.d	$a7, $a7, 4
	beqz	$a6, .LBB35_99
.LBB35_103:                             # %.lr.ph.i48.i
                                        #   Parent Loop BB35_100 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t1, $a7, 0
	blt	$t1, $a5, .LBB35_101
...
.LBB35_105:                             # %intsort.exit.i
	...
	addi.w	$a4, $a5, 0
	blt	$a4, $a3, .LBB35_113
# %bb.106:                              # %.lr.ph.preheader.i50.i.preheader
	addi.d	$a3, $a5, -1
	bstrpick.d	$a3, $a3, 31, 0
	addi.d	$a5, $a2, 4
	b	.LBB35_108
	.p2align	4, , 16
.LBB35_107:                             # %.loopexit.i58.i
                                        #   in Loop: Header=BB35_108 Depth=1
	beqz	$t1, .LBB35_113
.LBB35_108:                             # %.lr.ph.preheader.i50.i
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB35_111
	.p2align	4, , 16
.LBB35_109:                             #   in Loop: Header=BB35_111 Depth=2
	st.w	$t2, $t0, -4
	st.w	$a6, $t0, 0
	ori	$t1, $zero, 1
.LBB35_110:                             #   in Loop: Header=BB35_111 Depth=2
	addi.d	$a7, $a7, -1
	addi.d	$t0, $t0, 4
	beqz	$a7, .LBB35_107
.LBB35_111:                             # %.lr.ph.i52.i
                                        #   Parent Loop BB35_108 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t2, $t0, 0
	blt	$t2, $a6, .LBB35_109
# %bb.112:                              #   in Loop: Header=BB35_111 Depth=2
	move	$a6, $t2
	b	.LBB35_110
.LBB35_113:                             # %intsort.exit59.i
	slt	$a3, $a1, $a4
	masknez	$a4, $a4, $a3
	maskeqz	$a1, $a1, $a3
	or	$a1, $a1, $a4
	addi.w	$fp, $zero, -1
	blez	$a1, .LBB35_118
# %bb.114:                              # %.lr.ph.preheader.i61.i
	slli.d	$a1, $a1, 2
	.p2align	4, , 16
.LBB35_115:                             # %.lr.ph.i63.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a0, 0
	ld.w	$a4, $a2, 0
	blt	$a4, $a3, .LBB35_119
...
.LBB35_130:
	ld.w	$a0, $t6, 104
	beqz	$a0, .LBB35_133
.LBB35_131:                             # %cmp_eagerness.exit.thread.i
	ld.w	$a0, $t6, 108
	beqz	$a0, .LBB35_142
.LBB35_132:
	ld.d	$a0, $s0, 104
...
# %bb.136:                              #   in Loop: Header=BB35_135 Depth=1
	ld.d	$a5, $s1, 48
	ldx.d	$a5, $a5, $a1
.LBB35_137:                             #   in Loop: Header=BB35_135 Depth=1
	beqz	$a4, .LBB35_139
# %bb.138:                              #   in Loop: Header=BB35_135 Depth=1
	...
	b	.LBB35_147
.LBB35_139:                             #   in Loop: Header=BB35_135 Depth=1
	ld.d	$a6, $s0, 200
	ld.d	$a5, $a5, 200
	bltu	$a6, $a5, .LBB35_147
.LBB35_140:                             #   in Loop: Header=BB35_135 Depth=1
	bltu	$a5, $a6, .LBB35_146
# %bb.141:                              #   in Loop: Header=BB35_135 Depth=1
	addi.d	$a1, $a1, 8
	addi.d	$a0, $a0, -1
	addi.d	$a4, $a4, -1
	addi.d	$a3, $a3, -1
...
.LBB35_148:                             # %PNode_equal.exit.thread74
	move	$s0, $s1
.LBB35_149:                             # %PNode_equal.exit.thread74
	move	$a0, $s0
...
# %bb.156:                              # %.lr.ph.i52
	...
	ld.d	$a2, $s2, 8
	addi.w	$a3, $a0, -1
.LBB35_157:                             # =>This Inner Loop Header: Depth=1
	slli.d	$a4, $a3, 3
	ldx.d	$a4, $a2, $a4
	ld.d	$a5, $a1, 0
	ld.d	$a4, $a4, 0
	...
	ld.d	$a4, $a4, 112
	bne	$a5, $a4, .LBB35_151
# %bb.158:                              #   in Loop: Header=BB35_157 Depth=1
	addi.d	$a0, $a0, -1
	addi.w	$a3, $a3, -1
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB35_157
...
# %bb.3:                                # %.lr.ph100
	...
	b	.LBB37_5
	.p2align	4, , 16
.LBB37_4:                               # %check_path_priorities_internal.exit.thread81
...
# %bb.15:                               #   in Loop: Header=BB37_5 Depth=1
	...
	ld.d	$a2, $a0, 0
	b	.LBB37_47
.LBB37_16:                              #   in Loop: Header=BB37_5 Depth=1
	slli.d	$a0, $a1, 3
	...
	beqz	$a1, .LBB37_48
# %bb.17:                               # %.preheader104.lr.ph.i
                                        #   in Loop: Header=BB37_5 Depth=1
	ld.d	$a0, $a0, 16
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	st.d	$zero, $sp, 72                  # 8-byte Folded Spill
.LBB37_18:                              # %.preheader104.i
...
.LBB37_21:                              #   Parent Loop BB37_5 Depth=1
	...
	ldx.d	$fp, $a1, $a0
	beqz	$fp, .LBB37_20
# %bb.22:                               # %.preheader102.i
                                        #   in Loop: Header=BB37_21 Depth=3
	ld.wu	$a0, $fp, 8
	st.d	$a0, $sp, 80                    # 8-byte Folded Spill
	beqz	$a0, .LBB37_20
# %bb.23:                               # %.preheader100.lr.ph.i
                                        #   in Loop: Header=BB37_21 Depth=3
	ld.d	$a0, $fp, 16
	st.d	$a0, $sp, 88                    # 8-byte Folded Spill
	move	$s2, $zero
	b	.LBB37_25
	.p2align	4, , 16
.LBB37_24:                              # %._crit_edge.i
                                        #   in Loop: Header=BB37_25 Depth=4
	addi.d	$s2, $s2, 1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	beq	$s2, $a0, .LBB37_20
.LBB37_25:                              # %.preheader100.i
                                        #   Parent Loop BB37_5 Depth=1
                                        #     Parent Loop BB37_18 Depth=2
                                        #       Parent Loop BB37_21 Depth=3
                                        # =>      This Loop Header: Depth=4
                                        #           Child Loop BB37_28 Depth 5
	slli.d	$a0, $s2, 3
...
# %bb.26:                               # %.lr.ph.i
	...
	b	.LBB37_28
	.p2align	4, , 16
.LBB37_27:                              #   in Loop: Header=BB37_28 Depth=5
	addi.d	$s5, $s5, -1
	addi.d	$s8, $s8, 8
	beqz	$s5, .LBB37_24
.LBB37_28:                              #   Parent Loop BB37_5 Depth=1
                                        #     Parent Loop BB37_18 Depth=2
                                        #       Parent Loop BB37_21 Depth=3
                                        #         Parent Loop BB37_25 Depth=4
                                        # =>        This Inner Loop Header: Depth=5
	ld.d	$a0, $s8, 0
	beqz	$a0, .LBB37_27
# %bb.29:                               #   in Loop: Header=BB37_28 Depth=5
	ld.d	$a1, $fp, 0
	ld.d	$a2, $a0, 0
	move	$a0, $s6
...
.LBB37_30:                              # %._crit_edge112.i
	...
	bne	$a1, $a0, .LBB37_18
	b	.LBB37_48
.LBB37_31:                              #   in Loop: Header=BB37_5 Depth=1
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 8
	ld.d	$s6, $a1, 0
	ld.w	$a1, $s6, 8
	beqz	$a1, .LBB37_48
# %bb.32:                               #   in Loop: Header=BB37_5 Depth=1
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	ld.w	$a3, $a2, 0
	beqz	$a3, .LBB37_52
# %bb.33:                               #   in Loop: Header=BB37_5 Depth=1
	ld.w	$a4, $s6, 12
	ld.w	$a5, $a2, 4
	bge	$a4, $a5, .LBB37_53
...
.LBB37_40:                              # %.lr.ph115.i
	...
	b	.LBB37_42
	.p2align	4, , 16
.LBB37_41:                              #   in Loop: Header=BB37_42 Depth=3
	addi.d	$s5, $s5, -1
	addi.d	$s8, $s8, 8
	beqz	$s5, .LBB37_44
...
# %bb.43:                               #   in Loop: Header=BB37_42 Depth=3
	...
	bnez	$a0, .LBB37_41
	b	.LBB37_48
.LBB37_44:                              # %._crit_edge116.thread.i
                                        #   in Loop: Header=BB37_37 Depth=2
	move	$a0, $zero
	addi.d	$a2, $fp, 1
...
.LBB37_45:                              # %._crit_edge119.i
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB37_4
.LBB37_46:                              #   in Loop: Header=BB37_5 Depth=1
	move	$a2, $zero
.LBB37_47:                              # %check_path_priorities_internal.exit
                                        #   in Loop: Header=BB37_5 Depth=1
	move	$a0, $s6
	move	$a1, $s7
	pcaddu18i	$ra, %call36(check_assoc_priority)
	...
	bnez	$a0, .LBB37_4
	.p2align	4, , 16
.LBB37_48:                              # %check_path_priorities_internal.exit.thread
                                        #   in Loop: Header=BB37_5 Depth=1
...
# %bb.50:                               # %.lr.ph98
	...
	move	$s5, $zero
	.p2align	4, , 16
.LBB37_51:                              #   Parent Loop BB37_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s2, 16
	ldx.d	$a3, $a0, $fp
	move	$a0, $s0
	...
	bltu	$s5, $a0, .LBB37_51
	b	.LBB37_4
.LBB37_52:                              #   in Loop: Header=BB37_5 Depth=1
	ori	$a1, $zero, 1
	b	.LBB37_13
.LBB37_53:                              #   in Loop: Header=BB37_5 Depth=1
	ori	$a2, $zero, 1
	blt	$a5, $a4, .LBB37_55
# %bb.54:                               #   in Loop: Header=BB37_5 Depth=1
	srli.d	$a2, $a1, 1
	bstrpick.d	$a4, $a3, 1, 1
	bstrins.d	$a2, $a4, 63, 1
	addi.d	$a2, $a2, 2
.LBB37_55:                              # %check_child.exit.i
                                        #   in Loop: Header=BB37_5 Depth=1
	andi	$a4, $a3, 20
	sltui	$a4, $a4, 1
	addi.d	$a3, $a3, -9
...
.LBB37_63:                              # %.lr.ph.i74
	...
	beqz	$a0, .LBB37_62
# %bb.64:                               # %.lr.ph.i74
                                        #   in Loop: Header=BB37_63 Depth=1
	addi.d	$a3, $a2, 16
	beq	$a0, $a3, .LBB37_62
# %bb.65:                               #   in Loop: Header=BB37_63 Depth=1
	...
	ldx.d	$a2, $a1, $s1
	b	.LBB37_62
.LBB37_66:                              # %._crit_edge.i72
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB37_69
# %bb.67:                               # %._crit_edge.i72
	addi.d	$a1, $sp, 144
	beq	$a0, $a1, .LBB37_69
# %bb.68:
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB37_69:                              # %free_paths.exit
	st.w	$zero, $sp, 128
	st.d	$zero, $sp, 136
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
	b	.LBB37_72
...
# %bb.39:                               # %.lr.ph138
	...
	lu52i.d	$s5, $a1, -274
	b	.LBB44_42
.LBB44_40:                              # %find_SNode.exit.thread.loopexit
                                        #   in Loop: Header=BB44_42 Depth=1
	ld.d	$a0, $s0, 0
	.p2align	4, , 16
.LBB44_41:                              # %find_SNode.exit.thread
                                        #   in Loop: Header=BB44_42 Depth=1
	ld.wu	$a1, $a0, 32
	addi.d	$s4, $s4, 1
	bgeu	$s4, $a1, .LBB44_28
...
.LBB44_45:                              #   in Loop: Header=BB44_46 Depth=2
	ld.d	$s3, $s3, 120
	beqz	$s3, .LBB44_41
.LBB44_46:                              #   Parent Loop BB44_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $s3, 0
	sub.d	$a5, $a5, $a4
	srai.d	$a5, $a5, 3
...
# %bb.48:                               #   in Loop: Header=BB44_46 Depth=2
	ld.d	$a5, $s3, 16
	bne	$a5, $a3, .LBB44_45
# %bb.49:                               # %find_SNode.exit.preheader
                                        #   in Loop: Header=BB44_42 Depth=1
	ld.w	$a1, $s3, 72
	beqz	$a1, .LBB44_41
# %bb.50:                               # %.lr.ph136
	...
	b	.LBB44_52
	.p2align	4, , 16
.LBB44_51:                              # %find_SNode.exit
                                        #   in Loop: Header=BB44_52 Depth=2
	ld.wu	$a0, $s3, 72
	addi.d	$s8, $s8, 1
	addi.d	$s7, $s7, 8
	bgeu	$s8, $a0, .LBB44_40
.LBB44_52:                              #   Parent Loop BB44_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s3, 80
	ldx.d	$a1, $a0, $s7
	beqz	$a1, .LBB44_51
# %bb.53:                               #   in Loop: Header=BB44_52 Depth=2
	ld.d	$a3, $s6, 8
	move	$a0, $s1
	move	$a2, $s3
	pcaddu18i	$ra, %call36(add_Reduction)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB44_51
# %bb.54:                               #   in Loop: Header=BB44_52 Depth=2
	ld.hu	$a1, $s6, 0
	st.d	$s0, $a0, 24
	st.w	$a1, $a0, 32
	b	.LBB44_51
