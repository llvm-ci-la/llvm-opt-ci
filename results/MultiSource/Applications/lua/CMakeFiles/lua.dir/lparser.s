...
.LBB2_107:                              # %vector.body287
	...
	addi.d	$a7, $a7, 8
	bnez	$t0, .LBB2_107
# %bb.108:                              # %middle.block291
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s5, $zero, 59
	beq	$a6, $a5, .LBB2_111
.LBB2_109:                              # %scalar.ph282.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_114:                              # %vector.body227
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_114
# %bb.115:                              # %middle.block231
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_118
.LBB2_116:                              # %scalar.ph222.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_117:                              # %scalar.ph222
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_141:                              # %vector.body275
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_141
# %bb.142:                              # %middle.block279
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_145
.LBB2_143:                              # %scalar.ph270.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_144:                              # %scalar.ph270
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_156:                              # %vector.body239
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_156
# %bb.157:                              # %middle.block243
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_187
.LBB2_158:                              # %scalar.ph234.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_159:                              # %scalar.ph234
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_171:                              # %vector.body263
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_171
# %bb.172:                              # %middle.block267
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_175
.LBB2_173:                              # %scalar.ph258.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_174:                              # %scalar.ph258
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_183:                              # %vector.body251
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_183
# %bb.184:                              # %middle.block255
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_187
.LBB2_185:                              # %scalar.ph246.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_186:                              # %scalar.ph246
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB18_28:                              # %vector.body67
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB18_28
# %bb.29:                               # %middle.block71
	beq	$a5, $a6, .LBB18_32
.LBB18_30:                              # %scalar.ph62.preheader
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB18_31:                              # %scalar.ph62
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	alsl.d	$a6, $a6, $a3, 4
