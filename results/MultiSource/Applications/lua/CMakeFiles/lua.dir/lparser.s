...
# %bb.13:                               #   in Loop: Header=BB2_4 Depth=1
	...
	pcaddu18i	$ra, %call36(luaX_syntaxerror)
	jirl	$ra, $ra, 0
.LBB2_14:                               # %str_checkname.exit.i30
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$s8, $fp, 24
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
	...
	ld.w	$a0, $fp, 16
	beq	$a0, $s1, .LBB2_67
# %bb.15:                               # %str_checkname.exit.i30
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 267
	beq	$a0, $a1, .LBB2_67
# %bb.16:                               # %str_checkname.exit.i30
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s0, $zero, 61
	bne	$a0, $s0, .LBB2_112
...
# %bb.52:                               #   in Loop: Header=BB2_48 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB2_48
.LBB2_53:                               # %checknext.exit86.sink.split
                                        #   in Loop: Header=BB2_48 Depth=2
	ld.d	$s2, $fp, 56
	ori	$a1, $zero, 274
	move	$a0, $fp
...
.LBB2_79:                               # %.lr.ph124
	...
	beq	$a0, $s1, .LBB2_79
	b	.LBB2_104
.LBB2_80:                               # %funcstat.exit.loopexit
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$a2, $zero
.LBB2_81:                               # %funcstat.exit
                                        #   in Loop: Header=BB2_4 Depth=1
	addi.d	$a1, $sp, 704
	move	$a0, $fp
	move	$a3, $s4
...
# %bb.95:                               #   in Loop: Header=BB2_4 Depth=1
	...
	ori	$s4, $zero, 1
	b	.LBB2_202
.LBB2_96:                               # %forlist.exit.i.loopexit
                                        #   in Loop: Header=BB2_4 Depth=1
	addi.w	$s0, $s8, -3
.LBB2_97:                               # %forlist.exit.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 267
	beq	$a0, $a1, .LBB2_99
...
.LBB2_101:                              # %.lr.ph130
	...
	addi.w	$s2, $s2, 1
	beq	$a0, $s1, .LBB2_101
.LBB2_102:                              # %explist1.exit
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 3
	addi.d	$a3, $sp, 104
	move	$a0, $fp
	move	$a2, $s2
	pcaddu18i	$ra, %call36(adjust_assign)
	jirl	$ra, $ra, 0
	ori	$a1, $zero, 3
	move	$a0, $s7
...
.LBB2_106:                              # %vector.ph296
	...
	add.d	$a7, $a3, $a7
	addi.d	$a7, $a7, 196
	bstrpick.d	$t0, $s5, 31, 2
	slli.d	$t0, $t0, 2
	ori	$s7, $zero, 19
	ori	$s2, $zero, 1
	.p2align	4, , 16
.LBB2_107:                              # %vector.body299
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t1, $a7, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$t0, .LBB2_107
# %bb.108:                              # %middle.block304
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s5, $zero, 59
	beq	$a6, $a5, .LBB2_111
.LBB2_109:                              # %scalar.ph294.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_114:                              # %vector.body229
	...
	addi.d	$a7, $a7, -8
	bnez	$t0, .LBB2_114
# %bb.115:                              # %middle.block235
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_118
.LBB2_116:                              # %scalar.ph224.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_117:                              # %scalar.ph224
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_117
.LBB2_118:                              # %._crit_edge.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_119:                              # %removevars.exit.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s8, 13
	beqz	$a0, .LBB2_121
...
.LBB2_125:                              # %vector.body215
	...
	addi.d	$a7, $a7, -8
	bnez	$t0, .LBB2_125
# %bb.126:                              # %middle.block221
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_129
.LBB2_127:                              # %scalar.ph210.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_128:                              # %scalar.ph210
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_128
.LBB2_129:                              # %._crit_edge.i.i.i49
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_130:                              # %removevars.exit.i.i43
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_132
...
.LBB2_141:                              # %vector.body285
	...
	addi.d	$a7, $a7, -8
	bnez	$t0, .LBB2_141
# %bb.142:                              # %middle.block291
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_145
.LBB2_143:                              # %scalar.ph280.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_144:                              # %scalar.ph280
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_144
.LBB2_145:                              # %._crit_edge.i.i27.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_146:                              # %removevars.exit.i22.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_148
...
.LBB2_150:                              # %fornum.exit.i
	...
	pcaddu18i	$ra, %call36(forbody)
	jirl	$ra, $ra, 0
.LBB2_151:                              #   in Loop: Header=BB2_4 Depth=1
	ori	$s2, $zero, 1
.LBB2_152:                              #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 262
	ori	$a2, $zero, 264
	move	$a0, $fp
	move	$a3, $s4
...
.LBB2_156:                              # %vector.body243
	...
	addi.d	$a7, $a7, -8
	bnez	$t0, .LBB2_156
# %bb.157:                              # %middle.block249
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_187
.LBB2_158:                              # %scalar.ph238.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_159:                              # %scalar.ph238
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_164:                              # %scalar.ph
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_164
.LBB2_165:                              # %._crit_edge.i.i81
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_166:                              # %removevars.exit.i76
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s2, 13
	beqz	$a0, .LBB2_168
...
.LBB2_171:                              # %vector.body271
	...
	addi.d	$a7, $a7, -8
	bnez	$t0, .LBB2_171
# %bb.172:                              # %middle.block277
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_175
.LBB2_173:                              # %scalar.ph266.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_174:                              # %scalar.ph266
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_174
.LBB2_175:                              # %._crit_edge.i.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_176:                              # %removevars.exit.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_178
...
.LBB2_183:                              # %vector.body257
	...
	addi.d	$a7, $a7, -8
	bnez	$t0, .LBB2_183
# %bb.184:                              # %middle.block263
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_187
.LBB2_185:                              # %scalar.ph252.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_186:                              # %scalar.ph252
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_186
.LBB2_187:                              # %._crit_edge.i.i.i38
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_188:                              # %removevars.exit.i.i33
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_190
...
.LBB2_190:                              # %forstat.exit
	...
	pcaddu18i	$ra, %call36(luaK_patchtohere)
	jirl	$ra, $ra, 0
.LBB2_191:                              # %statement.exit
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s0, $zero, 1
.LBB2_192:                              # %statement.exit
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s5, $zero, 59
	ld.w	$a0, $fp, 16
	bne	$a0, $s5, .LBB2_3
...
.LBB2_200:                              #   in Loop: Header=BB2_4 Depth=1
	...
	pcaddu18i	$ra, %call36(luaK_exp2nextreg)
	jirl	$ra, $ra, 0
.LBB2_201:                              # %retstat.exit
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a1, $s0, 74
.LBB2_202:                              # %retstat.exit
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s2, $zero, 1
	b	.LBB2_42
.LBB2_203:                              # %.critedge
...
.LBB18_12:                              # %scalar.ph
	...
	addi.d	$a1, $a1, 2
	bnez	$a3, .LBB18_12
.LBB18_13:                              # %adjustlocalvars.exit31
	move	$a0, $fp
	move	$a1, $s2
	pcaddu18i	$ra, %call36(luaK_reserveregs)
	jirl	$ra, $ra, 0
...
.LBB18_17:                              # %vector.body55
	...
	addi.d	$a7, $a7, -8
	bnez	$t1, .LBB18_17
# %bb.18:                               # %middle.block60
	beq	$a5, $a6, .LBB18_21
.LBB18_19:                              # %scalar.ph50.preheader
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB18_20:                              # %scalar.ph50
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	alsl.d	$a6, $a6, $a3, 4
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB18_20
.LBB18_21:                              # %._crit_edge.i.i40
	st.b	$a4, $a0, 74
.LBB18_22:                              # %removevars.exit.i35
	ld.bu	$a0, $s5, 13
	beqz	$a0, .LBB18_24
# %bb.23:
	ori	$a1, $zero, 35
...
.LBB18_28:                              # %vector.body68
	...
	addi.d	$a7, $a7, -8
	bnez	$t1, .LBB18_28
# %bb.29:                               # %middle.block74
	beq	$a5, $a6, .LBB18_32
.LBB18_30:                              # %scalar.ph63.preheader
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB18_31:                              # %scalar.ph63
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	alsl.d	$a6, $a6, $a3, 4
...
.Lfunc_end18:
	.size	forbody, .Lfunc_end18-forbody
                                        # -- End function
	.p2align	5                               # -- Begin function adjust_assign
