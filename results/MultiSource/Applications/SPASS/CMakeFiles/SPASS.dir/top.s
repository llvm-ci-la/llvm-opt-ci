...
.LBB0_97:                               # %vector.body808
	...
	addi.d	$a3, $a3, 4
	bnez	$a4, .LBB0_97
# %bb.98:                               # %middle.block815
                                        #   in Loop: Header=BB0_94 Depth=1
	vadd.d	$vr0, $vr1, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a1, .LBB0_101
.LBB0_99:                               # %scalar.ph803.preheader
                                        #   in Loop: Header=BB0_94 Depth=1
	sub.d	$a0, $a0, $a1
	add.d	$a1, $fp, $a1
	.p2align	4, , 16
.LBB0_100:                              # %scalar.ph803
                                        #   Parent Loop BB0_94 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $a1, 0
	add.d	$a3, $a3, $a2
...
.LBB0_117:                              # %vector.body796
	...
	addi.d	$a3, $a3, 4
	bnez	$a4, .LBB0_117
# %bb.118:                              # %middle.block802
                                        #   in Loop: Header=BB0_114 Depth=1
	vadd.d	$vr0, $vr1, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a1, .LBB0_121
.LBB0_119:                              # %scalar.ph794.preheader
                                        #   in Loop: Header=BB0_114 Depth=1
	sub.d	$a0, $a0, $a1
	add.d	$a1, $fp, $a1
	.p2align	4, , 16
.LBB0_120:                              # %scalar.ph794
                                        #   Parent Loop BB0_114 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $a1, 0
	add.d	$a3, $a3, $a2
...
.LBB0_489:                              # %list_Delete.exit481
	...
	bgeu	$a1, $a0, .LBB0_492
# %bb.490:                              # %scalar.ph786.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_491:                              # %scalar.ph786
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a3, $a0
	ldx.w	$a1, $a1, $s1
	add.d	$a2, $s2, $a0
	...
	bnez	$a0, .LBB0_491
	b	.LBB0_494
.LBB0_492:                              # %vector.body788.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_493:                              # %vector.body788
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a2, $a0
	vldx	$vr0, $a1, $s1
	vldx	$vr1, $a1, $s5
