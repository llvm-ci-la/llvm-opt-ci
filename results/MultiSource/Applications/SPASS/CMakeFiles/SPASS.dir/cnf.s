...
# %bb.41:                               # %cnf_DistributiveFormula.exit
                                        #   in Loop: Header=BB31_37 Depth=1
	beqz	$s0, .LBB31_53
# %bb.42:                               # %.lr.ph359.preheader
                                        #   in Loop: Header=BB31_37 Depth=1
	move	$s2, $s0
	b	.LBB31_45
	.p2align	4, , 16
.LBB31_43:                              #   in Loop: Header=BB31_45 Depth=2
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
	move	$s8, $a0
...
.LBB31_45:                              # %.lr.ph359
	...
	move	$a0, $fp
	.p2align	4, , 16
.LBB31_46:                              #   Parent Loop BB31_37 Depth=1
                                        #     Parent Loop BB31_45 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $a0, 0
	beqz	$a0, .LBB31_43
# %bb.47:                               #   in Loop: Header=BB31_46 Depth=3
	ld.d	$s8, $a0, 8
	ld.d	$a1, $s8, 8
	bne	$a1, $s6, .LBB31_46
...
.LBB31_50:                              # %.lr.ph.i.i
	...
	ld.d	$a1, $a0, 8
	beq	$s4, $a1, .LBB31_44
# %bb.51:                               #   in Loop: Header=BB31_50 Depth=3
	ld.d	$a0, $a0, 0
	bnez	$a0, .LBB31_50
.LBB31_52:                              # %.loopexit.i
                                        #   in Loop: Header=BB31_45 Depth=2
...
# %bb.55:                               # %.preheader.i.preheader
	...
	move	$a1, $s7
	.p2align	4, , 16
.LBB31_56:                              # %.preheader.i
                                        #   Parent Loop BB31_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $a1
	ld.d	$a1, $a1, 0
	bnez	$a1, .LBB31_56
# %bb.57:                               #   in Loop: Header=BB31_37 Depth=1
	st.d	$s0, $a0, 0
	move	$s8, $s7
	b	.LBB31_36
.LBB31_58:                              # %.preheader342
	beqz	$s8, .LBB31_161
# %bb.59:
	move	$a0, $s8
...
.LBB31_75:                              # %.lr.ph.i241
	...
	ld.d	$a2, $a1, 8
	beq	$a0, $a2, .LBB31_77
# %bb.76:                               #   in Loop: Header=BB31_75 Depth=2
	ld.d	$a1, $a1, 0
	bnez	$a1, .LBB31_75
	b	.LBB31_79
	.p2align	4, , 16
.LBB31_77:                              # %list_PointerMember.exit.preheader
                                        #   in Loop: Header=BB31_73 Depth=1
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	move	$a0, $a1
	beqz	$a1, .LBB31_79
	.p2align	4, , 16
.LBB31_78:                              # %list_PointerMember.exit
                                        #   Parent Loop BB31_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $a0, 8
	ld.w	$a2, $a1, 48
	...
	bnez	$a0, .LBB31_78
	.p2align	4, , 16
.LBB31_79:                              # %list_PointerMember.exit.thread
                                        #   in Loop: Header=BB31_73 Depth=1
	ld.w	$a0, $s4, 36
	beqz	$a0, .LBB31_124
# %bb.80:                               #   in Loop: Header=BB31_73 Depth=1
	ld.d	$fp, $s2, 8
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(list_Copy)
	jirl	$ra, $ra, 0
...
.LBB31_83:                              # %vector.body426
	...
	addi.d	$a3, $a3, 4
	bnez	$a4, .LBB31_83
# %bb.84:                               # %middle.block432
                                        #   in Loop: Header=BB31_73 Depth=1
	vadd.d	$vr0, $vr1, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a1, .LBB31_87
.LBB31_85:                              # %scalar.ph424.preheader
                                        #   in Loop: Header=BB31_73 Depth=1
	sub.d	$a0, $a0, $a1
	add.d	$a1, $fp, $a1
	.p2align	4, , 16
.LBB31_86:                              # %scalar.ph424
                                        #   Parent Loop BB31_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $a1, 0
	add.d	$a3, $a3, $a2
...
.LBB31_87:                              # %hsh_StringHashKey.exit.i
	...
	move	$s8, $s6
	.p2align	4, , 16
.LBB31_88:                              #   Parent Loop BB31_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s8, $s8, 0
	beqz	$s8, .LBB31_95
# %bb.89:                               #   in Loop: Header=BB31_88 Depth=2
	ld.d	$s4, $s8, 8
	ld.d	$a0, $s4, 8
	move	$a1, $fp
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB31_88
# %bb.90:                               #   in Loop: Header=BB31_73 Depth=1
	ld.d	$a0, $s4, 0
	beqz	$a0, .LBB31_96
# %bb.91:                               #   in Loop: Header=BB31_73 Depth=1
	ld.d	$a3, $sp, 80                    # 8-byte Folded Reload
	beqz	$a3, .LBB31_97
# %bb.92:                               # %.preheader.i.i.preheader
                                        #   in Loop: Header=BB31_73 Depth=1
	move	$a2, $a0
	.p2align	4, , 16
.LBB31_93:                              # %.preheader.i.i
                                        #   Parent Loop BB31_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB31_93
# %bb.94:                               #   in Loop: Header=BB31_73 Depth=1
	st.d	$a3, $a1, 0
	b	.LBB31_97
	.p2align	4, , 16
.LBB31_95:                              #   in Loop: Header=BB31_73 Depth=1
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
	move	$s4, $a0
...
# %bb.100:                              #   in Loop: Header=BB31_73 Depth=1
	...
	b	.LBB31_72
	.p2align	4, , 16
.LBB31_101:                             #   in Loop: Header=BB31_103 Depth=2
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
	move	$s2, $a0
...
.LBB31_103:                             # %.lr.ph379
	...
	move	$a1, $s8
	.p2align	4, , 16
.LBB31_104:                             #   Parent Loop BB31_73 Depth=1
                                        #     Parent Loop BB31_103 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a1, $a1, 0
	beqz	$a1, .LBB31_112
# %bb.105:                              #   in Loop: Header=BB31_104 Depth=3
	ld.d	$a0, $a1, 8
	ld.d	$a2, $a0, 8
	bne	$a2, $s6, .LBB31_104
# %bb.106:                              #   in Loop: Header=BB31_103 Depth=2
	ld.d	$a1, $a0, 0
	beqz	$a1, .LBB31_113
# %bb.107:                              #   in Loop: Header=BB31_103 Depth=2
	beqz	$fp, .LBB31_111
# %bb.108:                              # %.preheader.i.i257.preheader
                                        #   in Loop: Header=BB31_103 Depth=2
	move	$a3, $a1
	.p2align	4, , 16
.LBB31_109:                             # %.preheader.i.i257
                                        #   Parent Loop BB31_73 Depth=1
                                        #     Parent Loop BB31_103 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a2, $a3
	ld.d	$a3, $a3, 0
	bnez	$a3, .LBB31_109
# %bb.110:                              #   in Loop: Header=BB31_103 Depth=2
	st.d	$fp, $a2, 0
.LBB31_111:                             # %list_Nconc.exit.i261
                                        #   in Loop: Header=BB31_103 Depth=2
	st.d	$a1, $a0, 0
	b	.LBB31_114
	.p2align	4, , 16
.LBB31_112:                             #   in Loop: Header=BB31_103 Depth=2
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
	move	$s2, $a0
...
.LBB31_114:                             # %hsh_PutList.exit
	...
	move	$a1, $s8
	.p2align	4, , 16
.LBB31_115:                             #   Parent Loop BB31_73 Depth=1
                                        #     Parent Loop BB31_103 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a1, $a1, 0
	beqz	$a1, .LBB31_101
# %bb.116:                              #   in Loop: Header=BB31_115 Depth=3
	ld.d	$a0, $a1, 8
	ld.d	$a2, $a0, 8
	bne	$a2, $s6, .LBB31_115
# %bb.117:                              #   in Loop: Header=BB31_103 Depth=2
	ld.d	$a1, $a0, 0
	beqz	$a1, .LBB31_123
# %bb.118:                              #   in Loop: Header=BB31_103 Depth=2
	beqz	$fp, .LBB31_122
# %bb.119:                              # %.preheader.i.i271.preheader
                                        #   in Loop: Header=BB31_103 Depth=2
	move	$a3, $a1
	.p2align	4, , 16
.LBB31_120:                             # %.preheader.i.i271
                                        #   Parent Loop BB31_73 Depth=1
                                        #     Parent Loop BB31_103 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a2, $a3
	ld.d	$a3, $a3, 0
	bnez	$a3, .LBB31_120
# %bb.121:                              #   in Loop: Header=BB31_103 Depth=2
	st.d	$fp, $a2, 0
.LBB31_122:                             # %list_Nconc.exit.i275
                                        #   in Loop: Header=BB31_103 Depth=2
	st.d	$a1, $a0, 0
	b	.LBB31_102
...
.LBB31_124:                             # %.loopexit
	...
	ld.d	$a1, $a0, 0
	beqz	$a1, .LBB31_129
# %bb.125:                              #   in Loop: Header=BB31_73 Depth=1
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	beqz	$a3, .LBB31_130
# %bb.126:                              # %.preheader.i280.preheader
                                        #   in Loop: Header=BB31_73 Depth=1
	move	$a2, $a1
	.p2align	4, , 16
.LBB31_127:                             # %.preheader.i280
                                        #   Parent Loop BB31_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB31_127
# %bb.128:                              #   in Loop: Header=BB31_73 Depth=1
	st.d	$a3, $a0, 0
	b	.LBB31_130
	.p2align	4, , 16
.LBB31_129:                             #   in Loop: Header=BB31_73 Depth=1
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
.LBB31_130:                             # %list_Nconc.exit285thread-pre-split
                                        #   in Loop: Header=BB31_73 Depth=1
	ld.d	$a0, $sp, 248
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	st.d	$a1, $a2, 0
...
.LBB31_134:                             # %scalar.ph436
	...
	bnez	$a0, .LBB31_134
	b	.LBB31_137
.LBB31_135:                             # %vector.body438.preheader
	ori	$a0, $a3, 384
	ori	$a1, $a2, 3712
	ori	$a2, $a2, 3728
	ld.d	$s5, $sp, 72                    # 8-byte Folded Reload
...
.LBB31_136:                             # %vector.body438
	...
	vstx	$vr1, $a3, $a2
	bnez	$a0, .LBB31_136
.LBB31_137:                             # %symbol_TransferPrecedence.exit295
	beqz	$a6, .LBB31_140
# %bb.138:                              # %.lr.ph.i297.preheader
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
	ld.d	$a0, $a0, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a1, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a1, $a1, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB31_139:                             # %.lr.ph.i297
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 128
	ld.w	$a3, $a2, 32
	ld.d	$a4, $a1, 0
...
# %bb.143:
	...
	ld.d	$a0, $a0, 0
	beqz	$a0, .LBB31_146
# %bb.144:                              # %.lr.ph.i303.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB31_145:                             # %.lr.ph.i303
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
	...
	move	$a0, $a6
	bnez	$a6, .LBB31_145
.LBB31_146:                             # %list_Delete.exit307
	st.d	$zero, $s7, 0
	beqz	$s6, .LBB31_151
# %bb.147:                              # %.lr.ph385.preheader
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
	ld.d	$fp, $a0, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a0, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$s0, $a0, %got_pc_lo12(memory_FREEDBYTES)
...
.LBB31_148:                             # %.lr.ph385
	...
	ld.d	$s1, $s1, 0
	bnez	$s1, .LBB31_148
# %bb.149:                              # %.lr.ph.i309.preheader
	ld.d	$s4, $sp, 104                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB31_150:                             # %.lr.ph.i309
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 128
	ld.w	$a1, $a0, 32
	ld.d	$a2, $s0, 0
	...
	move	$s6, $a3
	bnez	$a3, .LBB31_150
.LBB31_151:                             # %list_Delete.exit313
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB31_154
# %bb.152:                              # %.lr.ph.i315.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB31_153:                             # %.lr.ph.i315
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
	...
	move	$a0, $a6
	bnez	$a6, .LBB31_153
.LBB31_154:                             # %list_Delete.exit319
	ld.d	$a0, $sp, 256
	beqz	$a0, .LBB31_157
# %bb.155:                              # %.lr.ph.i321.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB31_156:                             # %.lr.ph.i321
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
...
.LBB54_3:                               # =>This Loop Header: Depth=1
                                        ...
                                        #     Child Loop BB54_197 Depth 2
                                        #       Child Loop BB54_200 Depth 3
                                        #         Child Loop BB54_203 Depth 4
                                        #       Child Loop BB54_208 Depth 3
                                        #         Child Loop BB54_211 Depth 4
                                        #     Child Loop BB54_215 Depth 2
                                        #       Child Loop BB54_220 Depth 3
                                        #       Child Loop BB54_222 Depth 3
                                        #       Child Loop BB54_224 Depth 3
                                        #       Child Loop BB54_227 Depth 3
                                        ...
                                        #       Child Loop BB54_148 Depth 3
                                        #       Child Loop BB54_152 Depth 3
                                        #       Child Loop BB54_158 Depth 3
                                        #         Child Loop BB54_160 Depth 4
                                        #           Child Loop BB54_162 Depth 5
                                        #           Child Loop BB54_166 Depth 5
                                        #       Child Loop BB54_168 Depth 3
                                        #     Child Loop BB54_170 Depth 2
                                        #     Child Loop BB54_172 Depth 2
                                        #     Child Loop BB54_174 Depth 2
...
.LBB54_148:                             # %.lr.ph408
	...
	sub.w	$a0, $a0, $s2
	move	$s0, $s4
	bltu	$fp, $a0, .LBB54_148
.LBB54_149:                             # %._crit_edge409
                                        #   in Loop: Header=BB54_139 Depth=2
	move	$a0, $s1
	pcaddu18i	$ra, %call36(list_Length)
	jirl	$ra, $ra, 0
	...
	st.d	$fp, $sp, 112                   # 8-byte Folded Spill
	beqz	$s2, .LBB54_154
# %bb.150:                              #   in Loop: Header=BB54_139 Depth=2
	beqz	$a0, .LBB54_155
# %bb.151:                              # %.preheader.i238.preheader
                                        #   in Loop: Header=BB54_139 Depth=2
	move	$a2, $s2
	.p2align	4, , 16
.LBB54_152:                             # %.preheader.i238
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_139 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a1, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB54_152
# %bb.153:                              #   in Loop: Header=BB54_139 Depth=2
	st.d	$a0, $a1, 0
	b	.LBB54_155
	.p2align	4, , 16
.LBB54_154:                             #   in Loop: Header=BB54_139 Depth=2
	move	$s2, $a0
.LBB54_155:                             # %list_Nconc.exit
                                        #   in Loop: Header=BB54_139 Depth=2
	pcalau12i	$a0, %got_pc_hi20(vec_MAX)
...
# %bb.156:                              # %.lr.ph40.preheader.i
	...
	b	.LBB54_158
	.p2align	4, , 16
.LBB54_157:                             # %._crit_edge.i230
                                        #   in Loop: Header=BB54_158 Depth=3
	ld.d	$s4, $s4, 0
	beqz	$s4, .LBB54_167
.LBB54_158:                             # %.lr.ph.preheader.i
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_139 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB54_160 Depth 4
	...
	b	.LBB54_160
	.p2align	4, , 16
.LBB54_159:                             # %.loopexit.i
                                        #   in Loop: Header=BB54_160 Depth=4
	beq	$s0, $a1, .LBB54_157
.LBB54_160:                             # %.lr.ph.i226
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_139 Depth=2
                                        #       Parent Loop BB54_158 Depth=3
	...
	ld.w	$a0, $s5, 0
	bne	$a0, $s8, .LBB54_164
# %bb.161:                              #   in Loop: Header=BB54_160 Depth=4
	ld.d	$a0, $s5, 16
	st.w	$s1, $s5, 0
	beqz	$a0, .LBB54_163
	.p2align	4, , 16
.LBB54_162:                             # %.lr.ph.i.i232
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_139 Depth=2
                                        #       Parent Loop BB54_158 Depth=3
                                        #         Parent Loop BB54_160 Depth=4
	...
	move	$a0, $a4
	bnez	$a4, .LBB54_162
.LBB54_163:                             # %list_Delete.exit.i236
                                        #   in Loop: Header=BB54_160 Depth=4
	pcalau12i	$a0, %got_pc_hi20(term_Copy)
	ld.d	$a1, $a0, %got_pc_lo12(term_Copy)
	move	$a0, $s2
	...
	b	.LBB54_159
	.p2align	4, , 16
.LBB54_164:                             # %.lr.ph._crit_edge.i
                                        #   in Loop: Header=BB54_160 Depth=4
	ld.d	$a0, $s5, 16
	beqz	$a0, .LBB54_159
.LBB54_165:                             # %.preheader.i
                                        #   in Loop: Header=BB54_160 Depth=4
	alsl.d	$a2, $a1, $fp, 3
	.p2align	4, , 16
.LBB54_166:                             #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_139 Depth=2
                                        #       Parent Loop BB54_158 Depth=3
                                        #         Parent Loop BB54_160 Depth=4
                                        # =>        This Inner Loop Header: Depth=5
	...
	b	.LBB54_159
	.p2align	4, , 16
.LBB54_167:                             # %cnf_SkolemFunctionFormulaMapped.exit
                                        #   in Loop: Header=BB54_139 Depth=2
	st.w	$s0, $s7, 0
	beqz	$s2, .LBB54_138
	.p2align	4, , 16
.LBB54_168:                             # %.lr.ph.i220
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_139 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $s3, 128
...
.LBB54_170:                             # %.lr.ph423
	...
	move	$s5, $a3
	bnez	$a3, .LBB54_170
.LBB54_171:                             # %._crit_edge424
                                        #   in Loop: Header=BB54_3 Depth=1
	ld.d	$a4, $sp, 136                   # 8-byte Folded Reload
	beqz	$a4, .LBB54_173
	.p2align	4, , 16
.LBB54_172:                             # %.lr.ph.i212
                                        #   Parent Loop BB54_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s3, 128
	ld.w	$a1, $a0, 32
...
# %bb.185:                              #   in Loop: Header=BB54_3 Depth=1
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB54_186:                             # %cnf_HaveProofOptSkolem.exit.thread
                                        #   in Loop: Header=BB54_3 Depth=1
	ld.w	$a0, $s4, 132
	beqz	$a0, .LBB54_188
# %bb.187:                              #   in Loop: Header=BB54_3 Depth=1
	...
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB54_188:                             # %cnf_HaveProofOptSkolem.exit.thread.thread
                                        #   in Loop: Header=BB54_3 Depth=1
	ld.d	$a0, $fp, 16
	ld.d	$a0, $a0, 0
	ld.d	$s0, $a0, 8
	...
	jirl	$ra, $ra, 0
	ori	$a1, $zero, 1
	bltu	$a1, $a0, .LBB54_192
# %bb.189:                              #   in Loop: Header=BB54_3 Depth=1
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 16
	ld.d	$a0, $a1, 8
	.p2align	4, , 16
.LBB54_190:                             # %.lr.ph.i.i174
                                        #   Parent Loop BB54_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $s3, 128
	ld.w	$a3, $a2, 32
...
# %bb.195:                              #   in Loop: Header=BB54_3 Depth=1
	...
	b	.LBB54_215
	.p2align	4, , 16
.LBB54_196:                             # %cnf_RplacVarsymbFunction.exit75.i
                                        #   in Loop: Header=BB54_197 Depth=2
	st.w	$s8, $s1, 0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(term_Delete)
	jirl	$ra, $ra, 0
...
.LBB54_197:                             # %.lr.ph.i164
	...
	b	.LBB54_200
	.p2align	4, , 16
.LBB54_198:                             #   in Loop: Header=BB54_200 Depth=3
	ld.w	$a0, $fp, 0
	st.w	$a0, $s5, 0
	ld.d	$a0, $fp, 16
	pcalau12i	$a1, %got_pc_hi20(term_Copy)
	...
	ld.w	$a2, $s1, 0
	st.d	$a0, $s5, 16
.LBB54_199:                             # %.loopexit.i.i166
                                        #   in Loop: Header=BB54_200 Depth=3
	move	$a0, $a2
	beq	$s8, $a2, .LBB54_205
.LBB54_200:                             #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_197 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB54_203 Depth 4
	addi.w	$a2, $a0, -1
	slli.d	$a1, $a2, 3
	...
	ld.w	$a1, $s5, 0
	beq	$a1, $s0, .LBB54_198
# %bb.201:                              #   in Loop: Header=BB54_200 Depth=3
	ld.d	$a1, $s5, 16
	beqz	$a1, .LBB54_199
# %bb.202:                              # %.preheader.i.i165.preheader
                                        #   in Loop: Header=BB54_200 Depth=3
	alsl.d	$a2, $a0, $s2, 3
	addi.d	$a2, $a2, -8
	.p2align	4, , 16
.LBB54_203:                             # %.preheader.i.i165
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_197 Depth=2
                                        #       Parent Loop BB54_200 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ld.d	$a3, $a1, 8
	st.w	$a0, $s1, 0
	st.d	$a3, $a2, 0
	...
	addi.d	$a0, $a0, 1
	bnez	$a1, .LBB54_203
# %bb.204:                              # %.loopexit.i.i166.loopexit
                                        #   in Loop: Header=BB54_200 Depth=3
	addi.w	$a2, $a0, -1
	b	.LBB54_199
	.p2align	4, , 16
.LBB54_205:                             # %cnf_RplacVarsymbFunction.exit.i
                                        #   in Loop: Header=BB54_197 Depth=2
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	...
	b	.LBB54_208
	.p2align	4, , 16
.LBB54_206:                             #   in Loop: Header=BB54_208 Depth=3
	ld.w	$a0, $fp, 0
	st.w	$a0, $s5, 0
	ld.d	$a0, $fp, 16
	pcalau12i	$a1, %got_pc_hi20(term_Copy)
	...
	ld.w	$a1, $s1, 0
	st.d	$a0, $s5, 16
.LBB54_207:                             # %.loopexit.i70.i
                                        #   in Loop: Header=BB54_208 Depth=3
	move	$s7, $a1
	beq	$s8, $a1, .LBB54_196
.LBB54_208:                             #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_197 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB54_211 Depth 4
	addi.w	$a1, $s7, -1
	...
	ld.w	$a0, $s5, 0
	beq	$a0, $s0, .LBB54_206
# %bb.209:                              #   in Loop: Header=BB54_208 Depth=3
	ld.d	$a0, $s5, 16
	beqz	$a0, .LBB54_207
# %bb.210:                              # %.preheader.i63.i.preheader
                                        #   in Loop: Header=BB54_208 Depth=3
	alsl.d	$a1, $s7, $s2, 3
	addi.d	$a1, $a1, -8
	.p2align	4, , 16
.LBB54_211:                             # %.preheader.i63.i
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_197 Depth=2
                                        #       Parent Loop BB54_208 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ld.d	$a2, $a0, 8
	st.w	$s7, $s1, 0
	st.d	$a2, $a1, 0
	...
	addi.d	$s7, $s7, 1
	bnez	$a0, .LBB54_211
# %bb.212:                              # %.loopexit.i70.i.loopexit
                                        #   in Loop: Header=BB54_208 Depth=3
	addi.w	$a1, $s7, -1
	b	.LBB54_207
	.p2align	4, , 16
.LBB54_213:                             #   in Loop: Header=BB54_215 Depth=2
	ld.d	$s7, $sp, 208                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 176                   # 8-byte Folded Reload
.LBB54_214:                             # %.loopexit.i80.i
                                        #   in Loop: Header=BB54_215 Depth=2
	beq	$s5, $a0, .LBB54_230
.LBB54_215:                             # %.lr.ph64.i.i
                                        #   Parent Loop BB54_3 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB54_220 Depth 3
                                        #       Child Loop BB54_222 Depth 3
...
# %bb.216:                              # %.lr.ph64.i.i
	...
	ld.w	$a0, $a0, 0
	bne	$a0, $a1, .LBB54_225
.LBB54_217:                             #   in Loop: Header=BB54_215 Depth=2
	ld.d	$a0, $s7, 16
	ld.d	$a0, $a0, 8
	ld.d	$a0, $a0, 16
	move	$fp, $a1
	pcaddu18i	$ra, %call36(list_Length)
	jirl	$ra, $ra, 0
	bltu	$a0, $s1, .LBB54_225
# %bb.218:                              #   in Loop: Header=BB54_215 Depth=2
	ld.d	$a0, $s7, 16
	ld.d	$a0, $a0, 8
	ld.d	$a0, $a0, 16
	ld.d	$a0, $a0, 0
...
# %bb.219:                              # %.lr.ph.i82.i.preheader
	...
	.p2align	4, , 16
.LBB54_220:                             # %.lr.ph.i82.i
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_215 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $s7, 16
	ld.d	$a0, $a0, 0
	ld.d	$s8, $a0, 8
	...
	ld.d	$s5, $s5, 0
	bnez	$s5, .LBB54_220
# %bb.221:                              # %.lr.ph60.i.i.preheader
                                        #   in Loop: Header=BB54_215 Depth=2
	move	$s0, $fp
	.p2align	4, , 16
.LBB54_222:                             # %.lr.ph60.i.i
                                        #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_215 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $s7, 16
	...
	ld.d	$s0, $s0, 0
	bnez	$s0, .LBB54_222
# %bb.223:                              # %.lr.ph.i.i.i172.preheader
                                        #   in Loop: Header=BB54_215 Depth=2
	ld.d	$s8, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 80                    # 8-byte Folded Reload
	ori	$s1, $zero, 2
...
.LBB54_224:                             # %.lr.ph.i.i.i172
	...
	bnez	$a3, .LBB54_224
	.p2align	4, , 16
.LBB54_225:                             # %list_Delete.exit.i.i
                                        #   in Loop: Header=BB54_215 Depth=2
	ld.d	$a1, $s7, 16
	ld.w	$a0, $s2, 0
	beqz	$a1, .LBB54_213
# %bb.226:                              # %.preheader.i77.i
                                        #   in Loop: Header=BB54_215 Depth=2
	ld.d	$a2, $sp, 240                   # 8-byte Folded Reload
	alsl.d	$a2, $a0, $a2, 3
	ld.d	$s7, $sp, 208                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 176                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB54_227:                             #   Parent Loop BB54_3 Depth=1
                                        #     Parent Loop BB54_215 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a3, $a1, 8
	addi.w	$a0, $a0, 1
	...
	bnez	$a1, .LBB54_227
	b	.LBB54_214
.LBB54_228:                             #   in Loop: Header=BB54_3 Depth=1
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s8, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 208                   # 8-byte Folded Reload
...
.LBB54_229:                             #   in Loop: Header=BB54_3 Depth=1
	...
	ld.d	$fp, $sp, 176                   # 8-byte Folded Reload
	b	.LBB54_231
.LBB54_230:                             # %cnf_QuantMakeOneVar.exit.i
                                        #   in Loop: Header=BB54_3 Depth=1
	st.w	$s5, $s2, 0
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
...
.LBB54_232:                             # %.lr.ph.i85.i
	...
	move	$a0, $a4
	bnez	$a4, .LBB54_232
.LBB54_233:                             # %cnf_MoveProvedTermToTopLevel.exit
                                        #   in Loop: Header=BB54_3 Depth=1
	...
	ld.w	$a0, $s4, 132
	beqz	$a0, .LBB54_235
# %bb.234:                              #   in Loop: Header=BB54_3 Depth=1
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$fp, $a0, %got_pc_lo12(stdout)
	ld.d	$a3, $fp, 0
...
.LBB54_236:
	ld.d	$s4, $sp, 120                   # 8-byte Folded Reload
.LBB54_237:                             # %tailrecurse.outer._crit_edge
	pcalau12i	$a0, %got_pc_hi20(fol_AND)
	ld.d	$a0, $a0, %got_pc_lo12(fol_AND)
	ld.w	$a1, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(fol_OR)
	...
	beq	$a4, $a1, .LBB54_239
# %bb.238:                              # %tailrecurse.outer._crit_edge
	bne	$a4, $a0, .LBB54_242
.LBB54_239:
	ld.d	$s0, $fp, 16
	beqz	$s0, .LBB54_242
# %bb.240:                              # %.lr.ph442.preheader
	xor	$a0, $a4, $a0
	sltui	$a0, $a0, 1
...
.L.str.3:
	.asciz	"/home/date/work/actions-runner/_work/llvm-opt-ci/llvm-opt-ci/repos/llvm-test-suite/MultiSource/Applications/SPASS/cnf.c"
	.size	.L.str.3, 120
