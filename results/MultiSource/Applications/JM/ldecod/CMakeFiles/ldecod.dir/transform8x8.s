...
.LBB0_45:
	...
	slli.d	$a6, $a0, 5
	vld	$vr0, $sp, 416
	pcalau12i	$t5, %pc_hi20(.LCPI0_18)
	vld	$vr1, $t5, %pc_lo12(.LCPI0_18)
	vld	$vr2, $sp, 384
	add.d	$a6, $t2, $a6
	stx.h	$t1, $a6, $a3
	alsl.d	$t1, $t4, $t3, 1
	...
	slli.d	$s3, $a0, 5
	add.d	$s3, $t2, $s3
	pcalau12i	$t2, %pc_hi20(.LCPI0_19)
	vld	$vr3, $t2, %pc_lo12(.LCPI0_19)
	vpickve2gr.w	$t2, $vr1, 1
	add.d	$t7, $t7, $t2
	alsl.d	$a0, $s8, $a7, 1
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
	addi.d	$t7, $t7, 2
	bstrpick.d	$s4, $t7, 19, 2
	stx.h	$s4, $a4, $s2
	alsl.d	$t7, $ra, $a2, 1
	addi.d	$fp, $fp, 2
	bstrpick.d	$fp, $fp, 19, 2
	stx.h	$fp, $a4, $s1
	alsl.d	$t5, $s5, $a6, 1
	stx.h	$s4, $t0, $s1
	alsl.d	$s1, $s7, $t1, 1
...
.LBB0_54:
	...
	vld	$vr1, $sp, 386
	ld.h	$t2, $sp, 402
	pcalau12i	$t3, %pc_hi20(.LCPI0_14)
	vld	$vr2, $t3, %pc_lo12(.LCPI0_14)
	alsl.d	$t3, $fp, $a4, 1
	vinsgr2vr.h	$vr3, $t2, 0
	vori.b	$vr4, $vr1, 0
	vextrins.h	$vr4, $vr1, 18
	vextrins.h	$vr4, $vr1, 35
	vextrins.h	$vr4, $vr1, 52
	vextrins.h	$vr4, $vr1, 69
	vextrins.h	$vr4, $vr1, 86
	vextrins.h	$vr4, $vr1, 103
	...
	pcalau12i	$t3, %pc_hi20(.LCPI0_20)
	vld	$vr3, $t3, %pc_lo12(.LCPI0_20)
	pcalau12i	$t3, %pc_hi20(.LCPI0_21)
	vld	$vr5, $t3, %pc_lo12(.LCPI0_21)
	pcalau12i	$t3, %pc_hi20(.LCPI0_22)
	vld	$vr7, $t3, %pc_lo12(.LCPI0_22)
	pcalau12i	$t3, %pc_hi20(.LCPI0_23)
	vld	$vr8, $t3, %pc_lo12(.LCPI0_23)
	pcalau12i	$t3, %pc_hi20(.LCPI0_24)
	vld	$vr9, $t3, %pc_lo12(.LCPI0_24)
	vpickve2gr.w	$t3, $vr2, 3
	slli.d	$t3, $t3, 1
	vpackev.w	$vr4, $vr2, $vr4
	vinsgr2vr.w	$vr4, $t3, 2
	pcalau12i	$t3, %pc_hi20(.LCPI0_25)
	vld	$vr10, $t3, %pc_lo12(.LCPI0_25)
	vpickve2gr.w	$t3, $vr6, 2
	addi.d	$t3, $t3, 2
	vshuf4i.w	$vr11, $vr6, 57
	vsll.w	$vr11, $vr11, $vr7
	vadd.w	$vr7, $vr6, $vr7
	...
	pcalau12i	$t3, %pc_hi20(.LCPI0_26)
	vld	$vr5, $t3, %pc_lo12(.LCPI0_26)
	or	$t3, $t2, $t0
	xor	$t2, $t2, $t0
	srli.d	$t2, $t2, 1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	...
	vshuf4i.w	$vr2, $vr2, 8
	vslli.w	$vr2, $vr2, 1
	vshuf.w	$vr8, $vr3, $vr11
	vaddi.wu	$vr3, $vr6, 2
	vshuf.w	$vr10, $vr11, $vr4
	vshuf4i.d	$vr7, $vr3, 6
	vadd.w	$vr3, $vr8, $vr10
	vadd.w	$vr4, $vr9, $vr7
	vshuf.w	$vr5, $vr1, $vr6
	vpackev.d	$vr1, $vr6, $vr2
...
.LBB0_62:
	...
	vld	$vr0, $sp, 384
	alsl.d	$t5, $s8, $a7, 1
	pcalau12i	$t6, %pc_hi20(.LCPI0_14)
	vld	$vr1, $t6, %pc_lo12(.LCPI0_14)
	ld.h	$t6, $sp, 400
	vori.b	$vr3, $vr0, 0
	vextrins.h	$vr3, $vr0, 18
	vextrins.h	$vr3, $vr0, 35
	vextrins.h	$vr3, $vr0, 52
	vextrins.h	$vr3, $vr0, 69
	vextrins.h	$vr3, $vr0, 86
	vextrins.h	$vr3, $vr0, 103
	...
	slli.d	$a0, $a0, 5
	add.d	$a0, $a4, $a0
	pcalau12i	$a4, %pc_hi20(.LCPI0_15)
	vld	$vr4, $a4, %pc_lo12(.LCPI0_15)
	pcalau12i	$a4, %pc_hi20(.LCPI0_16)
	vld	$vr6, $a4, %pc_lo12(.LCPI0_16)
	pcalau12i	$a4, %pc_hi20(.LCPI0_17)
	vld	$vr7, $a4, %pc_lo12(.LCPI0_17)
	vilvl.h	$vr1, $vr5, $vr1
	vilvh.h	$vr0, $vr5, $vr0
	vilvl.h	$vr2, $vr5, $vr2
	vshuf.w	$vr4, $vr1, $vr3
...
.LBB0_67:
	...
	vld	$vr4, $a7, %pc_lo12(.LCPI0_5)
	pcalau12i	$a7, %pc_hi20(.LCPI0_6)
	vld	$vr6, $a7, %pc_lo12(.LCPI0_6)
	pcalau12i	$a7, %pc_hi20(.LCPI0_7)
	vld	$vr5, $a7, %pc_lo12(.LCPI0_7)
	vshuf.h	$vr4, $vr1, $vr3
	vshuf.h	$vr6, $vr2, $vr3
	vilvl.h	$vr7, $vr1, $vr6
	vshuf.h	$vr5, $vr1, $vr3
	...
	vld	$vr2, $a7, %pc_lo12(.LCPI0_9)
	pcalau12i	$a7, %pc_hi20(.LCPI0_12)
	vld	$vr6, $a7, %pc_lo12(.LCPI0_12)
	...
	vshuf.w	$vr8, $vr9, $vr6
	vshuf4i.w	$vr9, $vr4, 80
	vshuf4i.w	$vr4, $vr4, 250
	vadd.w	$vr5, $vr5, $vr8
	vadd.w	$vr4, $vr7, $vr4
	vadd.w	$vr5, $vr5, $vr9
	stx.h	$a0, $a2, $a1
	...
	vsrl.w	$vr4, $vr4, $vr11
	vsrl.w	$vr5, $vr5, $vr11
	vpickev.h	$vr10, $vr4, $vr5
	vstx	$vr10, $t7, $t5
	alsl.d	$a0, $s6, $a5, 1
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	vilvl.h	$vr10, $vr1, $vr0
	vilvh.h	$vr11, $vr1, $vr0
	vshuf.h	$vr7, $vr1, $vr0
	vbsll.v	$vr0, $vr7, 4
	vbsrl.v	$vr1, $vr3, 12
	vor.v	$vr0, $vr0, $vr1
	vslli.w	$vr0, $vr0, 1
	vshuf.w	$vr8, $vr11, $vr7
	vslli.w	$vr1, $vr8, 1
	vadd.w	$vr1, $vr7, $vr1
	vpackev.d	$vr0, $vr0, $vr6
	vadd.w	$vr1, $vr1, $vr11
	vadd.w	$vr0, $vr2, $vr0
	vaddi.wu	$vr1, $vr1, 2
	vadd.w	$vr0, $vr0, $vr10
...
.LBB0_70:
	...
	vld	$vr1, $t6, %pc_lo12(.LCPI0_0)
	pcalau12i	$t6, %pc_hi20(.LCPI0_1)
	vld	$vr2, $t6, %pc_lo12(.LCPI0_1)
	slli.d	$t6, $s0, 1
	vrepli.b	$vr3, 0
	vilvl.h	$vr4, $vr3, $vr0
	...
	vshuf.w	$vr5, $vr0, $vr3
	vshuf.w	$vr7, $vr0, $vr3
	vshuf4i.w	$vr0, $vr4, 80
	vshuf4i.w	$vr3, $vr4, 250
	vreplgr2vr.h	$vr4, $a0
	vstx	$vr4, $t5, $t3
	ori	$t5, $zero, 1
	lu32i.d	$t5, 2
...
.LBB1_4:
	...
	vld	$vr5, $t3, %pc_lo12(.LCPI1_0)
	pcalau12i	$t3, %pc_hi20(.LCPI1_1)
	vld	$vr6, $t3, %pc_lo12(.LCPI1_1)
	slli.d	$t2, $t2, 1
	vshuf.h	$vr5, $vr0, $vr2
	vshuf.h	$vr6, $vr0, $vr2
	vilvh.h	$vr2, $vr0, $vr2
	vslli.w	$vr7, $vr5, 1
	vld	$vr3, $a6, %pc_lo12(.LCPI1_2)
	vslli.w	$vr8, $vr2, 1
	...
	vld	$vr7, $t0, %pc_lo12(.LCPI1_4)
	pcalau12i	$t0, %pc_hi20(.LCPI1_5)
	vld	$vr9, $t0, %pc_lo12(.LCPI1_5)
	...
	pcalau12i	$t0, %pc_hi20(.LCPI1_7)
	vld	$vr6, $t0, %pc_lo12(.LCPI1_7)
	vadd.w	$vr8, $vr1, $vr8
	vld	$vr9, $a5, %pc_lo12(.LCPI1_6)
...
.LBB1_16:
	...
	ld.w	$t1, $a0, 42
	pcalau12i	$t4, %pc_hi20(.LCPI1_8)
	vld	$vr4, $t4, %pc_lo12(.LCPI1_8)
	addi.d	$t4, $a2, 2
	vilvl.h	$vr5, $vr0, $vr3
