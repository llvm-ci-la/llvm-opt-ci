...
.LBB2_132:                              # %vector.body903
	...
	addi.d	$t4, $t4, -48
	bnez	$t6, .LBB2_132
# %bb.133:                              # %middle.block908
	add.d	$a6, $t2, $a6
	beq	$t1, $a7, .LBB2_136
.LBB2_134:                              # %scalar.ph898.preheader
	addi.d	$t2, $t1, 1
	ori	$t3, $zero, 24
	mul.d	$t4, $t1, $t3
	mul.d	$t0, $t0, $t3
...
.LBB2_143:                              # %vector.body926
	...
	addi.d	$t3, $t3, 16
	bnez	$t4, .LBB2_143
# %bb.144:                              # %middle.block931
                                        #   in Loop: Header=BB2_140 Depth=1
	move	$t5, $t0
	beq	$t0, $s4, .LBB2_139
.LBB2_145:                              # %scalar.ph913.preheader
                                        #   in Loop: Header=BB2_140 Depth=1
	add.d	$t3, $a0, $t5
	mul.d	$t3, $a4, $t3
	add.w	$t3, $t1, $t3
