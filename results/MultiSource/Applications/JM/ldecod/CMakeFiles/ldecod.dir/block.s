...
# %bb.73:
	move	$t1, $zero
.LBB2_74:                               # %scalar.ph885.preheader
	slli.d	$t2, $t1, 1
	alsl.d	$t2, $a5, $t2, 1
	add.d	$t2, $a3, $t2
	sub.d	$a5, $a5, $t1
...
.LBB2_132:                              # %vector.body906
	...
	addi.d	$t4, $t4, -48
	bnez	$t6, .LBB2_132
# %bb.133:                              # %middle.block911
	add.d	$a6, $t2, $a6
	beq	$t1, $a7, .LBB2_136
.LBB2_134:                              # %scalar.ph901.preheader
	addi.d	$t2, $t1, 1
	ori	$t3, $zero, 24
	mul.d	$t4, $t1, $t3
	mul.d	$t0, $t0, $t3
...
.LBB2_143:                              # %vector.body929
	...
	addi.d	$t3, $t3, 16
	bnez	$t4, .LBB2_143
# %bb.144:                              # %middle.block934
                                        #   in Loop: Header=BB2_140 Depth=1
	move	$t5, $t0
	beq	$t0, $s4, .LBB2_139
.LBB2_145:                              # %scalar.ph916.preheader
                                        #   in Loop: Header=BB2_140 Depth=1
	add.d	$t3, $a0, $t5
	mul.d	$t3, $a4, $t3
	add.w	$t3, $t1, $t3
...
# %bb.151:                              #   in Loop: Header=BB2_149 Depth=1
	move	$t1, $zero
.LBB2_152:                              # %vec.epilog.ph804
                                        #   in Loop: Header=BB2_149 Depth=1
	alsl.d	$ra, $t1, $s3, 1
	add.d	$t1, $s4, $t1
	.p2align	4, , 16
.LBB2_153:                              # %vec.epilog.vector.body812
	...
	addi.d	$ra, $ra, 16
	bnez	$t1, .LBB2_153
# %bb.154:                              # %vec.epilog.middle.block816
                                        #   in Loop: Header=BB2_149 Depth=1
	move	$ra, $s1
	beq	$a5, $a7, .LBB2_148
	b	.LBB2_159
...
# %bb.157:                              # %middle.block800
                                        #   in Loop: Header=BB2_149 Depth=1
	beq	$a5, $t8, .LBB2_148
# %bb.158:                              # %vec.epilog.iter.check805
                                        #   in Loop: Header=BB2_149 Depth=1
	move	$t1, $t8
	move	$ra, $s0
	bnez	$a6, .LBB2_152
...
# %bb.164:                              #   in Loop: Header=BB2_163 Depth=1
	...
	b	.LBB2_174
	.p2align	4, , 16
.LBB2_165:                              # %vector.main.loop.iter.check824
                                        #   in Loop: Header=BB2_163 Depth=1
	vreplgr2vr.h	$vr0, $s5
	bgeu	$a2, $s3, .LBB2_170
# %bb.166:                              #   in Loop: Header=BB2_163 Depth=1
	move	$s8, $zero
.LBB2_167:                              # %vec.epilog.ph837
                                        #   in Loop: Header=BB2_163 Depth=1
	add.d	$s6, $fp, $s8
	alsl.d	$s7, $s8, $s0, 1
	.p2align	4, , 16
.LBB2_168:                              # %vec.epilog.vector.body845
	...
	addi.d	$s7, $s7, 16
	bnez	$s6, .LBB2_168
# %bb.169:                              # %vec.epilog.middle.block848
                                        #   in Loop: Header=BB2_163 Depth=1
	move	$s7, $t7
	beq	$t7, $a1, .LBB2_162
	b	.LBB2_174
	.p2align	4, , 16
.LBB2_170:                              # %vector.ph825
                                        #   in Loop: Header=BB2_163 Depth=1
	move	$s6, $t8
	move	$s7, $t3
	.p2align	4, , 16
.LBB2_171:                              # %vector.body830
                                        #   Parent Loop BB2_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s6, -16
	vst	$vr0, $s6, 0
	...
	addi.d	$s6, $s6, 32
	bnez	$s7, .LBB2_171
# %bb.172:                              # %middle.block833
                                        #   in Loop: Header=BB2_163 Depth=1
	beq	$t3, $a1, .LBB2_162
# %bb.173:                              # %vec.epilog.iter.check838
                                        #   in Loop: Header=BB2_163 Depth=1
	move	$s8, $t3
	move	$s7, $t3
	bnez	$t6, .LBB2_167
	.p2align	4, , 16
.LBB2_174:                              # %vec.epilog.scalar.ph836.preheader
                                        #   in Loop: Header=BB2_163 Depth=1
	sub.d	$s6, $a1, $s7
	slli.d	$s7, $s7, 1
	.p2align	4, , 16
.LBB2_175:                              # %vec.epilog.scalar.ph836
                                        #   Parent Loop BB2_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.h	$s5, $s0, $s7
	addi.d	$s6, $s6, -1
...
.LBB2_178:                              # %iter.check854
	...
	move	$s2, $a1
	bltu	$a4, $fp, .LBB2_188
# %bb.179:                              # %vector.main.loop.iter.check856
                                        #   in Loop: Header=BB2_178 Depth=1
	vreplgr2vr.h	$vr0, $s1
	bgeu	$a4, $s0, .LBB2_184
...
.LBB2_181:                              # %vec.epilog.ph869
	...
	add.d	$s3, $t7, $s3
	.p2align	4, , 16
.LBB2_182:                              # %vec.epilog.vector.body877
	...
	addi.d	$s2, $s2, 16
	bnez	$s3, .LBB2_182
# %bb.183:                              # %vec.epilog.middle.block881
                                        #   in Loop: Header=BB2_178 Depth=1
	move	$s2, $t4
	beq	$a5, $a7, .LBB2_177
	b	.LBB2_188
	.p2align	4, , 16
.LBB2_184:                              # %vector.ph857
                                        #   in Loop: Header=BB2_178 Depth=1
	move	$s2, $a2
	move	$s3, $t5
	.p2align	4, , 16
.LBB2_185:                              # %vector.body862
                                        #   Parent Loop BB2_178 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s3, -16
	vst	$vr0, $s3, 0
	...
	addi.d	$s3, $s3, 32
	bnez	$s2, .LBB2_185
# %bb.186:                              # %middle.block865
                                        #   in Loop: Header=BB2_178 Depth=1
	beq	$a5, $a2, .LBB2_177
# %bb.187:                              # %vec.epilog.iter.check870
                                        #   in Loop: Header=BB2_178 Depth=1
	move	$s3, $a2
	move	$s2, $t3
	bnez	$a6, .LBB2_181
	.p2align	4, , 16
.LBB2_188:                              # %vec.epilog.scalar.ph868.preheader
                                        #   in Loop: Header=BB2_178 Depth=1
	alsl.d	$s3, $s2, $t0, 1
	.p2align	4, , 16
.LBB2_189:                              # %vec.epilog.scalar.ph868
                                        #   Parent Loop BB2_178 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$s1, $s3, 0
	addi.w	$s2, $s2, 1
...
.LBB3_4:                                # %.preheader108
	...
	vpackev.d	$vr12, $vr9, $vr12
	vinsgr2vr.w	$vr13, $a7, 0
	vinsgr2vr.w	$vr13, $t0, 1
	vpackev.d	$vr2, $vr2, $vr13
	vsub.w	$vr2, $vr12, $vr2
	vinsgr2vr.w	$vr12, $t1, 0
	vinsgr2vr.w	$vr12, $t2, 1
	pcalau12i	$a2, %pc_hi20(.LCPI3_0)
	vld	$vr13, $a2, %pc_lo12(.LCPI3_0)
	vpackev.d	$vr3, $vr3, $vr12
	vsub.w	$vr3, $vr11, $vr3
	vrepli.w	$vr11, 32
	vadd.w	$vr2, $vr2, $vr11
	vori.b	$vr12, $vr13, 0
	vshuf.w	$vr12, $vr9, $vr5
	vadd.w	$vr4, $vr4, $vr12
...
.Lfunc_end6:
	.size	itrans_2, .Lfunc_end6-itrans_2
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function itrans_sp
.LCPI7_0:
	.word	0                               # 0x0
	.word	1                               # 0x1
	.word	2                               # 0x2
...
.LBB7_19:                               # %.preheader192
	...
	vpackev.d	$vr7, $vr6, $vr7
	vsub.w	$vr7, $vr7, $vr2
	vinsgr2vr.w	$vr8, $a2, 0
	vinsgr2vr.w	$vr8, $a3, 1
	vpackev.d	$vr1, $vr1, $vr8
	vsrai.w	$vr1, $vr1, 1
	pcalau12i	$a1, %pc_hi20(.LCPI7_0)
	vld	$vr8, $a1, %pc_lo12(.LCPI7_0)
	vsub.w	$vr1, $vr1, $vr3
	vrepli.w	$vr3, 32
	vadd.w	$vr7, $vr7, $vr3
	vshuf.w	$vr8, $vr6, $vr0
...
# %bb.7:
	...
	slli.d	$t1, $a6, 6
	pcalau12i	$a6, %got_pc_hi20(dequant_coef)
	ld.d	$t2, $a6, %got_pc_lo12(dequant_coef)
	add.d	$t4, $t2, $t1
	pcalau12i	$a6, %pc_hi20(quant_coef)
	addi.d	$t3, $a6, %pc_lo12(quant_coef)
	add.d	$t8, $t3, $t1
	ld.d	$a6, $sp, 16                    # 8-byte Folded Reload
	andn	$a7, $a1, $a6
	slli.d	$a6, $t7, 6
