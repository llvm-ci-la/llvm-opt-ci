...
# %bb.26:                               #   in Loop: Header=BB1_6 Depth=2
	...
	bgez	$a0, .LBB1_33
	b	.LBB1_3
.LBB1_27:                               # %.preheader235.preheader.peel
                                        #   in Loop: Header=BB1_6 Depth=2
	ld.w	$a1, $sp, 160
	ld.d	$a2, $sp, 152
	ld.bu	$a0, $s0, 0
...
# %bb.35:                               #   in Loop: Header=BB1_6 Depth=2
	...
	beq	$a1, $a2, .LBB1_40
	b	.LBB1_43
.LBB1_36:                               #   in Loop: Header=BB1_6 Depth=2
	ori	$a1, $zero, 2
	beq	$a0, $a1, .LBB1_40
# %bb.37:                               #   in Loop: Header=BB1_6 Depth=2
	bnez	$a0, .LBB1_42
...
.LBB1_44:                               #   in Loop: Header=BB1_6 Depth=2
	...
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 96                    # 8-byte Folded Spill
.LBB1_45:                               #   in Loop: Header=BB1_6 Depth=2
	pcalau12i	$a0, %pc_hi20(erc_img)
	ld.d	$a0, $a0, %pc_lo12(erc_img)
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	ld.w	$a2, $a3, 4
	...
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	blt	$s6, $a0, .LBB1_48
# %bb.46:                               #   in Loop: Header=BB1_6 Depth=2
	beqz	$s2, .LBB1_48
# %bb.47:                               #   in Loop: Header=BB1_6 Depth=2
	...
	ld.d	$a7, $sp, 144                   # 8-byte Folded Reload
	b	.LBB1_5
.LBB1_48:                               # %.preheader235.preheader
                                        #   in Loop: Header=BB1_6 Depth=2
	ld.w	$a1, $sp, 160
	ld.d	$a2, $sp, 152
	ld.bu	$a0, $s0, 0
	...
	st.d	$a2, $sp, 168
	bltu	$a0, $s5, .LBB1_51
# %bb.49:                               #   in Loop: Header=BB1_6 Depth=2
	slli.d	$a0, $fp, 4
	alsl.d	$a0, $fp, $a0, 3
	ldx.bu	$a0, $s0, $a0
	ori	$a1, $zero, 4
...
.LBB1_50:                               #   in Loop: Header=BB1_6 Depth=2
	move	$a0, $zero
	b	.LBB1_53
.LBB1_51:                               #   in Loop: Header=BB1_6 Depth=2
	beqz	$a0, .LBB1_50
.LBB1_52:                               #   in Loop: Header=BB1_6 Depth=2
	ori	$a0, $zero, 1
.LBB1_53:                               #   in Loop: Header=BB1_6 Depth=2
	ori	$s2, $zero, 6
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	st.b	$a0, $a1, 0
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
...
.LBB19_36:                              # %vec.epilog.ph256
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB19_37:                              # %vec.epilog.vector.body259
                                        #   Parent Loop BB19_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB19_37
# %bb.38:                               # %vec.epilog.middle.block264
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s0, $t2
	beq	$t2, $a3, .LBB19_24
	b	.LBB19_27
...
# %bb.41:                               # %middle.block250
                                        #   in Loop: Header=BB19_25 Depth=1
	beq	$t1, $a3, .LBB19_24
# %bb.42:                               # %vec.epilog.iter.check254
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $t1
	move	$s0, $t1
	beqz	$t0, .LBB19_27
