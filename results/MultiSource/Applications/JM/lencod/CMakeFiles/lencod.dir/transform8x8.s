...
# %bb.49:
	...
	ld.hu	$t8, $fp, 28
	ld.hu	$a3, $fp, 16
	vsllwil.wu.hu	$vr7, $vr0, 0
	vbsrl.v	$vr6, $vr0, 8
	vsllwil.wu.hu	$vr5, $vr6, 0
	vsllwil.wu.hu	$vr0, $vr1, 0
	vbsrl.v	$vr1, $vr1, 8
	vsllwil.wu.hu	$vr1, $vr1, 0
	vsllwil.wu.hu	$vr8, $vr2, 0
	vbsrl.v	$vr2, $vr2, 8
	vsllwil.wu.hu	$vr9, $vr2, 0
	vaddi.wu	$vr2, $vr5, 2
	vaddi.wu	$vr3, $vr7, 2
	addi.d	$a4, $t5, 2
	alsl.d	$a5, $t2, $t6, 1
...
# %bb.51:                               # %.thread
	...
	stx.h	$a2, $a0, $s4
	vbsrl.v	$vr4, $vr0, 8
	vsllwil.wu.hu	$vr5, $vr4, 0
	vsllwil.wu.hu	$vr0, $vr0, 0
	vsllwil.wu.hu	$vr7, $vr1, 0
	vbsrl.v	$vr1, $vr1, 8
	...
	vstelm.h	$vr2, $a1, 108, 0
	vstelm.h	$vr2, $t7, 0, 0
	vstelm.h	$vr2, $a1, 72, 0
	vstelm.h	$vr2, $t8, 0, 0
	vstelm.h	$vr2, $a1, 36, 0
	vstelm.h	$vr2, $s0, 0, 0
	vstelm.h	$vr2, $a1, 0, 0
	vstelm.h	$vr2, $a1, 92, 2
	vstelm.h	$vr2, $t2, 0, 2
	vstelm.h	$vr2, $a1, 56, 2
	vstelm.h	$vr2, $t3, 0, 2
	vstelm.h	$vr2, $a1, 20, 2
	vstelm.h	$vr2, $t4, 0, 2
	vstelm.h	$vr2, $a1, 76, 4
	vstelm.h	$vr2, $t5, 0, 4
	vstelm.h	$vr2, $a1, 40, 4
	vstelm.h	$vr2, $t6, 0, 4
	vstelm.h	$vr2, $a1, 4, 4
	vstelm.h	$vr2, $a1, 60, 6
	vstelm.h	$vr2, $a7, 0, 6
	vstelm.h	$vr2, $a1, 24, 6
	vstelm.h	$vr2, $t0, 0, 6
	...
	srli.d	$a3, $a3, 1
	st.h	$a3, $a1, 124
	vstelm.h	$vr2, $a1, 228, 0
	ori	$a3, $s5, 4004
	add.d	$a3, $a0, $a3
	vstelm.h	$vr2, $a3, 0, 0
	vstelm.h	$vr2, $a1, 160, 0
	ori	$a3, $s5, 4040
	add.d	$a3, $a0, $a3
	vstelm.h	$vr2, $a3, 0, 2
	vstelm.h	$vr2, $a1, 196, 2
	ori	$a3, $s5, 3972
	add.d	$a3, $a0, $a3
	vstelm.h	$vr2, $a3, 0, 2
	vstelm.h	$vr2, $a1, 232, 4
	ori	$a3, $s5, 4008
	add.d	$a3, $a0, $a3
	vstelm.h	$vr2, $a3, 0, 4
	...
	add.d	$a3, $a0, $a3
	vstelm.h	$vr2, $a3, 0, 6
	vstelm.h	$vr2, $a1, 200, 6
	ori	$a3, $s5, 3976
	add.d	$a3, $a0, $a3
	vstelm.h	$vr2, $a3, 0, 6
	vstelm.h	$vr1, $a1, 236, 0
	ori	$a3, $s5, 4012
	add.d	$a3, $a0, $a3
	vstelm.h	$vr1, $a3, 0, 0
	vstelm.h	$vr1, $a1, 168, 0
	vstelm.h	$vr1, $a1, 204, 2
	ori	$a3, $s5, 3980
	add.d	$a3, $a0, $a3
	vstelm.h	$vr1, $a3, 0, 2
	vstelm.h	$vr1, $a1, 172, 4
	ld.hu	$t6, $fp, 36
	ld.hu	$a3, $fp, 34
	ori	$a4, $s5, 3936
	vstx	$vr0, $a0, $a4
