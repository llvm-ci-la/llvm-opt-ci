...
# %bb.49:
	...
	ld.hu	$a2, $fp, 28
	vrepli.b	$vr10, 0
	vilvl.h	$vr11, $vr10, $vr1
	vbsrl.v	$vr12, $vr1, 8
	vilvl.h	$vr3, $vr10, $vr12
	vilvl.h	$vr1, $vr10, $vr2
	vilvh.h	$vr2, $vr10, $vr2
	vilvl.h	$vr5, $vr10, $vr4
	vilvh.h	$vr4, $vr10, $vr4
	vaddi.wu	$vr8, $vr3, 2
	vaddi.wu	$vr9, $vr11, 2
	vslli.w	$vr6, $vr2, 1
	vslli.w	$vr2, $vr1, 1
	...
	vsrli.w	$vr6, $vr1, 2
	vsrli.w	$vr1, $vr4, 2
	vstelm.h	$vr6, $a1, 64, 0
	vstelm.h	$vr6, $a1, 36, 0
	vstelm.h	$vr6, $a1, 8, 0
	vstelm.h	$vr6, $a1, 52, 2
	vstelm.h	$vr6, $a1, 24, 2
	vstelm.h	$vr6, $a1, 96, 4
	vstelm.h	$vr6, $a1, 68, 4
	vstelm.h	$vr6, $a1, 40, 4
	vstelm.h	$vr6, $a1, 12, 4
	vstelm.h	$vr6, $a1, 112, 6
	vstelm.h	$vr6, $a1, 56, 6
	vstelm.h	$vr6, $a1, 28, 6
	vstelm.h	$vr1, $a1, 100, 0
	vstelm.h	$vr1, $a1, 72, 0
	vstelm.h	$vr1, $a1, 44, 0
	vstelm.h	$vr1, $a1, 116, 2
	vstelm.h	$vr1, $a1, 60, 2
	vstelm.h	$vr1, $a1, 104, 4
	vstelm.h	$vr1, $a1, 76, 4
	vstelm.h	$vr1, $a1, 120, 6
	ld.hu	$a3, $fp, 32
	alsl.d	$a2, $a0, $a2, 1
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 2
	...
	st.h	$a0, $a1, 620
	vld	$vr13, $fp, 2
	vilvh.h	$vr4, $vr10, $vr13
	vilvl.h	$vr5, $vr10, $vr13
	vbsrl.v	$vr7, $vr5, 4
	vbsll.v	$vr14, $vr4, 12
	vor.v	$vr7, $vr14, $vr7
	add.d	$a0, $s8, $s7
	...
	slli.d	$s2, $s1, 1
	slli.d	$s4, $s0, 1
	pcalau12i	$s6, %pc_hi20(.LCPI2_0)
	vpickve2gr.w	$s7, $vr13, 0
	vld	$vr13, $s6, %pc_lo12(.LCPI2_0)
	vpickve2gr.w	$s6, $vr5, 3
	vinsgr2vr.w	$vr7, $s2, 0
	bstrpick.d	$s2, $s7, 15, 0
	bstrpick.d	$s7, $s1, 15, 0
	or	$s1, $s7, $s2
	xor	$s2, $s7, $s2
	srli.d	$s2, $s2, 1
	sub.d	$s2, $s1, $s2
	...
	st.h	$ra, $a1, 556
	vld	$vr12, $fp, 16
	vshuf.w	$vr13, $vr4, $vr11
	vinsgr2vr.w	$vr7, $s4, 1
	slli.d	$s4, $s6, 1
	vilvl.h	$vr10, $vr10, $vr12
	pcalau12i	$s6, %pc_hi20(.LCPI2_1)
	vld	$vr11, $s6, %pc_lo12(.LCPI2_1)
	pcalau12i	$s6, %pc_hi20(.LCPI2_2)
	vld	$vr12, $s6, %pc_lo12(.LCPI2_2)
	ori	$s6, $s3, 156
	stx.h	$ra, $s8, $s6
	vpickve2gr.w	$s6, $vr4, 0
	vshuf.w	$vr11, $vr5, $vr3
	vshuf.w	$vr12, $vr4, $vr11
	vbsrl.v	$vr9, $vr9, 8
	vbsll.v	$vr8, $vr8, 8
	vor.v	$vr9, $vr8, $vr9
	pcalau12i	$ra, %pc_hi20(.LCPI2_4)
	vld	$vr8, $ra, %pc_lo12(.LCPI2_4)
	pcalau12i	$ra, %pc_hi20(.LCPI2_3)
	vld	$vr11, $ra, %pc_lo12(.LCPI2_3)
	slli.d	$a0, $s6, 1
	vshuf.w	$vr8, $vr4, $vr3
	vori.b	$vr3, $vr0, 0
	...
	add.d	$a2, $a2, $s6
	ori	$s0, $s3, 108
	vpackev.d	$vr9, $vr10, $vr9
	vld	$vr10, $a4, %pc_lo12(.LCPI2_5)
	add.d	$s6, $s8, $s0
	vadd.w	$vr9, $vr2, $vr9
	vadd.w	$vr2, $vr3, $vr8
	vsrl.w	$vr2, $vr2, $vr10
	vsrli.w	$vr8, $vr9, 2
	vpickev.h	$vr3, $vr8, $vr2
	vadd.w	$vr4, $vr4, $vr13
	vadd.w	$vr5, $vr12, $vr5
	vadd.w	$vr5, $vr5, $vr7
	vaddi.wu	$vr7, $vr4, 1
	...
	vsrli.w	$vr5, $vr7, 1
	alsl.d	$a2, $ra, $a2, 1
	bstrpick.d	$s0, $a2, 18, 2
	ori	$a2, $s5, 3728
	stx.h	$s0, $s8, $a2
	ori	$a2, $s5, 3700
	stx.h	$s0, $s8, $a2
	pcalau12i	$a2, %pc_hi20(.LCPI2_8)
	vld	$vr7, $a2, %pc_lo12(.LCPI2_8)
	ori	$a2, $s5, 3672
	stx.h	$s0, $s8, $a2
	pcalau12i	$a2, %pc_hi20(.LCPI2_9)
	vld	$vr9, $a2, %pc_lo12(.LCPI2_9)
	vshuf.h	$vr7, $vr5, $vr4
	ori	$a2, $s3, 84
	vstx	$vr7, $s8, $a2
	vshuf.w	$vr9, $vr6, $vr3
...
# %bb.51:                               # %.thread
	...
	vsrli.w	$vr5, $vr3, 2
	vsrli.w	$vr4, $vr4, 2
	vpickev.h	$vr3, $vr4, $vr5
	vstelm.h	$vr5, $a2, 108, 0
	vstelm.h	$vr5, $t2, 0, 0
	vstelm.h	$vr5, $a2, 72, 0
	vstelm.h	$vr5, $t3, 0, 0
	vstelm.h	$vr5, $a2, 36, 0
	vstelm.h	$vr5, $t4, 0, 0
	vstelm.h	$vr5, $a2, 0, 0
	vstelm.h	$vr5, $a2, 92, 2
	vstelm.h	$vr5, $a5, 0, 2
	vstelm.h	$vr5, $a2, 56, 2
	vstelm.h	$vr5, $a6, 0, 2
	vstelm.h	$vr5, $a2, 20, 2
	vstelm.h	$vr5, $a7, 0, 2
	vstelm.h	$vr5, $a2, 76, 4
	vstelm.h	$vr5, $t0, 0, 4
	vstelm.h	$vr5, $a2, 40, 4
	vstelm.h	$vr5, $t1, 0, 4
	vstelm.h	$vr5, $a2, 4, 4
	vstelm.h	$vr5, $a2, 60, 6
	vstelm.h	$vr5, $a4, 0, 6
	vstelm.h	$vr5, $a2, 24, 6
	vstelm.h	$vr5, $t5, 0, 6
	vstelm.h	$vr4, $a2, 44, 0
	vstelm.h	$vr4, $t6, 0, 0
	vstelm.h	$vr4, $a2, 8, 0
	vstelm.h	$vr4, $a2, 28, 2
	vstelm.h	$vr4, $a0, 0, 2
	vstelm.h	$vr4, $a2, 12, 4
	...
	ori	$a7, $s5, 4028
	add.d	$a7, $a1, $a7
	pcalau12i	$t0, %pc_hi20(.LCPI2_11)
	vld	$vr10, $t0, %pc_lo12(.LCPI2_11)
	ori	$t0, $s5, 3960
	pcalau12i	$t1, %pc_hi20(.LCPI2_13)
	vld	$vr11, $t1, %pc_lo12(.LCPI2_13)
	vshuf.w	$vr10, $vr9, $vr2
	pcalau12i	$t1, %pc_hi20(.LCPI2_12)
	vld	$vr9, $t1, %pc_lo12(.LCPI2_12)
	vshuf.w	$vr11, $vr7, $vr2
	pcalau12i	$t1, %pc_hi20(.LCPI2_14)
	vld	$vr2, $t1, %pc_lo12(.LCPI2_14)
	add.d	$t0, $a1, $t0
	ori	$t1, $s5, 3996
	vshuf.w	$vr9, $vr8, $vr7
	vshuf.w	$vr2, $vr8, $vr7
	pcalau12i	$t2, %pc_hi20(.LCPI2_15)
	vld	$vr7, $t2, %pc_lo12(.LCPI2_15)
	add.d	$t1, $a1, $t1
	ori	$t2, $s5, 3964
	add.d	$t2, $a1, $t2
	vshuf.w	$vr7, $vr6, $vr2
	vpickev.h	$vr2, $vr9, $vr10
	vpickev.h	$vr6, $vr7, $vr11
	vor.v	$vr7, $vr2, $vr6
	vxor.v	$vr2, $vr2, $vr6
	vsrli.h	$vr2, $vr2, 1
	vsub.h	$vr2, $vr7, $vr2
	vstelm.h	$vr2, $a2, 212, 0
	vstelm.h	$vr2, $a0, 0, 0
	vstelm.h	$vr2, $a2, 144, 0
	vstelm.h	$vr2, $a4, 0, 1
	vstelm.h	$vr2, $a2, 180, 1
	vstelm.h	$vr2, $a5, 0, 1
	vstelm.h	$vr2, $a2, 216, 2
	vstelm.h	$vr2, $a6, 0, 2
	vstelm.h	$vr2, $a2, 148, 2
	vstelm.h	$vr2, $a7, 0, 3
	vstelm.h	$vr2, $a2, 184, 3
	vstelm.h	$vr2, $t0, 0, 3
	vstelm.h	$vr2, $a2, 220, 4
	vstelm.h	$vr2, $t1, 0, 4
	vstelm.h	$vr2, $a2, 152, 4
	vstelm.h	$vr2, $a2, 188, 5
	vstelm.h	$vr2, $t2, 0, 5
	vstelm.h	$vr2, $a2, 156, 6
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	vstx	$vr2, $a1, $a0
	vstelm.h	$vr5, $a2, 228, 0
	ori	$a0, $s5, 4004
	add.d	$a0, $a1, $a0
	vstelm.h	$vr5, $a0, 0, 0
	vstelm.h	$vr5, $a2, 160, 0
	ori	$a0, $s5, 4040
	add.d	$a0, $a1, $a0
	vstelm.h	$vr5, $a0, 0, 2
	vstelm.h	$vr5, $a2, 196, 2
	ori	$a0, $s5, 3972
	add.d	$a0, $a1, $a0
	vstelm.h	$vr5, $a0, 0, 2
	vstelm.h	$vr5, $a2, 232, 4
	ori	$a0, $s5, 4008
	add.d	$a0, $a1, $a0
	vstelm.h	$vr5, $a0, 0, 4
	vstelm.h	$vr5, $a2, 164, 4
	ori	$a0, $s5, 4044
	add.d	$a0, $a1, $a0
	vstelm.h	$vr5, $a0, 0, 6
	vstelm.h	$vr5, $a2, 200, 6
	ori	$a0, $s5, 3976
	add.d	$a0, $a1, $a0
	vstelm.h	$vr5, $a0, 0, 6
	vstelm.h	$vr4, $a2, 236, 0
	ori	$a0, $s5, 4012
	add.d	$a0, $a1, $a0
	vstelm.h	$vr4, $a0, 0, 0
	vstelm.h	$vr4, $a2, 168, 0
	vstelm.h	$vr4, $a2, 204, 2
	ori	$a0, $s5, 3980
	add.d	$a0, $a1, $a0
	vstelm.h	$vr4, $a0, 0, 2
	vstelm.h	$vr4, $a2, 172, 4
	ori	$a0, $s5, 3936
	vstx	$vr3, $a1, $a0
	ld.hu	$s0, $fp, 36
	ld.hu	$a7, $fp, 34
	...
	vld	$vr5, $s2, %pc_lo12(.LCPI2_5)
	ori	$t4, $s3, 12
	add.d	$t4, $t2, $t4
	vshuf4i.w	$vr6, $vr3, 9
	vslli.w	$vr6, $vr6, 1
	vaddi.wu	$vr7, $vr3, 2
	vpackev.d	$vr4, $vr7, $vr4
	...
	vstelm.h	$vr0, $t0, 0, 4
	vstelm.h	$vr1, $t2, 0, 0
	vstelm.h	$vr0, $a0, 44, 2
	vstelm.h	$vr0, $a0, 24, 2
	vstelm.h	$vr0, $a0, 4, 2
	vstelm.h	$vr0, $a0, 28, 6
	vstelm.h	$vr0, $a0, 8, 6
	vstelm.h	$vr1, $a0, 12, 2
	b	.LBB2_53
.LBB2_52:
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	beqz	$a3, .LBB2_54
...
.LBB5_4:
	addi.d	$t0, $t2, 2
	add.d	$t1, $t0, $t1
	pcalau12i	$t3, %pc_hi20(.LCPI5_0)
	vld	$vr5, $t3, %pc_lo12(.LCPI5_0)
	pcalau12i	$t3, %pc_hi20(.LCPI5_1)
	vld	$vr6, $t3, %pc_lo12(.LCPI5_1)
	slli.d	$t2, $t2, 1
	vshuf.h	$vr5, $vr0, $vr2
	vshuf.h	$vr6, $vr0, $vr2
	vilvh.h	$vr2, $vr0, $vr2
	...
	vori.b	$vr10, $vr3, 0
	vshuf.w	$vr10, $vr5, $vr9
	vori.b	$vr9, $vr0, 0
	vinsgr2vr.w	$vr9, $t2, 1
	vpackev.d	$vr7, $vr7, $vr9
	vadd.w	$vr7, $vr10, $vr7
	pcalau12i	$a7, %pc_hi20(.LCPI5_3)
	vld	$vr9, $a7, %pc_lo12(.LCPI5_3)
	vadd.w	$vr8, $vr6, $vr8
	ori	$a7, $zero, 0
	lu32i.d	$a7, 2
	vshuf.w	$vr9, $vr6, $vr5
	...
	vld	$vr7, $t0, %pc_lo12(.LCPI5_4)
	pcalau12i	$t0, %pc_hi20(.LCPI5_5)
	vld	$vr9, $t0, %pc_lo12(.LCPI5_5)
