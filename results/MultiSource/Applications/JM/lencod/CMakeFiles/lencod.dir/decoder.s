...
.LBB0_5:
	...
	ld.d	$t1, $t4, %got_pc_lo12(start_frame_no_in_this_IGOP)
...
# %bb.4:                                # %.preheader.lr.ph.i
	...
	ldx.d	$s2, $a3, $a5
	bstrpick.d	$a0, $s5, 62, 59
	add.w	$a0, $s5, $a0
	bstrpick.d	$s4, $a2, 31, 4
	bstrpick.d	$s8, $a0, 35, 4
	b	.LBB4_6
	.p2align	4, , 16
.LBB4_5:                                # %._crit_edge.i
...
# %bb.1:                                # %.preheader.lr.ph
	ld.w	$s5, $a1, 52
	move	$s2, $zero
	bstrpick.d	$a1, $s5, 62, 59
	add.w	$a1, $s5, $a1
	bstrpick.d	$s6, $a0, 31, 4
	bstrpick.d	$s7, $a1, 35, 4
	b	.LBB6_3
	.p2align	4, , 16
.LBB6_2:                                # %._crit_edge
