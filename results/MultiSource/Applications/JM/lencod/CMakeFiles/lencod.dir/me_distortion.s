...
.Lfunc_end2:
	...
	.p2align	4, 0x0                          # -- Begin function HadamardSAD8x8
.LCPI3_0:
	.word	1                               # 0x1
	.word	0                               # 0x0
	.word	7                               # 0x7
...
# %bb.0:                                # %vector.body.preheader
	...
	vori.b	$vr6, $vr0, 0
	vshuf.w	$vr6, $vr5, $vr4
	pcalau12i	$a1, %pc_hi20(m2)
	addi.d	$a1, $a1, %pc_lo12(m2)
	vst	$vr6, $a1, 0
	vsub.w	$vr2, $vr2, $vr3
	vshuf4i.w	$vr3, $vr2, 78
	vadd.w	$vr4, $vr3, $vr2
	vsub.w	$vr2, $vr3, $vr2
	vori.b	$vr3, $vr1, 0
	vshuf.w	$vr3, $vr2, $vr4
	...
	vst	$vr3, $a1, 160
	vsub.w	$vr4, $vr6, $vr7
	vshuf4i.w	$vr5, $vr4, 78
	vadd.w	$vr6, $vr5, $vr4
	vsub.w	$vr4, $vr5, $vr4
	vori.b	$vr5, $vr1, 0
	vshuf.w	$vr5, $vr4, $vr6
	vshuf4i.d	$vr6, $vr4, 12
	vadd.w	$vr4, $vr6, $vr5
	vld	$vr7, $a0, 192
	vld	$vr8, $a0, 208
	vsub.w	$vr5, $vr6, $vr5
	...
	vst	$vr4, $a1, 192
	vsub.w	$vr5, $vr7, $vr8
	vshuf4i.w	$vr6, $vr5, 78
	vadd.w	$vr7, $vr6, $vr5
	vsub.w	$vr5, $vr6, $vr5
	vori.b	$vr6, $vr1, 0
	vshuf.w	$vr6, $vr5, $vr7
	vshuf4i.d	$vr7, $vr5, 12
	vadd.w	$vr5, $vr7, $vr6
	vld	$vr8, $a0, 224
	vld	$vr9, $a0, 240
	vsub.w	$vr6, $vr7, $vr6
...
.LBB5_27:                               # %vector.body224
	...
	addi.d	$a0, $a0, 8
	bnez	$t2, .LBB5_27
# %bb.28:                               # %middle.block235
                                        #   in Loop: Header=BB5_24 Depth=1
	add.w	$fp, $t0, $fp
	move	$t0, $a6
	beq	$a6, $a5, .LBB5_31
.LBB5_29:                               # %scalar.ph219.preheader
                                        #   in Loop: Header=BB5_24 Depth=1
	sub.d	$a0, $s4, $t0
	.p2align	4, , 16
.LBB5_30:                               # %scalar.ph219
                                        #   Parent Loop BB5_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t0, $a1, 0
	ld.hu	$t1, $a2, 0
...
# %bb.3:                                # %.preheader90.us.preheader
	...
	pcalau12i	$s7, %pc_hi20(luma_log_weight_denom)
...
.LBB10_5:                               #   Parent Loop BB10_4 Depth=1
	...
	ld.w	$a5, $s7, %pc_lo12(luma_log_weight_denom)
...
# %bb.3:                                # %.lr.ph.us.preheader
	...
	pcalau12i	$s7, %pc_hi20(ref2_line)
...
.LBB12_5:                               #   Parent Loop BB12_4 Depth=1
	...
	ld.d	$a2, $s7, %pc_lo12(ref2_line)
	ld.d	$a1, $s5, %pc_lo12(src_line)
	move	$a7, $zero
	ori	$t0, $zero, 8
...
.LBB12_14:                              #   Parent Loop BB12_13 Depth=1
	...
	ld.d	$a1, $a1, 0
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.h	$a5, $a2, %pc_lo12(offsetBi)
	ld.d	$a6, $s1, %pc_lo12(ref2_line)
...
.LBB13_25:                              # %vector.body230
	...
	addi.d	$a0, $a0, 8
	bnez	$t1, .LBB13_25
# %bb.26:                               # %middle.block241
                                        #   in Loop: Header=BB13_22 Depth=1
	add.w	$fp, $a7, $fp
	move	$a7, $a5
	beq	$a5, $a4, .LBB13_29
.LBB13_27:                              # %scalar.ph225.preheader
                                        #   in Loop: Header=BB13_22 Depth=1
	sub.d	$a0, $s4, $a7
	.p2align	4, , 16
.LBB13_28:                              # %scalar.ph225
                                        #   Parent Loop BB13_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a7, $a1, 0
	ld.hu	$t0, $a2, 0
...
# %bb.41:                               #   in Loop: Header=BB14_33 Depth=1
	...
	move	$t4, $a1
	bne	$a3, $s4, .LBB14_33
# %bb.42:                               # %._crit_edge107.split.us.us.1
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	st.d	$a0, $a2, %pc_lo12(ref_line)
	b	.LBB14_44
.LBB14_43:                              # %.loopexit.split.us
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	st.d	$a2, $a0, %pc_lo12(ref_line)
.LBB14_44:                              # %.loopexit
	st.d	$a1, $ra, %pc_lo12(src_line)
	b	.LBB14_46
.LBB14_45:                              # %.preheader.us118.preheader.1
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	st.d	$a0, $s2, %pc_lo12(ref_line)
.LBB14_46:                              # %.loopexit
...
# %bb.0:
	...
	move	$a2, $s3
	jirl	$ra, $a3, 0
	pcalau12i	$ra, %pc_hi20(ref1_line)
	st.d	$a0, $ra, %pc_lo12(ref1_line)
	st.d	$s2, $sp, 104                   # 8-byte Folded Spill
...
# %bb.2:                                # %.preheader109.lr.ph.split.us
	ld.d	$t4, $s8, %pc_lo12(src_line)
	pcalau12i	$a1, %pc_hi20(weight1)
	ld.h	$a4, $a1, %pc_lo12(weight1)
	pcalau12i	$a1, %pc_hi20(weight2)
	ld.h	$a5, $a1, %pc_lo12(weight2)
	pcalau12i	$a1, %pc_hi20(offsetBi)
	ld.h	$a7, $a1, %pc_lo12(offsetBi)
	sub.w	$a1, $s4, $s5
...
# %bb.11:                               #   in Loop: Header=BB16_3 Depth=1
	...
	move	$t4, $t0
	bne	$a2, $s6, .LBB16_3
# %bb.12:                               # %._crit_edge132.split.us
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	st.d	$t3, $a1, %pc_lo12(ref2_line)
	st.d	$a0, $ra, %pc_lo12(ref1_line)
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	st.d	$t0, $a0, %pc_lo12(src_line)
	pcalau12i	$a0, %pc_hi20(ChromaMEEnable)
	ld.w	$a0, $a0, %pc_lo12(ChromaMEEnable)
	bnez	$a0, .LBB16_16
	b	.LBB16_48
.LBB16_13:
	...
	bnez	$a0, .LBB16_16
	b	.LBB16_48
.LBB16_14:                              # %.preheader109.lr.ph.split
	blez	$fp, .LBB16_46
# %bb.15:                               # %.preheader109.preheader
	move	$a4, $s2
	move	$s2, $zero
	slli.d	$a1, $s4, 1
	slli.d	$a2, $s5, 1
...
# %bb.17:                               # %.preheader.lr.ph.us.preheader
	...
	slli.d	$a0, $a1, 3
	pcalau12i	$a1, %pc_hi20(get_crline)
	addi.d	$s7, $a1, %pc_lo12(get_crline)
	ldx.d	$a3, $s7, $a0
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 8
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
...
# %bb.23:                               # %middle.block385
	...
	move	$t6, $t1
	beq	$t1, $s5, .LBB16_26
.LBB16_24:                              # %scalar.ph335.preheader
                                        #   in Loop: Header=BB16_19 Depth=1
	sub.d	$a0, $s5, $t6
	.p2align	4, , 16
.LBB16_25:                              # %scalar.ph335
                                        #   Parent Loop BB16_19 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	ld.hu	$t5, $a3, 0
...
# %bb.27:                               #   in Loop: Header=BB16_19 Depth=1
	...
	bne	$a4, $s6, .LBB16_19
	b	.LBB16_32
.LBB16_28:                              # %.loopexit110.split.us
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	st.d	$t2, $a0, %pc_lo12(ref2_line)
	st.d	$t1, $ra, %pc_lo12(ref1_line)
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	st.d	$t0, $a0, %pc_lo12(src_line)
	b	.LBB16_48
.LBB16_29:                              # %.split.preheader
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.w	$a0, $a0, %pc_lo12(bipred2_access_method)
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	addi.d	$a1, $a1, 512
	...
	st.d	$a0, $s0, %pc_lo12(ref1_line)
	b	.LBB16_48
.LBB16_30:                              # %.preheader.lr.ph.split.us176
	addi.w	$a1, $s2, 0
	bge	$a1, $fp, .LBB16_48
# %bb.31:                               # %.preheader.us171.preheader
	add.d	$t4, $t4, $s8
	add.d	$a0, $a0, $s8
.LBB16_32:                              # %._crit_edge158.us
...
# %bb.38:                               # %middle.block443
	...
	move	$t6, $t1
	beq	$t1, $s5, .LBB16_41
.LBB16_39:                              # %scalar.ph393.preheader
                                        #   in Loop: Header=BB16_34 Depth=1
	sub.d	$a0, $s5, $t6
	.p2align	4, , 16
.LBB16_40:                              # %scalar.ph393
                                        #   Parent Loop BB16_34 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t4, $a2, 0
	ld.hu	$t5, $a3, 0
	...
	add.d	$s2, $t4, $t5
	bnez	$a0, .LBB16_40
.LBB16_41:                              # %._crit_edge.us160.us.1
                                        #   in Loop: Header=BB16_34 Depth=1
	addi.w	$a0, $s2, 0
	bge	$a0, $fp, .LBB16_44
# %bb.42:                               #   in Loop: Header=BB16_34 Depth=1
	...
	move	$t5, $a1
	bne	$a4, $s6, .LBB16_34
# %bb.43:                               # %._crit_edge158.split.us.us.1
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	st.d	$t4, $a2, %pc_lo12(ref2_line)
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	st.d	$a0, $a2, %pc_lo12(ref1_line)
	b	.LBB16_45
.LBB16_44:                              # %.loopexit.split.us
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	st.d	$a3, $a0, %pc_lo12(ref2_line)
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	st.d	$a2, $a0, %pc_lo12(ref1_line)
...
.LBB16_46:
	move	$s2, $zero
	b	.LBB16_48
.LBB16_47:                              # %.preheader.us171.preheader.1
