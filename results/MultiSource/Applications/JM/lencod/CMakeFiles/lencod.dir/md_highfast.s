	.file	"md_highfast.c"
	.text
	.globl	encode_one_macroblock_highfast  # -- Begin function encode_one_macroblock_highfast
	.p2align	5
...
.LBB0_51:                               # %call.sqrt
	...
	jirl	$ra, $ra, 0
	b	.LBB0_31
.LBB0_52:                               # %call.sqrt652
                                        #   in Loop: Header=BB0_29 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_33
.LBB0_53:                               # %call.sqrt654
                                        #   in Loop: Header=BB0_29 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
...
.LBB0_120:                              #   in Loop: Header=BB0_117 Depth=2
	ld.d	$a1, $t6, 0
	bne	$s8, $s0, .LBB0_126
# %bb.121:                              #   in Loop: Header=BB0_117 Depth=2
	bne	$s2, $s0, .LBB0_126
...
# %bb.129:                              #   in Loop: Header=BB0_117 Depth=2
	...
	ori	$a3, $zero, 3
	blt	$a3, $a2, .LBB0_131
# %bb.130:                              #   in Loop: Header=BB0_117 Depth=2
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a2, $a2, 364
	beqz	$a2, .LBB0_116
.LBB0_131:                              #   in Loop: Header=BB0_117 Depth=2
	bne	$s8, $s0, .LBB0_154
# %bb.132:                              #   in Loop: Header=BB0_117 Depth=2
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
...
# %bb.135:                              # %.preheader
	...
	move	$t1, $zero
	.p2align	4, , 16
.LBB0_136:                              #   Parent Loop BB0_100 Depth=1
...
# %bb.140:                              # %.preheader.1
	...
	move	$t2, $zero
	.p2align	4, , 16
.LBB0_141:                              #   Parent Loop BB0_100 Depth=1
                                        #     Parent Loop BB0_117 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t3, $t0, 0
	ld.w	$t4, $t1, 0
...
# %bb.145:                              # %.preheader.2
	...
	move	$t2, $zero
	.p2align	4, , 16
.LBB0_146:                              #   Parent Loop BB0_100 Depth=1
                                        #     Parent Loop BB0_117 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t3, $t0, 0
	ld.w	$t4, $t1, 0
...
# %bb.147:                              #   in Loop: Header=BB0_146 Depth=3
	beqz	$a7, .LBB0_149
# %bb.148:                              #   in Loop: Header=BB0_146 Depth=3
	move	$t3, $t2
	addi.d	$t2, $t2, 1
	addi.d	$t1, $t1, 4
	addi.d	$t0, $t0, 4
...
# %bb.150:                              # %.preheader.3
	...
	move	$a5, $zero
	.p2align	4, , 16
.LBB0_151:                              #   Parent Loop BB0_100 Depth=1
                                        #     Parent Loop BB0_117 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a6, $a3, 0
	ld.w	$a7, $a4, 0
...
# %bb.153:                              #   in Loop: Header=BB0_151 Depth=3
	...
	bltu	$a6, $s1, .LBB0_151
	.p2align	4, , 16
.LBB0_154:                              # %.critedge483
                                        #   in Loop: Header=BB0_117 Depth=2
	slli.d	$a2, $s2, 1
	addi.d	$a3, $sp, 396
	ldx.hu	$a2, $a3, $a2
	beqz	$a2, .LBB0_156
# %bb.155:                              #   in Loop: Header=BB0_117 Depth=2
	addi.d	$a0, $sp, 184
	addi.d	$a1, $sp, 352
	ori	$a2, $zero, 96
	pcaddu18i	$ra, %call36(memcpy)
	...
	ld.d	$a0, $a0, 0
	ld.d	$a1, $t6, 0
.LBB0_156:                              #   in Loop: Header=BB0_117 Depth=2
	bne	$s8, $s0, .LBB0_116
# %bb.157:                              #   in Loop: Header=BB0_117 Depth=2
	ori	$a2, $zero, 2120
	ldx.w	$a1, $a1, $a2
	beqz	$a1, .LBB0_116
# %bb.158:                              #   in Loop: Header=BB0_117 Depth=2
	bne	$s3, $s1, .LBB0_116
# %bb.159:                              #   in Loop: Header=BB0_117 Depth=2
	ori	$s3, $zero, 2
	bne	$s2, $s0, .LBB0_116
# %bb.160:                              #   in Loop: Header=BB0_117 Depth=2
	alsl.d	$a1, $s2, $a0, 1
	lu12i.w	$a2, 3
	ori	$a3, $a2, 2120
	ldx.h	$a2, $a1, $a3
	blt	$s0, $a2, .LBB0_116
# %bb.161:                              #   in Loop: Header=BB0_117 Depth=2
	ld.bu	$a4, $s4, 4
	beq	$a4, $s1, .LBB0_115
	b	.LBB0_116
.LBB0_162:                              # %.loopexit552
                                        #   in Loop: Header=BB0_117 Depth=2
	ldptr.w	$a1, $a1, 2120
	beqz	$a1, .LBB0_116
# %bb.163:                              # %.loopexit552
                                        #   in Loop: Header=BB0_117 Depth=2
	bne	$s3, $s1, .LBB0_116
# %bb.164:                              #   in Loop: Header=BB0_117 Depth=2
	ori	$s3, $zero, 2
	bne	$s2, $s0, .LBB0_116
# %bb.165:                              #   in Loop: Header=BB0_117 Depth=2
	alsl.d	$a1, $s2, $a0, 1
	lu12i.w	$a2, 3
	ori	$a3, $a2, 2120
	ldx.h	$a2, $a1, $a3
...
# %bb.220:                              #   in Loop: Header=BB0_215 Depth=1
	...
	b	.LBB0_214
	.p2align	4, , 16
.LBB0_221:                              #   in Loop: Header=BB0_215 Depth=1
	ld.w	$a4, $sp, 180
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB0_223
# %bb.222:                              #   in Loop: Header=BB0_215 Depth=1
	beqz	$a4, .LBB0_225
.LBB0_223:                              #   in Loop: Header=BB0_215 Depth=1
	ld.w	$a5, $sp, 176
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB0_226
# %bb.224:                              #   in Loop: Header=BB0_215 Depth=1
	bnez	$a5, .LBB0_226
.LBB0_225:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	b	.LBB0_214
.LBB0_226:                              #   in Loop: Header=BB0_215 Depth=1
	bne	$a1, $s3, .LBB0_230
# %bb.227:                              #   in Loop: Header=BB0_215 Depth=1
	ori	$a2, $zero, 3
	beqz	$a5, .LBB0_225
# %bb.228:                              #   in Loop: Header=BB0_215 Depth=1
	beqz	$a4, .LBB0_225
# %bb.229:                              #   in Loop: Header=BB0_215 Depth=1
	ld.w	$a1, $sp, 172
	beqz	$a1, .LBB0_225
	.p2align	4, , 16
.LBB0_230:                              # %.thread496
...
# %bb.233:                              # %.thread496
                                        #   in Loop: Header=BB0_215 Depth=1
	blt	$s3, $a1, .LBB0_235
# %bb.234:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a4, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a4, $a4, 364
	beqz	$a4, .LBB0_238
.LBB0_235:                              #   in Loop: Header=BB0_215 Depth=1
	or	$a3, $a3, $s0
	andi	$a3, $a3, 1
	beqz	$a3, .LBB0_238
# %bb.236:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a3, $sp, 88                    # 8-byte Folded Reload
	ld.hu	$a3, $a3, 0
	beqz	$a3, .LBB0_238
# %bb.237:                              #   in Loop: Header=BB0_215 Depth=1
	addi.d	$a0, $sp, 184
	addi.d	$a1, $sp, 352
	ori	$a2, $zero, 96
	pcaddu18i	$ra, %call36(memcpy)
	...
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	ld.hu	$a1, $a1, 0
.LBB0_238:                              #   in Loop: Header=BB0_215 Depth=1
	bnez	$a6, .LBB0_243
# %bb.239:                              #   in Loop: Header=BB0_215 Depth=1
	beqz	$a2, .LBB0_243
# %bb.240:                              #   in Loop: Header=BB0_215 Depth=1
	blt	$s4, $s1, .LBB0_243
# %bb.241:                              #   in Loop: Header=BB0_215 Depth=1
	ext.w.h	$a3, $a1
	blt	$s3, $a3, .LBB0_243
# %bb.242:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a3, $a3, 364
	beqz	$a3, .LBB0_246
.LBB0_243:                              #   in Loop: Header=BB0_215 Depth=1
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB0_246
# %bb.244:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a3, $sp, 80                    # 8-byte Folded Reload
	ld.hu	$a3, $a3, 0
	beqz	$a3, .LBB0_246
# %bb.245:                              #   in Loop: Header=BB0_215 Depth=1
	addi.d	$a0, $sp, 184
	addi.d	$a1, $sp, 352
	ori	$a2, $zero, 96
	pcaddu18i	$ra, %call36(memcpy)
	...
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	ld.hu	$a1, $a1, 0
.LBB0_246:                              #   in Loop: Header=BB0_215 Depth=1
	bnez	$a6, .LBB0_251
# %bb.247:                              #   in Loop: Header=BB0_215 Depth=1
	beqz	$a2, .LBB0_251
# %bb.248:                              #   in Loop: Header=BB0_215 Depth=1
	blt	$s5, $s1, .LBB0_251
# %bb.249:                              #   in Loop: Header=BB0_215 Depth=1
	ext.w.h	$a3, $a1
	blt	$s3, $a3, .LBB0_251
# %bb.250:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a3, $a3, 364
	beqz	$a3, .LBB0_254
.LBB0_251:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a3, $a3, 0
	ldptr.w	$a3, $a3, 15536
	sltui	$a3, $a3, 1
	...
	andi	$a3, $a3, 1
	beqz	$a3, .LBB0_254
# %bb.252:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a3, $sp, 72                    # 8-byte Folded Reload
	ld.hu	$a3, $a3, 0
	beqz	$a3, .LBB0_254
# %bb.253:                              #   in Loop: Header=BB0_215 Depth=1
	addi.d	$a0, $sp, 184
	addi.d	$a1, $sp, 352
	ori	$a2, $zero, 96
	pcaddu18i	$ra, %call36(memcpy)
	...
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	ld.hu	$a1, $a1, 0
.LBB0_254:                              #   in Loop: Header=BB0_215 Depth=1
	bnez	$a6, .LBB0_259
# %bb.255:                              #   in Loop: Header=BB0_215 Depth=1
	beqz	$a2, .LBB0_259
# %bb.256:                              #   in Loop: Header=BB0_215 Depth=1
	blt	$s2, $s1, .LBB0_259
# %bb.257:                              #   in Loop: Header=BB0_215 Depth=1
	ext.w.h	$a1, $a1
	blt	$s3, $a1, .LBB0_259
# %bb.258:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a1, $a1, 364
	beqz	$a1, .LBB0_213
.LBB0_259:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ldptr.w	$a1, $a1, 15536
	sltui	$a1, $a1, 1
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_213
# %bb.260:                              #   in Loop: Header=BB0_215 Depth=1
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.hu	$a1, $a1, 0
	beqz	$a1, .LBB0_213
# %bb.261:                              #   in Loop: Header=BB0_215 Depth=1
	addi.d	$a0, $sp, 184
	addi.d	$a1, $sp, 352
	ori	$a2, $zero, 96
	pcaddu18i	$ra, %call36(memcpy)
