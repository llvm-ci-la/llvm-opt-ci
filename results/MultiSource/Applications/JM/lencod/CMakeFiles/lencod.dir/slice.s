...
.LBB3_76:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a3, $a3, 4
	blt	$a6, $a1, .LBB3_76
# %bb.77:                               # %._crit_edge133.loopexit.i
	ld.w	$a3, $a0, 20
.LBB3_78:                               # %._crit_edge133.i
	ori	$a4, $zero, 1
	bne	$a3, $a4, .LBB3_83
# %bb.79:                               # %.preheader.i
	ldptr.w	$a3, $a0, 14460
...
.LBB3_81:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a1, $a1, 4
	blt	$a5, $a7, .LBB3_81
# %bb.82:                               # %thread-pre-split.loopexit.i
	ld.w	$a3, $a0, 20
.LBB3_83:                               # %thread-pre-split.i
	beq	$a3, $a2, .LBB3_61
# %bb.84:                               # %thread-pre-split.i
	ori	$a1, $zero, 4
	beq	$a3, $a1, .LBB3_61
# %bb.85:                               # %thread-pre-split.i.thread-pre-split.thread.i_crit_edge
	lu12i.w	$s6, 3
	ori	$a1, $s6, 2168
	ldx.w	$a1, $a0, $a1
.LBB3_86:                               # %thread-pre-split.thread.i
...
# %bb.99:
	ld.w	$a1, $a0, 24
	beqz	$a1, .LBB3_203
.LBB3_100:                              # %set_ref_pic_num.exit.i
	ld.w	$a1, $a0, 20
	ori	$a0, $zero, 1
	bne	$a1, $a0, .LBB3_102
# %bb.101:
...
.LBB3_117:
	...
	ori	$a6, $zero, 3
	bgeu	$a4, $a6, .LBB3_119
# %bb.118:                              # %switch.lookup184
	slli.d	$a4, $a4, 3
	ldx.d	$a4, $a1, $a4
	b	.LBB3_120
.LBB3_119:
	move	$a4, $a0
.LBB3_120:                              # %init_slice.exit
	move	$a6, $a5
	move	$a1, $a2
.LBB3_121:                              # %init_slice.exit
...
# %bb.138:                              #   in Loop: Header=BB3_137 Depth=1
	...
	ldptr.w	$a1, $a1, 5656
	beqz	$a1, .LBB3_142
# %bb.139:                              #   in Loop: Header=BB3_137 Depth=1
	ld.w	$a0, $a0, 12
	mod.w	$a0, $a0, $a1
	bnez	$a0, .LBB3_142
# %bb.140:                              #   in Loop: Header=BB3_137 Depth=1
...
.LBB3_142:                              #   in Loop: Header=BB3_137 Depth=1
	...
	ldptr.w	$a0, $a2, 15268
	beqz	$a0, .LBB3_172
# %bb.143:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a0, $fp, 0
...
# %bb.144:                              #   in Loop: Header=BB3_137 Depth=1
	...
	bne	$a1, $s2, .LBB3_149
# %bb.145:                              #   in Loop: Header=BB3_137 Depth=1
	beqz	$a3, .LBB3_149
# %bb.146:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a1, $a2, 15388
	blez	$a1, .LBB3_150
# %bb.147:                              #   in Loop: Header=BB3_137 Depth=1
	...
	mod.wu	$a1, $a1, $a2
	bnez	$a1, .LBB3_150
# %bb.148:                              #   in Loop: Header=BB3_137 Depth=1
...
.LBB3_150:                              # %.thread135
	...
	ldptr.w	$a0, $a0, 4708
	bne	$a0, $s2, .LBB3_152
# %bb.151:                              #   in Loop: Header=BB3_137 Depth=1
...
# %bb.153:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a1, $a0, 4708
	bne	$a1, $s2, .LBB3_157
# %bb.154:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a1, $s8, 0
	ldptr.w	$a2, $a1, 15388
	blez	$a2, .LBB3_157
# %bb.155:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a1, $a1, 15404
	mod.wu	$a1, $a2, $a1
	bnez	$a1, .LBB3_157
...
.LBB3_157:                              # %.thread138
	...
	ldptr.w	$a1, $a0, 4708
	bne	$a1, $s2, .LBB3_159
# %bb.158:                              #   in Loop: Header=BB3_137 Depth=1
...
.LBB3_160:                              #   in Loop: Header=BB3_137 Depth=1
	...
	addi.d	$s4, $a4, %pc_lo12(rddata_top_field_mb)
	bgeu	$a3, $s2, .LBB3_175
# %bb.161:                              #   in Loop: Header=BB3_137 Depth=1
	ori	$a3, $zero, 1
	ori	$a4, $a5, 2952
	ldx.w	$a4, $a2, $a4
	lu32i.d	$a3, 1
...
# %bb.162:                              #   in Loop: Header=BB3_137 Depth=1
	beqz	$a3, .LBB3_166
# %bb.163:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a1, $a2, 15388
	blez	$a1, .LBB3_167
# %bb.164:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a2, $a2, 15404
	mod.wu	$a1, $a1, $a2
	bnez	$a1, .LBB3_167
...
.LBB3_169:                              #   in Loop: Header=BB3_137 Depth=1
	...
	ld.d	$a1, $s3, %pc_lo12(encode_one_macroblock)
	...
	sltui	$a3, $a3, 1
	bne	$a1, $s2, .LBB3_176
# %bb.170:                              #   in Loop: Header=BB3_137 Depth=1
	fadd.d	$fa0, $fs1, $fa0
...
.LBB3_172:                              #   in Loop: Header=BB3_137 Depth=1
	...
	ld.w	$a0, $sp, 112
	beqz	$a0, .LBB3_134
# %bb.173:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a0, $s8, 0
	ld.w	$a0, $a0, 12
...
# %bb.177:                              # %.thread
	...
	ldptr.w	$a1, $a0, 5116
	beqz	$a1, .LBB3_184
.LBB3_178:                              #   in Loop: Header=BB3_137 Depth=1
	beqz	$a3, .LBB3_182
# %bb.179:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a1, $a2, 15388
	blez	$a1, .LBB3_182
# %bb.180:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a2, $a2, 15404
	mod.wu	$a1, $a1, $a2
	bnez	$a1, .LBB3_182
# %bb.181:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(quadratic_RC)
...
.LBB3_182:                              # %.thread153
	...
	ldptr.w	$a0, $a0, 4708
	bne	$a0, $s2, .LBB3_184
# %bb.183:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(generic_RC)
...
.LBB3_185:                              # %.thread70
	...
	stptr.w	$a0, $a2, 15408
.LBB3_186:                              #   in Loop: Header=BB3_137 Depth=1
	ldptr.w	$a1, $a2, 14464
	stptr.w	$a0, $a2, 14468
	stptr.w	$zero, $a2, 15412
	move	$a0, $s0
	...
	ld.w	$a0, $sp, 112
	beqz	$a0, .LBB3_188
# %bb.187:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a0, $s8, 0
	ld.w	$a0, $a0, 12
	b	.LBB3_192
	.p2align	4, , 16
.LBB3_188:                              #   in Loop: Header=BB3_137 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(FmoGetNextMBNr)
	jirl	$ra, $ra, 0
	move	$s0, $a0
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bne	$s0, $a0, .LBB3_190
# %bb.189:                              #   in Loop: Header=BB3_137 Depth=1
	st.w	$s7, $sp, 116
.LBB3_190:                              #   in Loop: Header=BB3_137 Depth=1
	pcaddu18i	$ra, %call36(proceed2nextMacroblock)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s8, 0
	ldptr.w	$a1, $a0, 14464
	...
	ld.w	$a0, $sp, 112
	beqz	$a0, .LBB3_194
# %bb.191:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a0, $s8, 0
	ld.w	$a0, $a0, 12
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	addi.w	$a1, $a1, 1
	...
	ld.d	$a1, $s8, 0
	st.w	$a0, $a1, 12
.LBB3_192:                              #   in Loop: Header=BB3_137 Depth=1
	pcaddu18i	$ra, %call36(FmoGetPreviousMBNr)
	jirl	$ra, $ra, 0
	ld.d	$a1, $s8, 0
	st.w	$a0, $a1, 12
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	bne	$a0, $a1, .LBB3_197
# %bb.193:                              #   in Loop: Header=BB3_137 Depth=1
	pcalau12i	$a0, %pc_hi20(errortext)
	...
	jirl	$ra, $ra, 0
	b	.LBB3_197
.LBB3_194:                              #   in Loop: Header=BB3_137 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(FmoGetNextMBNr)
	jirl	$ra, $ra, 0
	move	$s0, $a0
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bne	$s0, $a0, .LBB3_196
# %bb.195:                              #   in Loop: Header=BB3_137 Depth=1
	st.w	$s7, $sp, 116
.LBB3_196:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	addi.w	$a0, $a0, 2
	st.d	$a0, $sp, 80                    # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(proceed2nextMacroblock)
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB3_197:                              #   in Loop: Header=BB3_137 Depth=1
	ld.w	$a1, $s5, %pc_lo12(MBPairIsField)
	ld.d	$a0, $s8, 0
	beqz	$a1, .LBB3_199
# %bb.198:                              #   in Loop: Header=BB3_137 Depth=1
	ld.d	$a1, $fp, 0
	ldptr.w	$a2, $a0, 15240
	ld.w	$a3, $a1, 32
	srli.d	$a2, $a2, 1
	...
	srli.d	$a1, $a1, 1
	stptr.w	$a1, $a0, 14456
.LBB3_199:                              #   in Loop: Header=BB3_137 Depth=1
	ld.w	$a1, $sp, 116
	stptr.d	$zero, $a0, 14464
	bnez	$a1, .LBB3_211
# %bb.200:                              #   in Loop: Header=BB3_137 Depth=1
	move	$a0, $s0
	...
	jirl	$ra, $ra, 0
	beq	$s0, $a0, .LBB3_210
# %bb.201:                              #   in Loop: Header=BB3_137 Depth=1
	lu12i.w	$s1, 3
	b	.LBB3_136
.LBB3_202:                              #   in Loop: Header=BB3_137 Depth=1
	st.w	$s7, $sp, 116
	b	.LBB3_135
.LBB3_203:                              # %.preheader44.i.i
	...
	b	.LBB3_205
	.p2align	4, , 16
.LBB3_204:                              # %._crit_edge51.i.i
                                        #   in Loop: Header=BB3_205 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a1, $a1, 264
	beq	$a2, $a4, .LBB3_100
.LBB3_205:                              # %.preheader.i.i
...
# %bb.206:                              # %.lr.ph50.i.i
	...
	move	$a7, $a1
	.p2align	4, , 16
.LBB3_207:                              #   Parent Loop BB3_205 Depth=1
...
.LBB6_91:                               #   in Loop: Header=BB6_7 Depth=2
	...
	fldx.d	$fa1, $s2, $s7
	bne	$a0, $a5, .LBB6_94
# %bb.92:                               #   in Loop: Header=BB6_7 Depth=2
	fmov.d	$fa0, $fa1
.LBB6_93:                               # %.loopexit193.loopexit
                                        #   in Loop: Header=BB6_7 Depth=2
	ld.d	$s2, $sp, 56                    # 8-byte Folded Reload
	b	.LBB6_95
.LBB6_94:                               #   in Loop: Header=BB6_7 Depth=2
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
	ld.d	$s2, $sp, 56                    # 8-byte Folded Reload
	bceqz	$fcc0, .LBB6_128
.LBB6_95:                               # %.loopexit193.loopexit
                                        #   in Loop: Header=BB6_7 Depth=2
	fst.d	$fa0, $s1, 16
	fmadd.d	$fa0, $fa0, $fs3, $fa4
	ftintrz.w.d	$fa0, $fa0
...
# %bb.106:                              #   in Loop: Header=BB6_7 Depth=2
	ori	$a0, $zero, 32
	blt	$s8, $a0, .LBB6_108
# %bb.107:                              #   in Loop: Header=BB6_7 Depth=2
	ldptr.w	$a0, $s0, 5116
	beqz	$a0, .LBB6_110
...
.LBB6_109:                              #   in Loop: Header=BB6_7 Depth=2
	...
	vldi	$vr4, -928
	b	.LBB6_6
.LBB6_110:                              #   in Loop: Header=BB6_7 Depth=2
	move	$fp, $a4
	addi.w	$a0, $s4, -4
	b	.LBB6_109
.LBB6_111:                              # %call.sqrt
...
.LBB6_129:                              # %.preheader
	...
	ld.d	$s1, $a1, %got_pc_lo12(QP2QUANT)
...
.LBB6_130:                              # %._crit_edge212
	...
	ori	$a1, $zero, 6
	beq	$a0, $a1, .LBB6_140
.LBB6_131:                              # =>This Loop Header: Depth=1
...
.LBB6_133:                              #   in Loop: Header=BB6_136 Depth=2
	...
	or	$a0, $a0, $a1
	addi.w	$a0, $a0, -6
.LBB6_134:                              #   in Loop: Header=BB6_136 Depth=2
	slli.d	$a0, $a0, 3
	ldx.d	$a0, $s6, $a0
	fld.d	$fa0, $a0, 16
	fadd.d	$fa0, $fa0, $fa3
...
.LBB6_135:                              #   in Loop: Header=BB6_136 Depth=2
	...
	addi.d	$s7, $s7, 8
	beq	$a0, $a7, .LBB6_130
.LBB6_136:                              #   Parent Loop BB6_131 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slt	$a0, $fp, $s4
	masknez	$a1, $fp, $a0
	maskeqz	$a0, $s4, $a0
