...
.LBB3_2:                                #   Parent Loop BB3_1 Depth=1
	...
	ld.hu	$a1, $a0, 2
	ld.h	$a0, $a0, 0
	bstrpick.d	$a7, $a1, 15, 2
	slli.d	$a7, $a7, 2
	ext.w.h	$a7, $a7
	add.w	$a7, $s0, $a7
	srai.d	$s4, $a7, 2
	bstrpick.d	$a7, $a0, 15, 2
	slli.d	$a7, $a7, 2
	ext.w.h	$a7, $a7
	add.d	$t1, $s6, $s2
	alsl.w	$a7, $t1, $a7, 4
...
.LBB16_47:                              # %vector.body374
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_48:                              # %.loopexit600
	ld.d	$t0, $a4, 16
	ld.d	$a7, $a5, 16
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_51
# %bb.49:                               # %scalar.ph381.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_50:                              # %scalar.ph381
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_51:                              # %vector.body383
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_52:                              # %.loopexit599
	ld.d	$t0, $a4, 24
	ld.d	$a7, $a5, 24
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_55
# %bb.53:                               # %scalar.ph390.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_54:                              # %scalar.ph390
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_55:                              # %vector.body392
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_56:                              # %.loopexit598
	ld.d	$t0, $a4, 32
	ld.d	$a7, $a5, 32
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_59
# %bb.57:                               # %scalar.ph399.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_58:                              # %scalar.ph399
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_59:                              # %vector.body401
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_60:                              # %.loopexit597
	ld.d	$t0, $a4, 40
	ld.d	$a7, $a5, 40
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_63
# %bb.61:                               # %scalar.ph408.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_62:                              # %scalar.ph408
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_63:                              # %vector.body410
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_64:                              # %.loopexit596
	ld.d	$t0, $a4, 48
	ld.d	$a7, $a5, 48
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_67
# %bb.65:                               # %scalar.ph417.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_66:                              # %scalar.ph417
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_67:                              # %vector.body419
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_68:                              # %.loopexit595
	ld.d	$t0, $a4, 56
	ld.d	$a7, $a5, 56
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_71
# %bb.69:                               # %scalar.ph426.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_70:                              # %scalar.ph426
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_71:                              # %vector.body428
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_72:                              # %.loopexit594
	ld.d	$t0, $a4, 64
	ld.d	$a7, $a5, 64
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_75
# %bb.73:                               # %scalar.ph435.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_74:                              # %scalar.ph435
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_75:                              # %vector.body437
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_76:                              # %.loopexit593
	ld.d	$t0, $a4, 72
	ld.d	$a7, $a5, 72
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_79
# %bb.77:                               # %scalar.ph444.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_78:                              # %scalar.ph444
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_79:                              # %vector.body446
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_80:                              # %.loopexit592
	ld.d	$t0, $a4, 80
	ld.d	$a7, $a5, 80
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_83
# %bb.81:                               # %scalar.ph453.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_82:                              # %scalar.ph453
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_83:                              # %vector.body455
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_84:                              # %.loopexit591
	ld.d	$t0, $a4, 88
	ld.d	$a7, $a5, 88
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_87
# %bb.85:                               # %scalar.ph462.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_86:                              # %scalar.ph462
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_87:                              # %vector.body464
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_88:                              # %.loopexit590
	ld.d	$t0, $a4, 96
	ld.d	$a7, $a5, 96
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_91
# %bb.89:                               # %scalar.ph471.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_90:                              # %scalar.ph471
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_91:                              # %vector.body473
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_92:                              # %.loopexit589
	ld.d	$t0, $a4, 104
	ld.d	$a7, $a5, 104
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_95
# %bb.93:                               # %scalar.ph480.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_94:                              # %scalar.ph480
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_95:                              # %vector.body482
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_96:                              # %.loopexit588
	ld.d	$t0, $a4, 112
	ld.d	$a7, $a5, 112
	sub.d	$a6, $a7, $t0
	ori	$t1, $zero, 31
	bltu	$t1, $a6, .LBB16_99
# %bb.97:                               # %scalar.ph489.preheader
	addi.d	$a6, $a3, -1
	alsl.d	$a7, $a3, $a7, 1
	alsl.d	$t0, $a3, $t0, 1
	.p2align	4, , 16
.LBB16_98:                              # %scalar.ph489
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$t1, $t0, 0
	st.h	$t1, $a7, 0
	addi.d	$a6, $a6, 1
...
.LBB16_99:                              # %vector.body491
	...
	vstx	$vr0, $a7, $t1
	vst	$vr1, $a6, 16
.LBB16_100:                             # %.loopexit587
	ld.d	$a6, $a4, 120
	ld.d	$a5, $a5, 120
	sub.d	$a4, $a5, $a6
	ori	$a7, $zero, 31
	bltu	$a7, $a4, .LBB16_103
# %bb.101:                              # %scalar.ph498.preheader
	addi.d	$a4, $a3, -1
	alsl.d	$a5, $a3, $a5, 1
	alsl.d	$a3, $a3, $a6, 1
	.p2align	4, , 16
.LBB16_102:                             # %scalar.ph498
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a6, $a3, 0
	st.h	$a6, $a5, 0
	addi.d	$a4, $a4, 1
...
.LBB16_111:                             # %vec.epilog.scalar.ph
	...
	b	.LBB16_108
	.p2align	4, , 16
.LBB16_112:                             # %vector.memcheck505
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s8, $s3
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.113:                              # %vector.memcheck505
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s3, $s2
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.114:                              # %vector.memcheck505
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s5, $s3
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.115:                              # %vector.memcheck505
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s8, $s2
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.116:                              # %vector.memcheck505
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s8, $s5
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
...
# %bb.121:                              # %vec.epilog.middle.block
	...
	beq	$t2, $t7, .LBB16_108
	b	.LBB16_110
.LBB16_122:                             # %vector.body518.preheader
                                        #   in Loop: Header=BB16_109 Depth=1
	add.d	$s7, $s2, $fp
	add.d	$ra, $s8, $fp
	add.d	$t6, $s3, $fp
...
# %bb.161:                              #   in Loop: Header=BB16_160 Depth=1
	...
	b	.LBB16_165
	.p2align	4, , 16
.LBB16_162:                             # %vector.body573.preheader
                                        #   in Loop: Header=BB16_160 Depth=1
	move	$t2, $s3
	move	$t3, $t7
	move	$t1, $t0
...
# %bb.164:                              # %middle.block579
	...
	ori	$t4, $zero, 2
	beq	$t2, $s7, .LBB16_159
.LBB16_165:                             # %scalar.ph568.preheader
                                        #   in Loop: Header=BB16_160 Depth=1
	alsl.d	$t8, $s2, $t8, 1
	alsl.d	$fp, $s2, $fp, 1
	alsl.d	$s0, $s2, $s0, 1
...
# %bb.179:                              #   in Loop: Header=BB16_178 Depth=1
	...
	b	.LBB16_183
	.p2align	4, , 16
.LBB16_180:                             # %vector.body547.preheader
                                        #   in Loop: Header=BB16_178 Depth=1
	move	$t2, $s3
	move	$t3, $t7
	move	$t1, $t0
...
# %bb.182:                              # %middle.block553
	...
	ori	$t4, $zero, 2
	beq	$t2, $s7, .LBB16_177
.LBB16_183:                             # %scalar.ph542.preheader
                                        #   in Loop: Header=BB16_178 Depth=1
	alsl.d	$t8, $s2, $t8, 1
	alsl.d	$fp, $s2, $fp, 1
	alsl.d	$s0, $s2, $s0, 1
