...
# %bb.10:
	move	$t2, $zero
.LBB2_11:                               # %scalar.ph398.preheader
	sub.d	$a4, $s5, $t2
	alsl.d	$a5, $t2, $t6, 1
	alsl.d	$t6, $t2, $fp, 1
	alsl.d	$t8, $t2, $t8, 1
...
# %bb.18:                               #   in Loop: Header=BB2_16 Depth=1
	move	$a1, $zero
.LBB2_19:                               # %scalar.ph428.preheader
                                        #   in Loop: Header=BB2_16 Depth=1
	alsl.d	$a4, $a1, $a4, 1
	alsl.d	$t4, $a1, $t4, 1
	alsl.d	$t7, $a1, $t8, 1
...
.LBB2_20:                               # %scalar.ph428
	...
	b	.LBB2_15
	.p2align	4, , 16
.LBB2_21:                               # %vector.memcheck416
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$a6, $a4, $s1
	move	$a1, $zero
	bltu	$a6, $fp, .LBB2_19
# %bb.22:                               # %vector.memcheck416
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$a6, $a4, $s2
	bltu	$a6, $fp, .LBB2_19
...
# %bb.24:                               # %vector.memcheck416
	...
	sub.d	$a6, $a4, $t3
	bltu	$a6, $fp, .LBB2_19
# %bb.25:                               # %vector.memcheck416
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$a6, $a4, $t8
	bltu	$a6, $fp, .LBB2_19
# %bb.26:                               # %vector.memcheck416
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$a6, $a4, $t4
	bltu	$a6, $fp, .LBB2_19
# %bb.27:                               # %vector.ph430
...
# %bb.35:                               #   in Loop: Header=BB2_33 Depth=1
	move	$a1, $zero
.LBB2_36:                               # %scalar.ph459.preheader
                                        #   in Loop: Header=BB2_33 Depth=1
	alsl.d	$a4, $a1, $t7, 1
	alsl.d	$a5, $a1, $s3, 1
	alsl.d	$t7, $a1, $s2, 1
...
# %bb.41:                               # %vector.memcheck447
	...
	sub.d	$a4, $t7, $s1
	bltu	$a4, $t5, .LBB2_36
# %bb.42:                               # %vector.memcheck447
                                        #   in Loop: Header=BB2_33 Depth=1
	sub.d	$a4, $t7, $s2
	bltu	$a4, $t5, .LBB2_36
# %bb.43:                               # %vector.memcheck447
                                        #   in Loop: Header=BB2_33 Depth=1
	sub.d	$a4, $t7, $s3
	bltu	$a4, $t5, .LBB2_36
# %bb.44:                               # %vector.ph461
...
.LBB2_55:                               # %vector.body317
	...
	addi.d	$a4, $a4, 16
	bnez	$s2, .LBB2_55
# %bb.56:                               # %middle.block325
	beq	$t3, $a3, .LBB2_59
.LBB2_57:                               # %scalar.ph310.preheader
	sub.d	$t4, $a3, $t3
	alsl.d	$t8, $t3, $t8, 1
	alsl.d	$s1, $t3, $s1, 2
	alsl.d	$s0, $t3, $s0, 2
...
.LBB2_66:                               # %vector.body335
	...
	addi.d	$ra, $ra, 16
	bnez	$t6, .LBB2_66
# %bb.67:                               # %middle.block344
                                        #   in Loop: Header=BB2_62 Depth=1
	move	$t6, $a6
	beq	$a6, $a3, .LBB2_61
.LBB2_68:                               # %scalar.ph328.preheader
                                        #   in Loop: Header=BB2_62 Depth=1
	alsl.d	$s4, $t6, $a1, 1
	alsl.d	$s8, $t6, $s0, 2
	alsl.d	$s7, $t6, $t5, 2
...
.LBB2_77:                               # %vector.body354
	...
	addi.d	$s3, $s3, 16
	bnez	$a6, .LBB2_77
# %bb.78:                               # %middle.block363
                                        #   in Loop: Header=BB2_73 Depth=1
	move	$a1, $a5
	ld.d	$s6, $sp, 64                    # 8-byte Folded Reload
	beq	$a5, $a3, .LBB2_72
.LBB2_79:                               # %scalar.ph347.preheader
                                        #   in Loop: Header=BB2_73 Depth=1
	alsl.d	$t6, $a1, $t6, 1
	alsl.d	$s2, $a1, $s2, 2
	alsl.d	$s1, $a1, $s1, 2
...
.LBB2_87:                               # %vector.body378
	...
	addi.d	$a4, $a4, 16
	bnez	$s4, .LBB2_87
# %bb.88:                               # %middle.block385
	move	$s1, $a6
	bne	$s0, $s5, .LBB2_7
	b	.LBB2_9
.LBB2_89:                               # %vector.memcheck388
	sub.d	$a4, $t6, $t4
	ori	$a1, $zero, 16
	move	$t2, $zero
	bltu	$a4, $a1, .LBB2_11
# %bb.90:                               # %vector.memcheck388
	sub.d	$a4, $t6, $t5
	bltu	$a4, $a1, .LBB2_11
# %bb.91:                               # %vector.memcheck388
	sub.d	$a4, $t6, $t7
	ori	$a1, $zero, 16
	bltu	$a4, $a1, .LBB2_11
# %bb.92:                               # %vector.memcheck388
	sub.d	$a4, $t6, $t8
	bltu	$a4, $a1, .LBB2_11
# %bb.93:                               # %vector.memcheck388
	sub.d	$a1, $t6, $fp
	ori	$a4, $zero, 16
	bltu	$a1, $a4, .LBB2_11
# %bb.94:                               # %vector.ph400
