...
# %bb.56:                               # %.preheader251
	...
	vsub.w	$vr5, $vr5, $vr6
	vsub.w	$vr1, $vr2, $vr1
	vshuf4i.w	$vr2, $vr4, 27
	vshuf4i.w	$vr6, $vr1, 27
	vshuf4i.w	$vr7, $vr3, 27
	vshuf4i.w	$vr8, $vr5, 27
	vadd.w	$vr9, $vr5, $vr8
	vadd.w	$vr10, $vr3, $vr7
	vadd.w	$vr11, $vr1, $vr6
	vadd.w	$vr12, $vr4, $vr2
	pcalau12i	$a0, %pc_hi20(.LCPI38_0)
	vld	$vr13, $a0, %pc_lo12(.LCPI38_0)
	vsub.w	$vr5, $vr5, $vr8
	vsub.w	$vr3, $vr3, $vr7
	vsub.w	$vr1, $vr1, $vr6
	vsub.w	$vr2, $vr4, $vr2
	vori.b	$vr4, $vr13, 0
	vshuf.w	$vr4, $vr12, $vr2
	vshuf4i.d	$vr2, $vr12, 12
	vori.b	$vr6, $vr13, 0
	vshuf.w	$vr6, $vr11, $vr1
	vshuf4i.d	$vr1, $vr11, 12
	vori.b	$vr7, $vr13, 0
	vshuf.w	$vr7, $vr10, $vr3
	vshuf4i.d	$vr3, $vr10, 12
	vshuf.w	$vr13, $vr9, $vr5
	vshuf4i.d	$vr5, $vr9, 12
	vadd.w	$vr8, $vr5, $vr13
	vadd.w	$vr9, $vr3, $vr7
	vadd.w	$vr10, $vr1, $vr6
	vadd.w	$vr11, $vr2, $vr4
	pcalau12i	$a0, %pc_hi20(.LCPI38_1)
	vld	$vr12, $a0, %pc_lo12(.LCPI38_1)
	vsub.w	$vr5, $vr5, $vr13
	vsub.w	$vr3, $vr3, $vr7
	vsub.w	$vr1, $vr1, $vr6
	vsub.w	$vr2, $vr2, $vr4
	vori.b	$vr4, $vr12, 0
	vshuf.w	$vr4, $vr11, $vr2
	vori.b	$vr2, $vr12, 0
	vshuf.w	$vr2, $vr10, $vr1
	vori.b	$vr1, $vr12, 0
	vshuf.w	$vr1, $vr9, $vr3
	vshuf.w	$vr12, $vr8, $vr5
	vneg.w	$vr3, $vr12
	vmax.w	$vr3, $vr12, $vr3
	vneg.w	$vr5, $vr1
	vmax.w	$vr1, $vr1, $vr5
