...
.LBB3_25:
	...
	st.d	$a0, $sp, 112                   # 8-byte Folded Spill
	bge	$fp, $a0, .LBB3_31
.LBB3_26:                               # %.preheader.lr.ph.i127
	sub.w	$s8, $s0, $s8
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	bge	$a0, $s8, .LBB3_31
# %bb.27:                               # %.preheader.us.preheader.i128
	move	$s7, $zero
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	slli.d	$a0, $a0, 1
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
...
.LBB3_29:                               #   Parent Loop BB3_28 Depth=1
	...
	add.w	$s0, $s0, $s4
	blt	$s5, $s8, .LBB3_29
# %bb.30:                               # %._crit_edge.us.i133
                                        #   in Loop: Header=BB3_28 Depth=1
	addi.d	$fp, $fp, 1
	add.w	$s7, $s7, $s6
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	blt	$fp, $a0, .LBB3_28
.LBB3_31:                               # %img2buf.exit135
...
.LBB3_35:
	...
	st.d	$a0, $sp, 112                   # 8-byte Folded Spill
	bge	$s7, $a0, .LBB3_41
# %bb.36:                               # %.preheader.lr.ph.i137
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	sub.w	$s6, $fp, $a0
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	bge	$a0, $s6, .LBB3_41
# %bb.37:                               # %.preheader.us.preheader.i138
	move	$s5, $zero
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	slli.d	$a0, $a0, 1
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
...
.LBB3_44:
	...
	st.d	$a0, $sp, 112                   # 8-byte Folded Spill
	bge	$s7, $a0, .LBB3_50
.LBB3_45:                               # %.preheader.lr.ph.i147
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	sub.w	$s3, $fp, $a0
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	bge	$a0, $s3, .LBB3_50
# %bb.46:                               # %.preheader.us.preheader.i148
	move	$s6, $zero
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	slli.d	$a0, $a0, 1
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
...
.LBB3_47:                               # %.preheader.us.i149
	...
	.p2align	4, , 16
.LBB3_48:                               #   Parent Loop BB3_47 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a0, $s1, $s5
	move	$a1, $s2
	move	$a2, $s0
	...
	add.w	$s5, $s5, $s4
	blt	$s8, $s3, .LBB3_48
# %bb.49:                               # %._crit_edge.us.i153
                                        #   in Loop: Header=BB3_47 Depth=1
	addi.d	$s7, $s7, 1
	add.w	$s6, $s6, $fp
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	blt	$s7, $a0, .LBB3_47
.LBB3_50:                               # %img2buf.exit155
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	mul.w	$a2, $a1, $a0
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
