...
# %bb.0:
	...
	fst.d	$fs0, $sp, 800                  # 8-byte Folded Spill
	fst.d	$fs1, $sp, 792                  # 8-byte Folded Spill
	fst.d	$fs2, $sp, 784                  # 8-byte Folded Spill
	st.d	$a1, $sp, 176                   # 8-byte Folded Spill
	pcalau12i	$a1, %got_pc_hi20(img)
...
# %bb.47:                               # %.preheader653
	...
	or	$a0, $a0, $a3
	vstx	$vr0, $a2, $a1
	fld.d	$fs2, $sp, 784                  # 8-byte Folded Reload
	fld.d	$fs1, $sp, 792                  # 8-byte Folded Reload
	fld.d	$fs0, $sp, 800                  # 8-byte Folded Reload
...
# %bb.7:
	...
	slli.d	$s1, $a1, 6
	pcalau12i	$a1, %pc_hi20(quant_coef)
	addi.d	$s4, $a1, %pc_lo12(quant_coef)
	ldx.w	$ra, $s4, $s1
	st.d	$a4, $sp, 16                    # 8-byte Folded Spill
	move	$fp, $a4
	...
	addi.d	$a6, $t0, 16
	pcalau12i	$a1, %pc_hi20(dequant_coef)
	addi.d	$s6, $a1, %pc_lo12(dequant_coef)
	ldx.w	$s5, $s6, $s1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	slli.d	$s0, $a0, 2
...
# %bb.25:                               #   in Loop: Header=BB11_23 Depth=2
	ldptr.w	$a1, $a2, 14464
	bnez	$a1, .LBB11_27
.LBB11_26:                              #   in Loop: Header=BB11_23 Depth=2
	pcalau12i	$a0, %pc_hi20(SNGL_SCAN)
...
.LBB11_30:                              #   in Loop: Header=BB11_31 Depth=2
	...
	st.w	$a1, $a0, 0
	beq	$t1, $s4, .LBB11_20
.LBB11_31:                              #   Parent Loop BB11_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldptr.w	$a1, $a2, 15312
	pcalau12i	$a0, %pc_hi20(FIELD_SCAN)
	addi.d	$a0, $a0, %pc_lo12(FIELD_SCAN)
...
# %bb.33:                               #   in Loop: Header=BB11_31 Depth=2
	ldptr.w	$a1, $a2, 14464
	bnez	$a1, .LBB11_35
.LBB11_34:                              #   in Loop: Header=BB11_31 Depth=2
	pcalau12i	$a0, %pc_hi20(SNGL_SCAN)
	addi.d	$a0, $a0, %pc_lo12(SNGL_SCAN)
...
# %bb.36:                               #   in Loop: Header=BB11_31 Depth=2
	...
	ori	$t4, $zero, 2
	b	.LBB11_30
.LBB11_37:                              # %.preheader330.preheader
	move	$a1, $zero
