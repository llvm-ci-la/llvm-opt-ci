...
.LBB3_20:                               # %.preheader232
	...
	vpackev.d	$vr11, $vr9, $vr11
	vsrai.w	$vr11, $vr11, 1
	vinsgr2vr.w	$vr12, $a2, 0
	vinsgr2vr.w	$vr12, $a7, 1
	vpackev.d	$vr12, $vr8, $vr12
	vinsgr2vr.w	$vr13, $t1, 0
	vinsgr2vr.w	$vr13, $t2, 1
	vpackev.d	$vr10, $vr10, $vr13
	vsub.w	$vr10, $vr12, $vr10
	vinsgr2vr.w	$vr12, $t3, 0
	vinsgr2vr.w	$vr12, $t4, 1
	pcalau12i	$a0, %pc_hi20(.LCPI3_0)
	vld	$vr13, $a0, %pc_lo12(.LCPI3_0)
	vpackev.d	$vr4, $vr4, $vr12
	vsub.w	$vr11, $vr11, $vr4
	vrepli.w	$vr4, 32
	vadd.w	$vr10, $vr10, $vr4
	vori.b	$vr12, $vr13, 0
	vshuf.w	$vr12, $vr8, $vr3
	vadd.w	$vr2, $vr2, $vr12
	vshuf.w	$vr13, $vr9, $vr6
	vadd.w	$vr5, $vr5, $vr13
	vadd.w	$vr6, $vr2, $vr4
	vadd.w	$vr2, $vr6, $vr5
	vadd.w	$vr2, $vr2, $vr7
