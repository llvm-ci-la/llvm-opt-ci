...
# %bb.65:                               # %.preheader
	...
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	pcalau12i	$a2, %pc_hi20(dct_luma_16x16.M1+32)
	addi.d	$a5, $a2, %pc_lo12(dct_luma_16x16.M1+32)
	move	$a6, $zero
	addi.w	$a7, $zero, -16
	lu32i.d	$a7, 0
	ori	$t0, $zero, 16
...
# %bb.13:                               #   in Loop: Header=BB3_11 Depth=1
	pcalau12i	$t4, %got_pc_hi20(AdaptRndWeight)
	ld.d	$t4, $t4, %got_pc_lo12(AdaptRndWeight)
	ld.w	$t4, $t4, 0
	sll.w	$s5, $a1, $s6
	sub.d	$a0, $a0, $s5
	mul.d	$a0, $t4, $a0
...
.LBB4_60:                               # %.preheader786
	ld.d	$s4, $sp, 112                   # 8-byte Folded Reload
	bnez	$s4, .LBB4_62
# %bb.61:                               # %.lr.ph820.split.preheader
	ld.w	$a1, $a0, 0
	ld.w	$a2, $a0, 48
	ld.w	$a3, $a0, 16
	ld.w	$a4, $a0, 32
...
.LBB4_63:                               #   in Loop: Header=BB4_65 Depth=1
	beqz	$t6, .LBB4_78
.LBB4_64:                               # %.backedge1187.backedge
                                        #   in Loop: Header=BB4_65 Depth=1
	addi.d	$t6, $t6, -1
	addi.d	$t3, $t3, 2
.LBB4_65:                               # %.backedge1187
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $t3, -1
	ld.bu	$a5, $t3, 0
	alsl.d	$a2, $a2, $a0, 4
...
# %bb.170:                              #   in Loop: Header=BB4_167 Depth=2
	...
	ori	$s3, $zero, 2
	b	.LBB4_166
.LBB4_171:                              # %._crit_edge887
	beqz	$s4, .LBB4_188
# %bb.172:
	ld.d	$s3, $sp, 48                    # 8-byte Folded Reload
	lu12i.w	$s5, 3
	b	.LBB4_174
.LBB4_173:                              # %._crit_edge887.thread
	beqz	$s4, .LBB4_197
.LBB4_174:                              # %.preheader
	ldptr.w	$a0, $t4, 15548
	blez	$a0, .LBB4_217
...
.LBB4_179:                              #   in Loop: Header=BB4_177 Depth=1
	move	$fp, $zero
.LBB4_180:                              # %scalar.ph1271.preheader
                                        #   in Loop: Header=BB4_177 Depth=1
	add.d	$a2, $t7, $fp
	slli.d	$t7, $fp, 2
	slli.d	$t8, $fp, 1
...
# %bb.184:                              # %vector.memcheck
	...
	add.d	$a2, $t8, $a2
	bltu	$a2, $t5, .LBB4_179
# %bb.185:                              # %vector.body1276.preheader
                                        #   in Loop: Header=BB4_177 Depth=1
	move	$a2, $t7
	move	$t8, $a4
	move	$fp, $a5
...
.LBB4_199:                              #   in Loop: Header=BB4_200 Depth=1
	...
	addi.d	$a5, $a5, 128
	bge	$a1, $a6, .LBB4_204
.LBB4_200:                              # %.preheader770
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB4_202 Depth 2
	blez	$a4, .LBB4_199
# %bb.201:                              # %.preheader769.lr.ph
                                        #   in Loop: Header=BB4_200 Depth=1
	move	$a6, $zero
	move	$a7, $a5
	move	$t0, $a3
	.p2align	4, , 16
.LBB4_202:                              # %.preheader769
	...
	addi.d	$a7, $a7, 8
	blt	$a6, $a4, .LBB4_202
# %bb.203:                              # %._crit_edge916
                                        #   in Loop: Header=BB4_200 Depth=1
	ori	$a2, $s5, 3260
	ldx.w	$a6, $t4, $a2
	b	.LBB4_199
.LBB4_204:                              # %.preheader766
	blez	$a6, .LBB4_217
# %bb.205:                              # %.lr.ph924
	ld.w	$a1, $t4, 188
	ldx.wu	$a0, $t4, $a0
	...
	b	.LBB4_207
	.p2align	4, , 16
.LBB4_206:                              # %._crit_edge922
                                        #   in Loop: Header=BB4_207 Depth=1
	addi.d	$a4, $a4, 1
	addi.d	$a3, $a3, 64
	beq	$a4, $a6, .LBB4_217
.LBB4_207:                              # =>This Loop Header: Depth=1
...
# %bb.209:                              #   in Loop: Header=BB4_207 Depth=1
	move	$t7, $zero
.LBB4_210:                              # %scalar.ph1256.preheader
                                        #   in Loop: Header=BB4_207 Depth=1
	add.d	$a2, $a2, $t7
	slli.d	$t6, $t7, 2
	sub.d	$t7, $a0, $t7
	.p2align	4, , 16
.LBB4_211:                              # %scalar.ph1256
...
# %bb.213:                              # %vector.scevcheck
                                        #   in Loop: Header=BB4_207 Depth=1
	bnez	$t3, .LBB4_210
# %bb.214:                              # %vector.body1261.preheader
                                        #   in Loop: Header=BB4_207 Depth=1
	move	$t6, $a2
	move	$t7, $a3
	move	$t8, $t0
	.p2align	4, , 16
.LBB4_215:                              # %vector.body1261
                                        #   Parent Loop BB4_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $t7, 0
...
.LBB6_6:                                # %.preheader669
	...
	xvstelm.w	$xr7, $sp, 500, 1
	addi.d	$a1, $sp, 532
	xvstelm.w	$xr7, $a1, 0, 2
	addi.d	$a1, $sp, 564
	xvstelm.w	$xr7, $a1, 0, 3
	xvpermi.q	$xr7, $xr5, 2
	addi.d	$a1, $sp, 596
	...
	xvpermi.q	$xr7, $xr5, 2
	addi.d	$a2, $sp, 600
	xvstelm.w	$xr7, $a2, 0, 4
	addi.d	$a2, $sp, 632
	xvstelm.w	$xr7, $a2, 0, 5
	ori	$a3, $a4, 1232
	xvldx	$xr5, $s7, $a3
	addi.d	$a2, $sp, 664
	xvstelm.w	$xr7, $a2, 0, 6
	ori	$a2, $a4, 560
	vldx	$vr6, $s7, $a2
	xvadd.w	$xr5, $xr5, $xr7
	st.d	$a3, $sp, 64                    # 8-byte Folded Spill
	...
	xvstelm.w	$xr7, $sp, 508, 1
	addi.d	$a3, $sp, 540
	xvstelm.w	$xr7, $a3, 0, 2
	addi.d	$a3, $sp, 572
	xvstelm.w	$xr7, $a3, 0, 3
	xvpermi.q	$xr7, $xr5, 2
