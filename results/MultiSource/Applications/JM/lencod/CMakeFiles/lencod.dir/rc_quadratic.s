...
# %bb.48:                               # %.sink.split.i212
	...
	st.w	$a4, $a0, 1352
	st.w	$a3, $a0, 1356
.LBB4_49:                               # %updateQPInterlace.exit215
	ld.w	$a3, $a0, 1356
	ld.w	$a4, $a0, 1352
	sub.w	$a3, $a3, $a4
	slli.d	$a6, $a1, 1
...
# %bb.68:                               # %.sink.split.i222
	...
	st.w	$a4, $a0, 1352
	st.w	$a3, $a0, 1356
.LBB4_69:                               # %updateQPInterlace.exit225
	ld.w	$a3, $a0, 1356
	ld.w	$a4, $a0, 1352
	sub.w	$a3, $a3, $a4
	slli.d	$a6, $a1, 1
...
.LBB4_84:
	...
	maskeqz	$a1, $a1, $a4
	masknez	$a3, $a3, $a4
.LBB4_85:                               # %updateQPNonPicAFF.exit
	or	$a1, $a1, $a3
	slt	$a3, $a1, $a2
	maskeqz	$a1, $a1, $a3
	masknez	$a2, $a2, $a3
...
# %bb.92:
	...
	add.d	$a3, $a3, $a1
	st.w	$a3, $a2, 44
.LBB4_93:                               # %updateQPNonPicAFF.exit
	st.w	$a4, $a0, 1352
	st.w	$a1, $a0, 1356
	st.w	$a1, $a0, 1328
	b	.LBB4_95
...
.LBB5_44:
	...
	ori	$a5, $zero, 1468
	blez	$a6, .LBB5_46
.LBB5_45:                               # %.sink.split.i.sink.split
	ld.w	$a6, $a2, 44
	add.d	$a6, $a6, $a4
	st.w	$a6, $a2, 44
.LBB5_46:                               # %.sink.split.i
	st.w	$a4, $a0, 1384
	ldx.w	$a4, $a0, $a5
	st.w	$a4, $a0, 1380
.LBB5_47:
...
.LBB6_71:
	...
	ori	$a5, $zero, 1468
	blez	$a6, .LBB6_73
.LBB6_72:                               # %.sink.split.i169.sink.split
	ld.w	$a6, $a3, 44
	add.d	$a6, $a6, $a2
	st.w	$a6, $a3, 44
.LBB6_73:                               # %.sink.split.i169
	st.w	$a2, $a0, 1384
	ldx.w	$a2, $a0, $a5
	st.w	$a2, $a0, 1380
.LBB6_74:
...
.LBB7_20:
	ld.w	$a2, $a0, 72
.LBB7_21:                               # %updateQPNonPicAFF.exit
	st.w	$a2, $a0, 1344
	b	.LBB7_80
.LBB7_22:
...
.LBB7_25:
	ld.w	$a6, $a5, 4
	bnez	$a6, .LBB7_5
# %bb.26:                               # %updateQPInterlaceBU.exit
	ld.w	$a6, $a5, 8
	addi.d	$a6, $a6, -1
	sltui	$a6, $a6, 1
	ld.w	$a7, $a5, 44
...
.LBB7_56:
	...
	ori	$a5, $zero, 1468
	blez	$a6, .LBB7_58
.LBB7_57:                               # %.sink.split.i.sink.split
	ld.w	$a6, $a3, 44
	add.d	$a6, $a6, $a2
	st.w	$a6, $a3, 44
.LBB7_58:                               # %.sink.split.i
	st.w	$a2, $a0, 1384
	ldx.w	$a2, $a0, $a5
	st.w	$a2, $a0, 1380
.LBB7_59:
...
# %bb.76:
	...
	st.w	$a3, $a1, 44
	st.w	$a4, $a0, 1352
.LBB7_77:                               # %updateQPNonPicAFF.exit
	st.w	$a2, $a0, 1356
	st.w	$a2, $a0, 1328
	b	.LBB7_80
.LBB7_78:
...
# %bb.90:                               # %vec.epilog.middle.block
	...
	beq	$t3, $t1, .LBB9_93
.LBB9_91:                               # %vec.epilog.scalar.ph.preheader
	alsl.d	$t4, $t3, $a6, 2
	addi.d	$t4, $t4, 116
	sub.d	$t1, $t1, $t3
	.p2align	4, , 16
.LBB9_92:                               # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t3, $t4, 0
	ld.w	$t5, $t4, -24
	mul.d	$t3, $t5, $t3
...
.LBB14_8:
	...
	vldi	$vr1, -928
	fadd.d	$fa0, $fa0, $fa1
.LBB14_9:                               # %updateComplexity.exit23
	vreplvei.d	$vr0, $vr0, 0
	vfrintrm.d	$vr0, $vr0
	ftintrz.w.d	$fa0, $fa0
	movfr2gr.s	$a1, $fa0
...
# %bb.12:
	ori	$a2, $zero, 1
	bne	$a3, $a2, .LBB14_46
# %bb.13:                               # %updateComplexity.exit.thread37.thread
	ld.w	$a2, $a0, 1344
	mul.d	$a1, $a2, $a1
	movgr2fr.w	$fa0, $a1
	ffint.d.w	$fa0, $fa0
...
.LBB14_16:
	bne	$a5, $a6, .LBB14_33
.LBB14_17:                              # %updateComplexity.exit28
	ori	$a5, $zero, 2
	bne	$a4, $a5, .LBB14_24
.LBB14_18:
	ld.w	$a0, $a2, 0
...
.LBB14_21:                              # %updateComplexity.exit
	...
	movfr2gr.s	$a1, $fa0
	beqz	$a3, .LBB14_41
# %bb.22:                               # %updateComplexity.exit.thread37
	ori	$a2, $zero, 1
	bne	$a3, $a2, .LBB14_46
.LBB14_23:
	ld.w	$a2, $a0, 1548
	...
	st.w	$a0, $a2, 32
	ret
.LBB14_24:                              # %updateComplexity.exit28.thread
	ld.w	$a5, $a0, 1344
	mul.d	$a1, $a5, $a1
	movgr2fr.w	$fa0, $a1
	ffint.d.w	$fa0, $fa0
...
# %bb.40:
	...
	bnez	$a3, .LBB14_43
	b	.LBB14_55
.LBB14_41:                              # %updateComplexity.exit.thread
	ld.w	$a2, $a2, 0
	pcalau12i	$a3, %got_pc_hi20(start_frame_no_in_this_IGOP)
	ld.d	$a3, $a3, %got_pc_lo12(start_frame_no_in_this_IGOP)
	ld.w	$a3, $a3, 0
	beq	$a2, $a3, .LBB14_46
# %bb.42:                               # %updateComplexity.exit.thread.thread
	pcalau12i	$a2, %pc_hi20(generic_RC)
	ld.d	$a2, $a2, %pc_lo12(generic_RC)
	ld.w	$a3, $a2, 12
	beqz	$a3, .LBB14_55
...
.LBB14_44:
	...
	fmadd.d	$fa0, $fa1, $fa0, $fa2
	b	.LBB14_9
.LBB14_45:                              # %updateComplexity.exit28.thread.thread
	ld.w	$a2, $a2, 0
	pcalau12i	$a3, %got_pc_hi20(start_frame_no_in_this_IGOP)
	ld.d	$a3, $a3, %got_pc_lo12(start_frame_no_in_this_IGOP)
	ld.w	$a3, $a3, 0
...
.LBB14_49:
	...
	ftintrz.w.d	$fa0, $fa0
	movfr2gr.s	$a1, $fa0
.LBB14_50:                              # %updateComplexity.exit28.thread.thread.thread
	pcalau12i	$a2, %pc_hi20(generic_RC)
	ld.d	$a2, $a2, %pc_lo12(generic_RC)
	ld.w	$a3, $a2, 12
	beqz	$a3, .LBB14_53
...
.LBB15_32:                              # %vector.ph
	...
	b	.LBB15_34
	.p2align	4, , 16
.LBB15_33:                              # %pred.store.continue170
...
# %bb.35:                               # %pred.store.continue
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB15_39
.LBB15_36:                              # %pred.store.continue166
                                        #   in Loop: Header=BB15_34 Depth=1
	xvpickve2gr.d	$a6, $xr2, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB15_40
.LBB15_37:                              # %pred.store.continue168
                                        #   in Loop: Header=BB15_34 Depth=1
...
.LBB15_38:                              # %pred.store.if
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_36
.LBB15_39:                              # %pred.store.if165
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, -4
	xvpickve2gr.d	$a6, $xr2, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_37
.LBB15_40:                              # %pred.store.if167
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, 0
	xvpickve2gr.d	$a6, $xr2, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_33
.LBB15_41:                              # %pred.store.if169
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, 4
	b	.LBB15_33
...
.LBB15_48:
	...
	jr	$t8
.LBB15_49:                              # %.lr.ph137.preheader171
	pcalau12i	$a2, %pc_hi20(updateRCModel.error)
	addi.d	$a2, $a2, %pc_lo12(updateRCModel.error)
	alsl.d	$a2, $a0, $a2, 3
	alsl.d	$a3, $a0, $s0, 2
...
.LBB17_26:                              # %vector.ph
	...
	b	.LBB17_28
	.p2align	4, , 16
.LBB17_27:                              # %pred.store.continue126
...
# %bb.29:                               # %pred.store.continue
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB17_33
.LBB17_30:                              # %pred.store.continue122
                                        #   in Loop: Header=BB17_28 Depth=1
	xvpickve2gr.d	$a5, $xr2, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB17_34
.LBB17_31:                              # %pred.store.continue124
                                        #   in Loop: Header=BB17_28 Depth=1
...
.LBB17_32:                              # %pred.store.if
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_30
.LBB17_33:                              # %pred.store.if121
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, -4
	xvpickve2gr.d	$a5, $xr2, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_31
.LBB17_34:                              # %pred.store.if123
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, 0
	xvpickve2gr.d	$a5, $xr2, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_27
.LBB17_35:                              # %pred.store.if125
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, 4
	b	.LBB17_27
.LBB17_36:                              # %middle.block
	bne	$a0, $s0, .LBB17_38
.LBB17_37:                              # %._crit_edge92
	st.w	$zero, $s1, 0
	move	$a0, $fp
	move	$a1, $s0
	move	$a2, $s1
