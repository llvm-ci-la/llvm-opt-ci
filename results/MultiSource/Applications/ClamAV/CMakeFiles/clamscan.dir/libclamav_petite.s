...
.LBB0_161:                              # %.lr.ph1328
	...
	beqz	$a3, .LBB0_176
# %bb.162:                              # %.lr.ph1328.split.us.preheader
	move	$a5, $zero
	addi.d	$a3, $a4, 4
	add.d	$a4, $a3, $a6
	lu12i.w	$a6, -262399
	ori	$a6, $a6, 823
.LBB0_163:                              # %.lr.ph1328.split.us
                                        # =>This Loop Header: Depth=1
...
# %bb.174:                              #   in Loop: Header=BB0_170 Depth=2
	...
	andi	$a5, $t2, 7
	b	.LBB0_169
.LBB0_175:                              # %.critedge7.us
                                        #   in Loop: Header=BB0_163 Depth=1
	move	$t0, $a7
	bgeu	$a4, $s1, .LBB0_163
	b	.LBB0_148
.LBB0_176:                              # %.lr.ph1328.split
	lu12i.w	$a3, -262399
	ori	$a3, $a3, 823
	sltu	$a2, $a3, $a2
	sub.d	$a2, $zero, $a2
...
# %bb.194:
	move	$s7, $zero
.LBB0_195:                              # %.thread1058.sink.split
	move	$a0, $fp
...
.LBB0_196:                              # %.thread1058
	...
	addi.d	$sp, $sp, 400
	ret
.LBB0_197:                              # %.lr.ph1348.peel.next.preheader
	slt	$a0, $s2, $s5
	masknez	$a1, $s2, $a0
	maskeqz	$a0, $s5, $a0
	or	$a0, $a0, $a1
...
.LBB0_203:                              # %.thread1058.sink.split.sink.split
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_138
.Lfunc_end0:
