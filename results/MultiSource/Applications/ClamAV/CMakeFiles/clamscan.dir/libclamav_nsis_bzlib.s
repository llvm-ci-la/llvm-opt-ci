...
.LBB3_168:                              #   Parent Loop BB3_4 Depth=1
	...
	ldx.bu	$a1, $a2, $t2
	beqz	$a2, .LBB3_167
# %bb.169:                              # %iter.check574
                                        #   in Loop: Header=BB3_168 Depth=2
	ori	$a3, $zero, 8
	bltu	$a2, $a3, .LBB3_172
# %bb.170:                              # %vector.scevcheck568
                                        #   in Loop: Header=BB3_168 Depth=2
	addi.d	$a3, $a2, -1
	andi	$a4, $a3, 255
	bltu	$a3, $a4, .LBB3_172
# %bb.171:                              # %vector.memcheck569
                                        #   in Loop: Header=BB3_168 Depth=2
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	add.d	$a3, $a2, $a4
...
.LBB3_174:                              # %.lr.ph1525.i
	...
	bnez	$a5, .LBB3_174
	b	.LBB3_167
.LBB3_175:                              # %vector.main.loop.iter.check576
                                        #   in Loop: Header=BB3_168 Depth=2
	bgeu	$a2, $a6, .LBB3_180
# %bb.176:                              #   in Loop: Header=BB3_168 Depth=2
	move	$a6, $zero
.LBB3_177:                              # %vec.epilog.ph592
                                        #   in Loop: Header=BB3_168 Depth=2
	andi	$a7, $a2, 248
	andi	$a5, $a2, 7
	sub.d	$a3, $a2, $a7
	...
	add.d	$a6, $a6, $t1
	add.d	$a4, $t1, $a4
.LBB3_178:                              # %vec.epilog.vector.body596
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_168 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	addi.d	$a4, $a4, -8
	bnez	$t0, .LBB3_178
# %bb.179:                              # %vec.epilog.middle.block603
                                        #   in Loop: Header=BB3_168 Depth=2
	move	$t0, $s5
	move	$t1, $s3
	beq	$a7, $a2, .LBB3_167
	b	.LBB3_173
.LBB3_180:                              # %vector.ph577
                                        #   in Loop: Header=BB3_168 Depth=2
	andi	$a5, $a2, 8
	andi	$a6, $a2, 240
	addi.d	$a7, $sp, 499
...
.LBB3_181:                              # %vector.body580
	...
	addi.d	$a3, $a3, -16
	bnez	$t0, .LBB3_181
# %bb.182:                              # %middle.block586
                                        #   in Loop: Header=BB3_168 Depth=2
	move	$t0, $s5
	move	$t1, $s3
	beq	$a6, $a2, .LBB3_167
# %bb.183:                              # %vec.epilog.iter.check590
                                        #   in Loop: Header=BB3_168 Depth=2
	bnez	$a5, .LBB3_177
...
.LBB3_197:                              # %vector.body621
	...
	addi.d	$a3, $a3, 32
	bnez	$a2, .LBB3_197
# %bb.198:                              # %middle.block625
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$t6, $a0, .LBB3_165
# %bb.199:                              # %vec.epilog.iter.check630
                                        #   in Loop: Header=BB3_4 Depth=1
	beqz	$a1, .LBB3_203
.LBB3_200:                              # %vec.epilog.ph632
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a1, $t6, 504
	...
	vadd.b	$vr0, $vr0, $vr1
.LBB3_201:                              # %vec.epilog.vector.body636
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$a2, $a0, 248
	add.d	$a2, $t2, $a2
	...
	vaddi.bu	$vr0, $vr0, 8
	bne	$a1, $a0, .LBB3_201
# %bb.202:                              # %vec.epilog.middle.block643
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$t6, $a1, .LBB3_164
	b	.LBB3_165
...
.LBB3_275:                              # %.preheader68.i.thread.i
	...
	ori	$s2, $zero, 32
	b	.LBB3_290
.LBB3_276:                              # %vector.body555.preheader
                                        #   in Loop: Header=BB3_272 Depth=2
	move	$a0, $a1
...
# %bb.278:                              # %middle.block563
	...
	move	$a1, $a0
	beq	$a0, $s6, .LBB3_281
.LBB3_279:                              # %scalar.ph550.preheader
                                        #   in Loop: Header=BB3_272 Depth=2
	sub.d	$a0, $s6, $a1
	add.d	$a1, $s3, $a1
	.p2align	4, , 16
.LBB3_280:                              # %scalar.ph550
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_272 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a2, $a1, 0
...
# %bb.468:                              #   in Loop: Header=BB3_4 Depth=1
	move	$s0, $a5
.LBB3_469:                              # %scalar.ph499.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	slli.d	$a5, $s0, 1
	sub.d	$a6, $a4, $s0
	st.d	$t2, $sp, 456                   # 8-byte Folded Spill
.LBB3_470:                              # %scalar.ph499
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t0, $a1
	beqz	$a6, .LBB3_479
...
.LBB3_481:                              # %BZ2_decompress.exit
	...
	ld.d	$a5, $sp, 112                   # 8-byte Folded Reload
	b	.LBB3_352
.LBB3_482:                              # %unRLE_obuf_to_output_SMALL.exit.thread.loopexit886
	addi.w	$a0, $zero, -1
...
.LBB3_489:                              # %vec.epilog.vector.body
	...
	addi.w	$a0, $a0, -8
	b	.LBB3_489
.LBB3_490:                              # %vector.body520.preheader
	move	$a1, $s2
.LBB3_491:                              # %vector.body520
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $a5, -1
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a0, $a1, $a0
