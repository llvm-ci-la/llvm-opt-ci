...
.LBB3_164:                              #   Parent Loop BB3_4 Depth=1
	...
	ldx.bu	$a1, $a2, $t2
	beqz	$a2, .LBB3_163
# %bb.165:                              # %iter.check578
                                        #   in Loop: Header=BB3_164 Depth=2
	ori	$a3, $zero, 8
	bltu	$a2, $a3, .LBB3_168
# %bb.166:                              # %vector.scevcheck572
                                        #   in Loop: Header=BB3_164 Depth=2
	addi.d	$a3, $a2, -1
	andi	$a4, $a3, 255
	bltu	$a3, $a4, .LBB3_168
# %bb.167:                              # %vector.memcheck573
                                        #   in Loop: Header=BB3_164 Depth=2
	addi.w	$a4, $zero, -1
	lu32i.d	$a4, 0
	add.d	$a3, $a2, $a4
...
.LBB3_170:                              # %.lr.ph1525.i
	...
	bnez	$a5, .LBB3_170
	b	.LBB3_163
.LBB3_171:                              # %vector.main.loop.iter.check580
                                        #   in Loop: Header=BB3_164 Depth=2
	bgeu	$a2, $a6, .LBB3_173
# %bb.172:                              #   in Loop: Header=BB3_164 Depth=2
	move	$a6, $zero
	b	.LBB3_177
.LBB3_173:                              # %vector.ph581
                                        #   in Loop: Header=BB3_164 Depth=2
	andi	$a6, $a2, 224
	addi.d	$a5, $sp, 483
	add.d	$a5, $a5, $a2
	move	$a7, $a6
.LBB3_174:                              # %vector.body584
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_164 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	addi.d	$a3, $a3, -32
	bnez	$a7, .LBB3_174
# %bb.175:                              # %middle.block593
                                        #   in Loop: Header=BB3_164 Depth=2
	move	$t0, $s0
	beq	$a6, $a2, .LBB3_163
# %bb.176:                              # %vec.epilog.iter.check598
                                        #   in Loop: Header=BB3_164 Depth=2
	andi	$a3, $a2, 24
	beqz	$a3, .LBB3_180
.LBB3_177:                              # %vec.epilog.ph597
                                        #   in Loop: Header=BB3_164 Depth=2
	andi	$a7, $a2, 248
	andi	$a5, $a2, 7
	sub.d	$a3, $a2, $a7
	...
	add.d	$a6, $a6, $t1
	add.d	$a4, $t1, $a4
.LBB3_178:                              # %vec.epilog.vector.body604
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_164 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	addi.d	$a4, $a4, -8
	bnez	$t0, .LBB3_178
# %bb.179:                              # %vec.epilog.middle.block611
                                        #   in Loop: Header=BB3_164 Depth=2
	move	$t0, $s0
	move	$t1, $s4
	beq	$a7, $a2, .LBB3_163
	b	.LBB3_169
.LBB3_180:                              #   in Loop: Header=BB3_164 Depth=2
	andi	$a5, $a2, 31
	sub.d	$a3, $a2, $a6
	b	.LBB3_169
...
.LBB3_186:                              # %vector.scevcheck618
	...
	move	$a1, $zero
	beq	$a2, $a3, .LBB3_192
# %bb.187:                              # %vector.scevcheck618
                                        #   in Loop: Header=BB3_4 Depth=1
	ori	$a2, $zero, 255
	ld.d	$a3, $sp, 472                   # 8-byte Folded Reload
	bltu	$a2, $a0, .LBB3_160
# %bb.188:                              # %vector.main.loop.iter.check624
                                        #   in Loop: Header=BB3_4 Depth=1
	ori	$a0, $zero, 32
	bgeu	$t6, $a0, .LBB3_193
...
.LBB3_194:                              # %vector.body629
	...
	addi.d	$a2, $a2, 32
	bnez	$a1, .LBB3_194
# %bb.195:                              # %middle.block633
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$t6, $a0, .LBB3_161
# %bb.196:                              # %vec.epilog.iter.check639
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a1, $t6, 24
	beqz	$a1, .LBB3_200
.LBB3_197:                              # %vec.epilog.ph638
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a1, $t6, 504
	...
	vadd.b	$vr0, $vr0, $vr1
.LBB3_198:                              # %vec.epilog.vector.body645
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$a2, $a0, 248
	add.d	$a2, $t2, $a2
	...
	vaddi.bu	$vr0, $vr0, 8
	bne	$a1, $a0, .LBB3_198
# %bb.199:                              # %vec.epilog.middle.block652
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$t6, $a1, .LBB3_160
	b	.LBB3_161
...
.LBB3_291:                              # %.preheader68.i.thread.i
	...
	ori	$s8, $zero, 32
	b	.LBB3_306
.LBB3_292:                              # %vector.body559.preheader
                                        #   in Loop: Header=BB3_288 Depth=2
	move	$a0, $a1
...
# %bb.294:                              # %middle.block567
	...
	move	$a1, $a0
	beq	$a0, $s6, .LBB3_297
.LBB3_295:                              # %scalar.ph554.preheader
                                        #   in Loop: Header=BB3_288 Depth=2
	sub.d	$a0, $s6, $a1
	add.d	$a1, $s3, $a1
	.p2align	4, , 16
.LBB3_296:                              # %scalar.ph554
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_288 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a2, $a1, 0
...
.LBB3_488:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$s8, $sp, 376                   # 8-byte Folded Reload
	b	.LBB3_466
.LBB3_489:                              # %unRLE_obuf_to_output_SMALL.exit.thread.loopexit895
	addi.w	$a0, $zero, -1
