...
.LBB1_18:                               # %.loopexit546
	...
	beqz	$t1, .LBB1_147
# %bb.19:                               #   in Loop: Header=BB1_5 Depth=4
	slli.d	$s4, $s4, 8
...
.LBB1_20:                               #   in Loop: Header=BB1_5 Depth=4
	addi.w	$a3, $s0, 0
	ori	$a7, $zero, 256
	blt	$a3, $a7, .LBB1_15
	b	.LBB1_29
...
.LBB1_21:                               #   in Loop: Header=BB1_5 Depth=4
	...
	slli.d	$s0, $s0, 1
	bgeu	$s3, $t0, .LBB1_24
# %bb.22:                               #   in Loop: Header=BB1_5 Depth=4
	...
	beqz	$t0, .LBB1_25
	.p2align	4, , 16
.LBB1_23:                               #   in Loop: Header=BB1_5 Depth=4
...
.LBB1_25:                               # %.loopexit544
	...
	ld.d	$t1, $sp, 208                   # 8-byte Folded Reload
	beqz	$t1, .LBB1_148
# %bb.26:                               #   in Loop: Header=BB1_5 Depth=4
	slli.d	$s4, $s4, 8
	ld.d	$t0, $sp, 216                   # 8-byte Folded Reload
	ld.bu	$a3, $t0, 0
	slli.w	$a7, $s3, 8
	...
	addi.w	$a7, $a2, 0
	bne	$a7, $a3, .LBB1_33
.LBB1_27:                               #   in Loop: Header=BB1_5 Depth=4
	addi.w	$a3, $s0, 0
	ori	$a7, $zero, 256
	move	$a2, $t0
	blt	$a3, $a7, .LBB1_21
...
.LBB1_36:                               # %.loopexit498
	...
	ld.d	$t1, $sp, 208                   # 8-byte Folded Reload
	beqz	$t1, .LBB1_141
# %bb.37:                               #   in Loop: Header=BB1_5 Depth=4
	slli.d	$s4, $s4, 8
	ld.d	$t0, $sp, 216                   # 8-byte Folded Reload
	ld.bu	$a3, $t0, 0
	slli.w	$a7, $s3, 8
...
.LBB1_38:                               # %.loopexit1900
	...
	ori	$a4, $zero, 1
	bne	$a3, $a4, .LBB1_61
# %bb.39:                               #   in Loop: Header=BB1_4 Depth=3
	alsl.d	$a3, $t8, $t2, 1
	addi.d	$s1, $a3, 408
	ori	$a3, $zero, 8
	b	.LBB1_75
...
.LBB1_46:                               # %.loopexit1830
	...
	beqz	$a3, .LBB1_158
# %bb.47:                               #   in Loop: Header=BB1_4 Depth=3
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.bu	$a2, $a6, 0
	ori	$a3, $zero, 225
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	bltu	$a3, $a2, .LBB1_149
# %bb.48:                               #   in Loop: Header=BB1_4 Depth=3
...
# %bb.51:                               #   in Loop: Header=BB1_4 Depth=3
	...
	ori	$a3, $zero, 10
	b	.LBB1_75
.LBB1_52:                               #   in Loop: Header=BB1_4 Depth=3
	ld.d	$a3, $sp, 200                   # 8-byte Folded Reload
	addi.w	$a3, $a3, 0
	beqz	$a3, .LBB1_77
...
.LBB1_54:                               # %.loopexit1934
	...
	addi.w	$a3, $a3, 0
	beqz	$a3, .LBB1_81
# %bb.55:                               #   in Loop: Header=BB1_4 Depth=3
	alsl.d	$a3, $t8, $t2, 1
	addi.d	$s1, $a3, 456
	ori	$a3, $zero, 11
	b	.LBB1_75
.LBB1_56:                               # %.loopexit2216
	...
	addi.w	$a3, $a3, 0
	beqz	$a3, .LBB1_132
# %bb.57:                               #   in Loop: Header=BB1_4 Depth=3
	addi.d	$s1, $s8, 2
	ori	$a3, $zero, 19
	b	.LBB1_75
...
.LBB1_59:                               # %.loopexit2200
	...
	move	$s1, $s8
	b	.LBB1_76
.LBB1_60:                               #   in Loop: Header=BB1_4 Depth=3
	alsl.d	$a3, $t8, $t2, 1
	addi.d	$s1, $a3, 384
	ori	$a3, $zero, 7
	st.d	$a3, $sp, 176                   # 8-byte Folded Spill
	...
	b	.LBB1_76
.LBB1_61:                               #   in Loop: Header=BB1_4 Depth=3
	slti	$a3, $t8, 7
	ori	$a4, $zero, 10
	masknez	$a4, $a4, $a3
	ori	$a5, $zero, 7
	...
	b	.LBB1_83
.LBB1_62:                               #   in Loop: Header=BB1_4 Depth=3
	...
	beqz	$t2, .LBB1_64
# %bb.63:                               #   in Loop: Header=BB1_4 Depth=3
	move	$a0, $t2
...
# %bb.67:                               # %vec.epilog.vector.body
	...
	addi.w	$a5, $a5, -1
	blt	$a2, $a1, .LBB1_89
.LBB1_68:                               #   in Loop: Header=BB1_4 Depth=3
	st.d	$a5, $sp, 208                   # 8-byte Folded Spill
	addi.w	$a1, $t7, 0
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	addi.w	$a2, $a2, 0
	beq	$a2, $a1, .LBB1_72
# %bb.69:                               #   in Loop: Header=BB1_4 Depth=3
	...
	st.d	$a0, $sp, 64                    # 8-byte Folded Spill
	beqz	$t5, .LBB1_71
# %bb.70:                               #   in Loop: Header=BB1_4 Depth=3
	move	$a0, $t5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_71:                               #   in Loop: Header=BB1_4 Depth=3
	...
	ld.d	$a7, $sp, 72                    # 8-byte Folded Reload
	beqz	$t5, .LBB1_149
.LBB1_72:                               #   in Loop: Header=BB1_4 Depth=3
	addi.d	$a1, $t7, -1
...
.LBB1_77:                               #   in Loop: Header=BB1_4 Depth=3
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	beqz	$t4, .LBB1_149
# %bb.78:                               #   in Loop: Header=BB1_4 Depth=3
	slti	$a3, $t8, 7
	ori	$a4, $zero, 11
	masknez	$a4, $a4, $a3
	ori	$a5, $zero, 9
...
# %bb.84:                               #   in Loop: Header=BB1_4 Depth=3
	...
	add.d	$a3, $a3, $a6
	b	.LBB1_86
.LBB1_85:                               #   in Loop: Header=BB1_4 Depth=3
	sub.w	$s3, $s3, $a7
	sub.w	$a7, $s4, $a7
	srli.d	$a6, $a3, 5
	sub.d	$a3, $a3, $a6
...
.LBB1_87:                               # %.loopexit549
	...
	ld.d	$t1, $sp, 208                   # 8-byte Folded Reload
	beqz	$t1, .LBB1_151
# %bb.88:                               #   in Loop: Header=BB1_4 Depth=3
	slli.d	$s4, $s4, 8
...
.LBB1_93:                               # %.loopexit542
	...
	ld.d	$a5, $sp, 208                   # 8-byte Folded Reload
	beqz	$a5, .LBB1_152
# %bb.94:                               #   in Loop: Header=BB1_4 Depth=3
	ld.bu	$a3, $a6, 0
	slli.w	$a4, $s3, 8
	addi.w	$a5, $a5, -1
	st.d	$a5, $sp, 208                   # 8-byte Folded Spill
...
.LBB1_95:                               # %.loopexit2031
	...
	ori	$a4, $zero, 4
	blt	$a5, $a4, .LBB1_102
# %bb.96:                               #   in Loop: Header=BB1_3 Depth=2
	...
	move	$s0, $zero
	bltu	$a7, $a5, .LBB1_103
# %bb.97:                               #   in Loop: Header=BB1_3 Depth=2
	move	$a2, $zero
...
.LBB1_102:                              #   in Loop: Header=BB1_3 Depth=2
	move	$a5, $s0
	b	.LBB1_111
.LBB1_103:                              #   in Loop: Header=BB1_3 Depth=2
	addi.w	$a2, $a2, -5
	ld.d	$a7, $sp, 216                   # 8-byte Folded Reload
.LBB1_104:                              #   in Loop: Header=BB1_3 Depth=2
	blez	$a2, .LBB1_109
# %bb.105:                              #   in Loop: Header=BB1_3 Depth=2
...
.LBB1_106:                              # %.loopexit502
	...
	ld.d	$t1, $sp, 208                   # 8-byte Folded Reload
	beqz	$t1, .LBB1_156
# %bb.107:                              #   in Loop: Header=BB1_3 Depth=2
	slli.d	$a4, $s4, 8
	ld.bu	$a5, $a7, 0
	slli.w	$a6, $s3, 8
	addi.w	$t1, $t1, -1
...
.LBB1_109:                              #   in Loop: Header=BB1_3 Depth=2
	...
	addi.w	$a5, $a4, 0
	blt	$a2, $a5, .LBB1_118
.LBB1_110:                              #   in Loop: Header=BB1_3 Depth=2
	add.d	$a5, $t0, $s0
	st.d	$a4, $sp, 200                   # 8-byte Folded Spill
	st.d	$a6, $sp, 144                   # 8-byte Folded Spill
.LBB1_111:                              #   in Loop: Header=BB1_3 Depth=2
	addi.w	$t0, $a5, 1
.LBB1_112:                              #   in Loop: Header=BB1_3 Depth=2
	beqz	$t0, .LBB1_154
# %bb.113:                              #   in Loop: Header=BB1_3 Depth=2
	bltu	$t4, $t0, .LBB1_149
# %bb.114:                              #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	addi.w	$a7, $a7, 2
	add.w	$t4, $t4, $a7
	.p2align	4, , 16
.LBB1_115:                              #   Parent Loop BB1_2 Depth=1
                                        #     Parent Loop BB1_3 Depth=2
...
# %bb.117:                              #   in Loop: Header=BB1_3 Depth=2
	ori	$a3, $zero, 2
	b	.LBB1_3
.LBB1_118:                              #   in Loop: Header=BB1_3 Depth=2
	st.d	$t0, $sp, 184                   # 8-byte Folded Spill
	slli.d	$a5, $a6, 1
	ldx.hu	$a7, $s8, $a5
...
# %bb.119:                              #   in Loop: Header=BB1_3 Depth=2
	...
	bnez	$a6, .LBB1_123
	b	.LBB1_121
.LBB1_120:                              #   in Loop: Header=BB1_3 Depth=2
	ori	$t0, $zero, 1
	sll.w	$t0, $t0, $a2
	or	$s0, $t0, $s0
	sub.w	$s3, $s3, $a5
