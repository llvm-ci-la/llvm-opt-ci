...
# %bb.2:                                # %.noexc
	...
	st.d	$a0, $fp, 16
	st.b	$a1, $a0, 0
.LBB3_3:                                # %_ZN8RealNodeC2EfPc.exit
	st.d	$fp, $s0, 0
...
# %bb.9:
	...
	st.w	$s3, $s1, 8
	beqz	$s3, .LBB17_31
# %bb.10:                               # %_ZN4TreeC2EPcS_.exit
	addi.w	$a0, $s3, -1
	st.w	$a0, $s1, 8
	beqz	$a0, .LBB17_32
.LBB17_11:                              # %_ZN4TreeD2Ev.exit25
	ld.d	$s3, $sp, 72
...
# %bb.14:
	...
	st.w	$a0, $s1, 8
	beqz	$a0, .LBB17_33
# %bb.15:                               # %_ZN4TreeD2Ev.exit28
	ld.w	$a0, $fp, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $fp, 8
	beqz	$a0, .LBB17_34
.LBB17_16:                              # %_ZN4TreeD2Ev.exit29
	ld.d	$s4, $sp, 48
	ld.d	$a0, $s4, 0
	lu12i.w	$a1, 267294
	ori	$a1, $a1, 2949
...
# %bb.18:
	...
	st.w	$a0, $s2, 8
	beqz	$a0, .LBB17_35
# %bb.19:                               # %_ZN4TreeD2Ev.exit32
	ld.w	$a0, $fp, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $fp, 8
	beqz	$a0, .LBB17_36
.LBB17_20:                              # %_ZN4TreeD2Ev.exit33
	ld.d	$s5, $sp, 24
	ld.d	$a0, $s5, 0
	ld.d	$a1, $a0, 0
.Ltmp49:                                # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp50:                                # EH_LABEL
# %bb.21:                               # %_ZN4Tree5valueEv.exit35
	ld.w	$a0, $s5, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s5, 8
	beqz	$a0, .LBB17_37
# %bb.22:                               # %_ZN4TreeD2Ev.exit36
	ld.w	$a0, $s4, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s4, 8
	beqz	$a0, .LBB17_38
.LBB17_23:                              # %_ZN4TreeD2Ev.exit37
	ld.w	$a0, $s2, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s2, 8
	beqz	$a0, .LBB17_39
.LBB17_24:                              # %_ZN4TreeD2Ev.exit38
	ld.w	$a0, $s3, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s3, 8
	beqz	$a0, .LBB17_40
.LBB17_25:                              # %_ZN4TreeD2Ev.exit39
	ld.w	$a0, $s1, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s1, 8
	beqz	$a0, .LBB17_41
.LBB17_26:                              # %_ZN4TreeD2Ev.exit40
	ld.w	$a0, $s0, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s0, 8
	beqz	$a0, .LBB17_42
.LBB17_27:                              # %_ZN4TreeD2Ev.exit41
	ld.w	$a0, $fp, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $fp, 8
	beqz	$a0, .LBB17_43
.LBB17_28:                              # %_ZN4TreeD2Ev.exit42
	move	$a0, $zero
...
# %bb.46:
	...
	move	$a0, $s2
	jirl	$ra, $a1, 0
.LBB17_47:                              # %_ZN4TreeD2Ev.exit48
	ld.w	$a0, $fp, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $fp, 8
	move	$s5, $fp
	bnez	$a0, .LBB17_50
.LBB17_48:                              # %_ZN4TreeD2Ev.exit49.sink.split
	ld.d	$a0, $s5, 0
	ld.d	$a1, $a0, 16
	move	$a0, $s5
	jirl	$ra, $a1, 0
...
# %bb.52:
	...
	move	$a0, $s1
	jirl	$ra, $a1, 0
.LBB17_53:                              # %_ZN4TreeD2Ev.exit46
	ld.w	$a0, $fp, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $fp, 8
	move	$s4, $fp
	bnez	$a0, .LBB17_63
.LBB17_54:                              # %_ZN4TreeD2Ev.exit47.sink.split
	ld.d	$a0, $s4, 0
	ld.d	$a1, $a0, 16
	move	$a0, $s4
	jirl	$ra, $a1, 0
...
.LBB17_63:
	...
	st.w	$a0, $s2, 8
	bnez	$a0, .LBB17_65
.LBB17_64:                              # %_ZN4TreeD2Ev.exit45.sink.split
	ld.d	$a0, $s2, 0
	ld.d	$a1, $a0, 16
	move	$a0, $s2
	jirl	$ra, $a1, 0
.LBB17_65:                              # %_ZN4TreeD2Ev.exit45
	ld.d	$a0, $sp, 72
	ld.w	$a1, $a0, 8
	addi.w	$a1, $a1, -1
	st.w	$a1, $a0, 8
	bnez	$a1, .LBB17_67
.LBB17_66:                              # %_ZN4TreeD2Ev.exit44.sink.split
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
	jirl	$ra, $a1, 0
.LBB17_67:                              # %_ZN4TreeD2Ev.exit44
	ld.w	$a0, $s1, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s1, 8
	beqz	$a0, .LBB17_71
# %bb.68:                               # %_ZN4TreeD2Ev.exit54
	ld.w	$a0, $s0, 8
	addi.w	$a0, $a0, -1
	st.w	$a0, $s0, 8
	beqz	$a0, .LBB17_72
