...
# %bb.5:                                # %._crit_edge.us
	...
	blt	$s8, $a0, .LBB7_3
	b	.LBB7_8
.LBB7_6:                                # %.lr.ph18.split.preheader
	pcalau12i	$a0, %pc_hi20(global_data)
	addi.d	$fp, $a0, %pc_lo12(global_data)
	move	$s7, $zero
	lu12i.w	$a0, 31
...
# %bb.5:                                #   in Loop: Header=BB9_4 Depth=1
	move	$a1, $zero
.LBB9_6:                                # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB9_4 Depth=1
	alsl.d	$a0, $a1, $s0, 2
	sub.d	$a1, $fp, $a1
	.p2align	4, , 16
.LBB9_7:                                # %vec.epilog.scalar.ph
