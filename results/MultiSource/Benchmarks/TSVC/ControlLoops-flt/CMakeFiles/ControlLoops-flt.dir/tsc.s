...
# %bb.6:                                # %pred.store.continue
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_14
.LBB10_7:                               # %pred.store.continue22
                                        #   in Loop: Header=BB10_5 Depth=2
	xvpickve2gr.w	$a2, $xr1, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_15
.LBB10_8:                               # %pred.store.continue24
                                        #   in Loop: Header=BB10_5 Depth=2
	xvpickve2gr.w	$a2, $xr1, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_16
.LBB10_9:                               # %pred.store.continue26
                                        #   in Loop: Header=BB10_5 Depth=2
	xvpickve2gr.w	$a2, $xr1, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_17
.LBB10_10:                              # %pred.store.continue28
                                        #   in Loop: Header=BB10_5 Depth=2
	xvpickve2gr.w	$a2, $xr1, 5
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_18
.LBB10_11:                              # %pred.store.continue30
                                        #   in Loop: Header=BB10_5 Depth=2
	xvpickve2gr.w	$a2, $xr1, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_19
.LBB10_12:                              # %pred.store.continue32
                                        #   in Loop: Header=BB10_5 Depth=2
...
.LBB10_13:                              # %pred.store.if
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_7
.LBB10_14:                              # %pred.store.if21
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 4, 1
	xvpickve2gr.w	$a2, $xr1, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_8
.LBB10_15:                              # %pred.store.if23
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 8, 2
	xvpickve2gr.w	$a2, $xr1, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_9
.LBB10_16:                              # %pred.store.if25
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 12, 3
	xvpickve2gr.w	$a2, $xr1, 4
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_10
.LBB10_17:                              # %pred.store.if27
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 16, 4
	xvpickve2gr.w	$a2, $xr1, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_11
.LBB10_18:                              # %pred.store.if29
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 20, 5
	xvpickve2gr.w	$a2, $xr1, 6
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_12
.LBB10_19:                              # %pred.store.if31
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 24, 6
	xvpickve2gr.w	$a2, $xr1, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_4
.LBB10_20:                              # %pred.store.if33
                                        #   in Loop: Header=BB10_5 Depth=2
