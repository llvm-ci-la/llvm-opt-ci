...
# %bb.6:                                #   in Loop: Header=BB6_4 Depth=1
	...
	b	.LBB6_10
	.p2align	4, , 16
.LBB6_7:                                # %vector.body30.preheader
                                        #   in Loop: Header=BB6_4 Depth=1
...
.LBB6_10:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB6_4 Depth=1
	alsl.d	$a0, $a2, $a0, 2
	addi.d	$a0, $a0, 4
	alsl.d	$a1, $a2, $fp, 2
...
.LBB7_8:                                # %scalar.ph28
	...
	b	.LBB7_4
	.p2align	4, , 16
.LBB7_9:                                # %vector.body30.preheader
                                        #   in Loop: Header=BB7_5 Depth=1
	addi.d	$a0, $a0, 32
	move	$a1, $fp
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
...
# %bb.8:                                # %vec.epilog.vector.body
	...
	lu12i.w	$a1, 7
	ori	$a3, $a1, 3324
.LBB9_9:                                # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB9_4 Depth=1
	alsl.d	$a1, $a3, $fp, 2
	alsl.d	$a0, $a3, $a0, 2
...
# %bb.6:                                # %vec.epilog.vector.body
	...
	lu12i.w	$a1, 7
	ori	$a4, $a1, 3324
.LBB10_7:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB10_2 Depth=1
	alsl.d	$a1, $a4, $fp, 2
	alsl.d	$a2, $a4, $s8, 2
