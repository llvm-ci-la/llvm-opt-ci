...
# %bb.9:                                # %.preheader86.i.preheader
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB15_10:                              # %.preheader86.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB15_11 Depth 2
	move	$a5, $a2
	.p2align	4, , 16
.LBB15_11:                              #   Parent Loop BB15_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a6, $a1, $a5
	fldx.d	$fa2, $a6, $a3
	addi.d	$a5, $a5, 8
