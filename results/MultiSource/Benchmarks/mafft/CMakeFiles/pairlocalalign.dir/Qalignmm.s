...
.LBB3_44:                               # %vector.memcheck
	...
	vreplgr2vr.d	$vr2, $t0
	vreplgr2vr.d	$vr3, $a6
	vslt.du	$vr4, $vr3, $vr10
	vslt.du	$vr3, $vr3, $vr12
	vpickev.w	$vr3, $vr3, $vr4
	vslt.du	$vr4, $vr2, $vr10
	vslt.du	$vr2, $vr2, $vr12
	vpickev.w	$vr2, $vr2, $vr4
	vpickev.h	$vr2, $vr2, $vr3
	vreplgr2vr.d	$vr3, $t5
	vreplgr2vr.d	$vr4, $t4
	vslt.du	$vr5, $vr11, $vr4
	vslt.du	$vr4, $vr14, $vr4
...
.LBB3_54:                               # %vector.memcheck900
	...
	move	$t2, $zero
	bnez	$s1, .LBB3_32
# %bb.55:                               # %vector.memcheck900
	sltu	$s1, $a5, $t5
	sltu	$s2, $t0, $t6
	and	$s1, $s1, $s2
	bnez	$s1, .LBB3_249
# %bb.56:                               # %vector.memcheck900
	sltu	$s0, $a5, $s0
	sltu	$s1, $a0, $t6
	and	$s0, $s0, $s1
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	bnez	$s0, .LBB3_32
# %bb.57:                               # %vector.memcheck900
	sltu	$fp, $a5, $fp
	sltu	$s0, $a1, $t6
	and	$fp, $fp, $s0
	bnez	$fp, .LBB3_32
# %bb.58:                               # %vector.memcheck900
	...
	and	$t8, $t8, $fp
	bnez	$t8, .LBB3_32
# %bb.59:                               # %vector.memcheck900
	sltu	$t7, $a5, $t7
	sltu	$t6, $a7, $t6
	and	$t6, $t7, $t6
	bnez	$t6, .LBB3_32
# %bb.60:                               # %vector.memcheck900
	sltu	$t5, $a6, $t5
	sltu	$t4, $t0, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB3_32
...
.LBB3_62:                               # %vector.body1036
	...
	addi.d	$t3, $t3, 16
	bnez	$s2, .LBB3_62
# %bb.63:                               # %middle.block1050
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	bne	$t1, $t2, .LBB3_32
	b	.LBB3_34
.LBB3_64:                               # %clearvec.exit.thread
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	sltui	$a0, $a0, 1
.LBB3_65:                               # %imp_match_out_vead_tateQ.exit
	st.d	$a0, $sp, 200                   # 8-byte Folded Spill
.LBB3_66:                               # %imp_match_out_vead_tateQ.exit
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
	ld.bu	$a0, $a0, 0
	ori	$a1, $zero, 114
	slli.d	$s3, $s8, 32
...
.LBB3_75:                               # %.lr.ph.i526
	...
	move	$a2, $a3
	bnez	$a0, .LBB3_75
.LBB3_76:                               # %imp_match_out_veadQ.exit
...
# %bb.78:                               # %.lr.ph586
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB3_169
.LBB3_79:                               # %scalar.ph1128.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_80:                               # %scalar.ph1128
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a2, 0
...
# %bb.82:                               # %.lr.ph589
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB3_175
.LBB3_83:                               # %scalar.ph1166.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a5, $a4, $t3, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB3_84:                               # %scalar.ph1166
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a5, 0
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB3_84
.LBB3_85:                               # %.loopexit557.thread751
	ld.d	$a0, $sp, 312                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Q__align.m)
	st.w	$zero, $a0, 0
	b	.LBB3_102
.LBB3_86:                               # %.preheader560
	blez	$ra, .LBB3_94
# %bb.87:                               # %.lr.ph579
...
.LBB3_89:                               # %vector.body1085
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_89
# %bb.90:                               # %middle.block1090
	beq	$a2, $a4, .LBB3_94
.LBB3_91:                               # %scalar.ph1078.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_92:                               # %scalar.ph1078
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
	...
	bnez	$a1, .LBB3_92
	b	.LBB3_94
.LBB3_93:                               # %imp_match_out_veadQ.exit.thread
	pcalau12i	$a0, %got_pc_hi20(outgap)
	ld.d	$a0, $a0, %got_pc_lo12(outgap)
	ld.w	$a0, $a0, 0
	ori	$a1, $zero, 1
	beq	$a0, $a1, .LBB3_77
.LBB3_94:                               # %.preheader558
	blez	$s2, .LBB3_101
# %bb.95:                               # %.lr.ph582
	pcalau12i	$a0, %got_pc_hi20(offset)
	ld.d	$a0, $a0, %got_pc_lo12(offset)
...
.LBB3_97:                               # %vector.body1100
	...
	addi.d	$a6, $a6, 16
	bnez	$a7, .LBB3_97
# %bb.98:                               # %middle.block1107
	beq	$a3, $a5, .LBB3_101
.LBB3_99:                               # %scalar.ph1093.preheader
	mul.d	$a3, $a0, $a4
	alsl.d	$a1, $a4, $a1, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_100:                              # %scalar.ph1093
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a1, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB3_102:                              # %.lr.ph593
	...
	ori	$a4, $zero, 1
	bltu	$a3, $a5, .LBB3_107
# %bb.103:                              # %vector.memcheck1186
	sub.d	$a5, $a0, $t3
	addi.d	$a5, $a5, 4
	ori	$a6, $zero, 32
	bltu	$a5, $a6, .LBB3_107
# %bb.104:                              # %vector.ph1189
	move	$a6, $zero
	move	$a5, $a3
...
.LBB3_105:                              # %vector.body1194
	...
	addi.d	$a6, $a6, 32
	bnez	$t0, .LBB3_105
# %bb.106:                              # %middle.block1200
	beq	$a3, $a5, .LBB3_109
.LBB3_107:                              # %scalar.ph1187.preheader
...
.LBB3_109:
	move	$t2, $zero
	b	.LBB3_112
.LBB3_110:                              # %.loopexit557.thread
	ld.d	$a0, $sp, 312                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Q__align.m)
	st.w	$zero, $a0, 0
.LBB3_111:                              # %._crit_edge594
	ori	$t2, $zero, 1
	beqz	$ra, .LBB3_243
.LBB3_112:                              # %._crit_edge594.thread
	ori	$a1, $zero, 0
	lu32i.d	$a1, -1
	add.d	$a1, $s3, $a1
	srai.d	$a1, $a1, 30
...
# %bb.117:                              #   in Loop: Header=BB3_116 Depth=1
	ld.d	$a0, $sp, 320                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_125
# %bb.118:                              # %clearvec.exit529.thread
                                        #   in Loop: Header=BB3_116 Depth=1
	move	$a0, $t2
	move	$a1, $zero
...
.LBB3_120:                              # %.lr.ph.preheader.i531
	...
	ori	$a1, $zero, 7
	bltu	$a0, $a1, .LBB3_123
# %bb.121:                              # %vector.memcheck1203
                                        #   in Loop: Header=BB3_116 Depth=1
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	add.d	$a0, $a3, $a1
	bgeu	$t2, $a0, .LBB3_134
# %bb.122:                              # %vector.memcheck1203
                                        #   in Loop: Header=BB3_116 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a3, $a0, .LBB3_134
...
.LBB3_124:                              # %.lr.ph.i532
	...
	move	$a1, $a3
	bnez	$a2, .LBB3_124
.LBB3_125:                              # %imp_match_out_veadQ.exit537
                                        #   in Loop: Header=BB3_116 Depth=1
	slli.d	$a1, $s8, 2
	fldx.s	$fa0, $t5, $a1
	fst.s	$fa0, $t2, 0
...
# %bb.131:                              #   in Loop: Header=BB3_128 Depth=2
	...
	stx.w	$t1, $a6, $a3
	fmov.s	$fs0, $ft4
.LBB3_132:                              #   in Loop: Header=BB3_128 Depth=2
	fld.s	$ft4, $t0, -4
	fmul.s	$ft4, $fa1, $ft4
	fadd.s	$ft4, $ft1, $ft4
	fcmp.cult.s	$fcc0, $ft4, $ft3
	bcnez	$fcc0, .LBB3_127
# %bb.133:                              #   in Loop: Header=BB3_128 Depth=2
	fstx.s	$ft4, $s6, $a3
	stx.w	$t6, $fp, $a3
	b	.LBB3_127
.LBB3_134:                              # %vector.ph1211
                                        #   in Loop: Header=BB3_116 Depth=1
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.d	$a0, $a3, $a1
	add.d	$a1, $t2, $a1
...
.LBB3_137:
	...
	bnez	$a1, .LBB3_153
	b	.LBB3_139
.LBB3_138:                              # %._crit_edge631.loopexit
...
.LBB3_142:                              # %vector.body1240
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_142
# %bb.143:                              # %middle.block1247
	beq	$a2, $a4, .LBB3_146
.LBB3_144:                              # %scalar.ph1231.preheader
	sub.w	$a2, $s8, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_149:                              # %vector.body1255
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB3_149
# %bb.150:                              # %middle.block1260
	beq	$a3, $a5, .LBB3_153
.LBB3_151:                              # %scalar.ph1250.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_152:                              # %scalar.ph1250
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_169:                              # %vector.memcheck1110
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_79
# %bb.170:                              # %vector.memcheck1110
	addi.d	$t0, $a1, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a1, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_79
# %bb.171:                              # %vector.memcheck1110
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB3_173:                              # %vector.body1133
	...
	addi.d	$t0, $t0, 16
	bnez	$t2, .LBB3_173
# %bb.174:                              # %middle.block1145
	bne	$a6, $t1, .LBB3_79
	b	.LBB3_81
.LBB3_175:                              # %vector.memcheck1148
	addi.d	$a6, $t3, 4
	alsl.d	$t0, $a3, $t3, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_83
# %bb.176:                              # %vector.memcheck1148
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_83
# %bb.177:                              # %vector.memcheck1148
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_179:                              # %vector.body1171
	...
	addi.d	$a7, $a7, 16
	bnez	$t1, .LBB3_179
# %bb.180:                              # %middle.block1183
	bne	$a5, $t0, .LBB3_83
	b	.LBB3_85
.LBB3_181:                              # %vector.ph1265
...
.LBB3_182:                              # %vector.body1268
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_182
# %bb.183:                              # %middle.block1275
	beq	$a1, $a3, .LBB3_186
.LBB3_184:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $s2, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
...
.LBB3_190:                              # %vector.body1283
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_190
# %bb.191:                              # %middle.block1289
	beq	$a4, $a5, .LBB3_194
.LBB3_192:                              # %scalar.ph1278.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_193:                              # %scalar.ph1278
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_196:                              # %.lr.ph41.i
	...
	ldx.w	$t3, $t0, $t5
	bltz	$t3, .LBB3_204
# %bb.197:                              #   in Loop: Header=BB3_196 Depth=1
	beqz	$t3, .LBB3_225
# %bb.198:                              #   in Loop: Header=BB3_196 Depth=1
	...
	add.w	$t7, $s7, $t6
	beqz	$t7, .LBB3_205
.LBB3_199:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_196 Depth=1
	bltu	$t7, $a5, .LBB3_211
# %bb.200:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_196 Depth=1
	sub.d	$t8, $s3, $s5
	bltu	$t8, $a5, .LBB3_211
# %bb.201:                              # %vector.ph1321
                                        #   in Loop: Header=BB3_196 Depth=1
...
.LBB3_204:                              #   in Loop: Header=BB3_196 Depth=1
	...
	bnez	$t7, .LBB3_199
	.p2align	4, , 16
.LBB3_205:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_196 Depth=1
	beq	$t3, $s8, .LBB3_215
.LBB3_206:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_196 Depth=1
	addi.w	$t6, $zero, -9
	nor	$fp, $t3, $zero
	bltu	$t6, $t3, .LBB3_216
# %bb.207:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_196 Depth=1
	sub.d	$t6, $s3, $s5
	bltu	$t6, $a4, .LBB3_216
# %bb.208:                              # %vector.ph1298
                                        #   in Loop: Header=BB3_196 Depth=1
...
.LBB3_211:                              #   in Loop: Header=BB3_196 Depth=1
	move	$t8, $s5
	move	$fp, $s3
.LBB3_212:                              # %.lr.ph19.i.preheader1352
                                        #   in Loop: Header=BB3_196 Depth=1
	move	$s0, $t8
	move	$s1, $fp
	.p2align	4, , 16
.LBB3_213:                              # %.lr.ph19.i
	...
	move	$s1, $fp
	bnez	$t7, .LBB3_213
.LBB3_214:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_196 Depth=1
	add.d	$a7, $s7, $a7
	add.d	$a7, $t6, $a7
	move	$s3, $fp
...
.LBB3_215:                              #   in Loop: Header=BB3_196 Depth=1
	...
	b	.LBB3_222
	.p2align	4, , 16
.LBB3_216:                              #   in Loop: Header=BB3_196 Depth=1
	move	$t8, $fp
	move	$t6, $s5
	move	$t7, $s3
.LBB3_217:                              # %.lr.ph29.i.preheader
                                        #   in Loop: Header=BB3_196 Depth=1
	add.d	$a7, $a7, $t8
	.p2align	4, , 16
.LBB3_218:                              # %.lr.ph29.i
	...
	addi.d	$t6, $t6, -1
	bnez	$t8, .LBB3_218
.LBB3_219:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_196 Depth=1
	beq	$t1, $ra, .LBB3_222
.LBB3_220:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_196 Depth=1
...
# %bb.221:                              #   in Loop: Header=BB3_196 Depth=1
	...
	fadd.s	$fa3, $fa3, $fa4
	fst.s	$fa3, $a1, 0
.LBB3_222:                              #   in Loop: Header=BB3_196 Depth=1
	blez	$t1, .LBB3_227
# %bb.223:                              #   in Loop: Header=BB3_196 Depth=1
	blez	$t2, .LBB3_227
# %bb.224:                              #   in Loop: Header=BB3_196 Depth=1
	...
	b	.LBB3_226
	.p2align	4, , 16
.LBB3_225:                              #   in Loop: Header=BB3_196 Depth=1
	addi.d	$t0, $s7, -1
	move	$t3, $s8
	nor	$t6, $t0, $zero
	add.w	$t7, $s7, $t6
...
.LBB3_229:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_229
.LBB3_230:                              # %.preheader.i
	ld.d	$s7, $sp, 64                    # 8-byte Folded Reload
	blez	$s7, .LBB3_233
# %bb.231:                              # %.lr.ph52.preheader.i
...
.LBB3_232:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB3_232
.LBB3_233:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 400                   # 8-byte Folded Reload
...
.LBB6_2:
	...
	st.d	$a0, $sp, 280                   # 8-byte Folded Spill
	pcalau12i	$a1, %pc_hi20(Q__align_gapmap.ogcp1g)
...
.LBB6_7:
	...
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	st.w	$s6, $a0, %pc_lo12(Q__align_gapmap.orlgth1)
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
...
# %bb.9:                                # %.lr.ph
	ld.d	$a0, $s3, %pc_lo12(Q__align_gapmap.mseq)
	ld.d	$a1, $s5, %pc_lo12(Q__align_gapmap.mseq1)
...
.LBB6_24:
	addi.w	$a0, $zero, -1
	vld	$vr18, $sp, 288                 # 16-byte Folded Reload
	fcvt.d.s	$fa0, $ft10
...
# %bb.35:
	beqz	$s2, .LBB6_104
# %bb.36:                               # %.lr.ph.preheader.i
	ld.d	$s3, $s4, %pc_lo12(Q__align_gapmap.initverticalw)
	slli.d	$a0, $s8, 2
	bstrpick.d	$a0, $a0, 33, 2
	slli.d	$a2, $a0, 2
	move	$a0, $s3
...
# %bb.52:
	...
	ld.d	$a3, $s4, %pc_lo12(Q__align_gapmap.initverticalw)
	movgr2fr.w	$fa7, $zero
	fmadd.s	$fa0, $fa0, $fa1, $fa7
	fld.s	$fa1, $a1, 0
	fld.s	$fa7, $a3, 0
...
# %bb.53:                               # %.lr.ph582
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB6_158
.LBB6_54:                               # %scalar.ph1085.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a3, $a6, $a3, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_55:                               # %scalar.ph1085
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
# %bb.57:                               # %.lr.ph585
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB6_164
.LBB6_58:                               # %scalar.ph1123.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a6, $a5, $t5, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_59:                               # %scalar.ph1123
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a6, 0
...
.LBB6_64:                               # %vector.body1043
	...
	addi.d	$a6, $a6, 16
	bnez	$a7, .LBB6_64
# %bb.65:                               # %middle.block1047
	beq	$a3, $a5, .LBB6_68
.LBB6_66:                               # %scalar.ph1036.preheader
	mul.d	$a3, $a1, $a4
	alsl.d	$a5, $a4, $t5, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_67:                               # %scalar.ph1036
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a5, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
# %bb.69:                               # %.lr.ph578
	...
	ld.d	$a1, $a1, %got_pc_lo12(offset)
	ld.w	$a1, $a1, 0
	ld.d	$a2, $s4, %pc_lo12(Q__align_gapmap.initverticalw)
	addi.d	$a3, $s8, 1
	bstrpick.d	$a3, $a3, 31, 0
	addi.d	$a4, $a3, -1
	ori	$a6, $zero, 4
...
.LBB6_71:                               # %vector.body1057
	...
	addi.d	$a7, $a7, 16
	bnez	$t0, .LBB6_71
# %bb.72:                               # %middle.block1064
	beq	$a4, $a6, .LBB6_75
.LBB6_73:                               # %scalar.ph1050.preheader
	mul.d	$a4, $a1, $a5
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $a3, $a5
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_74:                               # %scalar.ph1050
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a2, 0
	movgr2fr.w	$fa2, $a4
	ffint.d.w	$fa2, $fa2
...
.LBB6_79:                               # %vector.body1151
	...
	addi.d	$a7, $a7, 32
	bnez	$t1, .LBB6_79
# %bb.80:                               # %middle.block1157
	beq	$a4, $a6, .LBB6_83
.LBB6_81:                               # %scalar.ph1144.preheader
	ld.d	$a4, $sp, 256                   # 8-byte Folded Reload
...
.LBB6_102:                              # %vector.body1019
	...
	addi.d	$t3, $t3, 16
	bnez	$s2, .LBB6_102
# %bb.103:                              # %middle.block1033
	ld.d	$s2, $sp, 96                    # 8-byte Folded Reload
	bne	$t1, $t2, .LBB6_32
	b	.LBB6_34
.LBB6_104:                              # %clearvec.exit.thread
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	sltui	$a0, $a0, 1
	st.d	$a0, $sp, 136                   # 8-byte Folded Spill
	ld.d	$t4, $sp, 360                   # 8-byte Folded Reload
	...
	beq	$a0, $a1, .LBB6_43
	b	.LBB6_46
.LBB6_105:                              # %.loopexit557.thread
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Q__align_gapmap.m)
	st.w	$zero, $a1, 0
.LBB6_106:                              # %._crit_edge590
	ori	$t2, $zero, 1
	beqz	$t4, .LBB6_233
.LBB6_107:                              # %._crit_edge590.thread
	ori	$a2, $zero, 0
	lu32i.d	$a2, -1
	add.d	$a2, $a0, $a2
	srai.d	$a2, $a2, 30
...
# %bb.109:                              # %.lr.ph626
	...
	ld.d	$t3, $s4, %pc_lo12(Q__align_gapmap.initverticalw)
	ld.d	$a2, $sp, 384                   # 8-byte Folded Reload
...
# %bb.112:                              #   in Loop: Header=BB6_111 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	bnez	$a0, .LBB6_117
# %bb.113:                              # %clearvec.exit537.thread
                                        #   in Loop: Header=BB6_111 Depth=1
	move	$a0, $t1
	move	$a1, $zero
...
.LBB6_116:                              # %.lr.ph.i539
	...
	move	$a2, $a4
	bnez	$a1, .LBB6_116
.LBB6_117:                              # %imp_match_out_veadQ_gapmap.exit544
                                        #   in Loop: Header=BB6_111 Depth=1
	fldx.s	$fa0, $t3, $t5
	fst.s	$fa0, $t1, 0
	addi.d	$a0, $s8, 1
...
# %bb.123:                              #   in Loop: Header=BB6_120 Depth=2
	...
	stx.w	$t0, $a5, $a2
	fmov.s	$fs0, $ft4
.LBB6_124:                              #   in Loop: Header=BB6_120 Depth=2
	fld.s	$ft4, $a7, -4
	fmul.s	$ft4, $fa1, $ft4
	fadd.s	$ft4, $ft1, $ft4
	fcmp.cult.s	$fcc0, $ft4, $ft3
	bcnez	$fcc0, .LBB6_119
# %bb.125:                              #   in Loop: Header=BB6_120 Depth=2
	fstx.s	$ft4, $s2, $a2
	stx.w	$t2, $s0, $a2
	b	.LBB6_119
.LBB6_126:
	...
	bnez	$s0, .LBB6_142
	b	.LBB6_128
.LBB6_127:                              # %._crit_edge627.loopexit
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.w	$s0, $a0, 0
	move	$t5, $t1
...
.LBB6_131:                              # %vector.body1169
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_131
# %bb.132:                              # %middle.block1176
	beq	$a2, $a4, .LBB6_135
.LBB6_133:                              # %scalar.ph1160.preheader
	ld.d	$a2, $sp, 312                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t5, 2
...
.LBB6_138:                              # %vector.body1184
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB6_138
# %bb.139:                              # %middle.block1189
	beq	$a3, $a5, .LBB6_142
.LBB6_140:                              # %scalar.ph1179.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_141:                              # %scalar.ph1179
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
# %bb.146:                              # %.lr.ph.i545
	...
	b	.LBB6_148
	.p2align	4, , 16
.LBB6_147:                              #   in Loop: Header=BB6_148 Depth=1
	addi.d	$a5, $a5, -1
	addi.d	$a6, $a6, -1
	addi.d	$s8, $s8, 4
	beqz	$a5, .LBB6_150
...
.LBB6_158:                              # %vector.memcheck1067
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_54
# %bb.159:                              # %vector.memcheck1067
	addi.d	$t1, $a2, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a2, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_54
# %bb.160:                              # %vector.memcheck1067
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB6_162:                              # %vector.body1090
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB6_162
# %bb.163:                              # %middle.block1102
	bne	$a7, $t2, .LBB6_54
	b	.LBB6_56
.LBB6_164:                              # %vector.memcheck1105
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB6_58
# %bb.165:                              # %vector.memcheck1105
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB6_58
# %bb.166:                              # %vector.memcheck1105
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB6_168:                              # %vector.body1128
	...
	addi.d	$t0, $t0, 16
	bnez	$t2, .LBB6_168
# %bb.169:                              # %middle.block1140
	bne	$a6, $t1, .LBB6_58
	b	.LBB6_60
.LBB6_170:                              # %vector.ph1194
...
.LBB6_171:                              # %vector.body1197
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_171
# %bb.172:                              # %middle.block1204
	beq	$a3, $a4, .LBB6_175
.LBB6_173:                              # %.lr.ph17.i.preheader
	alsl.d	$a5, $a4, $s3, 3
	sub.d	$a3, $a3, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
...
.LBB6_179:                              # %vector.body1212
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_179
# %bb.180:                              # %middle.block1218
	beq	$a3, $a4, .LBB6_183
.LBB6_181:                              # %scalar.ph1207.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_182:                              # %scalar.ph1207
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.190:                              # %.lr.ph53.i
	...
	b	.LBB6_192
	.p2align	4, , 16
.LBB6_191:                              # %._crit_edge47.i
                                        #   in Loop: Header=BB6_192 Depth=1
	addi.w	$a4, $a4, 2
	move	$s7, $t2
	blt	$a2, $a4, .LBB6_222
.LBB6_192:                              # =>This Loop Header: Depth=1
                                        #     Child Loop BB6_199 Depth 2
                                        #       Child Loop BB6_200 Depth 3
                                        #       Child Loop BB6_202 Depth 3
                                        #     Child Loop BB6_207 Depth 2
                                        #       Child Loop BB6_208 Depth 3
	...
	ldx.w	$t6, $t2, $t5
	bltz	$t6, .LBB6_195
# %bb.193:                              #   in Loop: Header=BB6_192 Depth=1
	beqz	$t6, .LBB6_196
# %bb.194:                              #   in Loop: Header=BB6_192 Depth=1
	sub.w	$t2, $s7, $t6
	b	.LBB6_197
	.p2align	4, , 16
.LBB6_195:                              #   in Loop: Header=BB6_192 Depth=1
	addi.w	$t2, $s7, -1
	nor	$t7, $t2, $zero
	add.w	$t8, $s7, $t7
	bnez	$t8, .LBB6_199
	b	.LBB6_204
	.p2align	4, , 16
.LBB6_196:                              #   in Loop: Header=BB6_192 Depth=1
	addi.w	$t2, $s7, -1
.LBB6_197:                              #   in Loop: Header=BB6_192 Depth=1
	...
	b	.LBB6_204
	.p2align	4, , 16
.LBB6_198:                              # %._crit_edge29.i
                                        #   in Loop: Header=BB6_199 Depth=2
	addi.d	$t8, $t8, -1
	ld.d	$s6, $sp, 424                   # 8-byte Folded Reload
	ld.d	$s8, $sp, 416                   # 8-byte Folded Reload
	beqz	$t8, .LBB6_203
.LBB6_199:                              # %.preheader3.i
                                        #   Parent Loop BB6_192 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB6_200 Depth 3
                                        #       Child Loop BB6_202 Depth 3
	move	$fp, $s8
...
.LBB6_202:                              # %.lr.ph28.i
	...
	b	.LBB6_198
	.p2align	4, , 16
.LBB6_203:                              # %._crit_edge32.loopexit.i
                                        #   in Loop: Header=BB6_192 Depth=1
	add.d	$a4, $s7, $a4
	add.d	$a4, $t7, $a4
.LBB6_204:                              # %._crit_edge32.i
                                        #   in Loop: Header=BB6_192 Depth=1
	add.w	$t1, $t6, $t1
	ld.d	$s7, $sp, 128                   # 8-byte Folded Reload
	ld.d	$t7, $sp, 280                   # 8-byte Folded Reload
	beq	$t6, $t7, .LBB6_211
# %bb.205:                              # %.preheader1.preheader.i
                                        #   in Loop: Header=BB6_192 Depth=1
	nor	$t6, $t6, $zero
	b	.LBB6_207
	.p2align	4, , 16
.LBB6_206:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB6_207 Depth=2
	addi.d	$t6, $t6, -1
	addi.d	$a4, $a4, 1
	beqz	$t6, .LBB6_211
.LBB6_207:                              # %.preheader1.i
                                        #   Parent Loop BB6_192 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB6_208 Depth 3
                                        #       Child Loop BB6_210 Depth 3
...
.LBB6_210:                              # %.lr.ph37.i
	...
	b	.LBB6_206
	.p2align	4, , 16
.LBB6_211:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB6_192 Depth=1
	beq	$t3, $a1, .LBB6_214
# %bb.212:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB6_192 Depth=1
	addi.w	$t6, $a0, 0
	beq	$t4, $t6, .LBB6_214
# %bb.213:                              #   in Loop: Header=BB6_192 Depth=1
	slli.d	$t6, $t3, 2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a3, 0
.LBB6_214:                              #   in Loop: Header=BB6_192 Depth=1
	blez	$t3, .LBB6_223
# %bb.215:                              #   in Loop: Header=BB6_192 Depth=1
	blez	$t4, .LBB6_223
# %bb.216:                              # %.preheader5.i
                                        #   in Loop: Header=BB6_192 Depth=1
	blez	$s6, .LBB6_219
# %bb.217:                              # %.lr.ph44.i
	...
	move	$t5, $a6
	.p2align	4, , 16
.LBB6_218:                              #   Parent Loop BB6_192 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $t3, 0
	ld.d	$t7, $t4, 0
	ldx.b	$t6, $t6, $t2
...
# %bb.220:                              # %.lr.ph46.i
	...
	move	$t5, $a7
	.p2align	4, , 16
.LBB6_221:                              #   Parent Loop BB6_192 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $s7, 0
	ld.d	$t7, $t4, 0
	ldx.b	$t6, $t6, $t1
...
.LBB6_222:
	ld.d	$s7, $sp, 128                   # 8-byte Folded Reload
.LBB6_223:                              # %Atracking_localhom_gapmap.exit
	ld.d	$fp, $sp, 80                    # 8-byte Folded Reload
.LBB6_224:                              # %Atracking_localhom_gapmap.exit
	ld.d	$a0, $s4, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	blt	$a2, $a3, .LBB6_234
# %bb.225:                              # %Atracking_localhom_gapmap.exit
	ori	$a0, $a4, 2881
	bge	$a3, $a0, .LBB6_234
# %bb.226:
	blez	$s6, .LBB6_229
