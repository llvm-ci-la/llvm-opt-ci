	.file	"genGalign11.c"
	.text
	.globl	genG__align11                   # -- Begin function genG__align11
	.p2align	5
...
# %bb.0:
	...
	pcalau12i	$s8, %pc_hi20(genG__align11.orlgth1)
	ld.w	$a1, $s8, %pc_lo12(genG__align11.orlgth1)
	ld.w	$s4, $a0, 0
...
# %bb.3:
	blez	$s3, .LBB0_97
.LBB0_4:
	ld.w	$s7, $s8, %pc_lo12(genG__align11.orlgth1)
	pcalau12i	$s6, %pc_hi20(genG__align11.orlgth2)
	ld.w	$s1, $s6, %pc_lo12(genG__align11.orlgth2)
	...
	pcalau12i	$a0, %pc_hi20(genG__align11.mseq)
...
# %bb.8:
	...
	ld.d	$a0, $a0, %pc_lo12(genG__align11.mseq)
...
.LBB0_9:
	...
	st.d	$a0, $s8, %pc_lo12(genG__align11.mseq)
	ori	$a0, $zero, 26
	move	$a1, $s6
	...
	st.w	$s7, $s8, %pc_lo12(genG__align11.orlgth1)
	ld.d	$s6, $sp, 160                   # 8-byte Folded Reload
	st.w	$s1, $s6, %pc_lo12(genG__align11.orlgth2)
...
.LBB0_34:                               # %vector.body376
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_34
# %bb.35:                               # %middle.block382
	beq	$a3, $t1, .LBB0_39
.LBB0_36:                               # %.lr.ph260.preheader420
	alsl.d	$a3, $t0, $a4, 2
	sub.d	$a2, $a2, $t0
	.p2align	4, , 16
.LBB0_37:                               # %.lr.ph260
...
.LBB0_39:                               # %.lr.ph263
	...
	ori	$t3, $zero, 1
	bgeu	$t4, $t5, .LBB0_44
.LBB0_40:                               # %scalar.ph390.preheader
	alsl.d	$t4, $t3, $a4, 2
	addi.d	$t4, $t4, -4
	alsl.d	$a2, $t3, $a2, 2
	alsl.d	$a3, $t3, $a3, 2
...
# %bb.53:                               # %.lr.ph296
	...
	b	.LBB0_56
	.p2align	4, , 16
.LBB0_54:                               # %match_calc.exit253.thread
                                        #   in Loop: Header=BB0_56 Depth=1
	fldx.s	$fa4, $a1, $a4
	fst.s	$fa4, $t6, 0
.LBB0_55:                               # %._crit_edge285
                                        #   in Loop: Header=BB0_56 Depth=1
	fldx.s	$fa4, $t6, $a6
	addi.d	$t5, $t5, 1
	fstx.s	$fa4, $a7, $a4
...
.LBB0_58:                               # %.lr.ph.i248
	...
	move	$a2, $t2
	bnez	$a3, .LBB0_58
# %bb.59:                               # %match_calc.exit253
                                        #   in Loop: Header=BB0_56 Depth=1
	fldx.s	$fa4, $a1, $a4
	fst.s	$fa4, $t6, 0
	blez	$s3, .LBB0_55
# %bb.60:                               # %.lr.ph284.preheader
                                        #   in Loop: Header=BB0_56 Depth=1
	fld.s	$fa4, $a5, 0
	slli.d	$a0, $t5, 3
...
.LBB0_80:                               # %vector.body411
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB0_80
# %bb.81:                               # %middle.block414
	beq	$a3, $a4, .LBB0_84
.LBB0_82:                               # %scalar.ph406.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	addi.w	$a4, $zero, -1
...
.LBB0_90:                               # %.lr.ph14.i
	...
	addi.d	$a3, $a3, 1
	bnez	$a0, .LBB0_90
.LBB0_91:                               # %._crit_edge15.i
                                        #   in Loop: Header=BB0_86 Depth=1
	blez	$a6, .LBB0_94
# %bb.92:                               # %._crit_edge15.i
                                        #   in Loop: Header=BB0_86 Depth=1
	blez	$a7, .LBB0_94
# %bb.93:                               #   in Loop: Header=BB0_86 Depth=1
	ld.d	$a0, $s0, 0
	ld.d	$a6, $s3, 0
	ldx.b	$a0, $a0, $a4
	addi.d	$a7, $a6, -1
