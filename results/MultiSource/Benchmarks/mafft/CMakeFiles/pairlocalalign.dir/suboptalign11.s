...
# %bb.4:                                # %middle.block
	...
	pcalau12i	$s7, %pc_hi20(suboptalign11.orlgth2)
	addi.w	$s8, $s1, 0
	...
	blt	$a0, $s5, .LBB0_6
# %bb.5:                                # %middle.block
	ld.w	$a0, $s7, %pc_lo12(suboptalign11.orlgth2)
	bge	$a0, $s8, .LBB0_10
.LBB0_6:
	ld.d	$a3, $fp, 0
	...
	pcalau12i	$s8, %pc_hi20(suboptalign11.cpmx2)
	pcalau12i	$s6, %pc_hi20(suboptalign11.floatwork)
	pcalau12i	$s3, %pc_hi20(suboptalign11.intwork)
	blez	$a1, .LBB0_9
# %bb.7:
	blez	$a0, .LBB0_9
# %bb.8:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s8, %pc_lo12(suboptalign11.cpmx2)
	pcaddu18i	$ra, %call36(FreeFloatMtx)
	jirl	$ra, $ra, 0
	ld.d	$a3, $fp, 0
	...
	pcaddu18i	$ra, %call36(FreeFloatMtx)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s3, %pc_lo12(suboptalign11.intwork)
...
.LBB0_9:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s8, %pc_lo12(suboptalign11.lastverticalw)
	move	$a0, $s0
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	st.w	$s4, $s7, %pc_lo12(suboptalign11.orlgth2)
	move	$s4, $s8
...
.LBB0_10:
	...
	blt	$a2, $a0, .LBB0_13
# %bb.11:
	ld.w	$a3, $s7, %pc_lo12(suboptalign11.orlgth2)
	blt	$a1, $a3, .LBB0_13
# %bb.12:                               # %._crit_edge539
...
.LBB0_16:
	slt	$a3, $a2, $a0
	ld.w	$a4, $s7, %pc_lo12(suboptalign11.orlgth2)
	masknez	$a2, $a2, $a3
	maskeqz	$a0, $a0, $a3
	or	$s2, $a0, $a2
	slt	$a0, $a1, $a4
...
.LBB0_17:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a6, $a0, %pc_lo12(suboptalign11.w1)
	ld.d	$a0, $sp, 232                   # 8-byte Folded Reload
	ld.d	$ra, $a0, %pc_lo12(suboptalign11.w2)
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	ld.d	$s2, $a0, %pc_lo12(suboptalign11.initverticalw)
...
# %bb.23:                               # %.lr.ph
	...
	ld.d	$a3, $a3, %pc_lo12(suboptalign11.Mp)
	bstrpick.d	$a4, $t8, 31, 0
	addi.d	$a7, $a4, -1
	ori	$t0, $zero, 16
	ori	$a5, $zero, 1
	bgeu	$a7, $t0, .LBB0_79
.LBB0_24:                               # %scalar.ph623.preheader
	alsl.d	$a7, $a5, $a6, 2
	addi.d	$a7, $a7, -4
	alsl.d	$a0, $a5, $a0, 2
	alsl.d	$a1, $a5, $a1, 2
...
.LBB0_26:                               # %._crit_edge
	...
	srai.d	$a1, $a0, 30
	fldx.s	$fa0, $a6, $a1
	ld.d	$a1, $s4, %pc_lo12(suboptalign11.lastverticalw)
	st.d	$a1, $sp, 232                   # 8-byte Folded Spill
	fst.s	$fa0, $a1, 0
	addi.w	$a2, $s0, 1
	add.d	$a3, $a2, $s1
...
.LBB0_70:                               # %vector.body637
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB0_70
# %bb.71:                               # %middle.block640
	beq	$a2, $a4, .LBB0_74
.LBB0_72:                               # %scalar.ph632.preheader
	alsl.d	$a3, $a4, $a3, 2
	alsl.d	$a1, $a4, $a1, 2
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB0_73:                               # %scalar.ph632
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	st.w	$a0, $a3, 0
	addi.d	$a3, $a3, 4
