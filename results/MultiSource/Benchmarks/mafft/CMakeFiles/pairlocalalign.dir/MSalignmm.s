...
.LBB1_40:                               # %.lr.ph15.i
	...
	bge	$a6, $a4, .LBB1_59
.LBB1_41:                               # %scalar.ph292.preheader
	sub.d	$a1, $a0, $a3
...
# %bb.82:                               # %middle.block332
	beq	$a3, $a2, .LBB1_85
.LBB1_83:                               # %scalar.ph321.preheader
	alsl.d	$a0, $a3, $a0, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_84:                               # %scalar.ph321
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $a2, -1
...
# %bb.89:                               #   in Loop: Header=BB1_87 Depth=1
	...
	add.w	$t1, $s5, $t0
	beqz	$t1, .LBB1_96
.LBB1_90:                               # %.lr.ph125.i.i.preheader
                                        #   in Loop: Header=BB1_87 Depth=1
	bltu	$t1, $a4, .LBB1_102
# %bb.91:                               # %.lr.ph125.i.i.preheader
                                        #   in Loop: Header=BB1_87 Depth=1
	sub.d	$t2, $s1, $s8
	bltu	$t2, $a4, .LBB1_102
# %bb.92:                               # %vector.ph362
...
.LBB1_95:                               #   in Loop: Header=BB1_87 Depth=1
	...
	bnez	$t1, .LBB1_90
	.p2align	4, , 16
.LBB1_96:                               # %._crit_edge126.i.i
                                        #   in Loop: Header=BB1_87 Depth=1
	beq	$a7, $a1, .LBB1_106
.LBB1_97:                               # %.lr.ph134.preheader.i.i
                                        #   in Loop: Header=BB1_87 Depth=1
	addi.w	$t0, $zero, -9
	nor	$t3, $a7, $zero
	bltu	$t0, $a7, .LBB1_107
# %bb.98:                               # %.lr.ph134.preheader.i.i
                                        #   in Loop: Header=BB1_87 Depth=1
	sub.d	$t0, $s1, $s8
	bltu	$t0, $a3, .LBB1_107
# %bb.99:                               # %vector.ph341
...
.LBB1_102:                              #   in Loop: Header=BB1_87 Depth=1
	move	$t2, $s8
	move	$t3, $s1
.LBB1_103:                              # %.lr.ph125.i.i.preheader382
                                        #   in Loop: Header=BB1_87 Depth=1
	move	$t4, $t2
	move	$t5, $t3
	.p2align	4, , 16
.LBB1_104:                              # %.lr.ph125.i.i
                                        #   Parent Loop BB1_87 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$t3, $t5, -1
	st.b	$a0, $t5, -1
	...
	move	$t5, $t3
	bnez	$t1, .LBB1_104
.LBB1_105:                              # %._crit_edge126.loopexit.i.i
                                        #   in Loop: Header=BB1_87 Depth=1
	add.d	$a6, $s5, $a6
	add.d	$a6, $t0, $a6
	move	$s1, $t3
...
.LBB1_107:                              #   in Loop: Header=BB1_87 Depth=1
	...
	move	$t0, $s8
	move	$t1, $s1
.LBB1_108:                              # %.lr.ph134.i.i.preheader
                                        #   in Loop: Header=BB1_87 Depth=1
	add.d	$a6, $a6, $t2
	.p2align	4, , 16
.LBB1_109:                              # %.lr.ph134.i.i
                                        #   Parent Loop BB1_87 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a2, $t1, -1
	addi.d	$t1, $t1, -1
	...
	addi.d	$t0, $t0, -1
	bnez	$t2, .LBB1_109
.LBB1_110:                              # %._crit_edge135.i.i
                                        #   in Loop: Header=BB1_87 Depth=1
	blez	$s5, .LBB1_115
.LBB1_111:                              # %._crit_edge135.i.i
                                        #   in Loop: Header=BB1_87 Depth=1
	blez	$s4, .LBB1_115
# %bb.112:                              #   in Loop: Header=BB1_87 Depth=1
	add.w	$s4, $a7, $s4
	addi.d	$s1, $t1, -1
	st.b	$a0, $t1, -1
	addi.d	$s8, $t0, -1
	...
	b	.LBB1_114
	.p2align	4, , 16
.LBB1_113:                              #   in Loop: Header=BB1_87 Depth=1
	addi.w	$a5, $s5, -1
	move	$a7, $a1
	nor	$t0, $a5, $zero
	add.w	$t1, $s5, $t0
...
.LBB1_128:                              # %.lr.ph32
	...
	addi.d	$s2, $t2, 4
	bge	$t8, $a4, .LBB1_192
.LBB1_129:                              # %scalar.ph89.preheader
	alsl.d	$a1, $a3, $s3, 2
	addi.d	$a1, $a1, -4
	alsl.d	$a2, $a3, $t2, 2
...
.LBB1_133:                              # %._crit_edge46
	...
	beq	$t5, $a1, .LBB1_144
.LBB1_134:                              # =>This Loop Header: Depth=1
	...
	ld.d	$a3, $sp, 496                   # 8-byte Folded Reload
	bne	$t5, $a3, .LBB1_140
# %bb.135:                              # %.lr.ph45.split.us.preheader
                                        #   in Loop: Header=BB1_134 Depth=1
	...
	b	.LBB1_138
	.p2align	4, , 16
.LBB1_136:                              # %.lr.ph45.split.us._crit_edge
...
# %bb.139:                              #   in Loop: Header=BB1_138 Depth=2
	...
	b	.LBB1_137
	.p2align	4, , 16
.LBB1_140:                              # %.lr.ph45.split.preheader
                                        #   in Loop: Header=BB1_134 Depth=1
	ld.d	$fp, $sp, 488                   # 8-byte Folded Reload
	fld.s	$fa0, $fp, 0
	ld.d	$a3, $sp, 360                   # 8-byte Folded Reload
...
# %bb.145:
	...
	ld.d	$t6, $sp, 296                   # 8-byte Folded Reload
.LBB1_146:                              # %scalar.ph116.preheader
	move	$t7, $s6
	ld.d	$t8, $sp, 280                   # 8-byte Folded Reload
	move	$ra, $s7
.LBB1_147:                              # %scalar.ph116.preheader
	slli.d	$a4, $a2, 2
	alsl.d	$a3, $a2, $t4, 2
	sub.d	$a1, $a1, $a2
	alsl.d	$a2, $t1, $a4, 2
...
# %bb.150:
	move	$a3, $zero
.LBB1_151:                              # %scalar.ph145.preheader
	slli.d	$a5, $a3, 2
	alsl.d	$a4, $a3, $t7, 2
	sub.d	$a2, $a2, $a3
	alsl.d	$a3, $a7, $a5, 2
...
.LBB1_154:
	move	$a0, $s0
.LBB1_155:                              # %scalar.ph175.preheader
	addi.d	$a3, $a0, 1
	ld.d	$a4, $sp, 200                   # 8-byte Folded Reload
	alsl.d	$a4, $a0, $a4, 2
	alsl.d	$a5, $a0, $t7, 2
...
.LBB1_158:                              #   in Loop: Header=BB1_160 Depth=1
	...
	ldx.w	$a0, $a1, $a0
	st.d	$a0, $sp, 488                   # 8-byte Folded Spill
.LBB1_159:                              #   in Loop: Header=BB1_160 Depth=1
	movcf2gr	$a0, $fcc0
	ld.d	$a1, $sp, 480                   # 8-byte Folded Reload
	masknez	$a1, $a1, $a0
	maskeqz	$a0, $s3, $a0
...
.LBB1_165:                              #   in Loop: Header=BB1_163 Depth=2
	...
	fcmp.cult.s	$fcc0, $fa5, $fa4
	bcnez	$fcc0, .LBB1_167
.LBB1_166:                              #   in Loop: Header=BB1_163 Depth=2
	fstx.s	$fa5, $s2, $a1
	stx.w	$s3, $t6, $a1
...
# %bb.168:                              #   in Loop: Header=BB1_163 Depth=2
	...
	stx.w	$t2, $t8, $a1
	beq	$s0, $t5, .LBB1_171
.LBB1_169:                              #   in Loop: Header=BB1_163 Depth=2
	fadd.s	$fa2, $fa2, $fa3
...
.LBB1_171:                              #   in Loop: Header=BB1_163 Depth=2
	...
	fsel	$fa0, $fa2, $fa0, $fcc0
	bne	$s3, $s4, .LBB1_162
.LBB1_172:                              #   in Loop: Header=BB1_163 Depth=2
	fldx.s	$fa2, $s6, $a1
	fadd.s	$fa2, $fa0, $fa2
	fstx.s	$fa2, $s6, $a1
	b	.LBB1_162
	.p2align	4, , 16
.LBB1_173:                              # %._crit_edge73
                                        #   in Loop: Header=BB1_160 Depth=1
	fldx.s	$fa0, $a2, $a1
	fldx.s	$fa1, $t3, $a0
	fadd.s	$fa0, $fa0, $fa1
	...
	bne	$s0, $t5, .LBB1_175
# %bb.174:                              #   in Loop: Header=BB1_160 Depth=1
	ld.d	$a0, $sp, 424                   # 8-byte Folded Reload
	fld.s	$fa0, $a0, 0
	fadd.s	$fa0, $fs0, $fa0
	fst.s	$fa0, $a0, 0
...
# %bb.180:                              # %._crit_edge87
	...
	addi.w	$a3, $s7, -1
	blez	$s7, .LBB1_184
# %bb.181:                              #   in Loop: Header=BB1_160 Depth=1
	slli.d	$a1, $a3, 2
	...
	move	$a1, $a3
	bcnez	$fcc1, .LBB1_183
# %bb.182:                              #   in Loop: Header=BB1_160 Depth=1
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	ldx.w	$a1, $a1, $a0
	fmov.s	$fa0, $fa1
.LBB1_183:                              #   in Loop: Header=BB1_160 Depth=1
	ld.d	$a2, $sp, 424                   # 8-byte Folded Reload
	fldx.s	$fa1, $a2, $a0
	fcmp.cule.s	$fcc1, $fa1, $fa0
	bceqz	$fcc1, .LBB1_158
...
# %bb.239:                              # %middle.block204
	beq	$a1, $s7, .LBB1_242
.LBB1_240:                              # %scalar.ph194.preheader
	alsl.d	$a2, $a1, $s5, 3
	sub.d	$a1, $s7, $a1
	.p2align	4, , 16
.LBB1_241:                              # %scalar.ph194
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
...
# %bb.247:                              # %middle.block217
	beq	$a1, $s4, .LBB1_250
.LBB1_248:                              # %scalar.ph207.preheader
	alsl.d	$a2, $a1, $s3, 3
	sub.d	$a1, $s4, $a1
	.p2align	4, , 16
.LBB1_249:                              # %scalar.ph207
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
