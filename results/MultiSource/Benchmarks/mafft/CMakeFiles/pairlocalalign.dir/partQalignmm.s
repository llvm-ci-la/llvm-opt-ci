...
.LBB4_2:
	...
	pcalau12i	$a7, %pc_hi20(partQ__align.mseq)
...
.LBB4_8:
	...
	blez	$a4, .LBB4_16
# %bb.9:                                # %.lr.ph
	ld.d	$a0, $a7, %pc_lo12(partQ__align.mseq)
...
# %bb.34:
	move	$t2, $zero
.LBB4_35:                               # %scalar.ph984.preheader
	slli.d	$t3, $t2, 2
	sub.d	$t1, $t1, $t2
	vldi	$vr1, -912
	vldi	$vr2, -928
...
# %bb.39:
	move	$t2, $zero
.LBB4_40:                               # %scalar.ph1135.preheader
	slli.d	$t3, $t2, 2
	sub.d	$t1, $t1, $t2
	vldi	$vr1, -912
	vldi	$vr2, -928
...
.LBB4_42:                               # %._crit_edge655
	...
	ld.d	$s3, $a0, %pc_lo12(partQ__align.w1)
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(partQ__align.w2)
	st.d	$a0, $sp, 400                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
...
# %bb.52:                               # %.lr.ph665
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB4_151
.LBB4_53:                               # %scalar.ph1208.preheader
	alsl.d	$a3, $a5, $a3, 2
	ld.d	$a6, $sp, 408                   # 8-byte Folded Reload
	alsl.d	$a6, $a5, $a6, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_54:                               # %scalar.ph1208
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a6, 0
...
# %bb.56:                               # %.lr.ph668
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB4_157
.LBB4_57:                               # %scalar.ph1246.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a6, $a5, $t5, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_58:                               # %scalar.ph1246
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a6, 0
...
# %bb.62:                               # %vector.ph1161
	...
	xvld	$xr0, $a6, %pc_lo12(.LCPI4_1)
	xvreplgr2vr.w	$xr1, $a1
	addi.d	$a6, $t5, 4
	xvldi	$xr2, -800
	move	$a7, $a5
	.p2align	4, , 16
.LBB4_63:                               # %vector.body1166
                                        # =>This Inner Loop Header: Depth=1
	xvmul.w	$xr3, $xr1, $xr0
	xvpermi.q	$xr4, $xr3, 1
	vext2xv.d.w	$xr4, $xr4
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_63
# %bb.64:                               # %middle.block1170
	beq	$a3, $a5, .LBB4_67
.LBB4_65:                               # %scalar.ph1159.preheader
	mul.d	$a3, $a1, $a4
	alsl.d	$a5, $a4, $t5, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB4_66:                               # %scalar.ph1159
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a5, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB4_70:                               # %vector.body1180
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_70
# %bb.71:                               # %middle.block1187
	beq	$a3, $a5, .LBB4_74
.LBB4_72:                               # %scalar.ph1173.preheader
	mul.d	$a3, $a1, $a4
...
.LBB4_79:                               # %vector.memcheck860
	...
	move	$t2, $zero
	bnez	$t4, .LBB4_358
# %bb.80:                               # %vector.memcheck860
	alsl.d	$s0, $t1, $a5, 2
	sltu	$t4, $a2, $s0
	sltu	$t5, $a5, $s2
	and	$t4, $t4, $t5
	bnez	$t4, .LBB4_358
# %bb.81:                               # %vector.memcheck860
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s2
	and	$t4, $t4, $t6
	bnez	$t4, .LBB4_358
# %bb.82:                               # %vector.memcheck860
	alsl.d	$t4, $t1, $t0, 2
	sltu	$t6, $a2, $t4
	sltu	$t7, $t0, $s2
	and	$t6, $t6, $t7
...
# %bb.88:                               # %vector.memcheck860
	...
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.89:                               # %vector.memcheck860
	sltu	$s2, $a4, $t4
	sltu	$s3, $t0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.90:                               # %vector.memcheck860
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.91:                               # %vector.memcheck860
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.92:                               # %vector.memcheck860
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.93:                               # %vector.memcheck860
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB4_358
# %bb.94:                               # %vector.memcheck860
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.95:                               # %vector.memcheck860
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.96:                               # %vector.memcheck860
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.97:                               # %vector.memcheck860
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.98:                               # %vector.memcheck860
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.99:                               # %vector.memcheck860
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 424                   # 8-byte Folded Reload
	bnez	$s0, .LBB4_359
# %bb.100:                              # %vector.memcheck860
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.101:                              # %vector.memcheck860
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.102:                              # %vector.memcheck860
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.103:                              # %vector.memcheck860
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.104:                              # %vector.memcheck860
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB4_359
# %bb.105:                              # %vector.memcheck860
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	ld.d	$s6, $sp, 144                   # 8-byte Folded Reload
	bnez	$t5, .LBB4_35
# %bb.106:                              # %vector.memcheck860
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_35
# %bb.107:                              # %vector.memcheck860
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_35
# %bb.108:                              # %vector.memcheck860
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB4_35
...
.LBB4_110:                              # %vector.body989
	...
	addi.d	$t3, $t3, 32
	bnez	$s5, .LBB4_110
# %bb.111:                              # %middle.block1003
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 144                   # 8-byte Folded Reload
	bne	$t1, $t2, .LBB4_35
	b	.LBB4_37
.LBB4_112:                              # %vector.memcheck1006
	alsl.d	$s2, $t1, $a2, 2
	alsl.d	$s1, $t1, $a4, 2
	sltu	$t2, $a2, $s1
	sltu	$t4, $a4, $s2
	...
	move	$t2, $zero
	bnez	$t4, .LBB4_360
# %bb.113:                              # %vector.memcheck1006
	alsl.d	$s0, $t1, $a5, 2
	sltu	$t4, $a2, $s0
	sltu	$t5, $a5, $s2
	and	$t4, $t4, $t5
	bnez	$t4, .LBB4_360
# %bb.114:                              # %vector.memcheck1006
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s2
	and	$t4, $t4, $t6
	bnez	$t4, .LBB4_360
# %bb.115:                              # %vector.memcheck1006
	alsl.d	$t4, $t1, $t0, 2
	sltu	$t6, $a2, $t4
	sltu	$t7, $t0, $s2
	and	$t6, $t6, $t7
	bnez	$t6, .LBB4_360
# %bb.116:                              # %vector.memcheck1006
	alsl.d	$t6, $t1, $a0, 2
	sltu	$t7, $a2, $t6
	sltu	$t8, $a0, $s2
	and	$t7, $t7, $t8
	bnez	$t7, .LBB4_360
# %bb.117:                              # %vector.memcheck1006
	alsl.d	$t7, $t1, $a1, 2
	sltu	$t8, $a2, $t7
	sltu	$fp, $a1, $s2
	and	$t8, $t8, $fp
	bnez	$t8, .LBB4_360
# %bb.118:                              # %vector.memcheck1006
	alsl.d	$t8, $t1, $a3, 2
	sltu	$fp, $a2, $t8
	sltu	$s3, $a3, $s2
	and	$fp, $fp, $s3
	bnez	$fp, .LBB4_360
# %bb.119:                              # %vector.memcheck1006
	alsl.d	$fp, $t1, $a7, 2
	sltu	$s3, $a2, $fp
	sltu	$s2, $a7, $s2
	and	$s2, $s3, $s2
	bnez	$s2, .LBB4_360
# %bb.120:                              # %vector.memcheck1006
	sltu	$s2, $a4, $s0
	sltu	$s3, $a5, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.121:                              # %vector.memcheck1006
	sltu	$s2, $a4, $t5
	sltu	$s3, $a6, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.122:                              # %vector.memcheck1006
	sltu	$s2, $a4, $t4
	sltu	$s3, $t0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.123:                              # %vector.memcheck1006
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.124:                              # %vector.memcheck1006
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.125:                              # %vector.memcheck1006
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.126:                              # %vector.memcheck1006
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB4_360
# %bb.127:                              # %vector.memcheck1006
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.128:                              # %vector.memcheck1006
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.129:                              # %vector.memcheck1006
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.130:                              # %vector.memcheck1006
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.131:                              # %vector.memcheck1006
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.132:                              # %vector.memcheck1006
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 424                   # 8-byte Folded Reload
	bnez	$s0, .LBB4_40
# %bb.133:                              # %vector.memcheck1006
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.134:                              # %vector.memcheck1006
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.135:                              # %vector.memcheck1006
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.136:                              # %vector.memcheck1006
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.137:                              # %vector.memcheck1006
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB4_40
# %bb.138:                              # %vector.memcheck1006
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_40
# %bb.139:                              # %vector.memcheck1006
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_40
# %bb.140:                              # %vector.memcheck1006
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_40
# %bb.141:                              # %vector.memcheck1006
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB4_40
# %bb.142:                              # %vector.ph1137
	bstrpick.d	$t2, $t3, 31, 3
	slli.d	$t2, $t2, 3
	xvreplve0.d	$xr1, $xr0
	xvldi	$xr2, -912
...
.LBB4_149:                              # %vector.body852
	...
	addi.d	$a6, $a6, 64
	bnez	$a5, .LBB4_149
# %bb.150:                              # %middle.block857
	beq	$a2, $s8, .LBB4_22
	b	.LBB4_20
.LBB4_151:                              # %vector.memcheck1190
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_53
# %bb.152:                              # %vector.memcheck1190
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_53
# %bb.153:                              # %vector.memcheck1190
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB4_155:                              # %vector.body1213
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB4_155
# %bb.156:                              # %middle.block1225
	bne	$a6, $t1, .LBB4_53
	b	.LBB4_55
.LBB4_157:                              # %vector.memcheck1228
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_57
# %bb.158:                              # %vector.memcheck1228
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_57
# %bb.159:                              # %vector.memcheck1228
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB4_161:                              # %vector.body1251
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB4_161
# %bb.162:                              # %middle.block1263
	bne	$a6, $t1, .LBB4_57
	b	.LBB4_59
.LBB4_163:                              # %vector.ph1272
	move	$a6, $zero
	move	$a7, $a4
...
# %bb.169:                              # %vec.epilog.middle.block
	beq	$a4, $t0, .LBB4_172
.LBB4_170:                              # %vec.epilog.scalar.ph.preheader
...
.LBB4_174:
	...
	ld.d	$a3, $a2, %pc_lo12(partQ__align.lastverticalw)
	sltu	$a2, $zero, $s0
	add.w	$a4, $a2, $t7
	ori	$a2, $zero, 2
...
# %bb.178:                              # %.lr.ph.i528
	...
	.p2align	4, , 16
.LBB4_179:                              #   Parent Loop BB4_177 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a5, $a2, 0
	add.w	$a5, $a5, $a6
	slli.d	$a5, $a5, 2
	...
	addi.d	$a2, $a2, 4
	bnez	$a4, .LBB4_179
.LBB4_180:                              # %part_imp_match_out_vead_gapmapQ.exit533
                                        #   in Loop: Header=BB4_177 Depth=1
	ld.d	$a1, $sp, 408                   # 8-byte Folded Reload
	fldx.s	$fa0, $a1, $a0
	fst.s	$fa0, $s4, 0
...
# %bb.184:                              #   in Loop: Header=BB4_183 Depth=2
	...
	stx.w	$t0, $a6, $a3
	fmov.s	$fs0, $ft2
.LBB4_185:                              #   in Loop: Header=BB4_183 Depth=2
	add.d	$t0, $t3, $a3
	fld.s	$ft4, $t0, 0
	fldx.s	$ft3, $s2, $a3
	fldx.s	$ft2, $fp, $a3
	...
	bcnez	$fcc0, .LBB4_187
# %bb.186:                              #   in Loop: Header=BB4_183 Depth=2
	ldx.w	$t1, $s8, $a3
	sub.d	$t1, $s7, $t1
	stx.w	$t1, $a6, $a3
	fmov.s	$fs0, $ft4
.LBB4_187:                              #   in Loop: Header=BB4_183 Depth=2
	fld.s	$ft4, $t0, -4
	fmul.s	$ft4, $fa1, $ft4
	fadd.s	$ft4, $ft1, $ft4
	fcmp.cult.s	$fcc0, $ft4, $ft3
	bcnez	$fcc0, .LBB4_182
# %bb.188:                              #   in Loop: Header=BB4_183 Depth=2
	fstx.s	$ft4, $s2, $a3
	stx.w	$t5, $s8, $a3
	b	.LBB4_182
.LBB4_189:
	...
	bnez	$s0, .LBB4_205
	b	.LBB4_191
.LBB4_190:                              # %._crit_edge710.loopexit
...
# %bb.193:                              # %vector.ph1296
	...
	xvld	$xr1, $a5, %pc_lo12(.LCPI4_3)
	pcalau12i	$a5, %pc_hi20(.LCPI4_4)
	xvld	$xr2, $a5, %pc_lo12(.LCPI4_4)
...
.LBB4_194:                              # %vector.body1303
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_194
# %bb.195:                              # %middle.block1310
	beq	$a2, $a4, .LBB4_198
.LBB4_196:                              # %scalar.ph1294.preheader
...
# %bb.200:                              # %vector.ph1315
	...
	vld	$vr3, $a5, %pc_lo12(.LCPI4_5)
	xvreplve0.d	$xr4, $xr1
	addi.d	$a5, $a1, 4
	xvldi	$xr5, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB4_201:                              # %vector.body1322
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_201
# %bb.202:                              # %middle.block1329
	beq	$a3, $a4, .LBB4_205
.LBB4_203:                              # %scalar.ph1313.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_204:                              # %scalar.ph1313
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.214:                              # %.lr.ph.i627
	...
	b	.LBB4_216
	.p2align	4, , 16
.LBB4_215:                              #   in Loop: Header=BB4_216 Depth=1
	addi.d	$a6, $a6, -1
	addi.d	$a7, $a7, -1
	addi.d	$fp, $fp, 4
	beqz	$a6, .LBB4_236
.LBB4_216:                              # =>This Inner Loop Header: Depth=1
	...
	fcmp.cult.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB4_215
# %bb.217:                              #   in Loop: Header=BB4_216 Depth=1
	ldx.d	$t0, $s7, $a4
	stx.w	$a7, $t0, $a5
	fmov.s	$fa0, $fa1
	b	.LBB4_215
.LBB4_218:                              # %.preheader9.i
	blez	$a3, .LBB4_223
# %bb.219:                              # %.lr.ph14.i
	slli.d	$a4, $s4, 32
	srai.d	$a4, $a4, 29
...
.LBB4_227:                              # %vector.body1387
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_227
# %bb.228:                              # %middle.block1395
	beq	$a4, $a5, .LBB4_231
.LBB4_229:                              # %.lr.ph17.i.preheader
	alsl.d	$a6, $a5, $s7, 3
	sub.d	$a4, $a4, $a5
	addi.d	$a5, $a5, 1
	.p2align	4, , 16
.LBB4_230:                              # %.lr.ph17.i
	...
	addi.d	$a5, $a5, 1
	bnez	$a4, .LBB4_230
.LBB4_231:                              # %.preheader8.i
	bltz	$a3, .LBB4_263
# %bb.232:                              # %iter.check1401
	ld.d	$a3, $s7, 0
	addi.d	$a6, $a0, 1
...
# %bb.233:
	move	$a5, $zero
	b	.LBB4_261
.LBB4_234:                              # %vector.main.loop.iter.check1403
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_254
# %bb.235:
	move	$a5, $zero
	b	.LBB4_258
.LBB4_236:                              # %.preheader9.i539
	blez	$a3, .LBB4_241
# %bb.237:                              # %.lr.ph14.i619
	slli.d	$a4, $s4, 32
	srai.d	$a4, $a4, 29
...
# %bb.240:                              #   in Loop: Header=BB4_239 Depth=1
	...
	fmov.s	$fa0, $fa1
	b	.LBB4_238
.LBB4_241:                              # %.loopexit.i541
	ld.d	$a2, $sp, 408                   # 8-byte Folded Reload
	bltz	$a2, .LBB4_249
# %bb.242:                              # %.lr.ph17.preheader.i543
	addi.d	$a4, $s4, 1
...
.LBB4_245:                              # %vector.body1337
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_245
# %bb.246:                              # %middle.block1344
	beq	$a2, $a4, .LBB4_249
.LBB4_247:                              # %.lr.ph17.i545.preheader
	alsl.d	$a5, $a4, $s7, 3
	sub.d	$a2, $a2, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB4_248:                              # %.lr.ph17.i545
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a6, $a5, 0
	st.w	$a4, $a6, 0
	addi.d	$a5, $a5, 8
	...
	addi.d	$a4, $a4, 1
	bnez	$a2, .LBB4_248
.LBB4_249:                              # %.preheader8.i549
	bltz	$a3, .LBB4_311
# %bb.250:                              # %iter.check1350
	ld.d	$a2, $s7, 0
	addi.d	$a5, $a0, 1
...
# %bb.251:
	move	$a4, $zero
	b	.LBB4_309
.LBB4_252:                              # %vector.main.loop.iter.check1352
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_302
# %bb.253:
	move	$a4, $zero
	b	.LBB4_306
.LBB4_254:                              # %vector.ph1404
...
.LBB4_255:                              # %vector.body1407
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_255
# %bb.256:                              # %middle.block1413
	beq	$a4, $a5, .LBB4_263
# %bb.257:                              # %vec.epilog.iter.check1418
	andi	$a7, $a6, 12
	beqz	$a7, .LBB4_261
.LBB4_258:                              # %vec.epilog.ph1417
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_259:                              # %vec.epilog.vector.body1426
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_259
# %bb.260:                              # %vec.epilog.middle.block1431
	beq	$a4, $a5, .LBB4_263
.LBB4_261:                              # %vec.epilog.scalar.ph1416.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_262:                              # %vec.epilog.scalar.ph1416
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.270:                              # %.lr.ph53.i
	...
	b	.LBB4_272
	.p2align	4, , 16
.LBB4_271:                              # %._crit_edge47.i
                                        #   in Loop: Header=BB4_272 Depth=1
	addi.w	$a4, $a4, 2
	move	$s4, $t3
	blt	$a1, $a4, .LBB4_347
.LBB4_272:                              # =>This Loop Header: Depth=1
...
# %bb.273:                              #   in Loop: Header=BB4_272 Depth=1
	beqz	$t7, .LBB4_276
# %bb.274:                              #   in Loop: Header=BB4_272 Depth=1
	sub.w	$t3, $s4, $t7
	b	.LBB4_277
	.p2align	4, , 16
.LBB4_275:                              #   in Loop: Header=BB4_272 Depth=1
	...
	b	.LBB4_284
	.p2align	4, , 16
.LBB4_276:                              #   in Loop: Header=BB4_272 Depth=1
	addi.w	$t3, $s4, -1
.LBB4_277:                              #   in Loop: Header=BB4_272 Depth=1
	move	$t7, $t0
	nor	$t8, $t3, $zero
	add.w	$fp, $s4, $t8
	bnez	$fp, .LBB4_279
	b	.LBB4_284
	.p2align	4, , 16
.LBB4_278:                              # %._crit_edge29.i
                                        #   in Loop: Header=BB4_279 Depth=2
	addi.d	$fp, $fp, -1
	ld.d	$ra, $sp, 416                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 424                   # 8-byte Folded Reload
	beqz	$fp, .LBB4_283
.LBB4_279:                              # %.preheader3.i
...
.LBB4_282:                              # %.lr.ph28.i
	...
	b	.LBB4_278
	.p2align	4, , 16
.LBB4_283:                              # %._crit_edge32.loopexit.i
                                        #   in Loop: Header=BB4_272 Depth=1
	add.d	$a4, $s4, $a4
	add.d	$a4, $t8, $a4
	ld.d	$s5, $sp, 136                   # 8-byte Folded Reload
.LBB4_284:                              # %._crit_edge32.i
                                        #   in Loop: Header=BB4_272 Depth=1
	add.w	$t2, $t7, $t2
	beq	$t7, $t0, .LBB4_291
# %bb.285:                              # %.preheader1.preheader.i
                                        #   in Loop: Header=BB4_272 Depth=1
	nor	$t7, $t7, $zero
	b	.LBB4_287
	.p2align	4, , 16
.LBB4_286:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB4_287 Depth=2
	addi.d	$t7, $t7, -1
	addi.d	$a4, $a4, 1
	beqz	$t7, .LBB4_291
.LBB4_287:                              # %.preheader1.i
                                        #   Parent Loop BB4_272 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_288 Depth 3
                                        #       Child Loop BB4_290 Depth 3
...
.LBB4_290:                              # %.lr.ph37.i
	...
	b	.LBB4_286
	.p2align	4, , 16
.LBB4_291:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB4_272 Depth=1
	ld.d	$a2, $sp, 408                   # 8-byte Folded Reload
	beq	$t4, $a2, .LBB4_294
# %bb.292:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB4_272 Depth=1
	addi.w	$t7, $a0, 0
	beq	$t5, $t7, .LBB4_294
# %bb.293:                              #   in Loop: Header=BB4_272 Depth=1
	slli.d	$t7, $t4, 2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a3, 0
.LBB4_294:                              #   in Loop: Header=BB4_272 Depth=1
	ld.d	$s2, $sp, 424                   # 8-byte Folded Reload
	blez	$t4, .LBB4_347
# %bb.295:                              #   in Loop: Header=BB4_272 Depth=1
	blez	$t5, .LBB4_347
# %bb.296:                              # %.preheader5.i
                                        #   in Loop: Header=BB4_272 Depth=1
	blez	$ra, .LBB4_299
# %bb.297:                              # %.lr.ph44.i
	...
	move	$t6, $a6
	.p2align	4, , 16
.LBB4_298:                              #   Parent Loop BB4_272 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $t3
...
# %bb.300:                              # %.lr.ph46.i
	...
	move	$t6, $a7
	.p2align	4, , 16
.LBB4_301:                              #   Parent Loop BB4_272 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $t2
...
.LBB4_303:                              # %vector.body1356
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_303
# %bb.304:                              # %middle.block1362
	beq	$a3, $a4, .LBB4_311
# %bb.305:                              # %vec.epilog.iter.check1367
	andi	$a6, $a5, 12
	beqz	$a6, .LBB4_309
.LBB4_306:                              # %vec.epilog.ph1366
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_307:                              # %vec.epilog.vector.body1374
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_307
# %bb.308:                              # %vec.epilog.middle.block1379
	beq	$a3, $a4, .LBB4_311
.LBB4_309:                              # %vec.epilog.scalar.ph1365.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_310:                              # %vec.epilog.scalar.ph1365
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.318:                              # %.lr.ph53.i558
	...
	b	.LBB4_320
	.p2align	4, , 16
.LBB4_319:                              # %._crit_edge47.i584
                                        #   in Loop: Header=BB4_320 Depth=1
	addi.w	$a3, $a3, 2
	move	$s4, $a6
	blt	$a1, $a3, .LBB4_347
.LBB4_320:                              # =>This Loop Header: Depth=1
                                        ...
                                        #       Child Loop BB4_338 Depth 3
                                        #     Child Loop BB4_343 Depth 2
	...
	ldx.w	$t1, $a6, $t1
	bltz	$t1, .LBB4_323
# %bb.321:                              #   in Loop: Header=BB4_320 Depth=1
	beqz	$t1, .LBB4_324
# %bb.322:                              #   in Loop: Header=BB4_320 Depth=1
	sub.w	$a6, $s4, $t1
	b	.LBB4_325
	.p2align	4, , 16
.LBB4_323:                              #   in Loop: Header=BB4_320 Depth=1
	addi.w	$a6, $s4, -1
	nor	$t2, $a6, $zero
	add.w	$t3, $s4, $t2
	bnez	$t3, .LBB4_327
	b	.LBB4_332
	.p2align	4, , 16
.LBB4_324:                              #   in Loop: Header=BB4_320 Depth=1
	addi.w	$a6, $s4, -1
.LBB4_325:                              #   in Loop: Header=BB4_320 Depth=1
	move	$t1, $ra
	nor	$t2, $a6, $zero
	add.w	$t3, $s4, $t2
	bnez	$t3, .LBB4_327
	b	.LBB4_332
	.p2align	4, , 16
.LBB4_326:                              # %._crit_edge29.i570
                                        #   in Loop: Header=BB4_327 Depth=2
	addi.d	$t3, $t3, -1
	beqz	$t3, .LBB4_331
.LBB4_327:                              # %.preheader3.i567
                                        #   Parent Loop BB4_320 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_328 Depth 3
                                        #       Child Loop BB4_330 Depth 3
	move	$t4, $s2
...
.LBB4_328:                              # %.lr.ph26.i605
	...
	addi.d	$t4, $t4, 8
	bnez	$t6, .LBB4_328
.LBB4_329:                              # %.preheader2.i569
                                        #   in Loop: Header=BB4_327 Depth=2
	move	$t4, $s6
	move	$t5, $a4
	blez	$s8, .LBB4_326
	.p2align	4, , 16
.LBB4_330:                              # %.lr.ph28.i601
                                        #   Parent Loop BB4_320 Depth=1
                                        #     Parent Loop BB4_327 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t6, $t4, 0
	...
	b	.LBB4_326
	.p2align	4, , 16
.LBB4_331:                              # %._crit_edge32.loopexit.i572
                                        #   in Loop: Header=BB4_320 Depth=1
	add.d	$a3, $s4, $a3
	add.d	$a3, $t2, $a3
.LBB4_332:                              # %._crit_edge32.i573
                                        #   in Loop: Header=BB4_320 Depth=1
	add.w	$a0, $t1, $a0
	beq	$t1, $ra, .LBB4_339
# %bb.333:                              # %.preheader1.preheader.i574
                                        #   in Loop: Header=BB4_320 Depth=1
	nor	$t1, $t1, $zero
	b	.LBB4_335
	.p2align	4, , 16
.LBB4_334:                              # %._crit_edge38.i578
                                        #   in Loop: Header=BB4_335 Depth=2
	addi.d	$t1, $t1, -1
	addi.d	$a3, $a3, 1
	beqz	$t1, .LBB4_339
.LBB4_335:                              # %.preheader1.i575
                                        #   Parent Loop BB4_320 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_336 Depth 3
                                        #       Child Loop BB4_338 Depth 3
...
.LBB4_338:                              # %.lr.ph37.i593
	...
	b	.LBB4_334
	.p2align	4, , 16
.LBB4_339:                              # %._crit_edge41.i580
                                        #   in Loop: Header=BB4_320 Depth=1
	blez	$a7, .LBB4_347
# %bb.340:                              # %._crit_edge41.i580
                                        #   in Loop: Header=BB4_320 Depth=1
	blez	$t0, .LBB4_347
# %bb.341:                              # %.preheader5.i582
                                        #   in Loop: Header=BB4_320 Depth=1
	blez	$s0, .LBB4_344
# %bb.342:                              # %.lr.ph44.i589
                                        #   in Loop: Header=BB4_320 Depth=1
	...
	move	$t1, $a2
	.p2align	4, , 16
.LBB4_343:                              #   Parent Loop BB4_320 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t2, $a7, 0
	ld.d	$t3, $t0, 0
	ldx.b	$t2, $t2, $a6
...
# %bb.345:                              # %.lr.ph46.i585
	...
	move	$t1, $a4
	.p2align	4, , 16
.LBB4_346:                              #   Parent Loop BB4_320 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t2, $a7, 0
	ld.d	$t3, $t0, 0
	ldx.b	$t2, $t2, $a0
	...
	bnez	$t1, .LBB4_346
	b	.LBB4_319
.LBB4_347:                              # %Atracking_localhom.exit
	ld.d	$a0, $s3, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	blt	$a2, $a3, .LBB4_356
# %bb.348:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	bge	$a3, $a0, .LBB4_356
# %bb.349:
