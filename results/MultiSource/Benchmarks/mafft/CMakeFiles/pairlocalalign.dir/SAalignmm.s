...
.LBB0_31:                               # %vector.body329
	...
	addi.d	$a5, $a5, 8
	bnez	$a6, .LBB0_31
# %bb.32:                               # %middle.block333
	beq	$a2, $a4, .LBB0_36
.LBB0_33:                               # %scalar.ph324.preheader
	alsl.d	$a2, $a3, $s8, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr1, -928
	.p2align	4, , 16
.LBB0_34:                               # %scalar.ph324
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa2, $a2, 0
	fcvt.d.s	$fa2, $fa2
	fmadd.d	$fa2, $fa0, $fa1, $fa2
...
.LBB0_37:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a2, $a2, 4
	bnez	$a0, .LBB0_37
# %bb.38:                               # %._crit_edge192.loopexit
	ld.w	$t2, $t1, 0
	b	.LBB0_40
.LBB0_39:                               # %.loopexit.._crit_edge192_crit_edge
	addi.w	$a0, $a0, 0
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
.LBB0_40:                               # %._crit_edge192
	slli.d	$a0, $t0, 32
	ori	$a1, $zero, 0
	lu32i.d	$a1, -1
	add.d	$a0, $a0, $a1
...
.LBB0_52:
	...
	b	.LBB0_54
.LBB0_53:                               # %._crit_edge202.loopexit
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	st.d	$a0, $sp, 168                   # 8-byte Folded Spill
	ld.d	$s0, $sp, 16                    # 8-byte Folded Reload
.LBB0_54:                               # %._crit_edge202
...
.LBB0_69:                               # %vector.body341
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_69
# %bb.70:                               # %middle.block346
	beq	$a2, $a3, .LBB0_73
.LBB0_71:                               # %.lr.ph18.i.preheader
	alsl.d	$a4, $a3, $s6, 3
	sub.d	$a2, $a2, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
...
.LBB0_77:                               # %vector.body354
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_77
# %bb.78:                               # %middle.block360
	beq	$a2, $a3, .LBB0_81
.LBB0_79:                               # %scalar.ph349.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_80:                               # %scalar.ph349
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB0_95:                               #   in Loop: Header=BB0_90 Depth=1
	...
	b	.LBB0_102
	.p2align	4, , 16
.LBB0_96:                               # %._crit_edge.i
                                        #   in Loop: Header=BB0_97 Depth=2
	addi.d	$t4, $t4, -1
	beqz	$t4, .LBB0_101
.LBB0_97:                               # %.preheader3.i
...
.LBB0_100:                              # %.lr.ph29.i
	...
	b	.LBB0_96
	.p2align	4, , 16
.LBB0_101:                              # %._crit_edge32.loopexit.i
                                        #   in Loop: Header=BB0_90 Depth=1
	add.d	$a3, $s3, $a3
	add.d	$a3, $t3, $a3
...
# %bb.103:                              # %.preheader1.preheader.i
	...
	b	.LBB0_105
	.p2align	4, , 16
.LBB0_104:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB0_105 Depth=2
	addi.d	$t2, $t2, -1
	addi.d	$a3, $a3, 1
	beqz	$t2, .LBB0_109
.LBB0_105:                              # %.preheader1.i
                                        #   Parent Loop BB0_90 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_106 Depth 3
                                        #       Child Loop BB0_108 Depth 3
...
.LBB0_108:                              # %.lr.ph37.i
	...
	b	.LBB0_104
	.p2align	4, , 16
.LBB0_109:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB0_90 Depth=1
	blez	$t1, .LBB0_117
# %bb.110:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB0_90 Depth=1
	blez	$t0, .LBB0_117
# %bb.111:                              # %.preheader5.i
                                        #   in Loop: Header=BB0_90 Depth=1
...
# %bb.112:                              # %.lr.ph44.i
	...
	move	$t2, $a2
	.p2align	4, , 16
.LBB0_113:                              #   Parent Loop BB0_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a7
...
# %bb.115:                              # %.lr.ph46.i
	...
	move	$t2, $a4
	.p2align	4, , 16
.LBB0_116:                              #   Parent Loop BB0_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a0
