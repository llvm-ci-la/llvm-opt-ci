...
.LBB2_13:                               # %vector.body759
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_13
# %bb.14:                               # %middle.block764
	beq	$a4, $s4, .LBB2_17
.LBB2_15:                               # %.lr.ph571.preheader781
	slli.d	$a1, $a4, 2
	sub.d	$a3, $s4, $a4
	.p2align	4, , 16
.LBB2_16:                               # %.lr.ph571
...
.LBB2_29:                               #   in Loop: Header=BB2_25 Depth=2
	...
	st.d	$a3, $sp, 216                   # 8-byte Folded Spill
	beqz	$a4, .LBB2_23
.LBB2_30:                               #   in Loop: Header=BB2_25 Depth=2
	ld.w	$a0, $s1, 0
...
# %bb.84:                               #   in Loop: Header=BB2_80 Depth=2
	...
	b	.LBB2_79
	.p2align	4, , 16
.LBB2_85:                               # %._crit_edge622
                                        #   in Loop: Header=BB2_73 Depth=1
	addi.w	$a0, $s4, 0
	addi.w	$a1, $zero, -2
	bge	$a1, $a0, .LBB2_91
.LBB2_86:                               # %._crit_edge622.thread
                                        #   in Loop: Header=BB2_73 Depth=1
	bstrpick.d	$a0, $t0, 31, 0
	bne	$s6, $a0, .LBB2_88
# %bb.87:                               #   in Loop: Header=BB2_73 Depth=1
	add.w	$t0, $t0, $s5
...
.LBB2_88:                               #   in Loop: Header=BB2_73 Depth=1
	st.d	$t0, $sp, 192                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
.LBB2_89:                               #   in Loop: Header=BB2_73 Depth=1
	move	$a1, $fp
	lu32i.d	$a1, 0
	slli.d	$a6, $s6, 2
	addi.d	$s0, $s6, 1
	st.d	$a0, $sp, 200                   # 8-byte Folded Spill
	beq	$s4, $a1, .LBB2_71
# %bb.90:                               #   in Loop: Header=BB2_73 Depth=1
	slli.d	$s5, $s4, 2
	slli.d	$a1, $s4, 3
	move	$s8, $fp
	ld.d	$fp, $sp, 160                   # 8-byte Folded Reload
...
# %bb.98:                               # %.lr.ph638
	...
	b	.LBB2_102
	.p2align	4, , 16
.LBB2_99:                               #   in Loop: Header=BB2_102 Depth=1
	slt	$t3, $a2, $a4
	xori	$t3, $t3, 1
	slt	$t4, $a2, $a5
	and	$t3, $t3, $t4
...
# %bb.103:                              #   in Loop: Header=BB2_102 Depth=1
	...
	add.d	$t4, $a3, $t3
	vstx	$vr0, $a3, $t3
	vstelm.w	$vr1, $t4, 16, 0
	vstelm.w	$vr1, $t4, 20, 1
	ld.w	$t3, $t1, 0
	slli.d	$t4, $a1, 2
...
# %bb.104:                              #   in Loop: Header=BB2_102 Depth=1
	bge	$a2, $a4, .LBB2_99
# %bb.105:                              #   in Loop: Header=BB2_102 Depth=1
	addi.d	$t3, $s2, 1
	sltui	$t3, $t3, 1
	masknez	$t4, $s2, $t3
	maskeqz	$t3, $a1, $t3
