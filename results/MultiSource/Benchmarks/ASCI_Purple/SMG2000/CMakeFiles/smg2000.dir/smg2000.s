...
# %bb.90:                               #   in Loop: Header=BB0_80 Depth=1
	move	$t1, $zero
	b	.LBB0_111
.LBB0_91:                               # %vector.body866.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t2, $a3
	move	$t3, $a2
	.p2align	4, , 16
.LBB0_92:                               # %vector.body866
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_92
# %bb.93:                               # %middle.block872
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_78
.LBB0_94:                               # %.lr.ph626.split.us628.preheader903
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
.LBB0_95:                               # %.lr.ph626.split.us628
	...
	bnez	$t4, .LBB0_95
	b	.LBB0_78
.LBB0_96:                               # %vector.body852.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a3
	move	$t3, $a2
	vori.b	$vr7, $vr6, 0
	.p2align	4, , 16
.LBB0_97:                               # %vector.body852
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t2, -16
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_97
# %bb.98:                               # %middle.block858
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_101
.LBB0_99:                               # %.lr.ph626.split.us.preheader902
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
...
.LBB0_101:                              # %._crit_edge627.split.us
	...
	fst.d	$fa5, $t1, 8
	b	.LBB0_79
.LBB0_102:                              # %vector.body880.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t2, $a3
	move	$t3, $a2
	.p2align	4, , 16
.LBB0_103:                              # %vector.body880
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t2, -16
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_103
# %bb.104:                              # %middle.block886
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_107
.LBB0_105:                              # %.lr.ph626.split.us631.preheader904
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
...
.LBB0_109:                              # %vector.body839
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB0_109
# %bb.110:                              # %middle.block844
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t1, $a2
	beq	$a2, $a1, .LBB0_79
.LBB0_111:                              # %.lr.ph626.split.preheader901
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t2, $t1, $s3, 2
	sub.d	$t3, $a1, $t1
	.p2align	4, , 16
...
# %bb.131:                              # %middle.block897
	beq	$a0, $s5, .LBB0_134
.LBB0_132:                              # %.lr.ph646.preheader900
	alsl.d	$a1, $a0, $s0, 3
	sub.d	$a0, $s5, $a0
	lu52i.d	$a2, $zero, 1023
	.p2align	4, , 16
