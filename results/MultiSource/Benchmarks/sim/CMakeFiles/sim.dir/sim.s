...
.LBB1_9:                                # %._crit_edge98
	...
	pcalau12i	$s1, %pc_hi20(numnode)
	st.w	$zero, $s1, %pc_lo12(numnode)
...
# %bb.11:
	...
	pcalau12i	$s0, %pc_hi20(al_len)
	pcalau12i	$s2, %pc_hi20(no_mis)
	b	.LBB1_13
	.p2align	4, , 16
.LBB1_12:                               # %.lr.ph102
...
.LBB1_20:                               # %findmax.exit
	...
	st.w	$zero, $s0, %pc_lo12(al_len)
	pcalau12i	$s1, %pc_hi20(no_mat)
	st.w	$zero, $s1, %pc_lo12(no_mat)
	st.w	$zero, $s2, %pc_lo12(no_mis)
	add.d	$a0, $s7, $s5
	...
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s1, %pc_lo12(no_mat)
	ld.w	$a1, $s0, %pc_lo12(al_len)
	ori	$a2, $zero, 100
	mul.w	$a0, $a0, $a2
	div.w	$a1, $a0, $a1
	...
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s1, %pc_lo12(no_mat)
	pcalau12i	$a0, %pc_hi20(.L.str.24)
	addi.d	$a0, $a0, %pc_lo12(.L.str.24)
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s2, %pc_lo12(no_mis)
...
# %bb.0:
	...
	pcalau12i	$a6, %pc_hi20(q)
	pcalau12i	$s4, %pc_hi20(CC)
	pcalau12i	$s3, %pc_hi20(RR)
	pcalau12i	$s2, %pc_hi20(EE)
	pcalau12i	$s6, %pc_hi20(DD)
	pcalau12i	$s7, %pc_hi20(SS)
	pcalau12i	$s8, %pc_hi20(FF)
	addi.d	$a7, $a3, 1
	st.d	$a3, $sp, 72                    # 8-byte Folded Spill
	blez	$a3, .LBB2_7
# %bb.1:                                # %.lr.ph
	ld.d	$a0, $s4, %pc_lo12(CC)
	ld.d	$a1, $s3, %pc_lo12(RR)
	st.d	$a1, $sp, 152                   # 8-byte Folded Spill
	ld.d	$a1, $s2, %pc_lo12(EE)
	st.d	$a1, $sp, 176                   # 8-byte Folded Spill
	ld.w	$a1, $a6, %pc_lo12(q)
	ld.d	$a2, $s6, %pc_lo12(DD)
	st.d	$a2, $sp, 168                   # 8-byte Folded Spill
	ld.d	$a2, $s7, %pc_lo12(SS)
	st.d	$a2, $sp, 144                   # 8-byte Folded Spill
	ld.d	$a2, $s8, %pc_lo12(FF)
...
.LBB2_7:                                # %.preheader
	blez	$s1, .LBB2_45
# %bb.8:                                # %.lr.ph212
	ld.w	$a0, $a6, %pc_lo12(q)
	pcalau12i	$a1, %pc_hi20(min)
	st.d	$a1, $sp, 112                   # 8-byte Folded Spill
	ld.w	$a6, $a1, %pc_lo12(min)
	sub.d	$a0, $zero, $a0
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(v)
	ld.d	$a0, $a0, %pc_lo12(v)
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
	ld.d	$t3, $s4, %pc_lo12(CC)
	ld.d	$t4, $s3, %pc_lo12(RR)
	ld.d	$t5, $s2, %pc_lo12(EE)
	pcalau12i	$a0, %pc_hi20(r)
	ld.w	$t6, $a0, %pc_lo12(r)
	pcalau12i	$a0, %pc_hi20(qr)
	ld.w	$t7, $a0, %pc_lo12(qr)
	ld.d	$t8, $s6, %pc_lo12(DD)
	ld.d	$fp, $s7, %pc_lo12(SS)
	ld.d	$s0, $s8, %pc_lo12(FF)
	addi.d	$a0, $s1, 1
...
# %bb.25:                               #   in Loop: Header=BB2_16 Depth=2
	blt	$a4, $ra, .LBB2_23
# %bb.26:                               #   in Loop: Header=BB2_16 Depth=2
	xor	$a7, $a4, $ra
	sltui	$a7, $a7, 1
	slt	$t0, $t1, $a5
	masknez	$t1, $t1, $t0
...
.LBB2_28:                               #   in Loop: Header=BB2_16 Depth=2
	pcalau12i	$a7, %pc_hi20(row)
	ld.d	$a7, $a7, %pc_lo12(row)
	slli.d	$t0, $s2, 3
	ldx.d	$a7, $a7, $t0
	pcalau12i	$t0, %pc_hi20(z)
	st.d	$a7, $t0, %pc_lo12(z)
	beqz	$a7, .LBB2_31
	.p2align	4, , 16
.LBB2_29:                               # %.lr.ph190
                                        #   Parent Loop BB2_10 Depth=1
...
# %bb.35:                               #   in Loop: Header=BB2_16 Depth=2
	...
	move	$a7, $a5
	blt	$a1, $a4, .LBB2_38
# %bb.36:                               #   in Loop: Header=BB2_16 Depth=2
	xor	$a2, $a1, $a4
	sltui	$a2, $a2, 1
	addi.w	$a7, $a0, 0
	slt	$t0, $a5, $a7
...
.LBB2_37:                               #   in Loop: Header=BB2_16 Depth=2
	...
	move	$a2, $a1
	move	$a7, $a0
.LBB2_38:                               #   in Loop: Header=BB2_16 Depth=2
	move	$s6, $s4
	move	$a1, $s7
	move	$t2, $s3
	blt	$t0, $s4, .LBB2_43
# %bb.39:                               #   in Loop: Header=BB2_16 Depth=2
	bne	$t0, $s4, .LBB2_42
# %bb.40:                               #   in Loop: Header=BB2_16 Depth=2
	addi.w	$a0, $s7, 0
	move	$s6, $s4
	move	$a1, $s7
	move	$t2, $s3
	blt	$a2, $a0, .LBB2_43
# %bb.41:                               #   in Loop: Header=BB2_16 Depth=2
	xor	$a0, $a2, $a0
	sltui	$a0, $a0, 1
	addi.w	$a1, $a7, 0
	addi.w	$t0, $s3, 0
	...
	b	.LBB2_43
	.p2align	4, , 16
.LBB2_42:                               #   in Loop: Header=BB2_16 Depth=2
	move	$s6, $t0
	move	$a1, $a2
	move	$t2, $a7
.LBB2_43:                               #   in Loop: Header=BB2_16 Depth=2
	...
	st.w	$a5, $t1, 0
	bge	$a6, $s6, .LBB2_15
# %bb.44:                               #   in Loop: Header=BB2_16 Depth=2
	addi.w	$a1, $a0, 0
	addi.w	$a2, $t2, 0
	move	$a0, $s6
	move	$a3, $s2
	...
	st.w	$a6, $a0, %pc_lo12(min)
	b	.LBB2_15
.LBB2_45:                               # %._crit_edge213
	move	$a0, $zero
...
.LBB3_10:                               # =>This Loop Header: Depth=1
                                        ...
                                        #             Child Loop BB3_55 Depth 6
                                        #         Child Loop BB3_75 Depth 4
                                        #           Child Loop BB3_88 Depth 5
...
.LBB3_12:                               # %.outer
	...
	b	.LBB3_15
	.p2align	4, , 16
.LBB3_13:                               #   in Loop: Header=BB3_15 Depth=4
	move	$s3, $a0
	beqz	$s3, .LBB3_15
...
.LBB3_24:                               #   in Loop: Header=BB3_15 Depth=4
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $t4, .LBB3_26
# %bb.25:                               #   in Loop: Header=BB3_15 Depth=4
	addi.w	$a1, $s3, 0
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	blt	$a2, $a1, .LBB3_27
.LBB3_26:                               #   in Loop: Header=BB3_15 Depth=4
	move	$a0, $zero
	.p2align	4, , 16
.LBB3_27:                               #   in Loop: Header=BB3_15 Depth=4
	move	$s0, $a7
	ld.d	$s4, $sp, 144                   # 8-byte Folded Reload
	b	.LBB3_30
	.p2align	4, , 16
.LBB3_28:                               #   in Loop: Header=BB3_15 Depth=4
	slli.d	$a0, $s3, 48
	beqz	$a0, .LBB3_124
# %bb.29:                               #   in Loop: Header=BB3_15 Depth=4
	ori	$a0, $zero, 1
	ori	$a1, $zero, 1
	bge	$a1, $t7, .LBB3_124
.LBB3_30:                               # %.critedge
	...
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB3_13
# %bb.31:                               #   in Loop: Header=BB3_15 Depth=4
	addi.w	$a1, $s0, 1
	xor	$a1, $t7, $a1
	sltu	$a1, $zero, $a1
	sltu	$a2, $zero, $t2
...
.LBB3_32:                               # %.lr.ph673
	...
	b	.LBB3_35
	.p2align	4, , 16
.LBB3_33:                               #   in Loop: Header=BB3_35 Depth=5
	ori	$t2, $zero, 1
	move	$t7, $s2
	move	$s6, $s7
	beqz	$t0, .LBB3_46
.LBB3_34:                               #   in Loop: Header=BB3_35 Depth=5
	addi.d	$s4, $a2, -1
	move	$t0, $t2
	bge	$t7, $a2, .LBB3_19
.LBB3_35:                               #   Parent Loop BB3_10 Depth=1
	...
	move	$a2, $s4
	bge	$a7, $t2, .LBB3_38
# %bb.36:                               #   in Loop: Header=BB3_35 Depth=5
	move	$a7, $t2
.LBB3_37:                               #   in Loop: Header=BB3_35 Depth=5
	move	$t4, $t1
	move	$s3, $t3
	b	.LBB3_41
	.p2align	4, , 16
.LBB3_38:                               #   in Loop: Header=BB3_35 Depth=5
	bne	$a7, $t2, .LBB3_41
# %bb.39:                               #   in Loop: Header=BB3_35 Depth=5
	blt	$t4, $t1, .LBB3_37
# %bb.40:                               #   in Loop: Header=BB3_35 Depth=5
	xor	$a5, $t4, $t1
	sltui	$a5, $a5, 1
	addi.w	$t1, $s3, 0
	addi.w	$t2, $t3, 0
	...
	or	$s3, $t1, $a5
	.p2align	4, , 16
.LBB3_41:                               #   in Loop: Header=BB3_35 Depth=5
	slli.d	$t1, $a2, 2
	ldx.w	$a5, $s6, $t1
	...
	sub.w	$t2, $t2, $a3
	bge	$t2, $s1, .LBB3_43
.LBB3_42:                               #   in Loop: Header=BB3_35 Depth=5
	move	$ra, $s0
	move	$s5, $t6
	b	.LBB3_54
	.p2align	4, , 16
.LBB3_43:                               #   in Loop: Header=BB3_35 Depth=5
	ld.d	$t3, $sp, 264                   # 8-byte Folded Reload
	ldx.w	$ra, $t3, $t1
	ld.d	$t3, $sp, 256                   # 8-byte Folded Reload
	ldx.w	$s5, $t3, $t1
	bne	$t2, $s1, .LBB3_53
# %bb.44:                               #   in Loop: Header=BB3_35 Depth=5
	blt	$ra, $s0, .LBB3_42
# %bb.45:                               #   in Loop: Header=BB3_35 Depth=5
	xor	$t1, $ra, $s0
	sltui	$t1, $t1, 1
	slt	$t2, $t6, $s5
	masknez	$t3, $t6, $t2
	...
	b	.LBB3_54
	.p2align	4, , 16
.LBB3_46:                               #   in Loop: Header=BB3_35 Depth=5
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $t1, .LBB3_48
# %bb.47:                               #   in Loop: Header=BB3_35 Depth=5
	addi.w	$a1, $t3, 0
	ld.d	$t0, $sp, 216                   # 8-byte Folded Reload
	blt	$t0, $a1, .LBB3_52
.LBB3_48:                               #   in Loop: Header=BB3_35 Depth=5
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $ra, .LBB3_50
# %bb.49:                               #   in Loop: Header=BB3_35 Depth=5
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	blt	$a1, $s5, .LBB3_52
.LBB3_50:                               #   in Loop: Header=BB3_35 Depth=5
	move	$t2, $zero
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $t4, .LBB3_34
# %bb.51:                               #   in Loop: Header=BB3_35 Depth=5
	addi.w	$a1, $s3, 0
	ld.d	$t0, $sp, 216                   # 8-byte Folded Reload
	bge	$t0, $a1, .LBB3_34
	.p2align	4, , 16
.LBB3_52:                               #   in Loop: Header=BB3_35 Depth=5
	ori	$t2, $zero, 1
	b	.LBB3_34
	.p2align	4, , 16
.LBB3_53:                               #   in Loop: Header=BB3_35 Depth=5
	move	$s1, $t2
.LBB3_54:                               #   in Loop: Header=BB3_35 Depth=5
	ld.d	$t1, $a6, 0
...
.LBB3_55:                               # %.lr.ph658
                                        ...
                                        #       Parent Loop BB3_12 Depth=3
                                        #         Parent Loop BB3_15 Depth=4
                                        #           Parent Loop BB3_35 Depth=5
                                        # =>          This Inner Loop Header: Depth=6
	ld.w	$t2, $t1, 0
	addi.w	$t3, $a2, 0
	beq	$t2, $t3, .LBB3_58
# %bb.56:                               #   in Loop: Header=BB3_55 Depth=6
	ld.d	$t1, $t1, 8
	st.d	$t1, $t8, %pc_lo12(z)
	bnez	$t1, .LBB3_55
.LBB3_57:                               # %._crit_edge659
                                        #   in Loop: Header=BB3_35 Depth=5
	...
	b	.LBB3_59
	.p2align	4, , 16
.LBB3_58:                               #   in Loop: Header=BB3_35 Depth=5
	move	$t1, $zero
.LBB3_59:                               # %.thread594
                                        #   in Loop: Header=BB3_35 Depth=5
	slti	$t3, $t1, 1
	...
	move	$s4, $s5
	blt	$t1, $s1, .LBB3_64
# %bb.60:                               #   in Loop: Header=BB3_35 Depth=5
	masknez	$a1, $a1, $t3
	maskeqz	$t2, $s8, $t3
	or	$a1, $t2, $a1
	masknez	$a0, $a0, $t3
	...
	or	$a0, $t2, $a0
	bne	$t1, $s1, .LBB3_63
# %bb.61:                               #   in Loop: Header=BB3_35 Depth=5
	move	$t2, $s1
	move	$fp, $ra
	move	$s4, $s5
	blt	$a1, $ra, .LBB3_64
# %bb.62:                               #   in Loop: Header=BB3_35 Depth=5
	xor	$t1, $a1, $ra
	sltui	$t1, $t1, 1
	addi.w	$t2, $a0, 0
	slt	$t3, $s5, $t2
	...
	b	.LBB3_64
	.p2align	4, , 16
.LBB3_63:                               #   in Loop: Header=BB3_35 Depth=5
	move	$t2, $t1
	move	$fp, $a1
	move	$s4, $a0
.LBB3_64:                               #   in Loop: Header=BB3_35 Depth=5
	move	$a0, $a7
	move	$t1, $t4
	move	$t3, $s3
	blt	$t2, $a7, .LBB3_69
# %bb.65:                               #   in Loop: Header=BB3_35 Depth=5
	bne	$t2, $a7, .LBB3_68
# %bb.66:                               #   in Loop: Header=BB3_35 Depth=5
	move	$a0, $a7
	move	$t1, $t4
	move	$t3, $s3
	blt	$fp, $t4, .LBB3_69
# %bb.67:                               #   in Loop: Header=BB3_35 Depth=5
	xor	$a0, $fp, $t4
	sltui	$a0, $a0, 1
	addi.w	$a1, $s4, 0
	addi.w	$t1, $s3, 0
	...
	b	.LBB3_69
	.p2align	4, , 16
.LBB3_68:                               #   in Loop: Header=BB3_35 Depth=5
	move	$a0, $t2
	move	$t1, $fp
	move	$t3, $s4
.LBB3_69:                               #   in Loop: Header=BB3_35 Depth=5
	move	$s7, $s6
	alsl.d	$a1, $a2, $s6, 2
	...
	bge	$a1, $a0, .LBB3_33
# %bb.70:                               #   in Loop: Header=BB3_35 Depth=5
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	ori	$t2, $zero, 1
	st.b	$t2, $a1, %pc_lo12(flag)
	b	.LBB3_33
	.p2align	4, , 16
...
# %bb.72:                               #   in Loop: Header=BB3_12 Depth=3
	...
	blt	$a0, $t3, .LBB3_114
# %bb.73:                               #   in Loop: Header=BB3_12 Depth=3
	slli.d	$a0, $t3, 2
...
.LBB3_75:                               # %.lr.ph703
	...
	move	$s2, $s3
	bge	$a7, $s1, .LBB3_78
# %bb.76:                               #   in Loop: Header=BB3_75 Depth=4
	move	$a7, $s1
.LBB3_77:                               #   in Loop: Header=BB3_75 Depth=4
	move	$t1, $t6
	move	$t5, $fp
	b	.LBB3_81
	.p2align	4, , 16
.LBB3_78:                               #   in Loop: Header=BB3_75 Depth=4
	bne	$a7, $s1, .LBB3_81
# %bb.79:                               #   in Loop: Header=BB3_75 Depth=4
	blt	$t1, $t6, .LBB3_77
# %bb.80:                               #   in Loop: Header=BB3_75 Depth=4
	xor	$a6, $t1, $t6
	sltui	$a6, $a6, 1
	slt	$t0, $fp, $t5
	masknez	$t4, $fp, $t0
	...
	or	$t5, $t0, $a6
	.p2align	4, , 16
.LBB3_81:                               #   in Loop: Header=BB3_75 Depth=4
	slli.d	$t4, $a2, 2
	...
	sub.w	$t6, $t6, $a3
	bge	$t6, $s3, .LBB3_83
.LBB3_82:                               #   in Loop: Header=BB3_75 Depth=4
	move	$ra, $t0
	move	$s5, $s8
	b	.LBB3_87
	.p2align	4, , 16
.LBB3_83:                               #   in Loop: Header=BB3_75 Depth=4
	ld.d	$t7, $sp, 168                   # 8-byte Folded Reload
	ldx.w	$ra, $t7, $t4
	ld.d	$t7, $sp, 160                   # 8-byte Folded Reload
	ldx.w	$s5, $t7, $t4
	bne	$t6, $s3, .LBB3_86
# %bb.84:                               #   in Loop: Header=BB3_75 Depth=4
	blt	$ra, $t0, .LBB3_82
# %bb.85:                               #   in Loop: Header=BB3_75 Depth=4
	xor	$t4, $ra, $t0
	sltui	$t4, $t4, 1
	slt	$t6, $s8, $s5
	masknez	$t7, $s8, $t6
	...
	b	.LBB3_87
	.p2align	4, , 16
.LBB3_86:                               #   in Loop: Header=BB3_75 Depth=4
	move	$s3, $t6
.LBB3_87:                               #   in Loop: Header=BB3_75 Depth=4
	slli.d	$t4, $a2, 3
...
.LBB3_88:                               # %.lr.ph688
                                        ...
                                        #     Parent Loop BB3_11 Depth=2
                                        #       Parent Loop BB3_12 Depth=3
                                        #         Parent Loop BB3_75 Depth=4
                                        # =>        This Inner Loop Header: Depth=5
	ld.w	$t6, $t4, 0
	beq	$t6, $t3, .LBB3_91
# %bb.89:                               #   in Loop: Header=BB3_88 Depth=5
	ld.d	$t4, $t4, 8
	st.d	$t4, $t8, %pc_lo12(z)
	bnez	$t4, .LBB3_88
.LBB3_90:                               # %._crit_edge689
                                        #   in Loop: Header=BB3_75 Depth=4
	...
	b	.LBB3_92
	.p2align	4, , 16
.LBB3_91:                               #   in Loop: Header=BB3_75 Depth=4
	move	$a5, $zero
.LBB3_92:                               # %.thread597
                                        #   in Loop: Header=BB3_75 Depth=4
	slti	$fp, $a5, 1
	...
	move	$t4, $s5
	blt	$t6, $s3, .LBB3_97
# %bb.93:                               #   in Loop: Header=BB3_75 Depth=4
	masknez	$a1, $a1, $fp
	maskeqz	$a5, $a2, $fp
	or	$a1, $a5, $a1
	addi.w	$a1, $a1, 0
	...
	or	$a0, $a5, $a0
	bne	$t6, $s3, .LBB3_96
# %bb.94:                               #   in Loop: Header=BB3_75 Depth=4
	move	$s1, $s3
	move	$a5, $ra
	move	$t4, $s5
	blt	$a1, $ra, .LBB3_97
# %bb.95:                               #   in Loop: Header=BB3_75 Depth=4
	xor	$a5, $a1, $ra
	sltui	$a5, $a5, 1
	slt	$t4, $s5, $a0
	masknez	$t6, $s5, $t4
	...
	b	.LBB3_97
	.p2align	4, , 16
.LBB3_96:                               #   in Loop: Header=BB3_75 Depth=4
	move	$s1, $t6
	move	$a5, $a1
	move	$t4, $a0
.LBB3_97:                               #   in Loop: Header=BB3_75 Depth=4
	move	$a0, $a7
	move	$t6, $t1
	move	$fp, $t5
	blt	$s1, $a7, .LBB3_102
# %bb.98:                               #   in Loop: Header=BB3_75 Depth=4
	bne	$s1, $a7, .LBB3_101
# %bb.99:                               #   in Loop: Header=BB3_75 Depth=4
	move	$a0, $a7
	move	$t6, $t1
	move	$fp, $t5
	blt	$a5, $t1, .LBB3_102
# %bb.100:                              #   in Loop: Header=BB3_75 Depth=4
	xor	$a0, $a5, $t1
	sltui	$a0, $a0, 1
	slt	$a1, $t5, $t4
	masknez	$t6, $t5, $a1
	...
	b	.LBB3_102
	.p2align	4, , 16
.LBB3_101:                              #   in Loop: Header=BB3_75 Depth=4
	move	$a0, $s1
	move	$t6, $a5
	move	$fp, $t4
.LBB3_102:                              #   in Loop: Header=BB3_75 Depth=4
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	alsl.d	$a1, $a2, $a1, 2
	ld.d	$a5, $sp, 192                   # 8-byte Folded Reload
	alsl.d	$a5, $a2, $a5, 2
	...
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	bge	$a1, $a0, .LBB3_104
# %bb.103:                              #   in Loop: Header=BB3_75 Depth=4
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	ori	$a5, $zero, 1
	st.b	$a5, $a1, %pc_lo12(flag)
.LBB3_104:                              #   in Loop: Header=BB3_75 Depth=4
	slli.d	$a1, $s2, 48
	bnez	$a1, .LBB3_111
# %bb.105:                              #   in Loop: Header=BB3_75 Depth=4
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $t6, .LBB3_107
# %bb.106:                              #   in Loop: Header=BB3_75 Depth=4
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	blt	$a1, $fp, .LBB3_111
.LBB3_107:                              #   in Loop: Header=BB3_75 Depth=4
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $ra, .LBB3_109
# %bb.108:                              #   in Loop: Header=BB3_75 Depth=4
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	blt	$a1, $s5, .LBB3_111
.LBB3_109:                              #   in Loop: Header=BB3_75 Depth=4
	move	$s3, $zero
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $t1, .LBB3_112
# %bb.110:                              #   in Loop: Header=BB3_75 Depth=4
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	bge	$a1, $t5, .LBB3_112
	.p2align	4, , 16
.LBB3_111:                              #   in Loop: Header=BB3_75 Depth=4
	ori	$s3, $zero, 1
.LBB3_112:                              #   in Loop: Header=BB3_75 Depth=4
	addi.d	$t4, $a2, -1
	blt	$s0, $a2, .LBB3_75
# %bb.113:                              #   in Loop: Header=BB3_12 Depth=3
	...
	b	.LBB3_116
	.p2align	4, , 16
.LBB3_114:                              #   in Loop: Header=BB3_12 Depth=3
	ld.d	$t0, $sp, 24                    # 8-byte Folded Reload
	move	$t6, $t0
	ld.d	$t4, $sp, 88                    # 8-byte Folded Reload
	bge	$t4, $s0, .LBB3_74
.LBB3_115:                              # %._crit_edge776
                                        #   in Loop: Header=BB3_12 Depth=3
	move	$s3, $zero
	move	$fp, $t3
	move	$t1, $t6
	move	$t5, $t3
.LBB3_116:                              # %._crit_edge704
                                        #   in Loop: Header=BB3_12 Depth=3
	slli.d	$a0, $s0, 2
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	ldx.w	$a1, $a1, $a0
	...
	ld.d	$s4, $sp, 144                   # 8-byte Folded Reload
	bnez	$t2, .LBB3_12
# %bb.117:                              #   in Loop: Header=BB3_12 Depth=3
	ld.d	$a0, $sp, 232                   # 8-byte Folded Reload
	bge	$a0, $t6, .LBB3_119
# %bb.118:                              #   in Loop: Header=BB3_12 Depth=3
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	blt	$a0, $fp, .LBB3_123
.LBB3_119:                              #   in Loop: Header=BB3_12 Depth=3
	addi.w	$a0, $ra, 0
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $a0, .LBB3_121
# %bb.120:                              #   in Loop: Header=BB3_12 Depth=3
	addi.w	$a0, $s5, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	blt	$a1, $a0, .LBB3_123
.LBB3_121:                              #   in Loop: Header=BB3_12 Depth=3
	move	$a0, $zero
	move	$t7, $t3
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$a1, $t1, .LBB3_12
# %bb.122:                              #   in Loop: Header=BB3_12 Depth=3
	move	$t7, $t3
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	bge	$a1, $t5, .LBB3_12
	.p2align	4, , 16
.LBB3_123:                              #   in Loop: Header=BB3_11 Depth=2
	move	$t7, $t3
	b	.LBB3_11
	.p2align	4, , 16
.LBB3_124:                              #   in Loop: Header=BB3_10 Depth=1
	ori	$a2, $zero, 1
	bne	$s0, $a2, .LBB3_126
# %bb.125:                              #   in Loop: Header=BB3_10 Depth=1
	ori	$a1, $zero, 1
	ori	$a0, $zero, 1
	beq	$t7, $a0, .LBB3_142
.LBB3_126:                              #   in Loop: Header=BB3_10 Depth=1
...
.LBB3_128:                              #   in Loop: Header=BB3_129 Depth=2
	...
	addi.d	$a5, $a5, 8
	beqz	$a6, .LBB3_143
.LBB3_129:                              #   Parent Loop BB3_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t1, $a5, 0
	ld.w	$t0, $t1, 4
...
# %bb.133:                              #   in Loop: Header=BB3_129 Depth=2
	...
	blt	$t0, $t1, .LBB3_135
# %bb.134:                              #   in Loop: Header=BB3_129 Depth=2
	ld.d	$t1, $sp, 216                   # 8-byte Folded Reload
	bge	$a7, $t1, .LBB3_128
.LBB3_135:                              #   in Loop: Header=BB3_10 Depth=1
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	bge	$t0, $a1, .LBB3_137
# %bb.136:                              #   in Loop: Header=BB3_10 Depth=1
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	st.w	$t0, $a1, %pc_lo12(rl)
	st.d	$t0, $sp, 232                   # 8-byte Folded Spill
.LBB3_137:                              #   in Loop: Header=BB3_10 Depth=1
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	bge	$a7, $a1, .LBB3_139
# %bb.138:                              #   in Loop: Header=BB3_10 Depth=1
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	st.w	$a7, $a1, %pc_lo12(cl)
	st.d	$a7, $sp, 216                   # 8-byte Folded Spill
.LBB3_139:                              #   in Loop: Header=BB3_10 Depth=1
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	ori	$a2, $zero, 1
	...
	b	.LBB3_141
	.p2align	4, , 16
.LBB3_140:                              #   in Loop: Header=BB3_10 Depth=1
	move	$a0, $zero
.LBB3_141:                              # %no_cross.exit
                                        #   in Loop: Header=BB3_10 Depth=1
	move	$a2, $t7
	move	$a1, $s0
	ld.d	$a5, $sp, 80                    # 8-byte Folded Reload
	bne	$a0, $a5, .LBB3_10
.LBB3_142:                              # %no_cross.exit.thread.loopexit728
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, -1
.LBB3_143:                              # %no_cross.exit.thread
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
...
.LBB3_146:                              # =>This Loop Header: Depth=1
	...
	or	$a7, $a1, $a0
	bge	$s4, $a7, .LBB3_149
.LBB3_147:                              # %._crit_edge640
                                        #   in Loop: Header=BB3_146 Depth=1
	beqz	$s8, .LBB3_145
# %bb.148:                              #   in Loop: Header=BB3_146 Depth=1
...
.LBB3_150:                              #   in Loop: Header=BB3_151 Depth=2
	...
	move	$s0, $t2
	bge	$a7, $t7, .LBB3_147
.LBB3_151:                              #   Parent Loop BB3_146 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_164 Depth 3
	sub.w	$t0, $t0, $a3
	sub.w	$a1, $a1, $a4
...
.LBB3_153:                              #   in Loop: Header=BB3_151 Depth=2
	...
	b	.LBB3_157
	.p2align	4, , 16
.LBB3_154:                              #   in Loop: Header=BB3_151 Depth=2
	bne	$t0, $a1, .LBB3_157
# %bb.155:                              #   in Loop: Header=BB3_151 Depth=2
	addi.w	$a1, $s3, 0
	addi.w	$a2, $a0, 0
	blt	$a2, $a1, .LBB3_153
# %bb.156:                              #   in Loop: Header=BB3_151 Depth=2
	xor	$a1, $a2, $a1
	sltui	$a1, $a1, 1
	addi.w	$a2, $t6, 0
	addi.w	$a5, $a5, 0
	...
	or	$t6, $a2, $a1
	.p2align	4, , 16
.LBB3_157:                              #   in Loop: Header=BB3_151 Depth=2
	slli.d	$a1, $t7, 2
	ldx.w	$t2, $s6, $a1
	...
	sub.w	$a5, $a5, $a3
	bge	$a5, $a2, .LBB3_159
.LBB3_158:                              #   in Loop: Header=BB3_151 Depth=2
	move	$ra, $t3
	move	$s5, $t5
	b	.LBB3_163
	.p2align	4, , 16
.LBB3_159:                              #   in Loop: Header=BB3_151 Depth=2
	ld.d	$a6, $sp, 264                   # 8-byte Folded Reload
	ldx.w	$ra, $a6, $a1
	ld.d	$a6, $sp, 256                   # 8-byte Folded Reload
	ldx.w	$s5, $a6, $a1
	bne	$a5, $a2, .LBB3_162
# %bb.160:                              #   in Loop: Header=BB3_151 Depth=2
	blt	$ra, $t3, .LBB3_158
# %bb.161:                              #   in Loop: Header=BB3_151 Depth=2
	xor	$a1, $ra, $t3
	sltui	$a1, $a1, 1
	slt	$a5, $t5, $s5
	masknez	$a6, $t5, $a5
	...
	b	.LBB3_163
	.p2align	4, , 16
.LBB3_162:                              #   in Loop: Header=BB3_151 Depth=2
	move	$a2, $a5
.LBB3_163:                              #   in Loop: Header=BB3_151 Depth=2
	ld.d	$a1, $fp, 0
	st.d	$a1, $t8, %pc_lo12(z)
	beqz	$a1, .LBB3_166
	.p2align	4, , 16
.LBB3_164:                              # %.lr.ph625
	...
	addi.w	$a6, $t7, 0
	beq	$a5, $a6, .LBB3_167
# %bb.165:                              #   in Loop: Header=BB3_164 Depth=3
	ld.d	$a1, $a1, 8
	st.d	$a1, $t8, %pc_lo12(z)
	bnez	$a1, .LBB3_164
.LBB3_166:                              # %._crit_edge626
	...
	b	.LBB3_168
	.p2align	4, , 16
.LBB3_167:                              #   in Loop: Header=BB3_151 Depth=2
	move	$a1, $zero
.LBB3_168:                              # %.thread
                                        #   in Loop: Header=BB3_151 Depth=2
	slti	$a5, $a1, 1
	...
	move	$s4, $s5
	blt	$s1, $a2, .LBB3_173
# %bb.169:                              #   in Loop: Header=BB3_151 Depth=2
	masknez	$a1, $t1, $a5
	maskeqz	$a6, $s7, $a5
	or	$a1, $a6, $a1
	addi.w	$a1, $a1, 0
	...
	or	$a5, $a5, $a6
	bne	$s1, $a2, .LBB3_172
# %bb.170:                              #   in Loop: Header=BB3_151 Depth=2
	move	$a6, $a2
	move	$s0, $ra
	move	$s4, $s5
	blt	$a1, $ra, .LBB3_173
# %bb.171:                              #   in Loop: Header=BB3_151 Depth=2
	xor	$a6, $a1, $ra
	sltui	$a6, $a6, 1
	addi.w	$t1, $a5, 0
	slt	$t4, $s5, $t1
	...
	b	.LBB3_173
	.p2align	4, , 16
.LBB3_172:                              #   in Loop: Header=BB3_151 Depth=2
	move	$a6, $s1
	move	$s0, $a1
	move	$s4, $a5
.LBB3_173:                              #   in Loop: Header=BB3_151 Depth=2
	move	$a1, $t0
	move	$s3, $a0
	move	$a5, $t6
	blt	$a6, $t0, .LBB3_178
# %bb.174:                              #   in Loop: Header=BB3_151 Depth=2
	bne	$a6, $t0, .LBB3_177
# %bb.175:                              #   in Loop: Header=BB3_151 Depth=2
	addi.w	$a6, $a0, 0
	move	$a1, $t0
	move	$s3, $a0
	move	$a5, $t6
	blt	$s0, $a6, .LBB3_178
# %bb.176:                              #   in Loop: Header=BB3_151 Depth=2
	xor	$a1, $s0, $a6
	sltui	$a1, $a1, 1
	addi.w	$a5, $s4, 0
	addi.w	$a6, $t6, 0
	...
	b	.LBB3_178
	.p2align	4, , 16
.LBB3_177:                              #   in Loop: Header=BB3_151 Depth=2
	move	$a1, $a6
	move	$s3, $s0
	move	$a5, $s4
.LBB3_178:                              #   in Loop: Header=BB3_151 Depth=2
	alsl.d	$a6, $t7, $s6, 2
	...
	bge	$a2, $a1, .LBB3_150
# %bb.179:                              #   in Loop: Header=BB3_151 Depth=2
	ld.d	$a2, $sp, 224                   # 8-byte Folded Reload
	ori	$a6, $zero, 1
	st.b	$a6, $a2, %pc_lo12(flag)
	b	.LBB3_150
.Lfunc_end3:
...
# %bb.0:
	...
	ld.w	$a1, $a0, %pc_lo12(n1)
	pcalau12i	$a0, %pc_hi20(nn)
	ld.w	$a2, $a0, %pc_lo12(nn)
	pcalau12i	$a0, %pc_hi20(m1)
	ld.w	$t3, $a0, %pc_lo12(m1)
	pcalau12i	$t2, %pc_hi20(CC)
	pcalau12i	$t5, %pc_hi20(RR)
	pcalau12i	$t6, %pc_hi20(EE)
	pcalau12i	$t4, %pc_hi20(q)
	pcalau12i	$s5, %pc_hi20(DD)
	pcalau12i	$t0, %pc_hi20(SS)
	pcalau12i	$s4, %pc_hi20(FF)
	st.d	$a1, $sp, 56                    # 8-byte Folded Spill
	st.d	$a2, $sp, 64                    # 8-byte Folded Spill
	bge	$a1, $a2, .LBB4_7
# %bb.1:                                # %.lr.ph
	ld.w	$a0, $t4, %pc_lo12(q)
	ld.d	$a1, $t2, %pc_lo12(CC)
	ld.d	$s7, $t5, %pc_lo12(RR)
	ld.d	$s8, $t6, %pc_lo12(EE)
	sub.d	$s6, $zero, $a0
	ld.d	$fp, $s5, %pc_lo12(DD)
	ld.d	$s0, $t0, %pc_lo12(SS)
	ld.d	$s2, $s4, %pc_lo12(FF)
...
# %bb.8:                                # %.lr.ph216
	...
	ld.d	$t4, $t2, %pc_lo12(CC)
	ld.d	$t5, $t5, %pc_lo12(RR)
	ld.d	$t6, $t6, %pc_lo12(EE)
	pcalau12i	$a0, %pc_hi20(r)
	ld.w	$t7, $a0, %pc_lo12(r)
	pcalau12i	$a0, %pc_hi20(qr)
	ld.w	$t8, $a0, %pc_lo12(qr)
	ld.d	$fp, $s5, %pc_lo12(DD)
	ld.d	$s0, $t0, %pc_lo12(SS)
	ld.d	$s1, $s4, %pc_lo12(FF)
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	addi.w	$a0, $a0, 1
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
...
.LBB4_33:                               # %.thread
	...
	move	$a7, $a5
	blt	$t1, $a3, .LBB4_38
# %bb.34:                               #   in Loop: Header=BB4_16 Depth=2
	masknez	$a0, $a0, $t2
	maskeqz	$a2, $t3, $t2
	or	$a0, $a2, $a0
	addi.w	$a0, $a0, 0
...
# %bb.35:                               #   in Loop: Header=BB4_16 Depth=2
	...
	move	$a7, $a5
	blt	$a0, $a4, .LBB4_38
# %bb.36:                               #   in Loop: Header=BB4_16 Depth=2
	xor	$a2, $a0, $a4
	sltui	$a2, $a2, 1
	addi.w	$a7, $a1, 0
	slt	$t0, $a5, $a7
	...
	b	.LBB4_38
	.p2align	4, , 16
.LBB4_37:                               #   in Loop: Header=BB4_16 Depth=2
	move	$t0, $t1
	move	$a2, $a0
	move	$a7, $a1
.LBB4_38:                               #   in Loop: Header=BB4_16 Depth=2
	move	$s5, $s6
	move	$a1, $s7
	move	$t2, $s3
	blt	$t0, $s6, .LBB4_43
# %bb.39:                               #   in Loop: Header=BB4_16 Depth=2
	bne	$t0, $s6, .LBB4_42
# %bb.40:                               #   in Loop: Header=BB4_16 Depth=2
	addi.w	$a0, $s7, 0
	move	$s5, $s6
	move	$a1, $s7
	move	$t2, $s3
	blt	$a2, $a0, .LBB4_43
# %bb.41:                               #   in Loop: Header=BB4_16 Depth=2
	xor	$a0, $a2, $a0
	sltui	$a0, $a0, 1
	addi.w	$a1, $a7, 0
	addi.w	$t0, $s3, 0
	...
	b	.LBB4_43
	.p2align	4, , 16
.LBB4_42:                               #   in Loop: Header=BB4_16 Depth=2
	move	$s5, $t0
	move	$a1, $a2
	move	$t2, $a7
.LBB4_43:                               #   in Loop: Header=BB4_16 Depth=2
	st.d	$a1, $sp, 176                   # 8-byte Folded Spill
	alsl.d	$a0, $s4, $t4, 2
	alsl.d	$a1, $s4, $t5, 2
	alsl.d	$a2, $s4, $t6, 2
	...
	st.w	$a5, $t1, 0
	bge	$a6, $s5, .LBB4_15
# %bb.44:                               #   in Loop: Header=BB4_16 Depth=2
	addi.w	$a1, $a0, 0
	addi.w	$a2, $t2, 0
	move	$a0, $s5
	move	$a3, $t3
...
.LBB8_7:                                # %vector.body522
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB8_7
# %bb.8:                                # %middle.block528
                                        #   in Loop: Header=BB8_4 Depth=1
	beq	$t2, $t1, .LBB8_11
.LBB8_9:                                # %scalar.ph505.preheader
                                        #   in Loop: Header=BB8_4 Depth=1
	alsl.d	$a3, $t8, $a3, 2
	alsl.d	$t1, $t8, $a0, 2
	sub.d	$t2, $a1, $t8
