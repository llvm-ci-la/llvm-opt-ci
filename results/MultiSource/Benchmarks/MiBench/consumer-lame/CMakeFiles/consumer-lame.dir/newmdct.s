...
# %bb.34:                               # %.preheader195.15
	...
	fld.d	$fa1, $a0, %pc_lo12(.LCPI1_46)
	fld.d	$fa2, $sp, 264
	pcalau12i	$a0, %pc_hi20(.LCPI1_47)
	fld.d	$fa3, $a0, %pc_lo12(.LCPI1_47)
	fmul.d	$fa0, $fa0, $fa1
	fst.d	$fa0, $s0, -120
	fmul.d	$fa0, $fa2, $fa3
	fld.d	$fa1, $sp, 272
	...
	fld.d	$fa3, $a0, %pc_lo12(.LCPI1_52)
	fld.d	$fa4, $sp, 312
	pcalau12i	$a0, %pc_hi20(.LCPI1_53)
	fld.d	$fa0, $a0, %pc_lo12(.LCPI1_53)
	fst.d	$fa1, $s0, -80
	fmul.d	$fa1, $fa2, $fa3
	fst.d	$fa1, $s0, -72
	fmul.d	$fa1, $fa4, $fa0
	...
	xvld	$xr2, $a0, %pc_lo12(.LCPI1_78)
	pcalau12i	$a0, %pc_hi20(.LCPI1_79)
	vld	$vr3, $a0, %pc_lo12(.LCPI1_79)
	xvst	$xr1, $fp, 1120
	xvreplve0.d	$xr1, $xr5
	...
	fld.d	$fa4, $a1, %pc_lo12(.LCPI1_81)
	pcalau12i	$a1, %pc_hi20(.LCPI1_82)
	vld	$vr5, $a1, %pc_lo12(.LCPI1_82)
	fst.d	$fa2, $a0, 32
	fmul.d	$fa2, $fa3, $fa4
	fst.d	$fa2, $a0, 128
	vfmul.d	$vr2, $vr1, $vr5
	...
	fld.d	$fa4, $a1, %pc_lo12(.LCPI1_83)
	pcalau12i	$a1, %pc_hi20(.LCPI1_84)
	fld.d	$fa5, $a1, %pc_lo12(.LCPI1_84)
	vst	$vr2, $a0, 144
	fmul.d	$fa2, $fa3, $fa4
	fst.d	$fa2, $a0, 200
	fmul.d	$fa2, $fa3, $fa5
	pcalau12i	$a1, %pc_hi20(.LCPI1_85)
	vld	$vr3, $a1, %pc_lo12(.LCPI1_85)
	pcalau12i	$a1, %pc_hi20(.LCPI1_86)
	xvld	$xr4, $a1, %pc_lo12(.LCPI1_86)
	fst.d	$fa2, $a0, 248
	vfmul.d	$vr2, $vr1, $vr3
	vst	$vr2, $a0, 264
