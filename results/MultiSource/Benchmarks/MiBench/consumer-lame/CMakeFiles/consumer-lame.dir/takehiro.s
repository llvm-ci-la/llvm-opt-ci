...
.LBB2_60:                               #   in Loop: Header=BB2_52 Depth=1
	...
	st.w	$a0, $sp, 32
	blt	$a1, $a0, .LBB2_63
# %bb.61:                               #   in Loop: Header=BB2_52 Depth=1
	ld.w	$a0, $s8, 16
	alsl.d	$a1, $a0, $fp, 2
	addi.d	$a2, $sp, 32
	move	$a0, $s1
...
# %bb.68:                               #   in Loop: Header=BB2_52 Depth=1
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s0, 0
.LBB2_69:                               #   in Loop: Header=BB2_52 Depth=1
	ld.w	$a0, $s2, 8
	add.w	$a0, $a0, $s3
	st.w	$a0, $sp, 32
	blt	$a1, $a0, .LBB2_72
# %bb.70:                               #   in Loop: Header=BB2_52 Depth=1
	ld.w	$a0, $s8, 28
	alsl.d	$a1, $a0, $fp, 2
	addi.d	$a2, $sp, 32
	move	$a0, $s1
	...
	st.w	$a0, $sp, 68
	blt	$a1, $a2, .LBB2_72
# %bb.71:                               #   in Loop: Header=BB2_52 Depth=1
	add.d	$a0, $s7, $s5
	ld.w	$a0, $a0, 8
	ori	$a1, $zero, 5
	st.w	$a1, $sp, 92
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s0, 0
.LBB2_72:                               #   in Loop: Header=BB2_52 Depth=1
	ld.w	$a0, $s2, 12
	add.w	$a0, $a0, $s3
	st.w	$a0, $sp, 32
	blt	$a1, $a0, .LBB2_75
# %bb.73:                               #   in Loop: Header=BB2_52 Depth=1
	ld.w	$a0, $s8, 32
	alsl.d	$a1, $a0, $fp, 2
	addi.d	$a2, $sp, 32
	move	$a0, $s1
	...
	st.w	$a0, $sp, 68
	blt	$a1, $a2, .LBB2_75
# %bb.74:                               #   in Loop: Header=BB2_52 Depth=1
	add.d	$a0, $s7, $s5
	ld.w	$a0, $a0, 12
	ori	$a1, $zero, 6
	st.w	$a1, $sp, 92
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s0, 0
.LBB2_75:                               #   in Loop: Header=BB2_52 Depth=1
	ld.w	$a0, $s2, 16
	add.w	$a0, $a0, $s3
	st.w	$a0, $sp, 32
	blt	$a1, $a0, .LBB2_51
# %bb.76:                               #   in Loop: Header=BB2_52 Depth=1
	ld.w	$a0, $s8, 36
	alsl.d	$a1, $a0, $fp, 2
	addi.d	$a2, $sp, 32
	move	$a0, $s1
	...
	st.w	$a0, $sp, 68
	blt	$a1, $a2, .LBB2_51
# %bb.77:                               #   in Loop: Header=BB2_52 Depth=1
	add.d	$a0, $s7, $s5
	ld.w	$a0, $a0, 16
	ori	$a1, $zero, 7
	st.w	$a1, $sp, 92
...
# %bb.19:                               # %middle.block216
	...
	beq	$t2, $t3, .LBB3_22
.LBB3_20:                               # %scalar.ph202.preheader
	addi.d	$t1, $t1, -4
	.p2align	4, , 16
.LBB3_21:                               # %scalar.ph202
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t2, $t1, 4
	ldx.bu	$t2, $t0, $t2
	addi.d	$t3, $t1, 4
...
# %bb.26:                               # %middle.block236
	...
	beq	$a4, $t1, .LBB3_29
.LBB3_27:                               # %scalar.ph222.preheader
	addi.d	$a4, $t0, -4
	.p2align	4, , 16
.LBB3_28:                               # %scalar.ph222
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a4, 4
	ldx.bu	$t0, $a6, $t0
	addi.d	$t1, $a4, 4
...
.LBB3_53:
	...
	addi.w	$a0, $a3, 0
	ret
.LBB3_54:                               # %scalar.ph134.preheader
	ori	$a0, $zero, 14
	ori	$a3, $zero, 15
	b	.LBB3_56
	.p2align	4, , 16
...
# %bb.64:                               # %middle.block196
	...
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a4, $a7, .LBB3_67
.LBB3_65:                               # %scalar.ph183.preheader
	addi.d	$a4, $a6, -4
	.p2align	4, , 16
.LBB3_66:                               # %scalar.ph183
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a6, $a4, 4
	ldx.bu	$a6, $a3, $a6
	addi.d	$a7, $a4, 4
...
# %bb.18:                               #   in Loop: Header=BB4_17 Depth=2
	...
	b	.LBB4_12
	.p2align	4, , 16
.LBB4_19:                               # %._crit_edge156
                                        #   in Loop: Header=BB4_14 Depth=1
	beq	$t6, $t7, .LBB4_12
	b	.LBB4_13
.LBB4_20:                               # %._crit_edge163
	ld.w	$t1, $fp, 84
	ori	$t2, $zero, 11
	blt	$t2, $t1, .LBB4_40
# %bb.21:                               # %.lr.ph162.1
	...
	b	.LBB4_24
	.p2align	4, , 16
.LBB4_22:                               # %._crit_edge156.1.thread
...
# %bb.28:                               #   in Loop: Header=BB4_27 Depth=2
	...
	b	.LBB4_22
	.p2align	4, , 16
.LBB4_29:                               # %._crit_edge156.1
                                        #   in Loop: Header=BB4_24 Depth=1
	beq	$t5, $t6, .LBB4_22
	b	.LBB4_23
.LBB4_30:                               # %._crit_edge163.1
	ld.w	$t0, $fp, 84
	ori	$t1, $zero, 11
	blt	$t1, $t0, .LBB4_40
# %bb.31:                               # %.lr.ph162.2
	...
	b	.LBB4_34
	.p2align	4, , 16
.LBB4_32:                               # %._crit_edge156.2.thread
...
.LBB4_50:                               # %scalar.ph
	...
	addi.d	$t2, $t2, 4
	bnez	$t0, .LBB4_50
.LBB4_51:                               # %._crit_edge168
	ld.w	$t0, $fp, 84
	ori	$t1, $zero, 11
	bltu	$t1, $t0, .LBB4_54
# %bb.52:                               # %.preheader144.lr.ph
	addi.d	$t1, $t0, 1
	ori	$t2, $zero, 488
	mul.d	$t2, $a1, $t2
	ori	$t3, $zero, 244
...
.LBB4_58:                               # %.lr.ph177
	...
	addi.d	$a7, $a7, 4
	bltu	$a3, $t0, .LBB4_58
# %bb.59:                               # %._crit_edge178.loopexit
	ld.w	$t0, $fp, 84
.LBB4_60:                               # %._crit_edge178
	ori	$a3, $zero, 11
	bltu	$a3, $t0, .LBB4_63
# %bb.61:                               # %.preheader.lr.ph
	addi.d	$a3, $t0, 1
	ori	$a7, $zero, 488
	mul.d	$a7, $a1, $a7
	ori	$t1, $zero, 244
...
.LBB4_100:                              # =>This Inner Loop Header: Depth=1
	...
	ldx.w	$t0, $t0, $a2
	bge	$a6, $t0, .LBB4_99
# %bb.101:                              #   in Loop: Header=BB4_100 Depth=1
