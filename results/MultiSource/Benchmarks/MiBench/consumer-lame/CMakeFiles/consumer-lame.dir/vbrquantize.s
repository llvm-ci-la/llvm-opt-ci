...
# %bb.0:
	...
	b	.LBB1_3
	.p2align	4, , 16
.LBB1_1:                                # %calc_sfb_ave_noise.exit.thread
...
# %bb.9:                                #   in Loop: Header=BB1_6 Depth=2
	...
	b	.LBB1_5
	.p2align	4, , 16
.LBB1_10:                               # %calc_sfb_ave_noise.exit
                                        #   in Loop: Header=BB1_3 Depth=1
	fdiv.d	$fa0, $fa1, $fs4
...
.LBB1_14:
	...
	fld.d	$fs6, $a0, %pc_lo12(.LCPI1_3)
	vldi	$vr0, -920
	fadd.d	$fa0, $fs1, $fa0
	fadd.d	$fs7, $fs1, $fs6
	fcmp.cule.d	$fcc0, $fa0, $fs7
	bcnez	$fcc0, .LBB1_27
# %bb.15:                               # %.lr.ph
	fst.d	$fs0, $sp, 8                    # 8-byte Folded Spill
	vldi	$vr1, -1024
	fmadd.d	$fs5, $fs5, $fa1, $fs1
	movgr2fr.d	$fs0, $zero
	b	.LBB1_17
	.p2align	4, , 16
.LBB1_16:                               # %calc_sfb_ave_noise.exit83.thread
...
# %bb.23:                               #   in Loop: Header=BB1_20 Depth=2
	...
	b	.LBB1_19
	.p2align	4, , 16
.LBB1_24:                               # %calc_sfb_ave_noise.exit83
                                        #   in Loop: Header=BB1_17 Depth=1
	fdiv.d	$fa0, $fa1, $fs4
	fcmp.cule.d	$fcc0, $fa0, $fs0
	bcnez	$fcc0, .LBB1_16
# %bb.25:                               # %calc_sfb_ave_noise.exit83
                                        #   in Loop: Header=BB1_17 Depth=1
