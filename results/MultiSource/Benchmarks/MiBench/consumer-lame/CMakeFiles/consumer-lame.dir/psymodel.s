...
.LBB0_80:                               #   in Loop: Header=BB0_78 Depth=1
	...
	ori	$a0, $zero, 2
	bne	$t1, $a0, .LBB0_89
# %bb.81:                               # %vector.body1580.preheader
...
.LBB0_82:                               # %vector.body1580
	...
	vstx	$vr1, $a1, $a6
	bnez	$a0, .LBB0_82
# %bb.83:                               # %vector.body1567.preheader
                                        #   in Loop: Header=BB0_78 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_84:                               # %vector.body1567
                                        #   Parent Loop BB0_78 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	vldx	$vr1, $a2, $a7
	...
	vstx	$vr1, $a2, $a3
	bne	$a1, $a0, .LBB0_84
# %bb.85:                               # %vector.body1554.preheader
                                        #   in Loop: Header=BB0_78 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_86:                               # %vector.body1554
                                        #   Parent Loop BB0_78 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	vld	$vr1, $a2, 2032
	...
	vstx	$vr1, $a2, $a3
	bne	$a1, $a0, .LBB0_86
# %bb.87:                               # %vector.body1541.preheader
                                        #   in Loop: Header=BB0_78 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_88:                               # %vector.body1541
                                        #   Parent Loop BB0_78 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	vld	$vr1, $a2, 1008
...
# %bb.102:                              #   in Loop: Header=BB0_100 Depth=2
	...
	fneg.s	$fa2, $fs7
	fmul.s	$fa2, $fs7, $fa2
	fmadd.s	$fa2, $fs6, $fs6, $fa2
	fmul.s	$fa3, $fa2, $fa6
	fmul.s	$fa2, $fs1, $fs1
	fcmp.ceq.s	$fcc0, $fs2, $fa4
	bcnez	$fcc0, .LBB0_104
...
.LBB0_118:                              # %.split2007
	...
	fmul.s	$fa1, $fa1, $fa6
	fneg.s	$fa2, $fs4
	fmadd.s	$fa2, $fa2, $ft1, $fa1
	fneg.s	$fa3, $fs3
	fmadd.s	$ft1, $fa3, $fs2, $fa1
	fmul.s	$fa5, $fa5, $fa0
	fmov.s	$fs1, $fa0
	fmov.s	$fs2, $fa2
