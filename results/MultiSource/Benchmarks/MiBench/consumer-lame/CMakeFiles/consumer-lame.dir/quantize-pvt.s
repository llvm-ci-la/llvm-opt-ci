...
# %bb.1:                                # %.preheader70
	ori	$a2, $zero, 148
	pcalau12i	$a0, %pc_hi20(sfBandIndex)
	addi.d	$a0, $a0, %pc_lo12(sfBandIndex)
...
.LBB7_15:                               # %.loopexit
	...
	ori	$a0, $zero, 2
	pcalau12i	$a5, %pc_hi20(scale_bitcount.slen1)
	addi.d	$a5, $a5, %pc_lo12(scale_bitcount.slen1)
	pcalau12i	$a7, %pc_hi20(scale_bitcount.slen2)
	addi.d	$a7, $a7, %pc_lo12(scale_bitcount.slen2)
	move	$t0, $zero
	move	$t1, $zero
	ori	$t2, $zero, 64
	b	.LBB7_17
...
.LBB9_14:
	ori	$a0, $zero, 11
	pcalau12i	$a6, %pc_hi20(masking_lower)
...
.LBB9_16:                               # %.loopexit111
	...
	fcmp.clt.d	$fcc0, $ft0, $fa6
	fsel	$fa7, $ft0, $fa6, $fcc0
...
.LBB9_29:                               # %.lr.ph120.2
	...
	addi.d	$s3, $s3, 24
	bnez	$t8, .LBB9_29
.LBB9_30:                               # %._crit_edge.2
                                        #   in Loop: Header=BB9_17 Depth=1
	fld.d	$ft0, $s0, 16
	fcmp.cule.d	$fcc0, $ft0, $fa1
	fdiv.d	$fa3, $fa7, $fa3
	bcnez	$fcc0, .LBB9_16
# %bb.31:                               #   in Loop: Header=BB9_17 Depth=1
	fld.d	$fa7, $s2, 16
	fmul.d	$fa7, $fa3, $fa7
	fmul.d	$fa7, $fa7, $fa0
	fdiv.d	$ft0, $fa7, $ft0
