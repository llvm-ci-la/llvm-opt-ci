...
# %bb.55:                               #   in Loop: Header=BB4_54 Depth=1
	...
	b	.LBB4_59
	.p2align	4, , 16
.LBB4_56:                               # %vector.body525.preheader
                                        #   in Loop: Header=BB4_54 Depth=1
	move	$t0, $a6
	move	$t1, $a4
	.p2align	4, , 16
.LBB4_57:                               # %vector.body525
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB4_57
# %bb.58:                               # %middle.block530
                                        #   in Loop: Header=BB4_54 Depth=1
	move	$t1, $a4
	beq	$a4, $a0, .LBB4_53
.LBB4_59:                               # %scalar.ph518.preheader
                                        #   in Loop: Header=BB4_54 Depth=1
	alsl.d	$t0, $t1, $a5, 2
	sub.d	$t1, $a0, $t1
	.p2align	4, , 16
.LBB4_60:                               # %scalar.ph518
                                        #   Parent Loop BB4_54 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t2, $t0, 0
	mul.w	$t2, $a2, $t2
...
.LBB4_61:                               # %.loopexit
	blez	$a1, .LBB4_107
.LBB4_62:                               # %.preheader342.lr.ph
	ld.w	$a0, $s4, 204
	addi.d	$s6, $s3, 48
	lu12i.w	$a2, 1
	blez	$a0, .LBB4_86
# %bb.63:                               # %.preheader342.preheader
	move	$s0, $zero
	addi.d	$a4, $s3, 288
	move	$a3, $a2
	lu12i.w	$a2, 2
	...
	b	.LBB4_66
	.p2align	4, , 16
.LBB4_64:                               # %._crit_edge399.loopexit
...
.LBB4_77:                               #   in Loop: Header=BB4_66 Depth=1
	...
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB4_64
.LBB4_78:                               # %.peel.next444.preheader
                                        #   in Loop: Header=BB4_66 Depth=1
	ori	$s1, $zero, 2
	...
	b	.LBB4_82
	.p2align	4, , 16
.LBB4_79:                               #   in Loop: Header=BB4_82 Depth=2
	ld.w	$a0, $fp, 92
	slli.d	$a0, $a0, 1
	addi.d	$a0, $a0, -6
	ld.w	$s5, $s3, 0
...
# %bb.84:                               #   in Loop: Header=BB4_82 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_80
.LBB4_85:                               # %.preheader341
	lu12i.w	$a2, 1
	blez	$a1, .LBB4_107
.LBB4_86:                               # %.preheader340.lr.ph
	ld.w	$a0, $s4, 204
	blez	$a0, .LBB4_96
# %bb.87:                               # %.preheader340.preheader
	move	$s2, $zero
	ori	$a3, $a2, 512
	...
	b	.LBB4_90
	.p2align	4, , 16
.LBB4_88:                               # %._crit_edge403.loopexit
                                        #   in Loop: Header=BB4_90 Depth=1
	ld.w	$a1, $s8, 200
	move	$s4, $s8
	lu12i.w	$a2, 1
	move	$s6, $fp
.LBB4_89:                               # %._crit_edge403
                                        #   in Loop: Header=BB4_90 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s6, $s6, 240
...
.LBB4_92:                               #   in Loop: Header=BB4_93 Depth=2
	...
	addi.d	$s5, $a1, 257
	bge	$s1, $a0, .LBB4_88
.LBB4_93:                               #   Parent Loop BB4_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s8
	move	$a1, $s2
	move	$a2, $s4
...
# %bb.94:                               #   in Loop: Header=BB4_93 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_92
.LBB4_95:                               # %.preheader339
	blez	$a1, .LBB4_107
.LBB4_96:                               # %.preheader338.lr.ph
	ld.w	$a5, $s4, 204
	blez	$a5, .LBB4_107
# %bb.97:                               # %.preheader338.preheader
	move	$a0, $zero
	move	$a3, $a2
	lu12i.w	$a2, -2
	ori	$a2, $a2, 3584
	...
	b	.LBB4_100
	.p2align	4, , 16
.LBB4_98:                               # %._crit_edge407.loopexit
                                        #   in Loop: Header=BB4_100 Depth=1
	ld.w	$a1, $s4, 200
.LBB4_99:                               # %._crit_edge407
                                        #   in Loop: Header=BB4_100 Depth=1
	addi.d	$a0, $a0, 1
...
.LBB4_104:                              #   in Loop: Header=BB4_105 Depth=3
	...
	addi.d	$a5, $a5, 4
	beqz	$t0, .LBB4_102
.LBB4_105:                              #   Parent Loop BB4_100 Depth=1
...
.LBB8_28:                               # %vector.body147
	...
	addi.d	$t6, $t6, 48
	bnez	$t7, .LBB8_28
# %bb.29:                               # %middle.block151
                                        #   in Loop: Header=BB8_23 Depth=1
	beq	$t4, $t5, .LBB8_22
.LBB8_30:                               # %.lr.ph91.preheader185
                                        #   in Loop: Header=BB8_23 Depth=1
	slli.d	$t4, $t3, 4
	alsl.d	$t4, $t3, $t4, 3
	add.d	$t4, $a0, $t4
...
.LBB8_43:                               # %vector.body160
	...
	addi.d	$fp, $fp, 48
	bnez	$s0, .LBB8_43
# %bb.44:                               # %middle.block164
                                        #   in Loop: Header=BB8_35 Depth=1
	beq	$t7, $t8, .LBB8_34
	b	.LBB8_38
.LBB8_45:                               # %._crit_edge95.1
	ld.w	$a1, $a1, 84
	ori	$a5, $zero, 11
	bltu	$a5, $a1, .LBB8_58
# %bb.46:                               # %.lr.ph94.2
...
# %bb.49:                               #   in Loop: Header=BB8_48 Depth=1
	...
	ld.w	$t2, $t2, 96
	bge	$t1, $t2, .LBB8_47
# %bb.50:                               # %.lr.ph91.preheader.2
                                        #   in Loop: Header=BB8_48 Depth=1
	sub.d	$t3, $t2, $t1
	bgeu	$t3, $a6, .LBB8_53
.LBB8_51:                               # %.lr.ph91.2.preheader
                                        #   in Loop: Header=BB8_48 Depth=1
	slli.d	$t3, $t1, 4
	alsl.d	$t3, $t1, $t3, 3
	add.d	$t3, $a5, $t3
