...
# %bb.2:                                # %vector.body
	...
	vsllwil.d.w	$vr8, $vr3, 0
	vshuf4i.w	$vr2, $vr3, 14
	...
	vadd.w	$vr8, $vr7, $vr3
	vsllwil.d.w	$vr9, $vr6, 0
	vshuf4i.w	$vr3, $vr6, 14
	vsllwil.d.w	$vr6, $vr3, 0
	vrepli.d	$vr3, 334
	vmul.d	$vr6, $vr6, $vr3
	vmul.d	$vr9, $vr9, $vr3
	vsrli.d	$vr9, $vr9, 8
	...
	vadd.w	$vr1, $vr1, $vr3
	vsllwil.d.w	$vr3, $vr6, 0
	vshuf4i.w	$vr5, $vr6, 14
	vsllwil.d.w	$vr5, $vr5, 0
	vmul.d	$vr5, $vr5, $vr0
	vmul.d	$vr0, $vr3, $vr0
	vsrli.d	$vr0, $vr0, 8
