...
# %bb.1:                                # %.lr.ph
	...
	fld.d	$fa6, $a0, %pc_lo12(.LCPI1_0)
	pcalau12i	$a0, %pc_hi20(.LCPI1_1)
	vld	$vr7, $a0, %pc_lo12(.LCPI1_1)
	lu52i.d	$a0, $zero, 1026
	vreplgr2vr.d	$vr8, $a0
	pcalau12i	$a0, %pc_hi20(.LCPI1_2)
	fld.d	$ft1, $a0, %pc_lo12(.LCPI1_2)
	pcalau12i	$a0, %pc_hi20(.LCPI1_3)
	vld	$vr10, $a0, %pc_lo12(.LCPI1_3)
	ori	$s2, $zero, 64
	vrepli.b	$vr11, 0
	ori	$a0, $zero, 1024
...
.LBB1_12:                               # %vector.body
	...
	ld.d	$a1, $s4, 16
	vilvl.h	$vr0, $vr11, $vr0
	vslli.w	$vr0, $vr0, 3
	vst	$vr0, $a0, 0
	vinsgr2vr.d	$vr0, $a1, 0
	ld.d	$a1, $s4, 24
	vilvl.h	$vr1, $vr11, $vr1
	vslli.w	$vr1, $vr1, 3
	vst	$vr1, $a0, 16
...
.LBB1_15:                               # %vector.ph111
	...
	move	$a1, $zero
	.p2align	4, , 16
.LBB1_16:                               # %vector.body112
                                        #   Parent Loop BB1_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.d	$a2, $s4, $a1
	vinsgr2vr.d	$vr0, $a2, 0
	vilvl.h	$vr0, $vr11, $vr0
	vilvl.w	$vr1, $vr11, $vr0
	vilvh.w	$vr0, $vr11, $vr0
...
.LBB2_3:                                # %vector.body
	...
	vslt.w	$vr5, $vr4, $vr1
	vor.v	$vr5, $vr2, $vr5
	vbitsel.v	$vr6, $vr1, $vr8, $vr5
	vdiv.w	$vr4, $vr4, $vr6
	vsub.w	$vr0, $vr3, $vr0
	vsle.w	$vr3, $vr1, $vr0
	vand.v	$vr6, $vr2, $vr3
	vbitsel.v	$vr1, $vr8, $vr1, $vr6
	vdiv.w	$vr0, $vr0, $vr1
	vand.v	$vr0, $vr3, $vr0
	vneg.w	$vr0, $vr0
	vbitsel.v	$vr1, $vr4, $vr7, $vr5
