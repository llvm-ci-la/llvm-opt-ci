...
.LBB13_27:                              # %.lr.ph25.i
	...
	move	$a1, $a6
	bltu	$a3, $a2, .LBB13_27
.LBB13_28:                              # %_rm_leading_zeros.exit
	...
	addi.d	$sp, $sp, 112
	ret
.LBB13_29:                              # %vector.main.loop.iter.check
	bgeu	$a2, $a4, .LBB13_31
# %bb.30:
	move	$a5, $zero
	b	.LBB13_35
...
.LBB13_35:                              # %vec.epilog.ph
	...
	add.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB13_36:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a3, 0
	st.d	$a5, $t1, 0
	addi.d	$t0, $t0, 8
...
# %bb.39:
	ori	$a0, $zero, 1
	st.w	$a0, $t2, 0
.LBB21_40:                              # %iter.check317
	ori	$a1, $zero, 16
	addi.d	$a0, $t2, 16
	ld.d	$a7, $sp, 104                   # 8-byte Folded Reload
	move	$t0, $s2
	bltu	$fp, $a1, .LBB21_43
# %bb.41:                               # %vector.memcheck307
	bgeu	$a0, $s0, .LBB21_132
# %bb.42:                               # %vector.memcheck307
	addi.d	$a1, $fp, -1
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $t2, $a1
	addi.d	$a2, $a2, 17
	nor	$a1, $a1, $zero
	add.d	$a1, $s0, $a1
	bgeu	$a1, $a2, .LBB21_132
.LBB21_43:
	move	$a3, $s0
.LBB21_44:                              # %vec.epilog.scalar.ph335.preheader
	addi.d	$a1, $fp, 1
	addi.d	$a2, $a3, -1
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB21_45:                              # %vec.epilog.scalar.ph335
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a0, 0
	addi.d	$a0, $a0, 1
...
.LBB21_61:                              # %.preheader
	...
	b	.LBB21_64
	.p2align	4, , 16
.LBB21_62:                              #   in Loop: Header=BB21_64 Depth=1
	addi.w	$a0, $s7, 0
...
.LBB21_66:                              # %.lr.ph.i100
	...
	addi.w	$s1, $s1, -1
	blt	$s2, $s1, .LBB21_66
.LBB21_67:                              # %.preheader.i
                                        #   in Loop: Header=BB21_64 Depth=1
	blez	$s2, .LBB21_70
# %bb.68:                               # %.lr.ph15.preheader.i
                                        #   in Loop: Header=BB21_64 Depth=1
...
# %bb.73:
	...
	st.d	$s2, $sp, 112
	bge	$a3, $a0, .LBB21_85
.LBB21_74:                              # %.loopexit177
	beqz	$t0, .LBB21_77
.LBB21_75:                              # %.loopexit177.thread
...
# %bb.79:
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB21_80:                              # %free_num.exit142
	ld.w	$a0, $s7, 12
	addi.w	$a0, $a0, -1
	st.w	$a0, $s7, 12
	beqz	$a0, .LBB21_82
# %bb.81:                               # %free_num.exit143
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	bnez	$a0, .LBB21_83
	b	.LBB21_84
.LBB21_82:
...
.LBB21_85:                              # %.lr.ph192
	...
	b	.LBB21_88
	.p2align	4, , 16
.LBB21_86:                              #   in Loop: Header=BB21_88 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ldx.b	$a0, $a0, $s7
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	jirl	$ra, $a1, 0
	ld.d	$s7, $sp, 72                    # 8-byte Folded Reload
.LBB21_87:                              #   in Loop: Header=BB21_88 Depth=1
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	addi.d	$a2, $sp, 112
	move	$a1, $s7
	move	$a3, $zero
...
.LBB21_88:                              # =>This Loop Header: Depth=1
	...
	blez	$a1, .LBB21_93
# %bb.89:                               # %.lr.ph.preheader.i104
                                        #   in Loop: Header=BB21_88 Depth=1
	move	$a0, $zero
	addi.d	$a2, $s6, 16
	.p2align	4, , 16
.LBB21_90:                              # %.lr.ph.i105
                                        #   Parent Loop BB21_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	move	$a3, $a1
	slli.d	$a1, $a0, 3
	...
	bltu	$a3, $s4, .LBB21_92
# %bb.91:                               # %.lr.ph.i105
                                        #   in Loop: Header=BB21_90 Depth=2
	addi.d	$a2, $a2, 1
	addi.w	$a1, $a3, -1
	blt	$a0, $s3, .LBB21_90
.LBB21_92:                              # %._crit_edge.loopexit.i109
                                        #   in Loop: Header=BB21_88 Depth=1
	sltu	$a1, $s0, $a3
	srai.d	$a2, $a0, 63
	andn	$a0, $a0, $a2
...
.LBB21_96:                              # %.lr.ph.i114
	...
	addi.d	$s5, $s5, 1
	bltu	$s1, $a1, .LBB21_96
.LBB21_97:                              # %._crit_edge.i121
                                        #   in Loop: Header=BB21_88 Depth=1
	beqz	$a0, .LBB21_100
# %bb.98:                               #   in Loop: Header=BB21_88 Depth=1
	ld.w	$a1, $a0, 12
	addi.w	$a1, $a1, -1
	st.w	$a1, $a0, 12
	bnez	$a1, .LBB21_100
# %bb.99:                               #   in Loop: Header=BB21_88 Depth=1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB21_100:                             # %free_num.exit.i124
                                        #   in Loop: Header=BB21_88 Depth=1
	addi.d	$a0, $s2, 1040
	bstrpick.d	$a0, $a0, 31, 0
	pcaddu18i	$ra, %call36(malloc)
	...
	st.d	$a7, $sp, 136
	bgez	$s7, .LBB21_102
# %bb.101:                              #   in Loop: Header=BB21_88 Depth=1
	st.w	$s0, $a7, 0
.LBB21_102:                             # %iter.check372
                                        #   in Loop: Header=BB21_88 Depth=1
	addi.d	$a0, $a7, 16
	ld.d	$t0, $sp, 56                    # 8-byte Folded Reload
	ori	$a1, $zero, 16
	bltu	$s2, $a1, .LBB21_105
# %bb.103:                              # %vector.memcheck360
                                        #   in Loop: Header=BB21_88 Depth=1
	bgeu	$a0, $s5, .LBB21_117
# %bb.104:                              # %vector.memcheck360
                                        #   in Loop: Header=BB21_88 Depth=1
	addi.d	$a1, $s2, -1
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $a7, $a1
	...
	nor	$a1, $a1, $zero
	add.d	$a1, $a1, $s5
	bgeu	$a1, $a2, .LBB21_117
.LBB21_105:                             #   in Loop: Header=BB21_88 Depth=1
	move	$a3, $s5
.LBB21_106:                             # %vec.epilog.scalar.ph390.preheader
                                        #   in Loop: Header=BB21_88 Depth=1
	addi.d	$a1, $s2, 1
	addi.d	$a2, $a3, -1
	.p2align	4, , 16
.LBB21_107:                             # %vec.epilog.scalar.ph390
                                        #   Parent Loop BB21_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a2, 0
	st.b	$a3, $a0, 0
...
.LBB21_108:                             # %int2num.exit129
	...
	ori	$a1, $zero, 16
	bge	$a1, $a0, .LBB21_86
# %bb.109:                              #   in Loop: Header=BB21_88 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.w	$s2, $a0, 4
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	beqz	$a0, .LBB21_111
# %bb.110:                              #   in Loop: Header=BB21_88 Depth=1
	ori	$a0, $zero, 32
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	jirl	$ra, $a1, 0
.LBB21_111:                             #   in Loop: Header=BB21_88 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.2)
	addi.d	$a1, $a0, %pc_lo12(.L.str.2)
	addi.d	$a0, $sp, 144
	move	$a2, $s7
...
.LBB21_112:                             # %.lr.ph.i139
	...
	addi.w	$s2, $s2, -1
	blt	$s5, $s2, .LBB21_112
.LBB21_113:                             # %.preheader.i131
                                        #   in Loop: Header=BB21_88 Depth=1
	ld.d	$s7, $sp, 72                    # 8-byte Folded Reload
	blez	$s5, .LBB21_116
# %bb.114:                              # %.lr.ph15.preheader.i133
                                        #   in Loop: Header=BB21_88 Depth=1
	bstrpick.d	$s2, $s6, 30, 0
	addi.d	$s5, $sp, 144
	.p2align	4, , 16
.LBB21_115:                             # %.lr.ph15.i135
                                        #   Parent Loop BB21_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a0, $s5, 0
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	...
	addi.d	$s5, $s5, 1
	bnez	$s2, .LBB21_115
.LBB21_116:                             # %out_long.exit141
                                        #   in Loop: Header=BB21_88 Depth=1
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	b	.LBB21_87
	.p2align	4, , 16
.LBB21_117:                             # %vector.main.loop.iter.check374
                                        #   in Loop: Header=BB21_88 Depth=1
	bstrpick.d	$a1, $s2, 31, 0
	ori	$a2, $zero, 32
	bgeu	$s2, $a2, .LBB21_122
# %bb.118:                              #   in Loop: Header=BB21_88 Depth=1
	move	$a2, $zero
.LBB21_119:                             # %vec.epilog.ph391
                                        #   in Loop: Header=BB21_88 Depth=1
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_120:                             # %vec.epilog.vector.body398
                                        #   Parent Loop BB21_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a6, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_120
# %bb.121:                              # %vec.epilog.middle.block406
                                        #   in Loop: Header=BB21_88 Depth=1
	bne	$a4, $a1, .LBB21_106
	b	.LBB21_108
.LBB21_122:                             # %vector.ph375
                                        #   in Loop: Header=BB21_88 Depth=1
...
.LBB21_123:                             # %vector.body378
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_123
# %bb.124:                              # %middle.block387
                                        #   in Loop: Header=BB21_88 Depth=1
	beq	$a2, $a1, .LBB21_108
# %bb.125:                              # %vec.epilog.iter.check392
                                        #   in Loop: Header=BB21_88 Depth=1
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_119
# %bb.126:                              #   in Loop: Header=BB21_88 Depth=1
	sub.d	$s2, $s2, $a2
	add.d	$a0, $a0, $a2
	sub.d	$a3, $s5, $a2
	b	.LBB21_106
.LBB21_127:                             # %vector.main.loop.iter.check
	ori	$a2, $zero, 32
	bstrpick.d	$a1, $fp, 31, 0
	bgeu	$fp, $a2, .LBB21_139
# %bb.128:
	move	$a2, $zero
.LBB21_129:                             # %vec.epilog.ph
	bstrpick.d	$a3, $a1, 31, 4
	slli.d	$a4, $a3, 4
	sub.d	$fp, $fp, $a4
	alsl.d	$a0, $a3, $a0, 4
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_130:                             # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vshuf.b	$vr1, $vr0, $vr1, $vr0
	vst	$vr1, $a2, 0
...
# %bb.131:                              # %vec.epilog.middle.block
	bne	$a4, $a1, .LBB21_31
	b	.LBB21_33
.LBB21_132:                             # %vector.main.loop.iter.check319
	ori	$a2, $zero, 32
	bstrpick.d	$a1, $fp, 31, 0
	bgeu	$fp, $a2, .LBB21_144
# %bb.133:
	move	$a2, $zero
.LBB21_134:                             # %vec.epilog.ph336
	bstrpick.d	$a3, $a1, 31, 4
	slli.d	$a4, $a3, 4
	sub.d	$fp, $fp, $a4
	alsl.d	$a0, $a3, $a0, 4
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_135:                             # %vec.epilog.vector.body343
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vshuf.b	$vr1, $vr0, $vr1, $vr0
	vst	$vr1, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_135
# %bb.136:                              # %vec.epilog.middle.block351
	bne	$a4, $a1, .LBB21_44
	b	.LBB21_46
.LBB21_137:
	ld.d	$s8, $sp, 184                   # 8-byte Folded Reload
...
.LBB21_145:                             # %vector.body323
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_145
# %bb.146:                              # %middle.block332
	beq	$a2, $a1, .LBB21_46
# %bb.147:                              # %vec.epilog.iter.check337
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_134
# %bb.148:
	sub.d	$fp, $fp, $a2
