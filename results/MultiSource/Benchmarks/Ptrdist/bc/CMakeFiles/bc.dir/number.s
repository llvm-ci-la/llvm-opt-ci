...
.LBB15_22:                              # %vector.ph201
	...
	or	$t3, $t7, $t3
	addi.d	$t3, $t3, 1
	bstrpick.d	$t3, $t3, 32, 2
	slli.d	$t7, $t3, 2
	addi.d	$ra, $s7, 1
	bstrpick.d	$t3, $ra, 32, 2
	slli.d	$s7, $t3, 2
	sub.d	$s5, $s5, $s7
	vori.b	$vr1, $vr0, 0
	vinsgr2vr.d	$vr1, $a4, 0
...
.LBB21_95:                              #   in Loop: Header=BB21_81 Depth=1
	...
	ori	$a1, $zero, 4
	bltu	$s2, $a1, .LBB21_98
.LBB21_96:                              # %vector.memcheck358
                                        #   in Loop: Header=BB21_81 Depth=1
	bgeu	$a0, $s5, .LBB21_110
# %bb.97:                               # %vector.memcheck358
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $s2, -1
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $t0, $a1
...
.LBB21_98:                              #   in Loop: Header=BB21_81 Depth=1
	move	$a2, $s5
.LBB21_99:                              # %vec.epilog.scalar.ph386.preheader
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $s2, 1
	addi.d	$a2, $a2, -1
	.p2align	4, , 16
.LBB21_100:                             # %vec.epilog.scalar.ph386
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a2, 0
	st.b	$a3, $a0, 0
...
.LBB21_109:                             # %out_long.exit141
	...
	b	.LBB21_80
	.p2align	4, , 16
.LBB21_110:                             # %vector.main.loop.iter.check372
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_112:                             # %vector.ph373
	...
	ld.d	$a7, $sp, 16                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB21_113:                             # %vector.body376
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vld	$vr1, $a7, %pc_lo12(.LCPI21_0)
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB21_113
# %bb.114:                              # %middle.block383
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a3, $a1, .LBB21_101
# %bb.115:                              # %vec.epilog.iter.check387
                                        #   in Loop: Header=BB21_81 Depth=1
	beqz	$a2, .LBB21_119
.LBB21_116:                             # %vec.epilog.ph389
                                        #   in Loop: Header=BB21_81 Depth=1
	...
	addi.d	$a3, $a3, 16
	.p2align	4, , 16
.LBB21_117:                             # %vec.epilog.vector.body393
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a7, $a6, 0
	...
	addi.d	$a3, $a3, 4
	bnez	$a5, .LBB21_117
# %bb.118:                              # %vec.epilog.middle.block401
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a4, $a1, .LBB21_101
	b	.LBB21_99
...
# %bb.121:
	move	$a3, $zero
	b	.LBB21_138
.LBB21_122:                             # %vector.main.loop.iter.check320
	ori	$a2, $zero, 16
	bstrpick.d	$a1, $fp, 31, 0
...
.LBB21_128:                             # %.lr.ph.i100
	...
	addi.w	$s0, $s0, -1
	blt	$s1, $s0, .LBB21_128
.LBB21_129:                             # %.preheader.i
                                        #   in Loop: Header=BB21_127 Depth=1
	blez	$s1, .LBB21_126
# %bb.130:                              # %.lr.ph15.preheader.i
                                        #   in Loop: Header=BB21_127 Depth=1
...
.LBB21_142:                             # %vector.body324
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB21_142
# %bb.143:                              # %middle.block331
	beq	$a3, $a1, .LBB21_46
# %bb.144:                              # %vec.epilog.iter.check335
	beqz	$a2, .LBB21_149
.LBB21_145:                             # %vec.epilog.ph337
	bstrpick.d	$a2, $a1, 31, 2
	slli.d	$a4, $a2, 2
	sub.d	$fp, $fp, $a4
	alsl.d	$a0, $a2, $a0, 2
	...
	addi.d	$a3, $a3, 16
	.p2align	4, , 16
.LBB21_146:                             # %vec.epilog.vector.body341
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $a6, 0
	vinsgr2vr.w	$vr0, $a7, 0
	vshuf4i.b	$vr0, $vr0, 27
	...
	addi.d	$a3, $a3, 4
	bnez	$a5, .LBB21_146
# %bb.147:                              # %vec.epilog.middle.block349
	beq	$a4, $a1, .LBB21_46
	b	.LBB21_44
.LBB21_148:
	sub.d	$fp, $fp, $a3
