...
# %bb.0:
	...
	pcalau12i	$t4, %pc_hi20(.LCPI0_35)
	ori	$a7, $zero, 16
	ori	$t0, $zero, 1
	vld	$vr1, $t1, %pc_lo12(.LCPI0_32)
	vld	$vr2, $t2, %pc_lo12(.LCPI0_33)
	vld	$vr3, $t3, %pc_lo12(.LCPI0_34)
	vld	$vr4, $t4, %pc_lo12(.LCPI0_35)
	lu12i.w	$t1, 8
	ori	$t1, $t1, 259
	vrepli.d	$vr9, 28
	b	.LBB0_3
...
.LBB10_2:
	...
	addi.d	$s3, $a1, %pc_lo12(.Lstr.1)
	pcalau12i	$a1, %pc_hi20(.Lstr)
	addi.d	$s6, $a1, %pc_lo12(.Lstr)
	addi.w	$s4, $a0, 0
	...
	addi.d	$a0, $a0, %pc_lo12(DES3_keys)
	addi.d	$a1, $a0, 8
...
.LBB10_13:                              # %vector.ph
	...
	pcalau12i	$a0, %pc_hi20(DES3_keys)
	addi.d	$a1, $a0, %pc_lo12(DES3_keys)
	addi.d	$a0, $sp, 1672
	pcaddu18i	$ra, %call36(des_main_ks)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 1816
	...
	add.d	$a0, $sp, $a0
	st.d	$a1, $a0, 0
.LBB10_14:                              # %des_set_key.exit.preheader
                                        #   in Loop: Header=BB10_7 Depth=3
	move	$s1, $s5
	b	.LBB10_18
	.p2align	4, , 16
...
# %bb.20:                               #   in Loop: Header=BB10_18 Depth=4
	...
	b	.LBB10_16
	.p2align	4, , 16
.LBB10_21:                              #   in Loop: Header=BB10_18 Depth=4
	beqz	$s8, .LBB10_23
# %bb.22:                               #   in Loop: Header=BB10_18 Depth=4
	addi.d	$a0, $sp, 1672
	addi.d	$a1, $sp, 128
	addi.d	$a2, $sp, 128
...
.LBB10_23:                              # %.critedge
	...
	b	.LBB10_17
	.p2align	4, , 16
.LBB10_24:                              #   in Loop: Header=BB10_7 Depth=3
	beqz	$s8, .LBB10_26
# %bb.25:                               #   in Loop: Header=BB10_7 Depth=3
...
.LBB10_27:                              # %.critedge43
	...
	ld.d	$a1, $sp, 128
	bne	$a1, $a0, .LBB10_31
# %bb.28:                               #   in Loop: Header=BB10_7 Depth=3
	addi.w	$s6, $s6, 1
	bne	$s6, $s4, .LBB10_7
	b	.LBB10_4
