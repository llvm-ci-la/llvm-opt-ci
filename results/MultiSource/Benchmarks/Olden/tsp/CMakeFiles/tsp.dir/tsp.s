...
.LBB0_19:                               # %.lr.ph212.i
	...
	or	$a5, $a7, $a5
	bne	$a4, $a1, .LBB0_19
# %bb.20:                               # %._crit_edge213.loopexit.i
	ld.d	$a4, $a5, 40
	fld.d	$ft0, $a5, 8
	fld.d	$fa7, $a5, 16
	b	.LBB0_22
...
.LBB0_28:
	...
	st.d	$zero, $a2, 48
	beqz	$a6, .LBB0_31
# %bb.29:                               # %.lr.ph.i192.i.preheader
	move	$a7, $a2
	.p2align	4, , 16
.LBB0_30:                               # %.lr.ph.i192.i
                                        # =>This Inner Loop Header: Depth=1
	move	$t0, $a6
	ld.d	$a6, $a6, 40
	st.d	$a7, $t0, 40
