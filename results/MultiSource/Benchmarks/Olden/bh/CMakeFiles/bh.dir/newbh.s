...
.LBB20_6:                               # %.lr.ph
	...
	fld.d	$fa0, $a0, %pc_lo12(.LCPI20_0)
	fst.d	$fa0, $sp, 32                   # 8-byte Folded Spill
	fcmp.cule.d	$fcc0, $fa0, $fs4
	bcnez	$fcc0, .LBB20_27
# %bb.7:                                # %.preheader46.preheader.preheader
	vldi	$vr1, -928
	pcalau12i	$s2, %pc_hi20(cp_free_list)
	ori	$s3, $zero, 2
	vrepli.b	$vr0, 0
	vst	$vr0, $sp, 16                   # 16-byte Folded Spill
	ori	$s4, $zero, 0
...
.LBB20_8:                               # %.backedge
	...
	bceqz	$fcc0, .LBB20_27
.LBB20_9:                               # %.preheader46.preheader
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $s0, 16
	fmadd.d	$fs0, $fs4, $fa1, $fs5
	fcmp.clt.d	$fcc0, $fa0, $fs0
	bceqz	$fcc0, .LBB20_11
# %bb.10:                               #   in Loop: Header=BB20_9 Depth=1
	fsub.d	$fs5, $fs5, $fs4
	fst.d	$fs5, $fp, 0
.LBB20_11:                              # %.preheader.1
                                        #   in Loop: Header=BB20_9 Depth=1
	fld.d	$fa0, $s0, 24
	fmadd.d	$fs1, $fs4, $fa1, $fs6
	fcmp.cule.d	$fcc0, $fs1, $fa0
	bcnez	$fcc0, .LBB20_13
# %bb.12:                               #   in Loop: Header=BB20_9 Depth=1
	fsub.d	$fs6, $fs6, $fs4
	fst.d	$fs6, $fp, 8
.LBB20_13:                              # %.preheader.2
                                        #   in Loop: Header=BB20_9 Depth=1
	fld.d	$fa0, $s0, 32
	fmadd.d	$fs2, $fs4, $fa1, $fs3
...
# %bb.16:                               #   in Loop: Header=BB20_9 Depth=1
	ld.d	$s1, $s2, %pc_lo12(cp_free_list)
	beqz	$s1, .LBB20_18
# %bb.17:                               #   in Loop: Header=BB20_9 Depth=1
	ld.d	$a0, $s1, 112
	st.d	$a0, $s2, %pc_lo12(cp_free_list)
	b	.LBB20_19
	.p2align	4, , 16
