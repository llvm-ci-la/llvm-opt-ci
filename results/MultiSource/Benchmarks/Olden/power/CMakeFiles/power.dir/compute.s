...
# %bb.0:
	...
	fdiv.d	$fa7, $fa7, $fa5
	fadd.d	$fa7, $fa0, $fa7
	fmadd.d	$fs0, $fa6, $fa7, $fa2
	fld.d	$fa2, $a0, 24
	ld.d	$s0, $a0, 48
	fmul.d	$fa5, $fa0, $fa5
	fdiv.d	$fa4, $fa5, $fa4
	fadd.d	$fa4, $fa1, $fa4
	fmadd.d	$fs1, $fa2, $fa4, $fa3
	beqz	$s0, .LBB2_2
# %bb.1:
	move	$a0, $s0
	fmov.d	$fa2, $fs0
...
.LBB2_4:                                #   in Loop: Header=BB2_6 Depth=1
	...
	st.d	$zero, $s3, %pc_lo12(Q)
	fmov.d	$fa1, $fs6
	fmov.d	$fa0, $fs6
.LBB2_5:                                # %Compute_Leaf.exit
