...
.LBB14_34:                              # =>This Loop Header: Depth=1
	...
	stx.w	$a0, $s5, $t5
	bge	$t3, $t4, .LBB14_33
# %bb.35:                               # %.lr.ph296.preheader
                                        #   in Loop: Header=BB14_34 Depth=1
	sub.d	$t5, $t4, $t3
	addi.w	$a0, $a0, 0
	bgeu	$t5, $t0, .LBB14_38
.LBB14_36:                              # %.lr.ph296.preheader581
                                        #   in Loop: Header=BB14_34 Depth=1
	alsl.d	$t5, $a0, $s1, 2
	alsl.d	$t6, $a0, $s3, 3
	alsl.d	$t7, $t3, $a3, 2
...
.Ltmp882:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp883:                               # EH_LABEL
# %bb.46:                               # %._ZNSt6vectorIiSaIiEE6resizeEm.exit_crit_edge
	ld.d	$a1, $s7, 0
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	b	.LBB14_50
.LBB14_47:
...
# %bb.48:
	alsl.d	$a0, $s6, $a1, 2
	beq	$a4, $a0, .LBB14_50
# %bb.49:                               # %_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i
	st.d	$a0, $s2, 40
.LBB14_50:                              # %_ZNSt6vectorIiSaIiEE6resizeEm.exit
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
...
# %bb.58:                               # %.lr.ph317
	...
	move	$a1, $s7
	bgeu	$a3, $a7, .LBB14_71
.LBB14_59:                              # %scalar.ph538.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
.Ltmp885:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp886:                               # EH_LABEL
# %bb.63:                               # %._ZNSt6vectorIiSaIiEE6resizeEm.exit166_crit_edge
	ld.d	$a0, $s2, 0
	b	.LBB14_67
.LBB14_64:
	bgeu	$s6, $a2, .LBB14_67
# %bb.65:
	alsl.d	$a2, $s6, $a0, 2
	beq	$a1, $a2, .LBB14_67
# %bb.66:                               # %_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i164
	st.d	$a2, $s2, 64
.LBB14_67:                              # %iter.check
	move	$a2, $zero
	ori	$a1, $zero, 1
...
# %bb.70:
	move	$a2, $zero
	b	.LBB14_80
.LBB14_71:                              # %vector.memcheck533
	alsl.d	$a1, $s7, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 32
	move	$a1, $s7
	bltu	$a7, $t0, .LBB14_59
# %bb.72:                               # %vector.memcheck533
	alsl.d	$a1, $s7, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 64
	move	$a1, $s7
...
.LBB14_74:                              # %vector.body543
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_74
# %bb.75:                               # %middle.block551
	bne	$a3, $a7, .LBB14_59
	b	.LBB14_61
.LBB14_76:                              # %vector.ph561
	move	$a2, $a1
...
.LBB14_77:                              # %vector.body564
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB14_77
# %bb.78:                               # %middle.block569
	beq	$s6, $a2, .LBB14_85
# %bb.79:                               # %vec.epilog.iter.check
	andi	$a3, $a1, 12
	beqz	$a3, .LBB14_83
.LBB14_80:                              # %vec.epilog.ph
	move	$a5, $a2
	move	$a2, $a1
	...
	alsl.d	$a5, $a5, $s5, 2
	.p2align	4, , 16
.LBB14_81:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vadd.w	$vr1, $vr1, $vr0
	vst	$vr1, $a4, 0
...
# %bb.82:                               # %vec.epilog.middle.block
	beq	$s6, $a2, .LBB14_85
.LBB14_83:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $s5, 2
	alsl.d	$a0, $a2, $a0, 2
	.p2align	4, , 16
.LBB14_84:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a3, 0
	add.d	$a2, $a2, $s7
	st.w	$a2, $a0, 0
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB14_84
.LBB14_85:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit168
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $s5
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.86:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_87:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit
	beqz	$s1, .LBB14_89
# %bb.88:
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $s1
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_89:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit171
	beqz	$s0, .LBB14_91
# %bb.90:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_91:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit173
	beqz	$fp, .LBB14_93
# %bb.92:
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $fp
	...
	jr	$t8
.LBB14_93:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit175
	ld.d	$s8, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 112                   # 8-byte Folded Reload
...
.Ltmp875:                               # EH_LABEL
# %bb.98:                               # %.noexc159
.LBB14_99:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit177.thread
.Ltmp873:                               # EH_LABEL
	move	$s2, $a0
	b	.LBB14_112
.LBB14_100:
.Ltmp887:                               # EH_LABEL
	move	$s2, $a0
	bnez	$s5, .LBB14_107
# %bb.101:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit
	bnez	$s3, .LBB14_111
.LBB14_102:                             # %_ZNSt6vectorIdSaIdEED2Ev.exit177
	bnez	$s1, .LBB14_112
.LBB14_103:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit179
	bnez	$s0, .LBB14_113
.LBB14_104:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit181
	bnez	$fp, .LBB14_114
.LBB14_105:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit183
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB14_106:                             # %.thread
...
.LBB14_107:
	...
	beqz	$s3, .LBB14_102
	b	.LBB14_111
.LBB14_108:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit181.thread
.Ltmp868:                               # EH_LABEL
	move	$s2, $a0
	b	.LBB14_114
.LBB14_109:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit179.thread
.Ltmp878:                               # EH_LABEL
	move	$s2, $a0
	b	.LBB14_113
.LBB14_110:
