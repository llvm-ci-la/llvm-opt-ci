...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %.lr.ph.i166.preheader373
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
# %bb.76:                               # %vector.memcheck344
	...
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.77:                               # %vector.memcheck344
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.78:                               # %vector.memcheck344
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
...
.LBB5_80:                               # %vector.body357
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB5_80
# %bb.81:                               # %middle.block369
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_67
	b	.LBB5_69
	.p2align	4, , 16
.LBB5_82:                               # %vector.memcheck324
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
# %bb.83:                               # %vector.memcheck324
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
...
.LBB5_85:                               # %vector.body333
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_85
# %bb.86:                               # %middle.block341
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_70
	b	.LBB5_72
	.p2align	4, , 16
.LBB5_87:                               # %vector.memcheck304
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
# %bb.88:                               # %vector.memcheck304
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $s3
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
