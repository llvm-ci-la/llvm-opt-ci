...
# %bb.111:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_112:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit170
	beqz	$s8, .LBB0_116
.LBB0_113:
	ori	$a1, $zero, 88
.LBB0_114:
...
# %bb.117:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_118:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit185
	ld.d	$a0, $s1, 0
	beqz	$a0, .LBB0_120
# %bb.119:
	ld.d	$a1, $fp, 128
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_120:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit187
...
# %bb.121:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_122:                              # %_ZNSt6vectorIP7HydroBCSaIS1_EED2Ev.exit
	move	$a0, $s0
...
.LBB1_6:                                # %vector.body153
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_6
# %bb.7:                                # %middle.block158
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a4, .LBB1_10
.LBB1_8:                                # %.lr.ph.i.i.i.preheader163
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a4, $s7, $s1, 3
	.p2align	4, , 16
.LBB1_9:                                # %.lr.ph.i.i.i
...
.LBB1_12:                               # %vector.body139
	...
	addi.d	$a1, $a1, 32
	bnez	$a4, .LBB1_12
# %bb.13:                               # %middle.block143
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a3, .LBB1_16
.LBB1_14:                               # %.lr.ph.i.i.i77.preheader162
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a0, $s7, $s2, 3
	.p2align	4, , 16
...
# %bb.35:                               # %.lr.ph99
	...
	b	.LBB1_37
	.p2align	4, , 16
.LBB1_36:                               # %_ZN5Hydro13initRadialVelEdii.exit
...
.LBB1_41:                               #   in Loop: Header=BB1_42 Depth=2
	...
	addi.d	$a2, $a2, 16
	beqz	$a1, .LBB1_36
.LBB1_42:                               #   Parent Loop BB1_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa1, $a2, 0
	fld.d	$fa2, $a2, -8
	fmul.d	$fa3, $fa1, $fa1
...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s4
.LBB5_19:                               # %.lr.ph.i166.preheader343
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB5_35:                               # %._crit_edge
	...
	jirl	$ra, $ra, 0
	pcalau12i	$s3, %pc_hi20(.LCPI5_0)
	blez	$s1, .LBB5_47
# %bb.36:                               # %.lr.ph223
	move	$s0, $zero
	ld.d	$a1, $fp, 40
	ld.d	$a0, $fp, 32
	fld.d	$fs0, $s3, %pc_lo12(.LCPI5_0)
	vld	$vr0, $sp, 256                  # 16-byte Folded Reload
...
# %bb.48:                               # %.lr.ph227
	...
	b	.LBB5_50
	.p2align	4, , 16
.LBB5_49:                               # %_ZSt4fillIPddEvT_S1_RKT0_.exit
	...
	vld	$vr0, $sp, 256                  # 16-byte Folded Reload
                                        # kill: def $f0_64 killed $f0_64 killed $vr0
	move	$a6, $s2
	pcaddu18i	$ra, %call36(_ZN5Hydro8calcWorkEPK7double2S2_S2_S2_S2_dPdS3_ii)
	jirl	$ra, $ra, 0
	addi.d	$s4, $s4, 4
	beq	$s5, $s4, .LBB5_52
...
# %bb.53:                               # %.lr.ph231
	...
	b	.LBB5_55
	.p2align	4, , 16
.LBB5_54:                               # %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit208
...
.LBB5_61:                               # %.lr.ph.i198
	...
	addi.d	$a2, $a2, 8
	bnez	$a7, .LBB5_61
.LBB5_62:                               # %.lr.ph.preheader.i202
                                        #   in Loop: Header=BB5_55 Depth=1
	ld.d	$a2, $fp, 304
	move	$a3, $a4
	bgeu	$a0, $s4, .LBB5_77
.LBB5_63:                               # %.lr.ph.i204.preheader
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a0, $a5, $a3
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a6, $a3, $s6, 3
...
.LBB5_64:                               # %.lr.ph.i204
	...
	b	.LBB5_54
	.p2align	4, , 16
.LBB5_65:                               # %vector.memcheck314
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a7, $a3, $s6
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_57
# %bb.66:                               # %vector.memcheck314
                                        #   in Loop: Header=BB5_55 Depth=1
	ld.d	$a6, $sp, 280                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_57
# %bb.67:                               # %vector.memcheck314
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_57
# %bb.68:                               # %vector.memcheck314
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_57
...
.LBB5_70:                               # %vector.body327
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB5_70
# %bb.71:                               # %middle.block339
                                        #   in Loop: Header=BB5_55 Depth=1
	bne	$a0, $a7, .LBB5_57
	b	.LBB5_59
	.p2align	4, , 16
.LBB5_72:                               # %vector.memcheck294
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.73:                               # %vector.memcheck294
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
...
# %bb.76:                               # %middle.block311
	...
	b	.LBB5_62
	.p2align	4, , 16
.LBB5_77:                               # %vector.memcheck274
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s5, .LBB5_63
# %bb.78:                               # %vector.memcheck274
                                        #   in Loop: Header=BB5_55 Depth=1
	sub.d	$a6, $a2, $s6
	move	$a3, $a4
	bltu	$a6, $s5, .LBB5_63
...
.LBB5_80:                               # %vector.body283
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB5_80
# %bb.81:                               # %middle.block291
                                        #   in Loop: Header=BB5_55 Depth=1
	beq	$a0, $a6, .LBB5_54
	b	.LBB5_63
.LBB5_82:                               # %._crit_edge232
...
.LBB19_19:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit.i
	...
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 16
.LBB19_20:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
	st.d	$zero, $sp, 24
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 16
	beq	$a0, $s2, .LBB19_22
# %bb.21:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB19_22:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
