...
.LBB0_19:                               #   Parent Loop BB0_3 Depth=1
	...
	addi.d	$a1, $a1, 1
	bnez	$a2, .LBB0_19
# %bb.20:                               # %strtoupper.exit.preheader.i.i
                                        #   in Loop: Header=BB0_14 Depth=2
	addi.d	$s4, $a0, 1
	ori	$s5, $zero, 41
	ori	$s6, $zero, 328
	.p2align	4, , 16
.LBB0_21:                               # %strtoupper.exit.i.i
                                        #   Parent Loop BB0_3 Depth=1
                                        #     Parent Loop BB0_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
...
.LBB0_53:                               #   in Loop: Header=BB0_14 Depth=2
	...
	st.d	$a0, $a1, 8
	b	.LBB0_14
.LBB0_54:                               #   in Loop: Header=BB0_14 Depth=2
	ld.b	$a0, $s4, 0
	ld.d	$a1, $s2, 0
	slli.d	$a0, $a0, 2
	ldx.w	$a0, $a1, $a0
...
.LBB0_56:                               #   in Loop: Header=BB0_14 Depth=2
	...
	b	.LBB0_14
.LBB0_57:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
...
.LBB0_60:                               #   in Loop: Header=BB0_14 Depth=2
	...
	st.d	$a0, $a1, 32
	b	.LBB0_14
.LBB0_61:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	st.d	$a0, $a1, 8
	b	.LBB0_14
.LBB0_62:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	st.d	$a0, $a1, 8
	b	.LBB0_14
.LBB0_63:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	st.d	$a0, $a1, 16
	b	.LBB0_14
.LBB0_64:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	b	.LBB0_66
.LBB0_65:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
...
.LBB0_67:                               # %.loopexit.i.i
	...
	st.w	$a0, $a1, 0
	b	.LBB0_14
.LBB0_68:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	st.d	$a0, $a1, 24
	b	.LBB0_14
.LBB0_69:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	st.d	$a0, $a1, 8
	b	.LBB0_14
.LBB0_70:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	st.d	$a0, $a1, 16
	b	.LBB0_14
.LBB0_71:                               #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 10
	move	$a0, $s4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(strtol)
	...
	st.d	$a0, $a1, 24
	b	.LBB0_14
.LBB0_72:                               #   in Loop: Header=BB0_14 Depth=2
	ld.b	$a0, $s4, 0
	ld.d	$a1, $s2, 0
	slli.d	$a0, $a0, 2
	ldx.w	$a0, $a1, $a0
...
# %bb.100:
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_101:                              # %output_string.exit110
...
# %bb.102:
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_103:                              # %output_string.exit113
...
# %bb.104:
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_105:                              # %output_string.exit116
...
# %bb.106:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB0_107:                              # %output_string.exit119
...
# %bb.108:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB0_109:                              # %output_string.exit122.preheader
	...
	b	.LBB0_111
	.p2align	4, , 16
.LBB0_110:                              # %output_string.exit138
	...
	ori	$a0, $zero, 80
	beq	$s5, $a0, .LBB0_152
.LBB0_111:                              # %output_string.exit122
...
# %bb.115:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_116:                              # %output_string.exit128
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.w	$a0, $a0, %pc_lo12(global_allstats)
	beqz	$a0, .LBB0_110
...
# %bb.118:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_119:                              # %output_string.exit131
                                        #   in Loop: Header=BB0_111 Depth=1
	move	$a0, $fp
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(sprintf)
...
# %bb.120:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_121:                              # %output_string.exit134
                                        #   in Loop: Header=BB0_111 Depth=1
	ori	$a0, $zero, 9
	bltu	$a0, $s6, .LBB0_150
# %bb.122:                              # %output_string.exit134
                                        #   in Loop: Header=BB0_111 Depth=1
	slli.d	$a0, $s6, 2
	ldx.w	$a0, $s3, $a0
	add.d	$a0, $s3, $a0
	jr	$a0
.LBB0_123:                              #   in Loop: Header=BB0_111 Depth=1
...
# %bb.129:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_130:                              # %output_string.exit12.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 32
...
# %bb.132:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_133:                              # %output_string.exit18.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 16
...
# %bb.135:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_136:                              # %output_string.exit36.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a2, $a0, 24
	b	.LBB0_147
...
# %bb.138:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_139:                              # %output_string.exit6.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
.LBB0_140:                              # %output_string.exit.i
	...
	bnez	$a0, .LBB0_149
	b	.LBB0_150
.LBB0_141:                              #   in Loop: Header=BB0_111 Depth=1
...
# %bb.144:                              #   in Loop: Header=BB0_111 Depth=1
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_145:                              # %output_string.exit30.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 24
...
.LBB0_146:                              #   in Loop: Header=BB0_111 Depth=1
	...
	ld.d	$a2, $a0, 16
.LBB0_147:                              # %output_string.exit36.i
                                        #   in Loop: Header=BB0_111 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.93)
	addi.d	$a1, $a0, %pc_lo12(.L.str.93)
.LBB0_148:                              #   in Loop: Header=BB0_111 Depth=1
	...
	ld.w	$a0, $s8, %pc_lo12(write_to_file)
	beqz	$a0, .LBB0_150
.LBB0_149:                              # %output_string.exit3.sink.split.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a1, $a0, %pc_lo12(global_ofile)
	addi.d	$a0, $sp, 200
...
.LBB0_150:                              # %show_stats.exit
	...
	ld.w	$a0, $s8, %pc_lo12(write_to_file)
	beqz	$a0, .LBB0_110
# %bb.151:                              #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a1, $a0, %pc_lo12(global_ofile)
	move	$a0, $fp
	pcaddu18i	$ra, %call36(fputs)
...
# %bb.154:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB0_155:                              # %output_string.exit141
	pcalau12i	$a0, %pc_hi20(buffer)
	addi.d	$fp, $a0, %pc_lo12(buffer)
...
# %bb.156:
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_157:                              # %output_string.exit144
	pcalau12i	$a0, %pc_hi20(buffer)
	addi.d	$fp, $a0, %pc_lo12(buffer)
...
# %bb.158:
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_159:                              # %output_string.exit147
...
# %bb.160:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB0_161:                              # %output_string.exit150
...
# %bb.162:
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB0_163:                              # %output_string.exit153
	move	$a0, $zero
