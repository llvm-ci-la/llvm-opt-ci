...
.LBB0_21:                               # %._crit_edge
	...
	addi.d	$a1, $a0, 1
	st.d	$a1, $t2, %pc_lo12(bits_to_follow)
	lu12i.w	$a0, 3
	ori	$a4, $a0, 4095
	srli.d	$a0, $a3, 1
	blt	$a4, $a2, .LBB0_29
...
# %bb.23:
	...
	stx.b	$a0, $a1, $a2
	ld.d	$a1, $t2, %pc_lo12(bits_to_follow)
	ori	$a2, $zero, 8
	st.w	$a2, $t1, %pc_lo12(bits_to_go)
...
.LBB0_31:                               # %output_bit.exit.i1.i
	blez	$a1, .LBB0_37
# %bb.32:                               # %.lr.ph.i4.i.preheader
	pcalau12i	$a3, %got_pc_hi20(ari)
	ld.d	$a3, $a3, %got_pc_lo12(ari)
	ori	$a4, $zero, 1
	b	.LBB0_34
	.p2align	4, , 16
.LBB0_33:                               # %output_bit.exit4.i6.i
...
# %bb.19:                               #   in Loop: Header=BB1_18 Depth=2
	...
	ori	$t8, $zero, 8
	b	.LBB1_17
.LBB1_20:                               # %._crit_edge.i15
                                        #   in Loop: Header=BB1_3 Depth=1
	st.w	$a5, $a0, %pc_lo12(buffer)
	st.w	$t8, $a3, %pc_lo12(bits_to_go)
.LBB1_21:                               # %bit_plus_follow.exit17
                                        #   in Loop: Header=BB1_3 Depth=1
	ld.d	$fp, $a2, %pc_lo12(low)
