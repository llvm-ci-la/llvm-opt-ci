...
# %bb.46:                               #   in Loop: Header=BB12_28 Depth=1
	move	$a2, $zero
.LBB12_47:                              # %.lr.ph271.preheader434
                                        #   in Loop: Header=BB12_28 Depth=1
	slli.d	$a4, $a2, 3
	alsl.d	$a3, $a2, $s0, 3
	sub.d	$a4, $s0, $a4
...
.LBB13_12:                              # %.lr.ph
	...
	bnez	$a3, .LBB13_12
	b	.LBB13_14
.LBB13_13:                              # %makect.exit.thread.._crit_edge_crit_edge
	addi.w	$s3, $t4, 0
.LBB13_14:                              # %._crit_edge
	slli.d	$a1, $s3, 3
	fldx.d	$fa0, $fp, $a1
...
# %bb.39:                               #   in Loop: Header=BB13_29 Depth=1
	...
	ld.d	$t7, $sp, 56                    # 8-byte Folded Reload
	ld.d	$t8, $sp, 48                    # 8-byte Folded Reload
.LBB13_40:                              # %rftfsub.exit234
                                        #   in Loop: Header=BB13_29 Depth=1
	ld.d	$s7, $sp, 40                    # 8-byte Folded Reload
	ori	$s2, $zero, 2
	ori	$t3, $zero, 4
.LBB13_41:                              # %rftfsub.exit234
                                        #   in Loop: Header=BB13_29 Depth=1
	fld.d	$fa0, $s0, 8
	fld.d	$fa1, $s0, 0
	fsub.d	$fa0, $fa0, $fa1
...
# %bb.42:                               # %.lr.ph243
	...
	move	$a6, $s8
	.p2align	4, , 16
.LBB13_43:                              #   Parent Loop BB13_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $a6, -8
	fld.d	$fa1, $a6, 0
	fneg.d	$fa0, $fa0
...
# %bb.50:                               # %vector.memcheck356
	...
	and	$a7, $t4, $a7
	bnez	$a7, .LBB13_56
# %bb.51:                               # %vector.memcheck356
                                        #   in Loop: Header=BB13_29 Depth=1
	sltu	$a7, $a6, $t1
	sltu	$t0, $t0, $a5
	and	$a7, $a7, $t0
	bnez	$a7, .LBB13_56
# %bb.52:                               # %vector.memcheck356
                                        #   in Loop: Header=BB13_29 Depth=1
	sltu	$a6, $a6, $t3
	sltu	$a5, $t2, $a5
	and	$a5, $a6, $a5
...
.LBB13_56:                              #   in Loop: Header=BB13_29 Depth=1
	ori	$t3, $zero, 4
	b	.LBB13_46
.LBB13_57:                              # %.preheader.._crit_edge252_crit_edge
	fld.d	$fa0, $s0, 0
	ori	$s3, $zero, 2
	b	.LBB13_60
.LBB13_58:                              # %._crit_edge244.thread
	slli.w	$s3, $s3, 1
.LBB13_59:                              # %._crit_edge252.loopexit
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $s0, $a0
	fst.d	$fa0, $s0, 0
.LBB13_60:                              # %._crit_edge252
	slli.d	$a0, $s3, 3
	fstx.d	$fa0, $fp, $a0
.LBB13_61:
	st.d	$zero, $fp, 0
...
# %bb.18:
	...
	ori	$a3, $zero, 1
	b	.LBB19_21
.LBB19_19:                              # %._crit_edge217
	slli.d	$a0, $a6, 2
	bne	$a7, $t0, .LBB19_27
# %bb.20:                               # %.preheader208
	blez	$a3, .LBB19_32
.LBB19_21:                              # %.preheader.lr.ph
	move	$a4, $zero
	slli.d	$a5, $a3, 2
...
.LBB27_16:                              # %.lr.ph
	...
	bnez	$a7, .LBB27_16
	b	.LBB27_2
.LBB27_17:                              # %._crit_edge246.thread
	ori	$a4, $zero, 2
	ori	$a5, $zero, 8
	ori	$a3, $zero, 1
	beq	$a0, $a5, .LBB27_20
	b	.LBB27_27
.LBB27_18:                              # %._crit_edge246
	slli.d	$a4, $a6, 2
	bne	$a7, $t0, .LBB27_27
# %bb.19:                               # %.preheader238
	blez	$a3, .LBB27_32
.LBB27_20:                              # %.preheader.lr.ph
	move	$a0, $zero
	slli.d	$a5, $a3, 2
...
.LBB27_27:
	...
	fst.d	$fa0, $a5, 8
	blt	$a3, $a6, .LBB27_32
# %bb.28:                               # %.preheader239.preheader
	slli.d	$a0, $a0, 3
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB27_29:                              # %.preheader239
                                        # =>This Loop Header: Depth=1
	...
	move	$t2, $a5
	.p2align	4, , 16
.LBB27_30:                              #   Parent Loop BB27_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t3, $t1, 0
	add.w	$t3, $t3, $a7
	fld.d	$fa0, $t0, 8
	...
	addi.d	$t1, $t1, 4
	bnez	$t2, .LBB27_30
# %bb.31:                               #   in Loop: Header=BB27_29 Depth=1
	add.w	$a6, $a6, $a7
	alsl.d	$a7, $a6, $a2, 3
	fld.d	$fa0, $a7, 8
	fneg.d	$fa0, $fa0
