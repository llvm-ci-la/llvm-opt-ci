...
.LBB0_29:                               # %vector.body340
	...
	addi.d	$a7, $a7, 32
	bnez	$a5, .LBB0_29
# %bb.30:                               # %middle.block347
	xvpickve2gr.w	$a5, $xr0, 7
	beq	$a4, $a6, .LBB0_33
.LBB0_31:                               # %.lr.ph.i270.preheader
	sub.d	$a3, $a3, $t2
	alsl.d	$a7, $t2, $a2, 2
	.p2align	4, , 16
.LBB0_32:                               # %.lr.ph.i270
...
.LBB0_40:                               # %vector.body359
	...
	addi.d	$t0, $t0, 32
	bnez	$a5, .LBB0_40
# %bb.41:                               # %middle.block366
	xvpickve2gr.w	$a5, $xr0, 7
	beq	$a4, $a6, .LBB0_44
.LBB0_42:                               # %.lr.ph.i285.preheader
	sub.d	$a3, $a3, $a2
	alsl.d	$a2, $a2, $fp, 2
	.p2align	4, , 16
.LBB0_43:                               # %.lr.ph.i285
...
# %bb.52:                               # %iter.check183
	...
	ori	$a2, $zero, 2
	bgeu	$a2, $a3, .LBB2_62
# %bb.53:                               # %vector.main.loop.iter.check185
...
.LBB2_56:                               # %vector.body189
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB2_56
# %bb.57:                               # %middle.block192
	beq	$a2, $a3, .LBB2_64
# %bb.58:                               # %vec.epilog.iter.check197
	andi	$a4, $a2, 12
	beqz	$a4, .LBB2_68
.LBB2_59:                               # %vec.epilog.ph196
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB2_60:                               # %vec.epilog.vector.body202
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, 16
	bnez	$a3, .LBB2_60
# %bb.61:                               # %vec.epilog.middle.block205
	beq	$a2, $a4, .LBB2_64
.LBB2_62:                               # %.lr.ph121.preheader209
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
...
# %bb.24:                               # %._crit_edge74.us
	...
	bne	$a5, $a0, .LBB13_22
	b	.LBB13_26
.LBB13_25:                              # %.lr.ph79.split.preheader
	mul.d	$a0, $a0, $a1
	sub.d	$a0, $a0, $a5
	add.d	$a0, $a0, $a3
	addi.d	$a6, $a0, 2
.LBB13_26:                              # %._crit_edge80
	ori	$a0, $zero, 101
	st.b	$a0, $a6, 0
	ld.w	$a2, $a2, 4
	addi.d	$a0, $a6, 1
...
# %bb.14:                               # %middle.block
	beq	$a1, $a5, .LBB36_17
.LBB36_15:                              # %.lr.ph.i.i.preheader214
	alsl.d	$a1, $a0, $s4, 3
	addi.d	$a1, $a1, 8
	.p2align	4, , 16
.LBB36_16:                              # %.lr.ph.i.i
...
# %bb.23:
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_27
# %bb.24:                               # %.lr.ph44.preheader.i
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_25:                              # %.lr.ph44.i108
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s7, $s7, -1
	slli.d	$a1, $s7, 2
	ldx.w	$a1, $s0, $a1
...
.LBB36_35:                              # %.lr.ph.i.i115
	...
	bltu	$a0, $s3, .LBB36_35
	b	.LBB36_37
.LBB36_36:                              # %.._crit_edge_crit_edge.i.i111
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
.LBB36_37:                              # %mp_squh_use_in1fft.exit118
	alsl.d	$a0, $s3, $s4, 3
	fld.d	$fa0, $a0, 8
	fmul.d	$fa0, $fa0, $fa0
	fst.d	$fa0, $a0, 8
...
# %bb.41:
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_45
# %bb.42:                               # %.lr.ph44.preheader.i125
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_43:                              # %.lr.ph44.i126
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s6, $a1
