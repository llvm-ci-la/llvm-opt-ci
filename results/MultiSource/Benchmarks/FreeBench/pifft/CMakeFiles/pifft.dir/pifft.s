...
# %bb.21:                               #   in Loop: Header=BB2_19 Depth=1
	beq	$a3, $a2, .LBB2_19
	b	.LBB2_30
.LBB2_22:                               # %.loopexit107..critedge4_crit_edge
	ld.w	$a0, $sp, 4
	b	.LBB2_30
.LBB2_23:
	ori	$a0, $zero, 32
...
.LBB2_50:                               # %vector.body178
	...
	addi.d	$a0, $a0, 32
	bnez	$a4, .LBB2_50
# %bb.51:                               # %middle.block181
	beq	$a2, $a3, .LBB2_54
.LBB2_52:                               # %.lr.ph121.preheader184
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
...
.LBB8_15:                               # %mp_mul_i2d.exit
	...
	move	$a5, $s4
	pcaddu18i	$ra, %call36(mp_mul_i2d)
	jirl	$ra, $ra, 0
	addi.d	$a2, $s4, 8
	ori	$a1, $zero, 1
	move	$a0, $s2
...
.LBB8_27:                               # %.lr.ph56.i96
	...
	addi.d	$a4, $a4, -4
	blt	$a5, $a2, .LBB8_27
.LBB8_28:                               # %._crit_edge57.i102
	ld.w	$a1, $fp, 12
	sub.d	$a0, $a1, $a0
	movgr2fr.w	$fa0, $a0
	ffint.d.w	$fa0, $fa0
	fst.d	$fa0, $s5, 16
.LBB8_29:                               # %mp_mul_i2d.exit109
	ld.d	$s6, $sp, 40                    # 8-byte Folded Reload
	alsl.d	$a0, $s6, $s8, 3
...
.LBB10_13:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$t3, $t3, 4
	bnez	$a0, .LBB10_13
.LBB10_14:                              # %mp_inv_init.exit.preheader
	ori	$s3, $zero, 8
	st.d	$a5, $sp, 48                    # 8-byte Folded Spill
	st.d	$t8, $sp, 40                    # 8-byte Folded Spill
	.p2align	4, , 16
.LBB10_15:                              # %mp_inv_init.exit
                                        # =>This Inner Loop Header: Depth=1
