...
# %bb.3:                                # %.preheader856.lr.ph.preheader
	...
	ld.d	$s2, $a0, %got_pc_lo12(randVar)
...
.LBB0_8:                                # %.thread826
	...
	beqz	$a0, .LBB0_46
# %bb.9:                                #   in Loop: Header=BB0_13 Depth=1
...
# %bb.24:                               #   in Loop: Header=BB0_13 Depth=1
	...
	ld.d	$s2, $a0, %got_pc_lo12(gridGiven)
	ld.w	$a0, $s2, 0
	beqz	$a0, .LBB0_49
...
# %bb.28:                               # %middle.block154
                                        #   in Loop: Header=BB3_22 Depth=1
	beq	$a6, $a7, .LBB3_21
# %bb.29:                               # %vec.epilog.iter.check159
                                        #   in Loop: Header=BB3_22 Depth=1
	move	$s3, $a7
	beqz	$t1, .LBB3_35
.LBB3_30:                               # %vec.epilog.ph158
                                        #   in Loop: Header=BB3_22 Depth=1
	add.d	$s0, $s0, $t2
	add.d	$s2, $t5, $s3
	add.d	$s1, $s1, $t6
	add.d	$s1, $s1, $s3
	.p2align	4, , 16
.LBB3_31:                               # %vec.epilog.vector.body165
                                        #   Parent Loop BB3_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s3, $s1, 0
	...
	addi.d	$s1, $s1, 8
	bnez	$s2, .LBB3_31
# %bb.32:                               # %vec.epilog.middle.block170
                                        #   in Loop: Header=BB3_22 Depth=1
	move	$s1, $t3
	beq	$a6, $t2, .LBB3_21
...
# %bb.28:                               # %middle.block149
                                        #   in Loop: Header=BB4_22 Depth=1
	beq	$a6, $a7, .LBB4_21
# %bb.29:                               # %vec.epilog.iter.check154
                                        #   in Loop: Header=BB4_22 Depth=1
	move	$s3, $a7
	beqz	$t1, .LBB4_35
.LBB4_30:                               # %vec.epilog.ph153
                                        #   in Loop: Header=BB4_22 Depth=1
	add.d	$s0, $s0, $t2
	add.d	$s2, $t5, $s3
	add.d	$s1, $s1, $t6
	add.d	$s1, $s1, $s3
	.p2align	4, , 16
.LBB4_31:                               # %vec.epilog.vector.body160
                                        #   Parent Loop BB4_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s3, $s1, 0
	vinsgr2vr.d	$vr0, $s3, 0
	...
	addi.d	$s1, $s1, 8
	bnez	$s2, .LBB4_31
# %bb.32:                               # %vec.epilog.middle.block165
                                        #   in Loop: Header=BB4_22 Depth=1
	move	$s1, $t3
	beq	$a6, $t2, .LBB4_21
