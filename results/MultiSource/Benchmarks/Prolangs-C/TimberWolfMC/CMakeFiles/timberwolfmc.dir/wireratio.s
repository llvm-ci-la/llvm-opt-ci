...
.LBB2_32:                               # %.loopexit227
	...
	fmul.d	$fs7, $ft12, $ft0
	vst	$vr9, $sp, 1456                 # 16-byte Folded Spill
	fst.d	$ft0, $sp, 1496                 # 8-byte Folded Spill
	bceqz	$fcc0, .LBB2_34
# %bb.33:
	fmul.d	$fa3, $ft12, $fs7
	vldi	$vr4, -876
...
.LBB2_35:
	...
	fst.d	$fa3, $sp, 1424                 # 8-byte Folded Spill
	fmul.d	$fa0, $fa0, $fa3
	fst.d	$fa0, $sp, 1448                 # 8-byte Folded Spill
	fdiv.d	$fa0, $fa0, $fa2
	fst.d	$fa0, $a0, 0
	...
	fmul.d	$fs0, $fa3, $fa0
	vst	$vr20, $sp, 1472                # 16-byte Folded Spill
...
# %bb.36:
	fadd.d	$fa0, $ft13, $fa0
	fneg.d	$fs2, $fa0
	fst.d	$fs2, $sp, 960                  # 8-byte Folded Spill
	fmul.d	$fs3, $fa2, $fs2
	fmov.d	$fa0, $fs3
	vst	$vr21, $sp, 1344                # 16-byte Folded Spill
	...
	fmul.d	$fa2, $fa1, $fa2
	vst	$vr2, $sp, 1328                 # 16-byte Folded Spill
	fmul.d	$fa1, $fa1, $fa2
	vldi	$vr2, -1000
	fdiv.d	$fa2, $fa1, $fa2
	fst.d	$fa2, $sp, 1504                 # 8-byte Folded Spill
	...
	vldi	$vr2, -1000
	fdiv.d	$fa1, $fa1, $fa2
	vst	$vr1, $sp, 1184                 # 16-byte Folded Spill
	vld	$vr1, $sp, 1536                 # 16-byte Folded Reload
	fdiv.d	$fa0, $fa0, $fa1
	...
	vld	$vr0, $sp, 1472                 # 16-byte Folded Reload
	vldi	$vr1, -784
	fadd.d	$fa0, $fa0, $fa1
	fneg.d	$fs6, $fa0
	vld	$vr0, $sp, 1520                 # 16-byte Folded Reload
	...
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
	fld.d	$fa1, $sp, 1496                 # 8-byte Folded Reload
	vldi	$vr2, -872
	fdiv.d	$fa2, $fa1, $fa2
	...
	fld.d	$fs3, $sp, 960                  # 8-byte Folded Reload
	fmul.d	$fs0, $fa3, $fs3
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
	...
	fdiv.d	$fa3, $fa0, $ft8
	fsub.d	$fa1, $fa1, $fa3
	fld.d	$fa3, $sp, 1424                 # 8-byte Folded Reload
	...
	fdiv.d	$ft3, $fa7, $ft9
	vfmul.d	$vr28, $vr4, $vr1
	vreplvei.d	$vr18, $vr28, 1
	...
	fsub.d	$ft4, $ft4, $ft5
	fneg.d	$ft4, $ft4
	fld.d	$ft1, $sp, 176                  # 8-byte Folded Reload
	fmul.d	$ft4, $ft1, $ft4
	vldi	$vr13, -1024
	...
	vpackod.d	$vr1, $vr2, $vr23
	vfdiv.d	$vr13, $vr9, $vr1
	vori.b	$vr9, $vr1, 0
	vst	$vr1, $sp, 224                  # 16-byte Folded Spill
	vpackod.d	$vr1, $vr4, $vr10
	vori.b	$vr31, $vr10, 0
	vfdiv.d	$vr14, $vr7, $vr1
	vori.b	$vr10, $vr1, 0
	...
	vldi	$vr11, -928
	vld	$vr7, $sp, 1408                 # 16-byte Folded Reload
	...
	vst	$vr2, $sp, 1392                 # 16-byte Folded Spill
	vpackod.d	$vr27, $vr20, $vr23
	vfdiv.d	$vr24, $vr12, $vr27
	vpackod.d	$vr30, $vr21, $vr31
	vori.b	$vr0, $vr31, 0
	vfdiv.d	$vr31, $vr2, $vr30
	...
	vfdiv.d	$vr27, $vr2, $vr27
	vori.b	$vr4, $vr2, 0
	vfdiv.d	$vr30, $vr11, $vr30
	vori.b	$vr7, $vr11, 0
	...
	fdiv.d	$fs3, $fa2, $ft5
	vld	$vr11, $sp, 368                 # 16-byte Folded Reload
	fdiv.d	$fs5, $ft3, $ft6
	fsub.d	$fs3, $fs3, $fs5
	vextrins.d	$vr2, $vr6, 16
	vextrins.d	$vr11, $vr1, 16
	vfmul.d	$vr20, $vr5, $vr20
	vfmul.d	$vr21, $vr3, $vr21
	vst	$vr8, $sp, 160                  # 16-byte Folded Spill
	vpackod.d	$vr29, $vr20, $vr8
	vfdiv.d	$vr30, $vr2, $vr29
	vst	$vr28, $sp, 144                 # 16-byte Folded Spill
	vpackod.d	$vr31, $vr21, $vr28
	...
	vld	$vr8, $sp, 304                  # 16-byte Folded Reload
	fdiv.d	$fa1, $ft0, $ft5
	vld	$vr19, $sp, 352                 # 16-byte Folded Reload
	fdiv.d	$fs5, $ft11, $ft6
	fsub.d	$fa1, $fa1, $fs5
	fdiv.d	$fs5, $ft0, $ft9
	fdiv.d	$fs6, $ft11, $ft10
	fsub.d	$fs5, $fs5, $fs6
	fld.d	$fa6, $sp, 344                  # 8-byte Folded Reload
	fmul.d	$fs5, $fa6, $fs5
	vldi	$vr31, -880
	fmadd.d	$fs6, $fa1, $fs7, $fs5
	vld	$vr7, $sp, 384                  # 16-byte Folded Reload
	fdiv.d	$fa1, $fa7, $ft5
	vld	$vr22, $sp, 432                 # 16-byte Folded Reload
	fdiv.d	$fs5, $ft14, $ft6
	fsub.d	$fa1, $fa1, $fs5
	fdiv.d	$fs5, $fa7, $ft9
	...
	vld	$vr5, $sp, 672                  # 16-byte Folded Reload
	fdiv.d	$fa1, $fa5, $fs7
	...
	vfdiv.d	$vr28, $vr0, $vr2
	vld	$vr4, $sp, 144                  # 16-byte Folded Reload
	vfdiv.d	$vr29, $vr7, $vr4
	vfsub.d	$vr28, $vr28, $vr29
	vfmadd.d	$vr1, $vr1, $vr28, $vr18
	vld	$vr28, $sp, 1040                # 16-byte Folded Reload
	fdiv.d	$ft5, $fs4, $ft5
	vld	$vr18, $sp, 1056                # 16-byte Folded Reload
	fdiv.d	$ft6, $ft10, $ft6
	fsub.d	$ft5, $ft5, $ft6
	fmul.d	$ft5, $fa6, $ft5
	...
	vfdiv.d	$vr2, $vr19, $vr2
	vfdiv.d	$vr4, $vr12, $vr4
	vfsub.d	$vr2, $vr2, $vr4
	vfmadd.d	$vr2, $vr17, $vr2, $vr9
	vld	$vr5, $sp, 944                  # 16-byte Folded Reload
	vfdiv.d	$vr4, $vr0, $vr5
	vld	$vr9, $sp, 912                  # 16-byte Folded Reload
	...
	vld	$vr4, $sp, 1168                 # 16-byte Folded Reload
	vextrins.d	$vr4, $vr3, 16
	vld	$vr3, $sp, 1200                 # 16-byte Folded Reload
	vld	$vr5, $sp, 1152                 # 16-byte Folded Reload
	...
	vld	$vr6, $sp, 1424                 # 16-byte Folded Reload
	...
	fld.d	$ft0, $sp, 1496                 # 8-byte Folded Reload
	fmul.d	$ft0, $ft0, $fs3
	vld	$vr12, $sp, 1104                # 16-byte Folded Reload
	vori.b	$vr9, $vr12, 0
	vld	$vr10, $sp, 1120                # 16-byte Folded Reload
	vextrins.d	$vr9, $vr10, 16
	vld	$vr13, $sp, 1088                # 16-byte Folded Reload
	...
	vfsub.d	$vr4, $vr5, $vr4
	vld	$vr5, $sp, 1472                 # 16-byte Folded Reload
...
.LBB2_37:
	...
	jirl	$ra, $ra, 0
	fld.d	$fa1, $s0, %pc_lo12(N)
	vst	$vr1, $sp, 1504                 # 16-byte Folded Spill
                                        # kill: def $f0_64 killed $f0_64 def $vr0
	vst	$vr0, $sp, 848                  # 16-byte Folded Spill
	vldi	$vr0, -1016
	fmul.d	$fa0, $fs6, $fa0
	...
	fdiv.d	$fa3, $fa0, $fa4
	fsub.d	$fa1, $fa1, $fa3
	fld.d	$fa6, $sp, 1424                 # 8-byte Folded Reload
	...
	vld	$vr12, $sp, 1392                # 16-byte Folded Reload
	...
	vst	$vr3, $sp, 1392                 # 16-byte Folded Spill
	...
	fld.d	$fa2, $sp, 1496                 # 8-byte Folded Reload
	...
	vld	$vr2, $sp, 1472                 # 16-byte Folded Reload
	vreplvei.d	$vr2, $vr2, 0
	vfmul.d	$vr2, $vr2, $vr5
	vfadd.d	$vr1, $vr1, $vr2
	vfsub.d	$vr1, $vr1, $vr6
...
.LBB2_38:
	...
	fdiv.d	$fa0, $fa0, $fa1
	fld.d	$fa1, $sp, 1448                 # 8-byte Folded Reload
	fdiv.d	$fa0, $fa1, $fa0
	fst.d	$fa0, $fp, 0
