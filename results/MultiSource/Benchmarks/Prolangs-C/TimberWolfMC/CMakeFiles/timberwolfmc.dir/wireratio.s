...
# %bb.36:
	...
	fdiv.d	$fa2, $ft3, $fa3
	vld	$vr5, $sp, 1040                 # 16-byte Folded Reload
	fdiv.d	$fa4, $fa5, $fs5
	fsub.d	$fa2, $fa2, $fa4
...
# %bb.15:
	move	$a0, $zero
	b	.LBB21_29
.LBB21_16:                              # %iter.check188
	ori	$a0, $zero, 5
	ori	$a5, $zero, 1
	bltu	$a1, $a0, .LBB21_26
# %bb.17:                               # %vector.main.loop.iter.check190
	addi.w	$a0, $a1, -1
	ori	$a2, $zero, 17
	ori	$a4, $zero, 1
	bgeu	$a1, $a2, .LBB21_19
...
.LBB21_19:                              # %vector.ph191
	...
	xvori.b	$xr2, $xr0, 0
	.p2align	4, , 16
.LBB21_20:                              # %vector.body196
                                        # =>This Inner Loop Header: Depth=1
	xvmul.w	$xr0, $xr0, $xr1
	addi.w	$a2, $a2, -16
	xvmul.w	$xr2, $xr2, $xr1
	bnez	$a2, .LBB21_20
# %bb.21:                               # %middle.block201
	xvmul.w	$xr0, $xr2, $xr0
	xvpermi.d	$xr1, $xr0, 78
	xvshuf4i.w	$xr1, $xr1, 228
	xvmul.w	$xr0, $xr0, $xr1
	...
	xvpickve2gr.w	$a2, $xr0, 0
	beq	$a0, $a3, .LBB21_28
# %bb.22:                               # %vec.epilog.iter.check208
	andi	$a5, $a0, 12
	beqz	$a5, .LBB21_70
.LBB21_23:                              # %vec.epilog.ph207
	move	$a6, $a0
	...
	sub.d	$a2, $a3, $a6
	.p2align	4, , 16
.LBB21_24:                              # %vec.epilog.vector.body215
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, 4
	vmul.w	$vr0, $vr0, $vr1
	bnez	$a2, .LBB21_24
# %bb.25:                               # %vec.epilog.middle.block219
	vshuf4i.w	$vr1, $vr0, 14
	vmul.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmul.w	$vr0, $vr0, $vr1
