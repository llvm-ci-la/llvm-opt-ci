...
.LBB1_137:                              #   in Loop: Header=BB1_125 Depth=2
	...
	ori	$a1, $zero, 2
	blt	$a0, $a1, .LBB1_124
# %bb.138:                              # %.lr.ph564.preheader
                                        #   in Loop: Header=BB1_125 Depth=2
	ori	$s4, $zero, 1
	b	.LBB1_141
	.p2align	4, , 16
.LBB1_139:                              #   in Loop: Header=BB1_141 Depth=3
	ld.w	$a0, $s0, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s0, 0
...
# %bb.142:                              #   in Loop: Header=BB1_141 Depth=3
	...
	addi.w	$a0, $a0, 0
	beq	$a0, $s6, .LBB1_145
.LBB1_143:                              #   in Loop: Header=BB1_141 Depth=3
	beqz	$s7, .LBB1_146
# %bb.144:                              #   in Loop: Header=BB1_141 Depth=3
	ld.wu	$a0, $sp, 88
	bstrpick.d	$a0, $a0, 31, 1
	slli.w	$a0, $a0, 1
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB1_146
.LBB1_145:                              #   in Loop: Header=BB1_141 Depth=3
	ld.w	$a0, $s1, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s1, 0
.LBB1_146:                              #   in Loop: Header=BB1_141 Depth=3
	beqz	$fp, .LBB1_148
# %bb.147:                              #   in Loop: Header=BB1_141 Depth=3
	ld.wu	$a0, $sp, 88
	addi.w	$a1, $zero, -3
	lu32i.d	$a1, 0
	and	$a0, $a0, $a1
	addi.w	$a0, $a0, 0
	beq	$a0, $s8, .LBB1_139
.LBB1_148:                              #   in Loop: Header=BB1_141 Depth=3
	beqz	$s7, .LBB1_140
# %bb.149:                              #   in Loop: Header=BB1_141 Depth=3
	ld.w	$a0, $sp, 88
	ori	$a1, $zero, 7
	beq	$a0, $a1, .LBB1_139
# %bb.150:                              #   in Loop: Header=BB1_141 Depth=3
	beq	$a0, $s6, .LBB1_139
	b	.LBB1_140
	.p2align	4, , 16
.LBB1_151:                              # %.loopexit513
                                        #   in Loop: Header=BB1_3 Depth=1
	ld.w	$a0, $s5, 128
...
# %bb.156:                              #   in Loop: Header=BB1_155 Depth=2
	...
	st.w	$s8, $sp, 84
	blez	$a0, .LBB1_154
# %bb.157:                              # %.lr.ph569.preheader
                                        #   in Loop: Header=BB1_155 Depth=2
	ori	$a1, $zero, 1
	b	.LBB1_160
	.p2align	4, , 16
.LBB1_158:                              #   in Loop: Header=BB1_160 Depth=3
	ld.w	$a0, $sp, 84
	alsl.d	$a0, $a0, $s1, 4
	ld.w	$a1, $a0, 4
	addi.d	$a1, $a1, 1
...
# %bb.161:                              #   in Loop: Header=BB1_160 Depth=3
	...
	addi.w	$a0, $a0, 0
	beq	$a0, $s6, .LBB1_164
.LBB1_162:                              #   in Loop: Header=BB1_160 Depth=3
	beqz	$s7, .LBB1_165
...
.LBB1_164:                              #   in Loop: Header=BB1_160 Depth=3
	...
	addi.d	$a1, $a1, 1
	stx.w	$a1, $s1, $a0
.LBB1_165:                              #   in Loop: Header=BB1_160 Depth=3
	beqz	$fp, .LBB1_167
# %bb.166:                              #   in Loop: Header=BB1_160 Depth=3
	ld.wu	$a0, $sp, 88
	addi.w	$a1, $zero, -3
	lu32i.d	$a1, 0
	and	$a0, $a0, $a1
	addi.w	$a0, $a0, 0
	beq	$a0, $s8, .LBB1_158
.LBB1_167:                              #   in Loop: Header=BB1_160 Depth=3
	beqz	$s7, .LBB1_159
# %bb.168:                              #   in Loop: Header=BB1_160 Depth=3
	ld.w	$a0, $sp, 88
	ori	$a1, $zero, 7
	beq	$a0, $a1, .LBB1_158
# %bb.169:                              #   in Loop: Header=BB1_160 Depth=3
	beq	$a0, $s6, .LBB1_158
	b	.LBB1_159
	.p2align	4, , 16
.LBB1_170:                              # %.loopexit.loopexit
                                        #   in Loop: Header=BB1_155 Depth=2
	ld.w	$a1, $sp, 88
	ld.d	$a4, $sp, 56                    # 8-byte Folded Reload
	b	.LBB1_154
	.p2align	4, , 16
.LBB1_171:                              # %.loopexit511
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a0, $a4, $s5, 3
	ld.d	$a1, $a0, 152
	ld.d	$a0, $a1, 88
...
# %bb.175:                              # %.lr.ph578
	...
	addi.d	$a6, $a6, 48
	.p2align	4, , 16
.LBB1_176:                              #   Parent Loop BB1_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a7, $a6, 0
	ld.w	$t0, $a6, -4
	st.w	$a7, $sp, 84
...
.LBB1_177:                              # %.lr.ph547
	...
	b	.LBB1_180
	.p2align	4, , 16
.LBB1_178:                              #   in Loop: Header=BB1_180 Depth=2
	ld.w	$a0, $s0, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s0, 0
...
.LBB1_184:                              #   in Loop: Header=BB1_180 Depth=2
	...
	addi.d	$a0, $a0, 1
	st.w	$a0, $s1, 0
.LBB1_185:                              #   in Loop: Header=BB1_180 Depth=2
	beqz	$s7, .LBB1_187
# %bb.186:                              #   in Loop: Header=BB1_180 Depth=2
	ld.wu	$a0, $sp, 88
	addi.w	$a1, $zero, -3
	lu32i.d	$a1, 0
	and	$a0, $a0, $a1
...
# %bb.188:                              #   in Loop: Header=BB1_180 Depth=2
	...
	ori	$a1, $zero, 7
	beq	$a0, $a1, .LBB1_178
# %bb.189:                              #   in Loop: Header=BB1_180 Depth=2
	ori	$a1, $zero, 4
	beq	$a0, $a1, .LBB1_178
	b	.LBB1_179
.LBB1_190:                              # %call.sqrt
