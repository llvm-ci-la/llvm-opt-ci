...
# %bb.100:                              #   in Loop: Header=BB0_93 Depth=1
	beq	$s0, $s6, .LBB0_98
# %bb.101:                              #   in Loop: Header=BB0_93 Depth=1
	beq	$s0, $s7, .LBB0_98
	.p2align	4, , 16
...
# %bb.103:                              # %.lr.ph791
	...
	or	$s3, $a0, $a1
	beqz	$a2, .LBB0_108
# %bb.104:                              # %.lr.ph791.split.us.preheader
                                        #   in Loop: Header=BB0_93 Depth=1
	ori	$s5, $zero, 1
	b	.LBB0_106
	.p2align	4, , 16
...
# %bb.107:                              #   in Loop: Header=BB0_106 Depth=2
	...
	st.w	$a0, $s2, 0
	b	.LBB0_105
.LBB0_108:                              # %.lr.ph791.split
                                        #   in Loop: Header=BB0_93 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	bnez	$a0, .LBB0_113
# %bb.109:                              # %.lr.ph791.split.split.us.preheader
                                        #   in Loop: Header=BB0_93 Depth=1
	ori	$s5, $zero, 1
	b	.LBB0_111
	.p2align	4, , 16
...
# %bb.112:                              #   in Loop: Header=BB0_111 Depth=2
	...
	st.w	$a0, $s1, 0
	b	.LBB0_110
.LBB0_113:                              # %.lr.ph791.split.split.preheader
                                        #   in Loop: Header=BB0_93 Depth=1
	ori	$s5, $zero, 1
	b	.LBB0_116
	.p2align	4, , 16
