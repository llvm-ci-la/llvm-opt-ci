...
.LBB0_96:                               #   in Loop: Header=BB0_89 Depth=2
	ld.d	$a2, $sp, 136                   # 8-byte Folded Reload
	beqz	$a2, .LBB0_99
# %bb.97:                               #   in Loop: Header=BB0_89 Depth=2
	ori	$a2, $zero, 7
	beq	$fp, $a2, .LBB0_95
# %bb.98:                               #   in Loop: Header=BB0_89 Depth=2
	...
	beq	$fp, $a2, .LBB0_95
	.p2align	4, , 16
.LBB0_99:                               #   in Loop: Header=BB0_89 Depth=2
...
# %bb.100:                              # %.lr.ph960
	...
	b	.LBB0_103
	.p2align	4, , 16
.LBB0_101:                              #   in Loop: Header=BB0_103 Depth=3
	...
	st.w	$a0, $s0, 80
	st.w	$a1, $s0, 84
.LBB0_102:                              #   in Loop: Header=BB0_103 Depth=3
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 60
	addi.w	$s6, $s6, 1
	bge	$s6, $a0, .LBB0_88
...
.LBB0_105:                              #   in Loop: Header=BB0_103 Depth=3
	...
	vst	$vr0, $s0, 72
	beqz	$s8, .LBB0_107
# %bb.106:                              #   in Loop: Header=BB0_103 Depth=3
	vpickve2gr.w	$a0, $vr0, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s0, 56
	vpickve2gr.w	$a1, $vr0, 1
...
.LBB0_107:                              #   in Loop: Header=BB0_103 Depth=3
	bnez	$s7, .LBB0_101
# %bb.108:                              #   in Loop: Header=BB0_103 Depth=3
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_102
# %bb.109:                              #   in Loop: Header=BB0_103 Depth=3
	ori	$a0, $zero, 7
	beq	$fp, $a0, .LBB0_101
# %bb.110:                              #   in Loop: Header=BB0_103 Depth=3
	ori	$a0, $zero, 4
	beq	$fp, $a0, .LBB0_101
	b	.LBB0_102
.LBB0_111:                              # %.preheader931
	blez	$a3, .LBB0_165
# %bb.112:                              # %.lr.ph977.preheader
	ori	$a2, $zero, 1
	b	.LBB0_115
	.p2align	4, , 16
.LBB0_113:                              # %.loopexit930.loopexit
...
# %bb.116:                              #   in Loop: Header=BB0_115 Depth=1
	...
	vpickve2gr.d	$a0, $vr0, 0
	st.d	$a0, $sp, 160                   # 8-byte Folded Spill
	vpickve2gr.d	$s3, $vr0, 1
	ori	$fp, $zero, 1
	b	.LBB0_118
	.p2align	4, , 16
.LBB0_117:                              # %.loopexit929
...
.LBB0_140:                              # %.preheader
	blez	$a3, .LBB0_165
# %bb.141:                              # %.lr.ph987.preheader
	ori	$s4, $zero, 7
	ori	$a2, $zero, 1
	b	.LBB0_144
	.p2align	4, , 16
.LBB0_142:                              # %.loopexit928.loopexit
...
.LBB0_147:                              # %.loopexit
	...
	ori	$a0, $zero, 8
	beq	$fp, $a0, .LBB0_142
.LBB0_148:                              #   Parent Loop BB0_144 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_160 Depth 3
                                        #       Child Loop BB0_155 Depth 3
	ld.wu	$a0, $s7, 56
...
# %bb.152:                              # %.lr.ph981
	...
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB0_157
# %bb.153:                              # %.lr.ph981.split.us.preheader
                                        #   in Loop: Header=BB0_148 Depth=2
	move	$s5, $zero
	addi.d	$s0, $a0, 16
...
# %bb.156:                              #   in Loop: Header=BB0_155 Depth=3
	...
	st.w	$a0, $s0, 8
	b	.LBB0_154
.LBB0_157:                              # %.lr.ph981.split.preheader
                                        #   in Loop: Header=BB0_148 Depth=2
	move	$s5, $zero
	addi.d	$s0, $a0, 16
	ld.d	$s6, $sp, 160                   # 8-byte Folded Reload
	b	.LBB0_160
	.p2align	4, , 16
.LBB0_158:                              #   in Loop: Header=BB0_160 Depth=3
	addi.d	$a0, $a0, 1
	st.w	$a0, $s0, 4
	st.w	$a0, $s0, 12
