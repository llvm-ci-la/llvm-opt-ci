...
# %bb.34:
	move	$a2, $zero
	b	.LBB21_103
.LBB21_35:                              # %vector.main.loop.iter.check278
	ori	$a2, $zero, 16
	bgeu	$s0, $a2, .LBB21_67
# %bb.36:
	move	$a2, $zero
.LBB21_37:                              # %vec.epilog.ph322
	move	$a4, $a2
	...
	b	.LBB21_39
	.p2align	4, , 16
.LBB21_38:                              # %pred.store.continue346
                                        #   in Loop: Header=BB21_39 Depth=1
	addi.d	$a3, $a3, 8
	addi.d	$a4, $a4, 16
	beqz	$a3, .LBB21_66
.LBB21_39:                              # %vec.epilog.vector.body328
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, -8
	vseq.h	$vr1, $vr1, $vr0
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_47
# %bb.40:                               # %pred.store.if331
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -8
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_48
.LBB21_41:                              # %pred.store.continue334
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_49
.LBB21_42:                              # %pred.store.if335
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_50
.LBB21_43:                              # %pred.store.continue338
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_51
.LBB21_44:                              # %pred.store.if339
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 0
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_52
.LBB21_45:                              # %pred.store.continue342
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_53
.LBB21_46:                              # %pred.store.if343
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 4
	...
	b	.LBB21_54
	.p2align	4, , 16
.LBB21_47:                              # %pred.store.continue332
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_41
.LBB21_48:                              # %pred.store.if333
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -6
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_42
.LBB21_49:                              # %pred.store.continue336
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_43
.LBB21_50:                              # %pred.store.if337
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_44
.LBB21_51:                              # %pred.store.continue340
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_45
.LBB21_52:                              # %pred.store.if341
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_46
.LBB21_53:                              # %pred.store.continue344
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_38
.LBB21_54:                              # %pred.store.if345
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 6
	b	.LBB21_38
.LBB21_55:                              # %.preheader121
	addi.w	$a1, $a1, 0
	addi.w	$a2, $a3, 0
	bge	$a2, $a1, .LBB21_28
# %bb.56:                               # %.lr.ph156
	blez	$s0, .LBB21_110
# %bb.57:                               # %.lr.ph150.us.preheader
	pcalau12i	$a0, %got_pc_hi20(LAruleno)
...
.LBB21_65:                              # %scalar.ph
	...
	bnez	$t5, .LBB21_65
	b	.LBB21_58
.LBB21_66:                              # %vec.epilog.middle.block348
	beq	$a2, $s0, .LBB21_111
	b	.LBB21_103
.LBB21_67:                              # %vector.ph279
	...
	b	.LBB21_69
	.p2align	4, , 16
.LBB21_68:                              # %pred.store.continue316
                                        #   in Loop: Header=BB21_69 Depth=1
	addi.d	$a4, $a4, -16
	addi.d	$a3, $a3, 32
	beqz	$a4, .LBB21_101
.LBB21_69:                              # %vector.body282
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr1, $a3, -16
	xvseq.h	$xr1, $xr1, $xr0
	vpickve2gr.h	$a5, $vr1, 0
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_85
# %bb.70:                               # %pred.store.if285
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -16
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_86
.LBB21_71:                              # %pred.store.continue288
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_87
.LBB21_72:                              # %pred.store.if289
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -12
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_88
.LBB21_73:                              # %pred.store.continue292
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_89
.LBB21_74:                              # %pred.store.if293
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -8
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_90
.LBB21_75:                              # %pred.store.continue296
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_91
.LBB21_76:                              # %pred.store.if297
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -4
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_92
.LBB21_77:                              # %pred.store.continue300
                                        #   in Loop: Header=BB21_69 Depth=1
	xvpermi.d	$xr1, $xr1, 14
	vpickve2gr.h	$a5, $vr1, 0
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_93
.LBB21_78:                              # %pred.store.if301
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_94
.LBB21_79:                              # %pred.store.continue304
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_95
.LBB21_80:                              # %pred.store.if305
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_96
.LBB21_81:                              # %pred.store.continue308
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_97
.LBB21_82:                              # %pred.store.if309
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 8
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_98
.LBB21_83:                              # %pred.store.continue312
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_99
.LBB21_84:                              # %pred.store.if313
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 12
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	...
	b	.LBB21_100
	.p2align	4, , 16
.LBB21_85:                              # %pred.store.continue286
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_71
.LBB21_86:                              # %pred.store.if287
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -14
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_72
.LBB21_87:                              # %pred.store.continue290
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_73
.LBB21_88:                              # %pred.store.if291
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -10
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_74
.LBB21_89:                              # %pred.store.continue294
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_75
.LBB21_90:                              # %pred.store.if295
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_76
.LBB21_91:                              # %pred.store.continue298
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_77
.LBB21_92:                              # %pred.store.if299
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -2
	xvpermi.d	$xr1, $xr1, 14
	vpickve2gr.h	$a5, $vr1, 0
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_78
.LBB21_93:                              # %pred.store.continue302
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_79
.LBB21_94:                              # %pred.store.if303
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_80
.LBB21_95:                              # %pred.store.continue306
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_81
.LBB21_96:                              # %pred.store.if307
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 6
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_82
.LBB21_97:                              # %pred.store.continue310
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_83
.LBB21_98:                              # %pred.store.if311
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 10
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_84
.LBB21_99:                              # %pred.store.continue314
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_68
.LBB21_100:                             # %pred.store.if315
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 14
	b	.LBB21_68
.LBB21_101:                             # %middle.block318
	beq	$a2, $s0, .LBB21_111
# %bb.102:                              # %vec.epilog.iter.check323
	andi	$a3, $s0, 8
	bnez	$a3, .LBB21_37
.LBB21_103:                             # %vec.epilog.scalar.ph321.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	lu12i.w	$a3, 8
	b	.LBB21_105
	.p2align	4, , 16
.LBB21_104:                             #   in Loop: Header=BB21_105 Depth=1
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 2
	beqz	$a2, .LBB21_111
.LBB21_105:                             # %vec.epilog.scalar.ph321
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a4, $a1, 0
	bne	$a4, $a3, .LBB21_104
...
.LBB21_114:                             # %vector.ph215
	...
	b	.LBB21_116
	.p2align	4, , 16
.LBB21_115:                             # %pred.store.continue252
                                        #   in Loop: Header=BB21_116 Depth=1
	addi.d	$a4, $a4, -16
	addi.d	$a3, $a3, 32
	beqz	$a4, .LBB21_148
.LBB21_116:                             # %vector.body220
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr1, $a3, -16
	vpickve2gr.h	$a5, $vr1, 0
	ext.w.h	$a5, $a5
...
# %bb.117:                              # %pred.store.if
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_125
.LBB21_118:                             # %pred.store.continue224
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_126
.LBB21_119:                             # %pred.store.if225
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -12
	xvpickve2gr.w	$a5, $xr2, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_127
.LBB21_120:                             # %pred.store.continue228
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_128
.LBB21_121:                             # %pred.store.if229
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -8
	xvpickve2gr.w	$a5, $xr2, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_129
.LBB21_122:                             # %pred.store.continue232
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_130
.LBB21_123:                             # %pred.store.if233
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -4
...
.LBB21_124:                             # %pred.store.continue
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_118
.LBB21_125:                             # %pred.store.if223
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -14
	xvpickve2gr.w	$a5, $xr2, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_119
.LBB21_126:                             # %pred.store.continue226
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_120
.LBB21_127:                             # %pred.store.if227
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -10
	xvpickve2gr.w	$a5, $xr2, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_121
.LBB21_128:                             # %pred.store.continue230
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_122
.LBB21_129:                             # %pred.store.if231
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -6
	xvpickve2gr.w	$a5, $xr2, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_123
.LBB21_130:                             # %pred.store.continue234
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_132
.LBB21_131:                             # %pred.store.if235
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -2
.LBB21_132:                             # %pred.store.continue236
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpermi.q	$xr1, $xr1, 1
	vpickve2gr.h	$a5, $vr1, 0
	ext.w.h	$a5, $a5
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_140
# %bb.133:                              # %pred.store.if237
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 0
	xvpickve2gr.w	$a5, $xr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_141
.LBB21_134:                             # %pred.store.continue240
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_142
.LBB21_135:                             # %pred.store.if241
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 4
	xvpickve2gr.w	$a5, $xr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_143
.LBB21_136:                             # %pred.store.continue244
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_144
.LBB21_137:                             # %pred.store.if245
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 8
	xvpickve2gr.w	$a5, $xr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_145
.LBB21_138:                             # %pred.store.continue248
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_146
.LBB21_139:                             # %pred.store.if249
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 12
	...
	b	.LBB21_147
	.p2align	4, , 16
.LBB21_140:                             # %pred.store.continue238
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_134
.LBB21_141:                             # %pred.store.if239
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 2
	xvpickve2gr.w	$a5, $xr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_135
.LBB21_142:                             # %pred.store.continue242
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_136
.LBB21_143:                             # %pred.store.if243
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 6
	xvpickve2gr.w	$a5, $xr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_137
.LBB21_144:                             # %pred.store.continue246
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_138
.LBB21_145:                             # %pred.store.if247
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 10
	xvpickve2gr.w	$a5, $xr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_139
.LBB21_146:                             # %pred.store.continue250
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_115
.LBB21_147:                             # %pred.store.if251
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 14
	b	.LBB21_115
.LBB21_148:                             # %middle.block254
	beq	$a2, $s0, .LBB21_161
...
.LBB21_150:                             # %vec.epilog.ph
	...
	b	.LBB21_152
	.p2align	4, , 16
.LBB21_151:                             # %pred.store.continue269
...
.LBB21_152:                             # %vec.epilog.vector.body
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_156
# %bb.153:                              # %pred.store.if262
                                        #   in Loop: Header=BB21_152 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.w	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_157
.LBB21_154:                             # %pred.store.continue265
                                        #   in Loop: Header=BB21_152 Depth=1
	vpickve2gr.w	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_158
.LBB21_155:                             # %pred.store.if266
                                        #   in Loop: Header=BB21_152 Depth=1
	st.h	$zero, $a3, 4
	...
	b	.LBB21_159
	.p2align	4, , 16
.LBB21_156:                             # %pred.store.continue263
                                        #   in Loop: Header=BB21_152 Depth=1
	vpickve2gr.w	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_154
.LBB21_157:                             # %pred.store.if264
                                        #   in Loop: Header=BB21_152 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.w	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_155
.LBB21_158:                             # %pred.store.continue267
                                        #   in Loop: Header=BB21_152 Depth=1
	vpickve2gr.w	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_151
.LBB21_159:                             # %pred.store.if268
                                        #   in Loop: Header=BB21_152 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_151
.LBB21_160:                             # %vec.epilog.middle.block
	bne	$a2, $s0, .LBB21_162
.LBB21_161:                             # %._crit_edge163
	sub.d	$a0, $zero, $a0
	b	.LBB21_31
.LBB21_162:                             # %vec.epilog.scalar.ph.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	addi.w	$a3, $a0, 0
	b	.LBB21_164
	.p2align	4, , 16
.LBB21_163:                             #   in Loop: Header=BB21_164 Depth=1
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 2
	beqz	$a2, .LBB21_161
.LBB21_164:                             # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a4, $a1, 0
	bne	$a3, $a4, .LBB21_163
# %bb.165:                              #   in Loop: Header=BB21_164 Depth=1
	st.h	$zero, $a1, 0
	b	.LBB21_163
.Lfunc_end21:
