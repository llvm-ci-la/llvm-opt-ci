...
.LBB2_14:
	...
	addi.d	$sp, $sp, 32
	pcaddu18i	$t8, %call36(output_program)
	jr	$t8
.Lfunc_end2:
...
.LBB16_13:                              # %.critedge2
	...
	addi.w	$t3, $a4, -1
	bge	$t2, $t3, .LBB16_2
# %bb.14:                               # %.lr.ph35.preheader
                                        #   in Loop: Header=BB16_4 Depth=1
	sub.d	$t5, $t3, $t2
	bgeu	$t5, $t1, .LBB16_18
.LBB16_15:                              #   in Loop: Header=BB16_4 Depth=1
	move	$t4, $a4
.LBB16_16:                              # %.lr.ph35.preheader56
                                        #   in Loop: Header=BB16_4 Depth=1
	alsl.d	$t5, $t3, $a0, 1
	move	$t6, $t3
	.p2align	4, , 16
...
# %bb.5:                                # %.lr.ph136
	...
	ld.d	$a5, $a5, 0
	pcalau12i	$a6, %got_pc_hi20(tokensetsize)
	ld.d	$a6, $a6, %got_pc_lo12(tokensetsize)
	ld.w	$a6, $a6, 0
...
.LBB21_35:                              # %vector.ph234
	...
	b	.LBB21_37
	.p2align	4, , 16
.LBB21_36:                              # %pred.store.continue255
                                        #   in Loop: Header=BB21_37 Depth=1
	addi.d	$a4, $a4, -8
	addi.d	$a3, $a3, 16
	beqz	$a4, .LBB21_53
.LBB21_37:                              # %vector.body237
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vseq.h	$vr1, $vr1, $vr0
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_39
# %bb.38:                               # %pred.store.if240
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -8
.LBB21_39:                              # %pred.store.continue241
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_41
# %bb.40:                               # %pred.store.if242
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -6
.LBB21_41:                              # %pred.store.continue243
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_43
# %bb.42:                               # %pred.store.if244
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -4
.LBB21_43:                              # %pred.store.continue245
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_45
# %bb.44:                               # %pred.store.if246
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -2
.LBB21_45:                              # %pred.store.continue247
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_47
# %bb.46:                               # %pred.store.if248
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 0
.LBB21_47:                              # %pred.store.continue249
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_49
# %bb.48:                               # %pred.store.if250
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 2
.LBB21_49:                              # %pred.store.continue251
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_51
# %bb.50:                               # %pred.store.if252
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 4
.LBB21_51:                              # %pred.store.continue253
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_36
# %bb.52:                               # %pred.store.if254
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_36
.LBB21_53:                              # %middle.block257
	bne	$a2, $s0, .LBB21_55
.LBB21_54:                              # %.loopexit
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	...
	addi.d	$sp, $sp, 48
	ret
.LBB21_55:                              # %scalar.ph232.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	lu12i.w	$a3, 8
	b	.LBB21_57
...
# %bb.60:                               # %.lr.ph156
	...
	b	.LBB21_63
	.p2align	4, , 16
.LBB21_61:                              #   in Loop: Header=BB21_63 Depth=1
	move	$t4, $zero
.LBB21_62:                              # %._crit_edge151
...
.LBB21_66:                              # %vector.ph
	...
	vori.b	$vr3, $vr0, 0
	.p2align	4, , 16
.LBB21_67:                              # %vector.body
                                        #   Parent Loop BB21_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $t4, -8
	ld.d	$t7, $t4, 0
...
# %bb.68:                               # %middle.block
	...
	move	$t6, $t0
	beq	$t0, $s1, .LBB21_62
.LBB21_69:                              # %.lr.ph150.preheader260
                                        #   in Loop: Header=BB21_63 Depth=1
	alsl.d	$t5, $t6, $a6, 1
	sub.d	$t6, $s1, $t6
	.p2align	4, , 16
...
.LBB21_75:                              # %vector.ph206
	...
	b	.LBB21_77
	.p2align	4, , 16
.LBB21_76:                              # %pred.store.continue227
                                        #   in Loop: Header=BB21_77 Depth=1
	addi.d	$a4, $a4, -8
	addi.d	$a3, $a3, 16
	beqz	$a4, .LBB21_93
.LBB21_77:                              # %vector.body211
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vilvl.h	$vr2, $vr1, $vr1
	vslli.w	$vr2, $vr2, 16
...
# %bb.78:                               # %pred.store.if
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, -8
.LBB21_79:                              # %pred.store.continue
                                        #   in Loop: Header=BB21_77 Depth=1
	vpickve2gr.h	$a5, $vr2, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_81
# %bb.80:                               # %pred.store.if214
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, -6
.LBB21_81:                              # %pred.store.continue215
                                        #   in Loop: Header=BB21_77 Depth=1
	vpickve2gr.h	$a5, $vr2, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_83
# %bb.82:                               # %pred.store.if216
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, -4
.LBB21_83:                              # %pred.store.continue217
                                        #   in Loop: Header=BB21_77 Depth=1
	vpickve2gr.h	$a5, $vr2, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_85
# %bb.84:                               # %pred.store.if218
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, -2
.LBB21_85:                              # %pred.store.continue219
                                        #   in Loop: Header=BB21_77 Depth=1
	vilvh.h	$vr1, $vr1, $vr1
	vslli.w	$vr1, $vr1, 16
	vsrai.w	$vr1, $vr1, 16
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_87
# %bb.86:                               # %pred.store.if220
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, 0
.LBB21_87:                              # %pred.store.continue221
                                        #   in Loop: Header=BB21_77 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_89
# %bb.88:                               # %pred.store.if222
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, 2
.LBB21_89:                              # %pred.store.continue223
                                        #   in Loop: Header=BB21_77 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_91
# %bb.90:                               # %pred.store.if224
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, 4
.LBB21_91:                              # %pred.store.continue225
                                        #   in Loop: Header=BB21_77 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_76
# %bb.92:                               # %pred.store.if226
                                        #   in Loop: Header=BB21_77 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_76
.LBB21_93:                              # %middle.block229
	bne	$a2, $s1, .LBB21_95
.LBB21_94:                              # %._crit_edge162
	sub.d	$a0, $zero, $a0
	b	.LBB21_31
.LBB21_95:                              # %scalar.ph204.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s1, $a2
	addi.w	$a3, $a0, 0
	b	.LBB21_97
...
# %bb.2:                                # %.lr.ph54
	...
	ld.d	$a4, $a4, %pc_lo12(width)
	pcalau12i	$a5, %pc_hi20(tos)
	ld.d	$a5, $a5, %pc_lo12(tos)
	pcalau12i	$a6, %pc_hi20(froms)
	ld.d	$a6, $a6, %pc_lo12(froms)
	ldx.h	$a7, $a3, $t0
	ldx.hu	$t0, $a4, $t0
	alsl.d	$t1, $t2, $a5, 3
	alsl.d	$t2, $t2, $a6, 3
...
# %bb.13:                               # %.lr.ph56
	...
	ori	$a2, $zero, 1
	.p2align	4, , 16
.LBB26_14:                              #   Parent Loop BB26_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$a4, $a1, 0
	xor	$a0, $fp, $a4
	sltu	$a0, $zero, $a0
...
.LBB26_23:                              # %.preheader
	...
	ld.w	$a1, $a3, %pc_lo12(lowzero)
	slli.d	$a2, $a1, 1
	ldx.hu	$a2, $a0, $a2
	beqz	$a2, .LBB26_27
# %bb.24:                               # %.lr.ph65.preheader
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	.p2align	4, , 16
.LBB26_25:                              # %.lr.ph65
