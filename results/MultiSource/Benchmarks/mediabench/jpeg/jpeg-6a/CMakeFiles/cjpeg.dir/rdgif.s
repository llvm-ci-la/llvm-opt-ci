...
# %bb.56:                               #   in Loop: Header=BB1_51 Depth=1
	...
	jirl	$ra, $a2, 0
	b	.LBB1_50
.LBB1_57:                               # %ReadByte.exit144.thread
	ld.d	$a0, $s0, 48
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 0
	ori	$a3, $zero, 42
...
.LBB3_5:                                # %.lr.ph
	...
	b	.LBB3_2
	.p2align	4, , 16
.LBB3_6:                                # %._crit_edge.us
                                        #   in Loop: Header=BB3_7 Depth=1
	ld.w	$a0, $s0, 44
	addi.w	$s1, $s1, 1
	bgeu	$s1, $a0, .LBB3_11
.LBB3_7:                                # %.lr.ph45.split.us
                                        # =>This Loop Header: Depth=1
...
.LBB3_10:
	move	$a0, $zero
.LBB3_11:                               # %._crit_edge46
	beqz	$s2, .LBB3_13
.LBB3_12:                               # %._crit_edge46.thread
	ld.w	$a1, $s2, 32
	addi.d	$a1, $a1, 1
	st.w	$a1, $s2, 32
.LBB3_13:
...
.LBB7_3:                                # %GetDataBlock.exit
                                        #   in Loop: Header=BB7_5 Depth=1
	beqz	$s1, .LBB7_11
.LBB7_4:                                # %GetDataBlock.exit.thread
                                        #   in Loop: Header=BB7_5 Depth=1
	ld.w	$a0, $fp, 332
	ld.w	$a1, $fp, 328
	sub.d	$a0, $a0, $a1
