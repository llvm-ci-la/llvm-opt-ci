...
.LBB2_40:
	move	$a5, $a3
.LBB2_41:                               # %vec.epilog.scalar.ph141.preheader
	addi.d	$a1, $a5, 1
	alsl.d	$a2, $a5, $fp, 1
	addi.d	$a2, $a2, 8
	.p2align	4, , 16
.LBB2_42:                               # %vec.epilog.scalar.ph141
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a2, 0
...
# %bb.45:                               # %vector.memcheck
	...
	addi.d	$a1, $a1, 8
	bltu	$a1, $a4, .LBB2_40
.LBB2_46:                               # %vector.main.loop.iter.check121
	ori	$a4, $zero, 15
	addi.d	$a1, $a3, 1
	bgeu	$a3, $a4, .LBB2_51
# %bb.47:
	move	$a4, $zero
.LBB2_48:                               # %vec.epilog.ph142
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_49:                               # %vec.epilog.vector.body148
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
...
# %bb.50:                               # %vec.epilog.middle.block157
	bne	$a1, $a6, .LBB2_41
	b	.LBB2_43
.LBB2_51:                               # %vector.ph122
	bstrpick.d	$a4, $a1, 32, 4
	slli.d	$a4, $a4, 4
	addi.d	$a5, $a5, -6
	move	$a6, $a1
	move	$a7, $a4
.LBB2_52:                               # %vector.body125
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vld	$vr1, $a5, -16
	...
	addi.d	$a5, $a5, -32
	bnez	$a7, .LBB2_52
# %bb.53:                               # %middle.block138
	beq	$a1, $a4, .LBB2_43
# %bb.54:                               # %vec.epilog.iter.check143
	andi	$a5, $a1, 8
	bnez	$a5, .LBB2_48
# %bb.55:
	sub.d	$a5, $a3, $a4
...
.Ltmp14:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
# %bb.12:                               # %_ZN9NCompress8NQuantum8CDecoder5FlushEv.exit.i
	ld.d	$a0, $fp, 56
	bnez	$a0, .LBB3_16
	b	.LBB3_18
.LBB3_13:
...
# %bb.17:                               # %.noexc.i
	st.d	$zero, $fp, 56
.LBB3_18:                               # %_ZN10COutBuffer13ReleaseStreamEv.exit.i.i
	ld.d	$a0, $fp, 0
	ld.d	$a1, $a0, 56
.Ltmp21:                                # EH_LABEL
	move	$a0, $fp
...
.Lcst_end2:
	...
	.p2align	2, 0x0
                                        # >> Catch TypeInfos <<
.Ltmp34:                                # TypeInfo 3
	.word	.L_ZTI18CInBufferException.DW.stub-.Ltmp34
.Ltmp35:                                # TypeInfo 2
	.word	.L_ZTI19COutBufferException.DW.stub-.Ltmp35
	.word	0                               # TypeInfo 1
.Lttbase2:
	.p2align	2, 0x0
                                        # -- End function
...
.Lcst_begin3:
	...
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp46-.Lfunc_begin3          # >> Call Site 5 <<
