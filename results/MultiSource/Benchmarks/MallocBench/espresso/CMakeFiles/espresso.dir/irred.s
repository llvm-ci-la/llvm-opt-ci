...
.LBB6_27:                               # %.loopexit
	...
	addi.d	$a2, $a2, 1
	bge	$a2, $a3, .LBB6_31
.LBB6_28:                               #   Parent Loop BB6_8 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB6_30 Depth 3
	slli.d	$a4, $a2, 2
	ldx.w	$a4, $a0, $a4
...
# %bb.29:                               #   in Loop: Header=BB6_28 Depth=2
	...
	alsl.d	$a5, $a5, $s0, 2
	.p2align	4, , 16
.LBB6_30:                               #   Parent Loop BB6_8 Depth=1
...
.LBB7_34:
	ld.d	$a0, $s0, 0
	beqz	$a0, .LBB7_36
# %bb.35:                               # %.loopexit82.sink.split.sink.split.i
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB7_36:
	move	$a0, $s0
