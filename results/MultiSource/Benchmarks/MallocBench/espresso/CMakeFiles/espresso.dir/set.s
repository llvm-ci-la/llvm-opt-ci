...
# %bb.0:
	...
	ld.d	$s8, $a3, %pc_lo12(set_family_garbage)
	ld.w	$fp, $s4, 12
	move	$s7, $a2
	move	$s1, $a1
	sub.w	$s3, $a0, $a2
...
.LBB47_11:                              #   in Loop: Header=BB47_12 Depth=2
	...
	add.w	$a6, $a6, $s5
	beq	$s6, $a7, .LBB47_8
.LBB47_12:                              #   Parent Loop BB47_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
...
.LBB47_16:                              # %sf_free.exit
	...
	st.d	$a0, $s1, 32
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	st.d	$s1, $a0, %pc_lo12(set_family_garbage)
	move	$a0, $s0
	ld.d	$s8, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 56                    # 8-byte Folded Reload
