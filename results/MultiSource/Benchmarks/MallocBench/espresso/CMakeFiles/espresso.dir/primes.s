...
.LBB0_21:
	...
	move	$s2, $a0
	beqz	$a1, .LBB0_23
.LBB0_22:                               # %primes_consensus_special_cases.exit.thread.sink.split.sink.split
	move	$a0, $a1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_23:                               # %primes_consensus_special_cases.exit.thread.sink.split
	move	$a0, $s4
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_24:                               # %primes_consensus_special_cases.exit.thread
	move	$a0, $s2
...
# %bb.36:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_21
.LBB0_37:                               # %primes_consensus_special_cases.exit
	ld.w	$s0, $s5, 0
	ori	$s1, $zero, 8
	ori	$fp, $zero, 33
	ori	$a0, $zero, 8
...
# %bb.45:                               #   in Loop: Header=BB0_43 Depth=1
	...
	alsl.d	$s4, $a0, $s4, 2
	bltu	$s4, $s7, .LBB0_43
.LBB0_46:                               # %and_with_cofactor.exit.i
	move	$a0, $s2
...
# %bb.50:                               #   in Loop: Header=BB0_48 Depth=1
	...
	alsl.d	$s4, $a0, $s4, 2
	bltu	$s4, $s2, .LBB0_48
.LBB0_51:                               # %and_with_cofactor.exit57.i
	move	$a0, $s3
	pcaddu18i	$ra, %call36(sf_inactive)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s8, 4
...
# %bb.52:                               # %.lr.ph68.i
	...
	b	.LBB0_55
	.p2align	4, , 16
.LBB0_53:                               # %._crit_edge.loopexit.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$s8, $s5
	ld.w	$a1, $s5, 0
.LBB0_54:                               # %._crit_edge.i
                                        #   in Loop: Header=BB0_55 Depth=1
	alsl.d	$s6, $a1, $s6, 2
...
# %bb.61:                               #   in Loop: Header=BB0_59 Depth=2
	...
	ld.d	$s7, $a0, 24
	b	.LBB0_58
.LBB0_62:                               # %primes_consensus_merge.exit
	move	$a0, $s8
