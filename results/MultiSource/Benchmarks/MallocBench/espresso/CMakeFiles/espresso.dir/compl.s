...
.LBB0_26:
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_27:                               # %compl_special_cases.exit.thread
	ld.bu	$a0, $s4, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_29
# %bb.28:
...
.LBB0_36:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_27
.LBB0_37:                               # %compl_special_cases.exit
	ld.w	$s1, $s2, 0
	ori	$s0, $zero, 8
	ori	$s3, $zero, 33
	ori	$a0, $zero, 8
...
.LBB1_23:
	...
	st.d	$a0, $fp, 0
	beqz	$a1, .LBB1_25
.LBB1_24:                               # %simp_comp_special_cases.exit.thread.sink.split.sink.split
	move	$a0, $a1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_25:                               # %simp_comp_special_cases.exit.thread.sink.split
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_26:                               # %simp_comp_special_cases.exit.thread
	ld.bu	$a0, $s5, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB1_28
# %bb.27:
...
# %bb.40:
	...
	jirl	$ra, $ra, 0
	b	.LBB1_51
.LBB1_41:                               # %simp_comp_special_cases.exit
	ld.w	$s2, $s6, 0
	ori	$s3, $zero, 8
	ori	$s7, $zero, 33
	ori	$a0, $zero, 8
...
.LBB2_23:
	...
	move	$s0, $a0
	beqz	$a1, .LBB2_25
.LBB2_24:                               # %simplify_special_cases.exit.thread.sink.split.sink.split
	move	$a0, $a1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB2_25:                               # %simplify_special_cases.exit.thread.sink.split
	move	$a0, $fp
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB2_26:                               # %simplify_special_cases.exit.thread
	ld.bu	$a0, $s4, 0
	andi	$a0, $a0, 1
	beqz	$a0, .LBB2_28
# %bb.27:
...
.LBB2_35:                               # %.lr.ph43
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB2_36:                               #   Parent Loop BB2_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a0, $a4
	ldx.w	$a6, $s1, $a4
	and	$a5, $a6, $a5
...
# %bb.40:
	...
	jirl	$ra, $ra, 0
	b	.LBB2_23
.LBB2_41:                               # %simplify_special_cases.exit
	ld.w	$s1, $s3, 0
	ori	$s0, $zero, 8
	ori	$s5, $zero, 33
	ori	$a0, $zero, 8
...
.LBB4_48:                               #   in Loop: Header=BB4_42 Depth=1
	move	$a5, $t1
.LBB4_49:                               # %scalar.ph178.preheader
                                        #   in Loop: Header=BB4_42 Depth=1
	addi.d	$a6, $a5, 1
	alsl.d	$a7, $a5, $a0, 2
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB4_50:                               # %scalar.ph178
                                        #   Parent Loop BB4_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t0, $a5, 0
	st.w	$t0, $a7, 0
