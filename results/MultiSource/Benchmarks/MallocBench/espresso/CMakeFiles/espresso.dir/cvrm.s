...
# %bb.37:                               # %.lr.ph105.i
	...
	b	.LBB0_41
	.p2align	4, , 16
.LBB0_38:                               # %._crit_edge100.loopexit.i
                                        #   in Loop: Header=BB0_41 Depth=3
	ld.w	$a5, $a3, 0
.LBB0_39:                               # %._crit_edge100.i
                                        #   in Loop: Header=BB0_41 Depth=3
	add.w	$a2, $a2, $a1
...
.LBB10_7:                               #   Parent Loop BB10_2 Depth=1
	...
	addi.d	$t1, $t1, 1
	bltu	$t1, $s6, .LBB10_13
# %bb.8:                                # %vector.memcheck104
                                        #   in Loop: Header=BB10_7 Depth=2
	alsl.d	$t4, $t3, $a2, 2
	alsl.d	$t6, $t2, $a7, 2
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_10
# %bb.9:                                # %vector.memcheck104
                                        #   in Loop: Header=BB10_7 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_13
.LBB10_10:                              # %vector.ph118
                                        #   in Loop: Header=BB10_7 Depth=2
	move	$t3, $t1
...
.LBB10_11:                              # %vector.body121
	...
	addi.d	$t5, $t5, -16
	bnez	$t6, .LBB10_11
# %bb.12:                               # %middle.block130
                                        #   in Loop: Header=BB10_7 Depth=2
	move	$t2, $t4
	beq	$t1, $t3, .LBB10_6
	.p2align	4, , 16
.LBB10_13:                              # %scalar.ph116.preheader
                                        #   in Loop: Header=BB10_7 Depth=2
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a3, 2
	alsl.d	$t2, $t2, $a2, 2
	.p2align	4, , 16
.LBB10_14:                              # %scalar.ph116
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t2, 0
...
.LBB10_21:                              #   Parent Loop BB10_2 Depth=1
	...
	addi.d	$t1, $t1, 1
	bltu	$t1, $s6, .LBB10_27
# %bb.22:                               # %vector.memcheck75
                                        #   in Loop: Header=BB10_21 Depth=2
	alsl.d	$t4, $t3, $a2, 2
	alsl.d	$t6, $t2, $a7, 2
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_24
# %bb.23:                               # %vector.memcheck75
                                        #   in Loop: Header=BB10_21 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_27
.LBB10_24:                              # %vector.ph89
                                        #   in Loop: Header=BB10_21 Depth=2
	move	$t3, $t1
	bstrins.d	$t3, $zero, 1, 0
	sub.d	$t4, $t2, $t3
...
.LBB10_25:                              # %vector.body92
	...
	addi.d	$t5, $t5, -16
	bnez	$t6, .LBB10_25
# %bb.26:                               # %middle.block101
                                        #   in Loop: Header=BB10_21 Depth=2
	move	$t2, $t4
	beq	$t1, $t3, .LBB10_20
	.p2align	4, , 16
.LBB10_27:                              # %scalar.ph87.preheader
                                        #   in Loop: Header=BB10_21 Depth=2
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a3, 2
	alsl.d	$t2, $t2, $a2, 2
	.p2align	4, , 16
.LBB10_28:                              # %scalar.ph87
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_21 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t2, 0
