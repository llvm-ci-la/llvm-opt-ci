...
.LBB5_57:
	move	$a2, $a4
.LBB5_58:                               # %scalar.ph171.preheader
	addi.d	$a1, $a2, 1
	alsl.d	$a3, $a2, $s3, 2
	alsl.d	$a0, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
...
# %bb.61:                               # %vector.memcheck193
	...
	add.d	$a6, $s3, $a4
	bgeu	$a5, $a6, .LBB5_63
# %bb.62:                               # %vector.memcheck193
	add.d	$a4, $s2, $a4
	alsl.d	$a2, $a2, $s3, 2
	bltu	$a2, $a4, .LBB5_66
.LBB5_63:                               # %vector.ph205
	move	$a2, $a1
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a0, $a0, $a2
	addi.d	$a4, $a3, -12
...
.LBB5_64:                               # %vector.body208
	...
	addi.d	$a4, $a4, -32
	bnez	$a5, .LBB5_64
# %bb.65:                               # %middle.block222
	beq	$a1, $a2, .LBB5_68
.LBB5_66:                               # %scalar.ph203.preheader
	addi.d	$a1, $a0, 1
	alsl.d	$a2, $a0, $s3, 2
	alsl.d	$a0, $a0, $s2, 2
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB5_67:                               # %scalar.ph203
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a0, 0
	ld.w	$a5, $a2, 0
	and	$a4, $a5, $a4
...
.LBB5_82:
	...
	addi.d	$sp, $sp, 112
	ret
.LBB5_83:                               # %vector.memcheck168
	sub.d	$a3, $s1, $s3
	ori	$a2, $zero, 32
	bltu	$a3, $a2, .LBB5_57
# %bb.84:                               # %vector.memcheck168
	sub.d	$a3, $a0, $s3
	bltu	$a3, $a2, .LBB5_57
# %bb.85:                               # %vector.ph173
	move	$a3, $a1
