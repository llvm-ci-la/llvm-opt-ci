...
# %bb.31:                               #   in Loop: Header=BB0_30 Depth=2
	move	$s5, $zero
.LBB0_32:                               # %scalar.ph227.preheader
                                        #   in Loop: Header=BB0_30 Depth=2
	sub.d	$s6, $t1, $s5
	.p2align	4, , 16
.LBB0_33:                               # %scalar.ph227
                                        #   Parent Loop BB0_28 Depth=1
...
.LBB0_34:                               # %vector.scevcheck224
	...
	move	$s5, $zero
	blt	$s7, $s6, .LBB0_32
# %bb.35:                               # %vector.scevcheck224
                                        #   in Loop: Header=BB0_30 Depth=2
	mul.d	$s7, $a1, $s0
	add.w	$s7, $s2, $s7
	add.w	$s8, $s7, $t4
	blt	$s8, $s7, .LBB0_32
# %bb.36:                               # %vector.scevcheck224
                                        #   in Loop: Header=BB0_30 Depth=2
	srli.d	$s8, $t4, 32
	bnez	$s8, .LBB0_32
# %bb.37:                               # %vector.scevcheck224
                                        #   in Loop: Header=BB0_30 Depth=2
	alsl.d	$s6, $s6, $a0, 3
	alsl.d	$s7, $s7, $a7, 3
	sub.d	$s6, $s6, $s7
	bltu	$s6, $t7, .LBB0_32
# %bb.38:                               # %vector.body232.preheader
                                        #   in Loop: Header=BB0_30 Depth=2
	move	$s5, $s3
	move	$s6, $s4
	move	$s7, $t5
	.p2align	4, , 16
.LBB0_39:                               # %vector.body232
                                        #   Parent Loop BB0_28 Depth=1
                                        #     Parent Loop BB0_30 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	alsl.d	$s8, $s5, $a7, 3
...
.Lfunc_end2:
	.size	rebuild_lambda, .Lfunc_end2-rebuild_lambda
                                        # -- End function
	.globl	smooth                          # -- Begin function smooth
	.p2align	5
...
.LBB3_15:                               # %.preheader210.us.us
	...
	st.d	$s4, $sp, 592                   # 8-byte Folded Spill
	...
	st.d	$t8, $sp, 888                   # 8-byte Folded Spill
...
# %bb.21:                               # %vector.scevcheck
	...
	add.w	$a5, $t1, $a0
	ld.d	$s3, $sp, 912                   # 8-byte Folded Reload
	st.d	$t1, $sp, 832                   # 8-byte Folded Spill
	blt	$a5, $t1, .LBB3_17
...
.LBB4_39:                               #   in Loop: Header=BB4_9 Depth=3
	...
	ld.d	$t6, $sp, 248                   # 8-byte Folded Reload
	move	$s6, $s5
.LBB4_40:                               # %scalar.ph.preheader
                                        #   in Loop: Header=BB4_9 Depth=3
	move	$s5, $t2
.LBB4_41:                               # %scalar.ph.preheader
                                        #   in Loop: Header=BB4_9 Depth=3
	ld.d	$t2, $sp, 240                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 272                   # 8-byte Folded Reload
	b	.LBB4_11
.LBB4_42:                               #   in Loop: Header=BB4_9 Depth=3
	ori	$t1, $zero, 8
	ld.d	$t6, $sp, 248                   # 8-byte Folded Reload
	move	$s6, $fp
	b	.LBB4_40
.LBB4_43:                               #   in Loop: Header=BB4_9 Depth=3
	ori	$t1, $zero, 8
.LBB4_44:                               #   in Loop: Header=BB4_9 Depth=3
	ld.d	$t6, $sp, 248                   # 8-byte Folded Reload
	move	$s6, $s5
	move	$s5, $t2
	ld.d	$t2, $sp, 240                   # 8-byte Folded Reload
	b	.LBB4_11
.LBB4_45:                               # %._crit_edge160
	pcaddu18i	$ra, %call36(CycleTime)
	jirl	$ra, $ra, 0
...
.LBB5_38:                               #   in Loop: Header=BB5_9 Depth=3
	...
	ld.d	$t3, $sp, 296                   # 8-byte Folded Reload
	b	.LBB5_11
.LBB5_39:                               #   in Loop: Header=BB5_9 Depth=3
	ori	$t2, $zero, 8
	move	$s8, $t3
	ld.d	$t3, $sp, 296                   # 8-byte Folded Reload
	b	.LBB5_11
.LBB5_40:                               # %._crit_edge163
	pcaddu18i	$ra, %call36(CycleTime)
	jirl	$ra, $ra, 0
...
# %bb.10:                               # %._crit_edge.us.us.us
	...
	add.w	$t1, $t1, $t6
	bne	$s6, $a7, .LBB7_8
# %bb.11:                               # %._crit_edge105.split.us.us.us
...
# %bb.10:                               #   in Loop: Header=BB8_9 Depth=3
	move	$s3, $zero
.LBB8_11:                               # %scalar.ph442.preheader
...
.LBB8_14:                               # %vector.scevcheck389
	...
	move	$s3, $zero
	blt	$a6, $ra, .LBB8_11
# %bb.15:                               # %vector.scevcheck389
                                        #   in Loop: Header=BB8_9 Depth=3
	add.w	$s5, $t3, $a1
	add.w	$a6, $s5, $t8
	blt	$a6, $s5, .LBB8_11
# %bb.16:                               # %vector.scevcheck389
                                        #   in Loop: Header=BB8_9 Depth=3
	add.w	$a6, $a2, $a1
	add.w	$t0, $a6, $t8
	blt	$t0, $a6, .LBB8_11
# %bb.17:                               # %vector.scevcheck389
                                        #   in Loop: Header=BB8_9 Depth=3
	mul.d	$t0, $a7, $a0
	...
	add.w	$s4, $t0, $s0
	blt	$s4, $t0, .LBB8_11
# %bb.18:                               # %vector.scevcheck389
                                        #   in Loop: Header=BB8_9 Depth=3
	add.w	$a1, $t6, $a1
	add.w	$s4, $a1, $t8
	blt	$s4, $a1, .LBB8_11
# %bb.19:                               # %vector.scevcheck389
                                        #   in Loop: Header=BB8_9 Depth=3
	srli.d	$s4, $s0, 32
	bnez	$s4, .LBB8_11
# %bb.20:                               # %vector.memcheck402
                                        #   in Loop: Header=BB8_9 Depth=3
...
# %bb.29:                               # %._crit_edge
                                        #   in Loop: Header=BB8_3 Depth=1
	blez	$t1, .LBB8_51
# %bb.30:                               # %.preheader199.us.us.preheader
                                        #   in Loop: Header=BB8_3 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 48
	move	$s0, $zero
...
# %bb.34:                               #   in Loop: Header=BB8_33 Depth=3
	move	$s3, $zero
.LBB8_35:                               # %scalar.ph372.preheader
...
.LBB8_36:                               # %scalar.ph372
	...
	addi.w	$s8, $s8, 1
	bnez	$s3, .LBB8_36
.LBB8_37:                               # %._crit_edge210.us.us.us
                                        #   in Loop: Header=BB8_33 Depth=3
	addi.w	$s4, $s4, 1
	add.w	$a6, $a6, $a7
	add.d	$t0, $t0, $t5
...
.LBB8_38:                               # %vector.scevcheck319
	...
	move	$s3, $zero
	blt	$a1, $s5, .LBB8_35
# %bb.39:                               # %vector.scevcheck319
                                        #   in Loop: Header=BB8_33 Depth=3
	add.w	$a1, $t3, $a0
	add.w	$s0, $a1, $t8
	blt	$s0, $a1, .LBB8_35
# %bb.40:                               # %vector.scevcheck319
                                        #   in Loop: Header=BB8_33 Depth=3
	add.w	$s0, $fp, $a0
	add.w	$s7, $s0, $t8
	blt	$s7, $s0, .LBB8_35
# %bb.41:                               # %vector.scevcheck319
                                        #   in Loop: Header=BB8_33 Depth=3
	mul.d	$s7, $a7, $s4
	...
	add.w	$s8, $s7, $a3
	blt	$s8, $s7, .LBB8_35
# %bb.42:                               # %vector.scevcheck319
                                        #   in Loop: Header=BB8_33 Depth=3
	add.w	$s8, $t6, $a0
	add.w	$a0, $s8, $t8
	blt	$a0, $s8, .LBB8_35
# %bb.43:                               # %vector.scevcheck319
                                        #   in Loop: Header=BB8_33 Depth=3
	srli.d	$a0, $a3, 32
	bnez	$a0, .LBB8_35
# %bb.44:                               # %vector.memcheck332
                                        #   in Loop: Header=BB8_33 Depth=3
...
# %bb.53:                               # %._crit_edge214
                                        #   in Loop: Header=BB8_3 Depth=1
	blez	$t1, .LBB8_2
# %bb.54:                               # %.preheader198.us.us.preheader
                                        #   in Loop: Header=BB8_3 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 56
	move	$s0, $zero
...
.LBB8_60:                               # %scalar.ph
	...
	addi.w	$s7, $s7, 1
	bnez	$s3, .LBB8_60
.LBB8_61:                               # %._crit_edge220.us.us.us
                                        #   in Loop: Header=BB8_57 Depth=3
	addi.w	$s4, $s4, 1
	add.w	$a6, $a6, $a7
	add.d	$t0, $t0, $t5
...
.Lfunc_end9:
	.size	interpolation_constant, .Lfunc_end9-interpolation_constant
                                        # -- End function
	.globl	interpolation_linear            # -- Begin function interpolation_linear
	.p2align	5
...
.LBB10_8:                               # %.preheader.us.us.us
	...
	add.d	$s7, $a1, $s4
	movgr2cf	$fcc0, $a2
	fsel	$ft9, $fa1, $fa0, $fcc0
	fsel	$ft11, $fa0, $fa1, $fcc0
	fmul.d	$ft1, $fa3, $ft9
	fmul.d	$ft2, $ft1, $fa2
	fmul.d	$ft3, $fa3, $ft11
	fmul.d	$ft4, $ft3, $fa2
...
.LBB10_9:                               #   Parent Loop BB10_3 Depth=1
	...
	add.w	$s1, $s7, $a2
	movgr2cf	$fcc0, $a3
	fsel	$ft14, $fa1, $fa0, $fcc0
	fsel	$ft13, $fa0, $fa1, $fcc0
	addi.w	$fp, $s1, -1
	sub.w	$a3, $fp, $t6
	sub.w	$a2, $a3, $t7
	slli.d	$a2, $a2, 3
...
.LBB12_29:                              # %._crit_edge.split.us.us.us.us.us
	...
	add.d	$a4, $a4, $t6
	beq	$s8, $t3, .LBB12_7
.LBB12_30:                              # %.preheader.us.us.us.us
                                        #   Parent Loop BB12_3 Depth=1
                                        #     Parent Loop BB12_8 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB12_36 Depth 4
...
.Lfunc_end21:
	.size	matmul_grids, .Lfunc_end21-matmul_grids
                                        # -- End function
	.globl	initialize_problem              # -- Begin function initialize_problem
	.p2align	5
...
.LBB22_3:                               # =>This Loop Header: Depth=1
	...
	ld.w	$a1, $s5, 28
	blez	$a1, .LBB22_2
# %bb.4:                                # %.preheader316.lr.ph
                                        #   in Loop: Header=BB22_3 Depth=1
	ld.w	$a0, $s5, 24
	blez	$a0, .LBB22_2
# %bb.5:                                # %.preheader316.preheader
                                        #   in Loop: Header=BB22_3 Depth=1
	move	$s6, $zero
	addi.d	$a2, $s5, 28
	...
	b	.LBB22_8
	.p2align	4, , 16
.LBB22_6:                               # %._crit_edge319.loopexit
                                        #   in Loop: Header=BB22_8 Depth=2
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	ld.w	$a1, $a1, 0
.LBB22_7:                               # %._crit_edge319
                                        #   in Loop: Header=BB22_8 Depth=2
	addi.w	$s6, $s6, 1
	bge	$s6, $a1, .LBB22_2
.LBB22_8:                               # %.preheader316
...
# %bb.43:                               #   in Loop: Header=BB22_41 Depth=1
	ld.w	$a7, $t4, 20
	blez	$a7, .LBB22_40
# %bb.44:                               # %.preheader65.us.us.preheader.i301
                                        #   in Loop: Header=BB22_41 Depth=1
	ld.w	$t0, $t4, 48
	ld.d	$t5, $t4, 176
	ld.w	$t1, $t4, 52
	...
	b	.LBB22_46
	.p2align	4, , 16
.LBB22_45:                              # %._crit_edge68.split.us.us.us.i312
                                        #   in Loop: Header=BB22_46 Depth=2
	addi.w	$t3, $t3, 1
	add.w	$t2, $t2, $t1
	beq	$t3, $a5, .LBB22_40
.LBB22_46:                              # %.preheader65.us.us.i303
	...
	b	.LBB22_48
	.p2align	4, , 16
.LBB22_47:                              # %._crit_edge.us.us.us.i310
                                        #   in Loop: Header=BB22_48 Depth=3
	addi.w	$t7, $t7, 1
	add.w	$s0, $s0, $t0
	beq	$t7, $a6, .LBB22_45
.LBB22_48:                              # %.preheader.us.us.us.i305
                                        #   Parent Loop BB22_41 Depth=1
...
# %bb.49:                               #   in Loop: Header=BB22_48 Depth=3
	move	$s2, $zero
.LBB22_50:                              # %scalar.ph357.preheader
                                        #   in Loop: Header=BB22_48 Depth=3
	sub.d	$s3, $a7, $s2
	add.w	$s2, $s0, $s2
	.p2align	4, , 16
.LBB22_51:                              # %scalar.ph357
                                        #   Parent Loop BB22_41 Depth=1
                                        #     Parent Loop BB22_46 Depth=2
...
.LBB22_52:                              # %vector.scevcheck356
	...
	move	$s2, $zero
	blt	$s4, $s3, .LBB22_50
# %bb.53:                               # %vector.scevcheck356
                                        #   in Loop: Header=BB22_48 Depth=3
	srli.d	$s3, $t5, 32
	bnez	$s3, .LBB22_50
# %bb.54:                               # %vector.body364.preheader
                                        #   in Loop: Header=BB22_48 Depth=3
	move	$s2, $s0
	move	$s3, $t6
	.p2align	4, , 16
.LBB22_55:                              # %vector.body364
                                        #   Parent Loop BB22_41 Depth=1
                                        #     Parent Loop BB22_46 Depth=2
                                        #       Parent Loop BB22_48 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.w	$s2, $s2, 4
	bnez	$s3, .LBB22_55
# %bb.56:                               # %middle.block369
                                        #   in Loop: Header=BB22_48 Depth=3
	move	$s2, $t6
	beq	$t6, $a7, .LBB22_47
	b	.LBB22_50
.LBB22_57:                              # %shift_grid.exit314
	pcaddu18i	$ra, %call36(CycleTime)
	jirl	$ra, $ra, 0
	ld.d	$a1, $fp, 0
	sub.d	$a0, $a0, $s1
