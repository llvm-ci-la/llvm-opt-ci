...
# %bb.18:                               # %.lr.ph.i366
	...
	add.d	$a1, $sp, $a1
	vld	$vr2, $a1, 0
	vfmul.d	$vr3, $vr11, $vr20
	vfadd.d	$vr10, $vr1, $vr3
	vfmul.d	$vr0, $vr11, $vr0
	vfadd.d	$vr9, $vr2, $vr0
	lu12i.w	$a1, 1
	ori	$a1, $a1, 2800
	...
	add.d	$a1, $sp, $a1
	vst	$vr12, $a1, 0
	vst	$vr10, $sp, 304                 # 16-byte Folded Spill
	lu12i.w	$a1, 1
	ori	$a1, $a1, 2480
	add.d	$a1, $sp, $a1
	vst	$vr10, $a1, 0
	vst	$vr9, $sp, 320                  # 16-byte Folded Spill
	lu12i.w	$a1, 1
	ori	$a1, $a1, 2496
	add.d	$a1, $sp, $a1
	vst	$vr9, $a1, 0
	...
	add.d	$a1, $sp, $a1
	vst	$vr17, $a1, 0
	fst.d	$ft10, $sp, 248                 # 8-byte Folded Spill
	lu12i.w	$a1, 1
	ori	$a1, $a1, 2560
	add.d	$a1, $sp, $a1
	fst.d	$ft10, $a1, 0
