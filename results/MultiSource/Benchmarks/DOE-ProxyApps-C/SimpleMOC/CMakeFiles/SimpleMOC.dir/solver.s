...
.LBB0_42:                               # %.lr.ph349
	...
	addi.d	$s2, $s2, 4
	bnez	$a1, .LBB0_42
.LBB0_43:                               # %.lr.ph351.preheader
	ori	$a2, $zero, 8
	move	$a1, $zero
	bltu	$a7, $a2, .LBB0_67
# %bb.44:                               # %.lr.ph351.preheader
	sub.d	$a2, $t8, $a6
	ori	$a5, $zero, 32
...
.LBB0_46:                               # %vector.body682
	...
	addi.d	$a5, $a5, 32
	bnez	$t1, .LBB0_46
# %bb.47:                               # %middle.block687
	bne	$a1, $s1, .LBB0_68
	b	.LBB0_70
.LBB0_48:                               # %vector.memcheck603
	sub.d	$t1, $t2, $t4
	ori	$a5, $zero, 32
	move	$a2, $zero
	bltu	$t1, $a5, .LBB0_37
...
.LBB0_53:                               # %vector.body616
	...
	addi.d	$s4, $s4, 32
	bnez	$s5, .LBB0_53
# %bb.54:                               # %middle.block627
	bne	$a2, $s1, .LBB0_37
	b	.LBB0_39
.LBB0_55:                               # %vector.memcheck630
	sub.d	$a5, $a6, $t6
	ori	$a2, $zero, 16
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_41
...
# %bb.57:                               # %vector.memcheck630
	...
	ori	$a2, $zero, 16
	bltu	$a5, $a2, .LBB0_41
# %bb.58:                               # %vector.memcheck630
	sub.d	$a5, $a6, $a0
	bltu	$a5, $a2, .LBB0_41
# %bb.59:                               # %vector.memcheck630
	sub.d	$a5, $a6, $t0
	ori	$a2, $zero, 16
	bltu	$a5, $a2, .LBB0_41
# %bb.60:                               # %vector.memcheck630
	sub.d	$a5, $a6, $t5
	bltu	$a5, $a2, .LBB0_41
# %bb.61:                               # %vector.memcheck630
	sub.d	$a5, $a6, $t3
	ori	$a2, $zero, 16
	bltu	$a5, $a2, .LBB0_41
# %bb.62:                               # %vector.memcheck630
	sub.d	$a5, $a6, $t2
	bltu	$a5, $a2, .LBB0_41
# %bb.63:                               # %vector.memcheck630
	sub.d	$a2, $a6, $fp
	ori	$a5, $zero, 16
	bltu	$a2, $a5, .LBB0_41
# %bb.64:                               # %vector.ph651
...
.LBB0_69:                               # %.lr.ph351
	...
	addi.d	$a5, $a5, 4
	bnez	$a1, .LBB0_69
.LBB0_70:                               # %.lr.ph353.preheader
	ori	$a1, $zero, 8
	bltu	$a7, $a1, .LBB0_73
# %bb.71:                               # %vector.memcheck690
	alsl.d	$a1, $s1, $t8, 2
	bgeu	$s3, $a1, .LBB0_127
# %bb.72:                               # %vector.memcheck690
	alsl.d	$a1, $s1, $s3, 2
	bgeu	$t8, $a1, .LBB0_127
.LBB0_73:
	move	$a1, $zero
.LBB0_74:                               # %.lr.ph353.preheader835
	alsl.d	$a2, $a1, $s3, 2
	alsl.d	$a5, $a1, $t8, 2
	sub.d	$a1, $s1, $a1
	.p2align	4, , 16
...
.LBB0_96:                               # %._crit_edge364
	...
	addi.d	$sp, $sp, 128
	ret
.LBB0_97:                               # %vector.memcheck711
	sub.d	$a5, $a3, $t6
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_78
# %bb.98:                               # %vector.memcheck711
	sub.d	$a5, $a3, $t0
	bltu	$a5, $a2, .LBB0_78
# %bb.99:                               # %vector.memcheck711
	sub.d	$a2, $a3, $t7
	ori	$a5, $zero, 32
	bltu	$a2, $a5, .LBB0_78
# %bb.100:                              # %vector.ph719
...
.LBB0_101:                              # %vector.body722
	...
	addi.d	$t1, $t1, 32
	bnez	$t8, .LBB0_101
# %bb.102:                              # %middle.block731
	bne	$a1, $s1, .LBB0_78
	b	.LBB0_80
.LBB0_103:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t3
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_82
# %bb.104:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t4
	bltu	$a5, $a2, .LBB0_82
# %bb.105:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t0
	ori	$a2, $zero, 32
	bltu	$a5, $a2, .LBB0_82
# %bb.106:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t5
	bltu	$a5, $a2, .LBB0_82
# %bb.107:                              # %vector.ph744
	bstrpick.d	$a1, $s1, 30, 3
...
.LBB0_108:                              # %vector.body749
	...
	addi.d	$t6, $t6, 32
	bnez	$t7, .LBB0_108
# %bb.109:                              # %middle.block760
	bne	$a1, $s1, .LBB0_82
	b	.LBB0_84
.LBB0_110:                              # %vector.memcheck763
	sub.d	$a5, $s0, $fp
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_86
...
.LBB0_113:                              # %vector.body774
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_113
# %bb.114:                              # %middle.block781
	bne	$a1, $s1, .LBB0_86
	b	.LBB0_88
.LBB0_115:                              # %vector.memcheck784
	sub.d	$a5, $s2, $a0
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_90
# %bb.116:                              # %vector.memcheck784
	sub.d	$a5, $s2, $t0
	bltu	$a5, $a2, .LBB0_90
# %bb.117:                              # %vector.ph790
	bstrpick.d	$a1, $s1, 30, 3
...
.LBB0_118:                              # %vector.body793
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_118
# %bb.119:                              # %middle.block800
	bne	$a1, $s1, .LBB0_90
	b	.LBB0_92
.LBB0_120:                              # %vector.memcheck803
	sub.d	$a5, $a0, $a3
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_94
# %bb.121:                              # %vector.memcheck803
	sub.d	$a5, $a0, $a4
	bltu	$a5, $a2, .LBB0_94
# %bb.122:                              # %vector.memcheck803
	sub.d	$a5, $a0, $s0
	ori	$a2, $zero, 32
	bltu	$a5, $a2, .LBB0_94
# %bb.123:                              # %vector.memcheck803
	sub.d	$a5, $a0, $s2
	bltu	$a5, $a2, .LBB0_94
# %bb.124:                              # %vector.ph813
	bstrpick.d	$a1, $s1, 30, 3
...
.LBB0_125:                              # %vector.body816
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB0_125
# %bb.126:                              # %middle.block827
	bne	$a1, $s1, .LBB0_94
	b	.LBB0_96
.LBB0_127:                              # %vector.ph698
	bstrpick.d	$a1, $s1, 30, 3
	slli.d	$a1, $a1, 3
	addi.d	$a2, $s3, 16
	addi.d	$a5, $t8, 16
...
.LBB0_128:                              # %vector.body701
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_128
# %bb.129:                              # %middle.block708
	beq	$a1, $s1, .LBB0_76
	b	.LBB0_74
.LBB0_130:                              # %vector.memcheck520
	sub.d	$s0, $t3, $t6
	move	$a5, $zero
	bltu	$s0, $t1, .LBB0_10
# %bb.131:                              # %vector.memcheck520
	sub.d	$s0, $fp, $t6
	ori	$t1, $zero, 16
	bltu	$s0, $t1, .LBB0_10
# %bb.132:                              # %vector.memcheck520
	sub.d	$s0, $t6, $s1
	bltu	$s0, $t1, .LBB0_10
# %bb.133:                              # %vector.memcheck520
	sub.d	$s0, $t6, $s3
	ori	$t1, $zero, 16
	bltu	$s0, $t1, .LBB0_10
# %bb.134:                              # %vector.memcheck520
	sub.d	$s0, $t6, $s4
	bltu	$s0, $t1, .LBB0_10
# %bb.135:                              # %vector.memcheck520
	sub.d	$s0, $fp, $t3
	ori	$t1, $zero, 16
	bltu	$s0, $t1, .LBB0_10
# %bb.136:                              # %vector.memcheck520
	sub.d	$s0, $t3, $s1
	bltu	$s0, $t1, .LBB0_10
# %bb.137:                              # %vector.memcheck520
	sub.d	$s0, $t3, $s3
	ori	$t1, $zero, 16
	bltu	$s0, $t1, .LBB0_10
# %bb.138:                              # %vector.memcheck520
	sub.d	$s0, $t3, $s4
	bltu	$s0, $t1, .LBB0_10
# %bb.139:                              # %vector.memcheck520
	sub.d	$s0, $fp, $s1
	ori	$t1, $zero, 16
	bltu	$s0, $t1, .LBB0_10
# %bb.140:                              # %vector.memcheck520
	sub.d	$s0, $fp, $s3
	bltu	$s0, $t1, .LBB0_10
# %bb.141:                              # %vector.memcheck520
	sub.d	$t1, $fp, $s4
	ori	$s0, $zero, 16
	bltu	$t1, $s0, .LBB0_10
# %bb.142:                              # %vector.ph546
...
.LBB0_143:                              # %vector.body555
	...
	addi.d	$t1, $t1, 16
	bnez	$s5, .LBB0_143
# %bb.144:                              # %middle.block561
	bne	$a5, $a7, .LBB0_10
	b	.LBB0_17
.LBB0_145:                              # %vector.memcheck476
	sub.d	$t1, $t3, $t6
	move	$s5, $zero
	bltu	$t1, $a5, .LBB0_5
...
# %bb.151:                              # %vector.memcheck476
	sub.d	$t1, $t3, $s1
	bltu	$t1, $a5, .LBB0_5
# %bb.152:                              # %vector.memcheck476
	sub.d	$t1, $t3, $s3
	ori	$a5, $zero, 16
	bltu	$t1, $a5, .LBB0_5
# %bb.153:                              # %vector.memcheck476
	sub.d	$t1, $t3, $s4
	bltu	$t1, $a5, .LBB0_5
# %bb.154:                              # %vector.memcheck476
	sub.d	$t1, $fp, $s1
	ori	$a5, $zero, 16
	bltu	$t1, $a5, .LBB0_5
# %bb.155:                              # %vector.memcheck476
	sub.d	$t1, $fp, $s3
	bltu	$t1, $a5, .LBB0_5
# %bb.156:                              # %vector.memcheck476
	sub.d	$a5, $fp, $s4
	ori	$t1, $zero, 16
	bltu	$a5, $t1, .LBB0_5
# %bb.157:                              # %vector.ph502
...
.LBB2_34:                               # %scalar.ph321.preheader
                                        #   in Loop: Header=BB2_22 Depth=5
	sub.d	$a7, $a0, $a6
...
# %bb.36:                               #   in Loop: Header=BB2_22 Depth=5
	...
	move	$t1, $a0
	b	.LBB2_45
.LBB2_37:                               # %vector.memcheck316
                                        #   in Loop: Header=BB2_22 Depth=5
	ld.d	$a7, $sp, 72                    # 8-byte Folded Reload
	vld	$vr7, $sp, 208                  # 16-byte Folded Reload
	bltu	$a7, $t4, .LBB2_34
# %bb.38:                               # %vector.memcheck316
                                        #   in Loop: Header=BB2_22 Depth=5
	ld.d	$a7, $sp, 184                   # 8-byte Folded Reload
	sub.d	$a7, $a7, $a5
	ori	$t0, $zero, 32
	bltu	$a7, $t0, .LBB2_34
# %bb.39:                               # %vector.memcheck316
                                        #   in Loop: Header=BB2_22 Depth=5
...
# %bb.48:                               #   in Loop: Header=BB2_22 Depth=5
	move	$a4, $zero
.LBB2_49:                               # %scalar.ph300.preheader
                                        #   in Loop: Header=BB2_22 Depth=5
	sub.d	$a5, $a0, $a4
...
.LBB2_54:                               #   in Loop: Header=BB2_22 Depth=5
	move	$a2, $zero
.LBB2_55:                               # %.lr.ph85.i.preheader336
                                        #   in Loop: Header=BB2_22 Depth=5
	sub.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $a1, 2
...
# %bb.63:                               # %vector.memcheck265
	...
	and	$a6, $t2, $a6
	bnez	$a6, .LBB2_49
# %bb.64:                               # %vector.memcheck265
                                        #   in Loop: Header=BB2_22 Depth=5
	sltu	$a6, $a3, $a7
	sltu	$a7, $a2, $a5
	and	$a6, $a6, $a7
	bnez	$a6, .LBB2_49
# %bb.65:                               # %vector.memcheck265
                                        #   in Loop: Header=BB2_22 Depth=5
	sltu	$a6, $a3, $t0
...
.Lfunc_end8:
	.size	alt_attenuate_fluxes, .Lfunc_end8-alt_attenuate_fluxes
                                        # -- End function
	.globl	renormalize_flux                # -- Begin function renormalize_flux
	.p2align	5
...
.Lfunc_end9:
	.size	renormalize_flux, .Lfunc_end9-renormalize_flux
                                        # -- End function
	.globl	update_sources                  # -- Begin function update_sources
	.p2align	5
