...
# %bb.1:                                # %.lr.ph74
	...
	pcalau12i	$a0, %pc_hi20(.L__const.createFccLattice.basis)
	addi.d	$s4, $a0, %pc_lo12(.L__const.createFccLattice.basis)
	ori	$s2, $zero, 96
	movgr2fr.d	$fs1, $zero
	b	.LBB2_3
	.p2align	4, , 16
...
# %bb.13:                               #   in Loop: Header=BB2_11 Depth=4
	...
	bcnez	$fcc0, .LBB2_10
# %bb.14:                               #   in Loop: Header=BB2_11 Depth=4
	fld.d	$fa2, $s1, 128
...
# %bb.15:                               #   in Loop: Header=BB2_11 Depth=4
	...
	bcnez	$fcc0, .LBB2_10
# %bb.16:                               #   in Loop: Header=BB2_11 Depth=4
	fld.d	$fa3, $s1, 136
	fcmp.cle.d	$fcc0, $fa3, $fa2
	bcnez	$fcc0, .LBB2_10
# %bb.17:                               #   in Loop: Header=BB2_11 Depth=4
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	move	$a2, $s0
	move	$a3, $zero
...
.Lfunc_end5:
	.size	randomDisplacements, .Lfunc_end5-randomDisplacements
                                        # -- End function
	.type	.L__const.createFccLattice.basis,@object # @__const.createFccLattice.basis
	.section	.rodata,"a",@progbits
	.p2align	3, 0x0
.L__const.createFccLattice.basis:
	...
	.dword	0x3fe8000000000000              # double 0.75
	.dword	0x3fd0000000000000              # double 0.25
	.size	.L__const.createFccLattice.basis, 96
