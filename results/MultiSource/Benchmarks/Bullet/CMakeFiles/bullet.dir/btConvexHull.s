...
# %bb.27:                               # %middle.block592
                                        #   in Loop: Header=BB28_18 Depth=1
	beq	$a2, $a1, .LBB28_32
.LBB28_28:                              # %scalar.ph582.preheader
                                        #   in Loop: Header=BB28_18 Depth=1
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s2, 2
	.p2align	4, , 16
.LBB28_29:                              # %scalar.ph582
                                        #   Parent Loop BB28_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
...
# %bb.44:                               # %middle.block576
                                        #   in Loop: Header=BB28_18 Depth=1
	beq	$s7, $a0, .LBB28_48
.LBB28_45:                              # %.lr.ph.i.i.i243.preheader601
                                        #   in Loop: Header=BB28_18 Depth=1
	alsl.d	$a1, $a0, $s4, 2
	alsl.d	$a2, $a0, $s2, 2
	.p2align	4, , 16
...
.LBB33_44:
	ld.w	$a0, $fp, 0
	beqz	$a0, .LBB33_49
# %bb.45:                               # %.lr.ph388.preheader
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	fld.s	$fa3, $a2, %pc_lo12(.LCPI33_0)
