...
# %bb.1:                                # %.lr.ph
	...
	fld.s	$fs0, $a2, %pc_lo12(.LCPI5_0)
	pcalau12i	$a2, %pc_hi20(.LCPI5_1)
	fld.s	$fs1, $a2, %pc_lo12(.LCPI5_1)
	addi.d	$s1, $a1, 12
	ori	$s2, $zero, 1
	move	$s3, $s0
	b	.LBB5_3
...
# %bb.33:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB8_6 Depth=1
	beq	$a4, $a3, .LBB8_36
.LBB8_34:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB8_6 Depth=1
	sub.d	$a3, $a3, $a4
	alsl.d	$a5, $a4, $a1, 2
	alsl.d	$a4, $a4, $t3, 2
	.p2align	4, , 16
.LBB8_35:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB8_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
	...
	addi.d	$a4, $a4, 4
	bnez	$a3, .LBB8_35
.LBB8_36:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.thread.i.i
                                        #   in Loop: Header=BB8_6 Depth=1
	ld.bu	$a3, $a2, 24
	beqz	$a3, .LBB8_2
...
# %bb.36:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB9_6 Depth=1
	beq	$a6, $a5, .LBB9_39
.LBB9_37:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB9_6 Depth=1
	sub.d	$a5, $a5, $a6
	alsl.d	$a7, $a6, $a4, 2
	alsl.d	$a6, $a6, $fp, 2
	.p2align	4, , 16
.LBB9_38:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB9_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t0, $a7, 0
	st.w	$t0, $a6, 0
	...
	addi.d	$a6, $a6, 4
	bnez	$a5, .LBB9_38
.LBB9_39:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.thread.i.i
                                        #   in Loop: Header=BB9_6 Depth=1
	ld.bu	$a5, $a3, 24
	beqz	$a5, .LBB9_2
