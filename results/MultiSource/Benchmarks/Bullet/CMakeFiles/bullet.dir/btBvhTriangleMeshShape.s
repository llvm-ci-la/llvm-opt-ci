...
# %bb.1:                                # %_Z8btSetMinIfEvRT_RKS0_.exit.i
	...
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bceqz	$fcc0, .LBB3_11
.LBB3_2:                                # %_Z8btSetMinIfEvRT_RKS0_.exit5.i
	fld.s	$fa0, $s1, 8
	fld.s	$fa1, $fp, 36
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bceqz	$fcc0, .LBB3_12
.LBB3_3:                                # %_Z8btSetMinIfEvRT_RKS0_.exit6.i
	fld.s	$fa0, $s1, 12
	fld.s	$fa1, $fp, 40
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bceqz	$fcc0, .LBB3_13
...
.LBB3_5:                                # %_Z8btSetMaxIfEvRT_RKS0_.exit.i
	...
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bceqz	$fcc0, .LBB3_15
.LBB3_6:                                # %_Z8btSetMaxIfEvRT_RKS0_.exit5.i
	fld.s	$fa1, $fp, 52
	fld.s	$fa0, $s0, 8
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bceqz	$fcc0, .LBB3_16
.LBB3_7:                                # %_Z8btSetMaxIfEvRT_RKS0_.exit6.i
	fld.s	$fa1, $fp, 56
	fld.s	$fa0, $s0, 12
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB3_9
...
.Ltmp48:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp49:                                # EH_LABEL
# %bb.8:                                # %_ZN22btBvhTriangleMeshShapedlEPv.exit
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_9:
...
.LBB18_3:                               # %.split.us
	bne	$a4, $a5, .LBB18_7
# %bb.4:                                # %.split.us.split.us.preheader
	ld.hu	$a4, $a2, 4
	mul.w	$a4, $a1, $a4
	add.d	$a5, $a0, $a4
	fldx.s	$fa0, $a0, $a4
