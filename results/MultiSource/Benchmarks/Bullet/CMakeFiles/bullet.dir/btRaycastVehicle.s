...
# %bb.11:
	ld.w	$a0, $fp, 48
	bge	$a0, $s2, .LBB25_19
# %bb.12:                               # %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i155
	slli.d	$a0, $s2, 4
	ori	$a1, $zero, 16
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
	jirl	$ra, $ra, 0
...
.LBB25_14:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 16
	bne	$a1, $a0, .LBB25_14
.LBB25_15:                              # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i157
	ld.d	$a0, $fp, 56
	beqz	$a0, .LBB25_18
# %bb.16:                               # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i157
	ld.b	$a1, $fp, 64
	andi	$a1, $a1, 1
	beqz	$a1, .LBB25_18
# %bb.17:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB25_18:                              # %_ZN20btAlignedObjectArrayI9btVector3E10deallocateEv.exit.i.i160
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 64
	st.d	$s0, $fp, 56
	st.w	$s2, $fp, 48
.LBB25_19:                              # %_ZN20btAlignedObjectArrayI9btVector3E6resizeEiRKS0_.exit166
	ld.w	$s3, $fp, 76
	st.w	$s2, $fp, 44
	blt	$s3, $s2, .LBB25_22
# %bb.20:                               # %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit
	...
	st.w	$s2, $fp, 76
	blt	$s3, $s2, .LBB25_38
.LBB25_21:                              # %_ZN20btAlignedObjectArrayIfE6resizeEiRKf.exit204
	ld.w	$a0, $fp, 196
	st.w	$s2, $fp, 108
	bgtz	$a0, .LBB25_54
	b	.LBB25_88
...
.LBB25_30:                              # %scalar.ph
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB25_30
.LBB25_31:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i
	ld.bu	$a0, $fp, 96
	bnez	$a0, .LBB25_35
	b	.LBB25_36
.LBB25_32:                              # %..lr.ph.i167_crit_edge
	ld.d	$s1, $fp, 88
	slli.d	$s0, $s2, 2
	b	.LBB25_37
...
# %bb.44:                               # %middle.block317
	beq	$a0, $a2, .LBB25_47
.LBB25_45:                              # %scalar.ph307.preheader
	sub.d	$a2, $a2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB25_46:                              # %scalar.ph307
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB25_46
.LBB25_47:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.thread.i.i200
	ld.bu	$a0, $fp, 128
	bnez	$a0, .LBB25_51
	b	.LBB25_52
.LBB25_48:                              # %..lr.ph.i181_crit_edge
	ld.d	$s1, $fp, 120
	slli.d	$s0, $s2, 2
	b	.LBB25_53
.LBB25_49:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i191
	beqz	$a1, .LBB25_52
...
.LBB25_51:
	...
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB25_52:                              # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i194
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 128
	st.d	$s1, $fp, 120
	st.w	$s2, $fp, 112
...
# %bb.58:                               # %middle.block330
	beq	$a3, $a0, .LBB25_61
.LBB25_59:                              # %scalar.ph322.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a1, $a3, $a1, 2
	sub.d	$a3, $a0, $a3
	.p2align	4, , 16
.LBB25_60:                              # %scalar.ph322
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a1, 0
	st.w	$zero, $a2, 0
	addi.d	$a2, $a2, 4
...
# %bb.70:                               #   in Loop: Header=BB25_69 Depth=1
	...
	bcnez	$fcc0, .LBB25_72
# %bb.71:                               #   in Loop: Header=BB25_69 Depth=1
	fmul.s	$fa0, $fs0, $fa0
	b	.LBB25_73
	.p2align	4, , 16
.LBB25_72:                              #   in Loop: Header=BB25_69 Depth=1
	fld.s	$fa0, $s6, 256
	fcmp.ceq.s	$fcc0, $fa0, $fs1
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 168
	...
	fcmp.clt.s	$fcc0, $fa0, $fa1
	fsel	$fa0, $fa0, $fa1, $fcc0
.LBB25_73:                              #   in Loop: Header=BB25_69 Depth=1
	ld.d	$a2, $fp, 88
	stx.w	$zero, $a2, $s1
	add.d	$a1, $a0, $s0
	st.w	$s4, $a1, 284
	...
	bcnez	$fcc0, .LBB25_68
# %bb.74:                               #   in Loop: Header=BB25_69 Depth=1
	fld.s	$fa2, $a1, 284
	fsqrt.s	$fa0, $fa0
	fdiv.s	$fa0, $fa1, $fa0
	fmul.s	$fa0, $fa0, $fa2
...
# %bb.76:                               # %.lr.ph262
	...
	b	.LBB25_78
	.p2align	4, , 16
.LBB25_77:                              #   in Loop: Header=BB25_78 Depth=1
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, 288
	addi.d	$a4, $a4, -1
	addi.d	$a0, $a0, 4
	beqz	$a4, .LBB25_81
.LBB25_78:                              # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a0, 0
	fcmp.ceq.s	$fcc0, $fa1, $fs1
	bcnez	$fcc0, .LBB25_77
# %bb.79:                               #   in Loop: Header=BB25_78 Depth=1
	fld.s	$fa1, $a3, 0
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB25_77
# %bb.80:                               #   in Loop: Header=BB25_78 Depth=1
	fld.s	$fa2, $a2, 0
	fmul.s	$fa1, $fa1, $fa2
	fst.s	$fa1, $a2, 0
	fld.s	$fa1, $a3, 0
...
.LBB25_86:                              #   in Loop: Header=BB25_84 Depth=1
	...
	fcmp.ceq.s	$fcc0, $fa0, $fs1
	bcnez	$fcc0, .LBB25_83
# %bb.87:                               #   in Loop: Header=BB25_84 Depth=1
	ld.d	$a1, $fp, 208
	add.d	$a1, $a1, $s2
	ld.d	$s0, $a1, 88
	fld.s	$fa0, $s7, 16
