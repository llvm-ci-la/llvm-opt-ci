...
# %bb.14:
	fst.s	$fa0, $a0, 0
.LBB12_15:                              # %_Z8btSetMinIfEvRT_RKS0_.exit.i
	fld.s	$fa0, $a2, 4
	fld.s	$fa1, $a0, 4
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB12_17
# %bb.16:
	fst.s	$fa0, $a0, 4
.LBB12_17:                              # %_Z8btSetMinIfEvRT_RKS0_.exit5.i
	fld.s	$fa0, $a2, 8
	fld.s	$fa1, $a0, 8
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB12_19
# %bb.18:
	fst.s	$fa0, $a0, 8
.LBB12_19:                              # %_Z8btSetMinIfEvRT_RKS0_.exit6.i
	fld.s	$fa0, $a2, 12
	fld.s	$fa1, $a0, 12
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB12_21
# %bb.20:
	fst.s	$fa0, $a0, 12
.LBB12_21:                              # %_ZN9btVector36setMinERKS_.exit
	fld.s	$fa1, $a0, 16
	fld.s	$fa0, $a3, 0
...
# %bb.22:
	fst.s	$fa0, $a0, 16
.LBB12_23:                              # %_Z8btSetMaxIfEvRT_RKS0_.exit.i
	fld.s	$fa1, $a0, 20
	fld.s	$fa0, $a3, 4
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB12_25
# %bb.24:
	fst.s	$fa0, $a0, 20
.LBB12_25:                              # %_Z8btSetMaxIfEvRT_RKS0_.exit5.i
	fld.s	$fa1, $a0, 24
	fld.s	$fa0, $a3, 8
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB12_27
# %bb.26:
	fst.s	$fa0, $a0, 24
.LBB12_27:                              # %_Z8btSetMaxIfEvRT_RKS0_.exit6.i
	fld.s	$fa1, $a0, 28
	fld.s	$fa0, $a3, 12
	fcmp.cule.s	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB12_29
# %bb.28:
	fst.s	$fa0, $a0, 28
.LBB12_29:                              # %_ZN9btVector36setMaxERKS_.exit
	ret
.Lfunc_end12:
...
.LBB15_12:
	...
	addi.d	$sp, $sp, 128
	pcaddu18i	$t8, %call36(_ZNK14btQuantizedBvh17walkStacklessTreeEP21btNodeOverlapCallbackRK9btVector3S4_)
	jr	$t8
.LBB15_13:
	addi.d	$a2, $sp, 34
	addi.d	$a3, $sp, 28
...
.LBB15_18:                              # %_ZNK14btQuantizedBvh26walkStacklessQuantizedTreeEP21btNodeOverlapCallbackPtS2_ii.exit
	ld.d	$s8, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 64                    # 8-byte Folded Reload
...
# %bb.13:                               #   in Loop: Header=BB19_5 Depth=1
	...
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB19_18
.LBB19_14:                              # %_Z20TestAabbAgainstAabb2RK9btVector3S1_S1_S1_.exit.thread
                                        #   in Loop: Header=BB19_5 Depth=1
	ld.w	$a1, $s4, 32
	move	$a0, $zero
	addi.d	$a1, $a1, 1
...
# %bb.17:                               #   in Loop: Header=BB19_5 Depth=1
	...
	b	.LBB19_4
	.p2align	4, , 16
.LBB19_18:                              # %_Z20TestAabbAgainstAabb2RK9btVector3S1_S1_S1_.exit
                                        #   in Loop: Header=BB19_5 Depth=1
	ld.w	$a1, $s4, 32
	addi.d	$a1, $a1, 1
	sltui	$a1, $a1, 1
...
# %bb.15:                               # %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit
	...
	sltui	$a1, $a1, 1
	beqz	$a0, .LBB20_18
# %bb.16:                               # %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit
                                        #   in Loop: Header=BB20_5 Depth=1
	beq	$a2, $s7, .LBB20_2
	b	.LBB20_18
	.p2align	4, , 16
.LBB20_17:                              # %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit.thread
                                        #   in Loop: Header=BB20_5 Depth=1
	ld.w	$a1, $s6, 32
	move	$a0, $zero
	addi.d	$a1, $a1, 1
...
.LBB22_2:
	...
	jirl	$ra, $ra, 0
.LBB22_3:                               # %_ZNK14btQuantizedBvh29reportBoxCastOverlappingNodexEP21btNodeOverlapCallbackRK9btVector3S4_S4_S4_.exit
	ld.d	$ra, $sp, 40                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 48
	ret
.Lfunc_end22:
...
# %bb.30:
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB26_31:                              # %_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE20initializeFromBufferEPvii.exit
	ld.w	$a0, $s0, 240
	st.d	$s2, $fp, 224
	beqz	$s1, .LBB26_35
# %bb.32:                               # %.preheader
...
.LBB26_37:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a2, $a2, 32
	blt	$a0, $a4, .LBB26_37
.LBB26_38:                              # %_ZN20btAlignedObjectArrayI16btBvhSubtreeInfoE20initializeFromBufferEPvii.exit217
	st.b	$zero, $fp, 232
	st.d	$zero, $fp, 224
	st.d	$zero, $fp, 212
	ori	$a0, $zero, 1
