...
.LBB8_22:
                                        ...
                                        # implicit-def: $f0
                                        # kill: killed $f0
.LBB8_23:                               # %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit
	ld.d	$a1, $fp, 8
	ld.w	$a1, $a1, 728
	ld.w	$a2, $s1, 152
	addi.d	$a4, $s2, 56
...
.LBB8_46:
	...
	st.d	$zero, $sp, 168
	movgr2fr.w	$fa5, $zero
.LBB8_47:                               # %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit.i
	fadd.s	$fa2, $fa2, $ft1
	fadd.s	$fa3, $fa3, $ft2
	fadd.s	$fa4, $fa4, $ft3
	fmul.s	$ft0, $fa6, $ft0
...
.LBB8_50:
	...
	ld.w	$a1, $a0, 728
	beqz	$a1, .LBB8_52
# %bb.51:                               # %_ZN16btManifoldResult20refreshContactPointsEv.exit.sink.split
	ld.d	$a1, $a0, 712
	ld.d	$a2, $fp, 144
	xor	$a1, $a1, $a2
	sltui	$a1, $a1, 1
	...
	jirl	$ra, $ra, 0
.LBB8_52:                               # %_ZN16btManifoldResult20refreshContactPointsEv.exit
...
.Lfunc_end8:
	...
	.p2align	4, 0x0                          # -- Begin function _ZN30btConvexSeparatingDistanceUtil24updateSeparatingDistanceERK11btTransformS2_
.LCPI9_0:
	.dword	32                              # 0x20
	.dword	0                               # 0x0
...
# %bb.1:
	...
	vfcmp.cune.s	$vr1, $vr3, $vr1
	vmskltz.w	$vr1, $vr1
	vpickve2gr.hu	$a0, $vr1, 0
	vpickev.w	$vr10, $vr2, $vr0
	fmov.s	$fa4, $fs0
	fmov.s	$ft3, $fs0
	fmov.s	$fs6, $fs0
	beqz	$a0, .LBB9_3
# %bb.2:                                # %_ZNK10btQuadWordneERKS_.exit.thread.i
	addi.d	$a1, $sp, 48
	addi.d	$a2, $sp, 80
	addi.d	$a3, $sp, 76
	move	$a0, $fp
	...
	fmul.s	$ft3, $fa1, $fa2
	fmul.s	$fa4, $fa1, $fa3
.LBB9_3:                                # %_ZN15btTransformUtil27calculateVelocityQuaternionERK9btVector3S2_RK12btQuaternionS5_fRS0_S6_.exit
	fsub.s	$fa7, $fs4, $fs5
	fsub.s	$ft0, $fs3, $fs7
	fld.s	$fa0, $s0, 48
	fld.s	$fa1, $fp, 48
	...
	fmov.s	$fa1, $fs0
	beqz	$a0, .LBB9_5
# %bb.4:                                # %_ZNK10btQuadWordneERKS_.exit.thread.i37
	addi.d	$a0, $fp, 16
	addi.d	$a1, $sp, 32
	addi.d	$a2, $sp, 80
	addi.d	$a3, $sp, 76
	...
	fmul.s	$fa2, $fa1, $fa2
	fmul.s	$fa1, $fa1, $fa3
.LBB9_5:                                # %_ZN15btTransformUtil27calculateVelocityQuaternionERK9btVector3S2_RK12btQuaternionS5_fRS0_S6_.exit45
	fmul.s	$fa3, $ft3, $ft3
	fmadd.s	$fa3, $fs6, $fs6, $fa3
