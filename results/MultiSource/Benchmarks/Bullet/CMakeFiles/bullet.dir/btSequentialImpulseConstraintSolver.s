...
.LBB21_96:                              # %vector.body465
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_96
# %bb.97:                               # %middle.block470
	beq	$a2, $a1, .LBB21_100
.LBB21_98:                              # %scalar.ph460.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s0, 2
	.p2align	4, , 16
.LBB21_99:                              # %scalar.ph460
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
...
.LBB21_112:                             # %vector.body478
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB21_112
# %bb.113:                              # %middle.block481
	beq	$a0, $fp, .LBB21_116
.LBB21_114:                             # %scalar.ph473.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $fp, $a0
	.p2align	4, , 16
.LBB21_115:                             # %scalar.ph473
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $a2, -1
...
.LBB21_120:                             # %vector.body489
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB21_120
# %bb.121:                              # %middle.block495
	beq	$a0, $s1, .LBB21_124
.LBB21_122:                             # %scalar.ph484.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $s1, $a0
	.p2align	4, , 16
.LBB21_123:                             # %scalar.ph484
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $a2, -1
