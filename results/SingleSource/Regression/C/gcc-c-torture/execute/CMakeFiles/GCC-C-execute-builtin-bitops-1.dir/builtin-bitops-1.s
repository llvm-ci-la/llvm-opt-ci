...
# %bb.0:
	...
	vld	$vr7, $a1, %pc_lo12(.LCPI11_16)
	pcalau12i	$a1, %pc_hi20(.LCPI11_17)
	vld	$vr9, $a1, %pc_lo12(.LCPI11_17)
	...
	vld	$vr9, $a1, %pc_lo12(.LCPI11_24)
	pcalau12i	$a1, %pc_hi20(.LCPI11_25)
	vld	$vr12, $a1, %pc_lo12(.LCPI11_25)
	pcalau12i	$a1, %pc_hi20(.LCPI11_26)
	vld	$vr14, $a1, %pc_lo12(.LCPI11_26)
	pcalau12i	$a1, %pc_hi20(.LCPI11_27)
	vld	$vr16, $a1, %pc_lo12(.LCPI11_27)
	vsrl.d	$vr9, $vr0, $vr9
	vsrl.d	$vr12, $vr0, $vr12
	vsrl.d	$vr14, $vr0, $vr14
	vsrl.d	$vr0, $vr0, $vr16
...
# %bb.0:
	...
	vld	$vr7, $a1, %pc_lo12(.LCPI17_16)
	pcalau12i	$a1, %pc_hi20(.LCPI17_17)
	vld	$vr9, $a1, %pc_lo12(.LCPI17_17)
	...
	vld	$vr9, $a1, %pc_lo12(.LCPI17_24)
	pcalau12i	$a1, %pc_hi20(.LCPI17_25)
	vld	$vr12, $a1, %pc_lo12(.LCPI17_25)
	pcalau12i	$a1, %pc_hi20(.LCPI17_26)
	vld	$vr14, $a1, %pc_lo12(.LCPI17_26)
	pcalau12i	$a1, %pc_hi20(.LCPI17_27)
	vld	$vr16, $a1, %pc_lo12(.LCPI17_27)
	vsrl.d	$vr9, $vr0, $vr9
	vsrl.d	$vr12, $vr0, $vr12
	vsrl.d	$vr14, $vr0, $vr14
	vsrl.d	$vr0, $vr0, $vr16
...
# %bb.7:                                #   in Loop: Header=BB18_1 Depth=1
	...
	vsrl.w	$vr4, $vr0, $vr4
	vld	$vr5, $sp, 544                  # 16-byte Folded Reload
	vsrl.w	$vr5, $vr0, $vr5
	vld	$vr6, $sp, 528                  # 16-byte Folded Reload
	vsrl.w	$vr6, $vr0, $vr6
	vld	$vr7, $sp, 512                  # 16-byte Folded Reload
	vsrl.w	$vr0, $vr0, $vr7
...
# %bb.9:                                # %.preheader956.preheader
	...
	vst	$vr19, $sp, 512                 # 16-byte Folded Spill
	vst	$vr20, $sp, 496                 # 16-byte Folded Spill
	.p2align	4, , 16
...
# %bb.41:                               #   in Loop: Header=BB18_10 Depth=1
	vst	$vr21, $sp, 544                 # 16-byte Folded Spill
	vldi	$vr0, 0
...
# %bb.42:                               #   in Loop: Header=BB18_10 Depth=1
	...
	vsrl.d	$vr6, $vr19, $vr0
	vsrl.d	$vr7, $vr19, $vr22
	vsrl.d	$vr8, $vr19, $vr23
...
# %bb.43:                               #   in Loop: Header=BB18_10 Depth=1
	addi.d	$s6, $s6, 1
	vld	$vr18, $sp, 528                 # 16-byte Folded Reload
	vld	$vr19, $sp, 512                 # 16-byte Folded Reload
	vld	$vr20, $sp, 496                 # 16-byte Folded Reload
	ori	$a0, $zero, 13
	bne	$s6, $a0, .LBB18_10
...
.LBB18_45:                              # %.preheader952
	...
	vreplgr2vr.d	$vr0, $fp
	vst	$vr0, $sp, 608                  # 16-byte Folded Spill
	vst	$vr17, $sp, 80                  # 16-byte Folded Spill
...
.LBB18_47:                              # %vector.body1139
	...
	vsll.d	$vr14, $vr19, $vr6
	vsll.d	$vr15, $vr19, $vr7
	vld	$vr21, $sp, 608                 # 16-byte Folded Reload
	vand.v	$vr16, $vr8, $vr21
	vand.v	$vr9, $vr9, $vr21
	vand.v	$vr10, $vr10, $vr21
	vand.v	$vr11, $vr11, $vr21
...
.LBB18_53:                              # %vector.body1127
	...
	vsrl.d	$vr15, $vr8, $vr6
	vsrl.d	$vr8, $vr8, $vr7
	vld	$vr16, $sp, 608                 # 16-byte Folded Reload
	vand.v	$vr9, $vr9, $vr16
...
# %bb.76:                               #   in Loop: Header=BB18_45 Depth=1
	vst	$vr31, $sp, 160                 # 16-byte Folded Spill
	vst	$vr30, $sp, 176                 # 16-byte Folded Spill
	vst	$vr29, $sp, 192                 # 16-byte Folded Spill
	vst	$vr28, $sp, 208                 # 16-byte Folded Spill
	vst	$vr27, $sp, 224                 # 16-byte Folded Spill
	vst	$vr26, $sp, 240                 # 16-byte Folded Spill
	vst	$vr25, $sp, 256                 # 16-byte Folded Spill
	vst	$vr24, $sp, 272                 # 16-byte Folded Spill
	vst	$vr23, $sp, 288                 # 16-byte Folded Spill
	vst	$vr22, $sp, 304                 # 16-byte Folded Spill
	vldi	$vr0, 0
	vinsgr2vr.d	$vr0, $fp, 0
	vpcnt.d	$vr0, $vr0
...
# %bb.77:                               #   in Loop: Header=BB18_45 Depth=1
	...
	vld	$vr18, $sp, 608                 # 16-byte Folded Reload
	vsrl.d	$vr0, $vr18, $vr0
	vld	$vr22, $sp, 304                 # 16-byte Folded Reload
	vsrl.d	$vr1, $vr18, $vr22
	vld	$vr23, $sp, 288                 # 16-byte Folded Reload
	vsrl.d	$vr2, $vr18, $vr23
	vld	$vr24, $sp, 272                 # 16-byte Folded Reload
	...
	vsrl.d	$vr13, $vr18, $vr13
	vpickev.w	$vr5, $vr13, $vr5
	vpickev.w	$vr1, $vr3, $vr1
	vld	$vr3, $sp, 368                  # 16-byte Folded Reload
	vsrl.d	$vr3, $vr18, $vr3
	vld	$vr13, $sp, 352                 # 16-byte Folded Reload
	vsrl.d	$vr13, $vr18, $vr13
	vpickev.w	$vr3, $vr13, $vr3
