...
# %bb.3:                                # %vector.ph20
	...
	st.w	$a7, $a1, 120
	st.w	$t0, $a1, 124
	vxor.v	$vr17, $vr13, $vr6
	vxor.v	$vr18, $vr14, $vr6
	vld	$vr15, $a1, 32
	vld	$vr16, $a1, 48
	vst	$vr17, $a1, 128
	vst	$vr18, $a1, 144
	vxor.v	$vr19, $vr15, $vr6
	vxor.v	$vr20, $vr16, $vr6
	vld	$vr17, $a1, 64
	vld	$vr18, $a1, 80
	vst	$vr19, $a1, 160
	vst	$vr20, $a1, 176
	vxor.v	$vr21, $vr17, $vr6
	vxor.v	$vr22, $vr18, $vr6
	vld	$vr19, $a1, 96
	vld	$vr20, $a1, 112
	vst	$vr21, $a1, 192
	vst	$vr22, $a1, 208
	vxor.v	$vr23, $vr19, $vr6
	vxor.v	$vr24, $vr20, $vr6
	vld	$vr21, $a1, 0
	vld	$vr22, $a1, 16
	vst	$vr23, $a1, 224
	vst	$vr24, $a1, 240
	vxor.v	$vr25, $vr21, $vr7
	vxor.v	$vr26, $vr22, $vr7
	vld	$vr23, $a1, 32
	vld	$vr24, $a1, 48
	vst	$vr25, $a1, 256
	vst	$vr26, $a1, 272
	vxor.v	$vr27, $vr23, $vr7
	vxor.v	$vr28, $vr24, $vr7
	vld	$vr25, $a1, 64
	vld	$vr26, $a1, 80
	vst	$vr27, $a1, 288
	vst	$vr28, $a1, 304
	vxor.v	$vr29, $vr25, $vr7
	vxor.v	$vr30, $vr26, $vr7
	vld	$vr27, $a1, 96
	vld	$vr28, $a1, 112
	vst	$vr29, $a1, 320
	vst	$vr30, $a1, 336
	vxor.v	$vr29, $vr27, $vr7
	vxor.v	$vr30, $vr28, $vr7
	vst	$vr29, $a1, 352
	vst	$vr30, $a1, 368
	vxor.v	$vr29, $vr13, $vr8
	vxor.v	$vr30, $vr14, $vr8
	vst	$vr29, $a1, 384
	vst	$vr30, $a1, 400
	vxor.v	$vr29, $vr15, $vr8
	vxor.v	$vr30, $vr16, $vr8
	vst	$vr29, $a1, 416
	vst	$vr30, $a1, 432
	vxor.v	$vr29, $vr17, $vr8
	vxor.v	$vr30, $vr18, $vr8
	vst	$vr29, $a1, 448
	vst	$vr30, $a1, 464
	vxor.v	$vr29, $vr19, $vr8
	vxor.v	$vr30, $vr20, $vr8
	vld	$vr31, $a1, 0
	vst	$vr29, $a1, 480
	vst	$vr30, $a1, 496
	vld	$vr29, $a1, 16
	vxor.v	$vr30, $vr31, $vr9
	vst	$vr30, $a1, 512
	vld	$vr30, $a1, 32
	vld	$vr31, $a1, 48
	vxor.v	$vr29, $vr29, $vr9
	vst	$vr29, $a1, 528
	vxor.v	$vr29, $vr30, $vr9
	vxor.v	$vr30, $vr31, $vr9
	vld	$vr31, $a1, 64
	vst	$vr29, $a1, 544
	vst	$vr30, $a1, 560
	...
	vst	$vr29, $a1, 608
	vst	$vr30, $a1, 624
	vxor.v	$vr29, $vr13, $vr10
	vxor.v	$vr30, $vr14, $vr10
	vst	$vr29, $a1, 640
	vst	$vr30, $a1, 656
	vxor.v	$vr29, $vr15, $vr10
	vxor.v	$vr30, $vr16, $vr10
	vst	$vr29, $a1, 672
	vst	$vr30, $a1, 688
	vxor.v	$vr29, $vr17, $vr10
	vxor.v	$vr30, $vr18, $vr10
	vst	$vr29, $a1, 704
	vst	$vr30, $a1, 720
	vxor.v	$vr29, $vr19, $vr10
	vxor.v	$vr30, $vr20, $vr10
	vst	$vr29, $a1, 736
	vst	$vr30, $a1, 752
	vxor.v	$vr21, $vr21, $vr11
	vxor.v	$vr22, $vr22, $vr11
	vst	$vr21, $a1, 768
	vst	$vr22, $a1, 784
	vxor.v	$vr21, $vr23, $vr11
	vxor.v	$vr22, $vr24, $vr11
	vst	$vr21, $a1, 800
	vst	$vr22, $a1, 816
	vxor.v	$vr21, $vr25, $vr11
	vxor.v	$vr22, $vr26, $vr11
	vst	$vr21, $a1, 832
	vst	$vr22, $a1, 848
	vxor.v	$vr21, $vr27, $vr11
	vxor.v	$vr22, $vr28, $vr11
	vst	$vr21, $a1, 864
	vst	$vr22, $a1, 880
	...
	vst	$vr13, $a1, 896
	vst	$vr14, $a1, 912
	vxor.v	$vr13, $vr15, $vr12
	vxor.v	$vr14, $vr16, $vr12
	vst	$vr13, $a1, 928
	vst	$vr14, $a1, 944
	vxor.v	$vr13, $vr17, $vr12
	vxor.v	$vr14, $vr18, $vr12
	vst	$vr13, $a1, 960
	vst	$vr14, $a1, 976
	vxor.v	$vr13, $vr19, $vr12
	vxor.v	$vr14, $vr20, $vr12
	vst	$vr13, $a1, 992
	vst	$vr14, $a1, 1008
	b	.LBB0_1
.LBB0_4:
