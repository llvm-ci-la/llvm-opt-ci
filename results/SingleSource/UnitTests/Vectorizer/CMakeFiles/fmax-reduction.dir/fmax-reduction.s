...
.Ltmp227:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp228:                               # EH_LABEL
.LBB1_23:                               # %_ZNSt14_Function_baseD2Ev.exit224
	addi.d	$a0, $fp, 16
	ori	$a1, $zero, 2048
	.p2align	4, , 16
.LBB1_24:                               # %vector.body
...
.Ltmp254:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp255:                               # EH_LABEL
.LBB1_36:                               # %vector.body835.preheader
	lu12i.w	$a0, -1
	lu12i.w	$a1, 522239
	ori	$a1, $a1, 4095
	vreplgr2vr.w	$vr0, $a1
...
.Ltmp281:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp282:                               # EH_LABEL
.LBB1_49:                               # %vector.body841.preheader
	lu12i.w	$a0, -1
	lu12i.w	$a1, 2048
	vreplgr2vr.w	$vr0, $a1
	.p2align	4, , 16
.LBB1_50:                               # %vector.body841
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $fp, $a0
	vstx	$vr0, $a1, $s2
	addi.d	$a0, $a0, 32
...
.LBB1_87:                               # %_ZNSt14_Function_baseD2Ev.exit344
	...
	addi.d	$s6, $s6, 1
	beq	$s6, $s7, .LBB1_101
.LBB1_88:                               # %vector.ph853
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB1_89 Depth 2
	move	$a0, $s4
	vld	$vr0, $sp, 48                   # 16-byte Folded Reload
	.p2align	4, , 16
.LBB1_89:                               # %vector.body854
