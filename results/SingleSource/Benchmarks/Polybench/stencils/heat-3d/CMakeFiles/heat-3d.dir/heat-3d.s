...
.LBB7_23:                               # %vector.body56
	...
	vfadd.d	$vr4, $vr4, $vr6
	vfmadd.d	$vr6, $vr5, $vr2, $vr7
	vfadd.d	$vr6, $vr6, $vr8
	vld	$vr7, $a6, 968
	vld	$vr8, $a6, 952
	vfmul.d	$vr6, $vr6, $vr3
	vfmadd.d	$vr4, $vr4, $vr3, $vr6
	vfmadd.d	$vr6, $vr5, $vr2, $vr7
	vfadd.d	$vr6, $vr6, $vr8
	vfmadd.d	$vr4, $vr6, $vr3, $vr4
	vfadd.d	$vr4, $vr5, $vr4
	vstx	$vr4, $s6, $t6
	addi.d	$t6, $t6, 16
	bne	$t6, $t4, .LBB7_23
	b	.LBB7_20
	.p2align	4, , 16
.LBB7_24:                               # %.preheader114.i.preheader
