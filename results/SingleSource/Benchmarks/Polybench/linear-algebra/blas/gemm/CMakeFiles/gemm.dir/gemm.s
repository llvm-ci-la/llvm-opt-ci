...
.LBB7_14:                               # %vector.body
	...
	bnez	$t5, .LBB7_14
	b	.LBB7_9
.LBB7_15:                               # %.preheader51.i.preheader
	move	$a5, $zero
...
.LBB7_29:                               # %.preheader.i39
	...
	alsl.d	$t5, $t2, $t1, 3
	beqz	$t3, .LBB7_32
# %bb.30:                               # %scalar.ph125.preheader
                                        #   in Loop: Header=BB7_29 Depth=2
	move	$t6, $a5
	.p2align	4, , 16
.LBB7_31:                               # %scalar.ph125
                                        #   Parent Loop BB7_25 Depth=1
	...
	b	.LBB7_28
	.p2align	4, , 16
.LBB7_32:                               # %vector.body127.preheader
                                        #   in Loop: Header=BB7_29 Depth=2
	fld.d	$fa2, $t5, 0
	fmul.d	$fa2, $fa2, $fa1
...
# %bb.38:                               # %.preheader28.i45
	...
	b	.LBB7_40
	.p2align	4, , 16
.LBB7_39:                               # %middle.block169
                                        #   in Loop: Header=BB7_40 Depth=2
	addi.d	$t2, $t2, 1
	add.d	$t4, $t4, $s4
	beq	$t2, $a6, .LBB7_35
.LBB7_40:                               # %.preheader.i46
                                        #   Parent Loop BB7_36 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB7_44 Depth 3
                                        #       Child Loop BB7_42 Depth 3
	alsl.d	$t5, $t2, $t1, 3
	beqz	$t3, .LBB7_43
# %bb.41:                               # %scalar.ph158.preheader
                                        #   in Loop: Header=BB7_40 Depth=2
	move	$t6, $a5
	.p2align	4, , 16
.LBB7_42:                               # %scalar.ph158
                                        #   Parent Loop BB7_36 Depth=1
	...
	b	.LBB7_39
	.p2align	4, , 16
.LBB7_43:                               # %vector.body160.preheader
                                        #   in Loop: Header=BB7_40 Depth=2
	fld.d	$fa2, $t5, 0
	fmul.d	$fa2, $fa2, $fa1
	vreplvei.d	$vr2, $vr2, 0
...
# %bb.50:                               # %check_FP.exit
	...
	vld	$vr5, $a0, %pc_lo12(.LCPI7_3)
	pcalau12i	$a0, %pc_hi20(.LCPI7_4)
	vld	$vr6, $a0, %pc_lo12(.LCPI7_4)
	pcalau12i	$a0, %pc_hi20(.LCPI7_5)
	vld	$vr7, $a0, %pc_lo12(.LCPI7_5)
	pcalau12i	$a0, %pc_hi20(.LCPI7_6)
	vld	$vr8, $a0, %pc_lo12(.LCPI7_6)
	stx.b	$zero, $s3, $s5
	lu12i.w	$a0, -5
	ori	$a0, $a0, 2880
