...
.LBB7_10:                               # =>This Loop Header: Depth=1
	...
	move	$a4, $a5
	bltu	$a2, $a5, .LBB7_9
# %bb.11:                               # %.lr.ph134.split.us.preheader.i
                                        #   in Loop: Header=BB7_10 Depth=1
	move	$a5, $zero
	addi.d	$a6, $a4, 1
	mul.d	$a7, $a4, $s3
	...
	b	.LBB7_13
	.p2align	4, , 16
.LBB7_12:                               # %._crit_edge.us.i
                                        #   in Loop: Header=BB7_13 Depth=2
	addi.d	$t2, $t2, 1
	addi.d	$a5, $a5, 1
	addi.d	$t1, $t1, 4
	beq	$t2, $a1, .LBB7_9
.LBB7_13:                               # %.lr.ph134.split.us.i
...
.LBB7_16:                               # %.lr.ph.us.i
	...
	bnez	$t7, .LBB7_16
	b	.LBB7_12
.LBB7_17:                               # %vector.body96.preheader
...
.LBB7_18:                               # %vector.body96
	...
	vadd.d	$vr0, $vr0, $vr11
	bnez	$a0, .LBB7_18
# %bb.19:                               # %vec.epilog.vector.body110
	stptr.w	$s8, $fp, 2496
	move	$a0, $s1
	move	$a1, $zero
	move	$a2, $s2
...
.LBB7_21:                               # =>This Loop Header: Depth=1
	...
	move	$a4, $a5
	bltu	$a2, $a5, .LBB7_20
# %bb.22:                               # %.lr.ph134.split.us.preheader.i37
                                        #   in Loop: Header=BB7_21 Depth=1
	move	$a5, $zero
	addi.d	$a6, $a4, 1
	mul.d	$a7, $a4, $s3
	...
	b	.LBB7_24
	.p2align	4, , 16
.LBB7_23:                               # %._crit_edge.us.i45
                                        #   in Loop: Header=BB7_24 Depth=2
	addi.d	$t2, $t2, 1
	addi.d	$a5, $a5, 1
	addi.d	$t1, $t1, 4
	beq	$t2, $a1, .LBB7_20
.LBB7_24:                               # %.lr.ph134.split.us.i38
...
# %bb.33:                               # %check_FP.exit
	...
	vld	$vr5, $a1, %pc_lo12(.LCPI7_9)
	pcalau12i	$a1, %pc_hi20(.LCPI7_10)
	vld	$vr6, $a1, %pc_lo12(.LCPI7_10)
	pcalau12i	$a1, %pc_hi20(.LCPI7_11)
	vld	$vr7, $a1, %pc_lo12(.LCPI7_11)
	pcalau12i	$a1, %pc_hi20(.LCPI7_12)
	vld	$vr8, $a1, %pc_lo12(.LCPI7_12)
	move	$s2, $a0
	ori	$s4, $s4, 3136
	stx.b	$zero, $a0, $s4
	pcalau12i	$a0, %got_pc_hi20(stderr)
