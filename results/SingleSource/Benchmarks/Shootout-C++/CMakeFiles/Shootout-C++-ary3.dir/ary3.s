...
.LBB0_3:                                # %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i.thread
	...
	slli.d	$s3, $s6, 2
	beqz	$s6, .LBB0_5
# %bb.4:                                # %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i
	addi.d	$a0, $fp, 4
	move	$a1, $zero
	move	$a2, $s3
...
# %bb.6:                                # %.noexc34
	...
	addi.d	$s1, $a0, 4
	beqz	$s6, .LBB0_9
# %bb.7:                                # %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i29
	move	$a0, $s1
	move	$a1, $zero
	move	$a2, $s3
	pcaddu18i	$ra, %call36(memset)
...
.LBB0_8:
	...
	move	$s5, $zero
	move	$s1, $zero
.LBB0_9:                                # %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit35
	addi.w	$a0, $s2, 0
...
.LBB0_19:                               # %.preheader
	...
	blez	$a0, .LBB0_18
# %bb.20:                               # %.lr.ph92.preheader
                                        #   in Loop: Header=BB0_19 Depth=1
	move	$t5, $a1
	beq	$a0, $t1, .LBB0_24
# %bb.21:                               # %vector.body107.preheader
                                        #   in Loop: Header=BB0_19 Depth=1
	move	$t3, $a6
	move	$t4, $a5
	move	$t5, $a3
...
.LBB0_22:                               # %vector.body107
	...
	addi.d	$t3, $t3, -8
	bnez	$t5, .LBB0_22
# %bb.23:                               # %middle.block110
                                        #   in Loop: Header=BB0_19 Depth=1
	move	$t5, $a4
	beq	$a3, $a1, .LBB0_18
.LBB0_24:                               # %.lr.ph92.preheader113
                                        #   in Loop: Header=BB0_19 Depth=1
	addi.d	$t3, $t5, 1
	alsl.d	$t4, $t5, $a7, 2
	alsl.d	$t5, $t5, $t0, 2
...
.Ltmp11:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp12:                                # EH_LABEL
.LBB0_34:                               # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i
.Ltmp13:                                # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s1
...
.Ltmp15:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp16:                                # EH_LABEL
# %bb.36:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit
	sub.d	$a1, $s5, $s0
	move	$a0, $s0
...
# %bb.37:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_38:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit39
	move	$a0, $zero
...
.LBB0_44:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_45:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit43
	move	$a0, $s1
