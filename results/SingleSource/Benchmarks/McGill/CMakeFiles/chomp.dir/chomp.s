...
.LBB14_13:                              # %vector.body135
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB14_13
# %bb.14:                               # %middle.block138
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a2, $a0, .LBB14_17
.LBB14_15:                              # %scalar.ph128.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
	sub.d	$a3, $a0, $a2
	alsl.d	$a2, $a2, $s3, 2
	.p2align	4, , 16
.LBB14_16:                              # %scalar.ph128
                                        #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a1, $a2, 0
...
# %bb.27:                               # %middle.block
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a1, $s2, .LBB14_30
.LBB14_28:                              # %.lr.ph.i42.preheader143
                                        #   in Loop: Header=BB14_8 Depth=2
...
# %bb.0:
	...
	ld.w	$s6, $a1, %pc_lo12(nrow)
	st.d	$zero, $a0, 8
	beqz	$s6, .LBB16_35
# %bb.1:                                # %.preheader.lr.ph
	pcalau12i	$a1, %pc_hi20(ncol)
	ld.wu	$s3, $a1, %pc_lo12(ncol)
	move	$a2, $a0
	move	$s0, $zero
	addi.w	$s4, $s3, 0
	slli.d	$s5, $s4, 2
...
.LBB16_11:                              # %vector.body107
	...
	addi.d	$a3, $a3, 32
	bnez	$a2, .LBB16_11
# %bb.12:                               # %middle.block110
                                        #   in Loop: Header=BB16_6 Depth=2
	move	$a5, $s1
	beq	$s8, $a1, .LBB16_16
.LBB16_13:                              # %scalar.ph100.preheader
                                        #   in Loop: Header=BB16_6 Depth=2
	alsl.d	$a2, $a1, $a0, 2
	.p2align	4, , 16
.LBB16_14:                              # %scalar.ph100
                                        #   Parent Loop BB16_4 Depth=1
                                        #     Parent Loop BB16_6 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$s6, $a2, 0
...
.LBB16_19:                              # %vector.body93
	...
	addi.d	$a5, $a5, 32
	bnez	$a4, .LBB16_19
# %bb.20:                               # %middle.block97
                                        #   in Loop: Header=BB16_6 Depth=2
	beq	$a2, $a3, .LBB16_23
.LBB16_21:                              # %.lr.ph15.i.preheader
                                        #   in Loop: Header=BB16_6 Depth=2
	sub.d	$a2, $s3, $a1
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
...
# %bb.26:                               # %middle.block
	...
	beq	$a2, $s4, .LBB16_29
.LBB16_27:                              # %.lr.ph.i28.preheader113
                                        #   in Loop: Header=BB16_6 Depth=2
...
.LBB16_28:                              # %.lr.ph.i28
	...
	addi.d	$a3, $a3, -4
	bnez	$a1, .LBB16_28
.LBB16_29:                              # %melt_data.exit.loopexit.preheader
                                        #   in Loop: Header=BB16_6 Depth=2
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	move	$a1, $s7
	.p2align	4, , 16
.LBB16_30:                              # %melt_data.exit.loopexit
                                        #   Parent Loop BB16_4 Depth=1
                                        #     Parent Loop BB16_6 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	beq	$a1, $s2, .LBB16_2
# %bb.31:                               #   in Loop: Header=BB16_30 Depth=3
	...
	addi.d	$a2, $a2, -4
	beq	$a3, $a4, .LBB16_30
# %bb.32:                               # %equal_data.exit
                                        #   in Loop: Header=BB16_6 Depth=2
	blez	$a1, .LBB16_2
# %bb.33:                               #   in Loop: Header=BB16_6 Depth=2
	move	$s3, $a0
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	...
	bne	$s1, $a0, .LBB16_6
	b	.LBB16_3
.LBB16_34:                              # %._crit_edge46.loopexit
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	ld.d	$fp, $a0, 8
	b	.LBB16_36
.LBB16_35:
