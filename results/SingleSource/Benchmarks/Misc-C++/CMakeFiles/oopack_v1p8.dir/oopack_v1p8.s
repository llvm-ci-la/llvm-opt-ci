...
.LBB18_5:                               # %.lr.ph.i17
	...
	addi.w	$s1, $s1, -1
	bnez	$s1, .LBB18_5
.LBB18_6:                               # %_ZNK9Benchmark8time_oneEMS_KFvvEiRdS2_S2_.exit20
	pcaddu18i	$ra, %call36(clock)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s0, 0
	ld.d	$a4, $a0, 32
...
# %bb.3:
	...
	ori	$s6, $zero, 5
	pcalau12i	$s7, %pc_hi20(_ZN9Benchmark5countE)
	pcalau12i	$a0, %pc_hi20(_ZN9Benchmark4listE)
	addi.d	$s1, $a0, %pc_lo12(_ZN9Benchmark4listE)
	b	.LBB20_5
	.p2align	4, , 16
...
# %bb.6:                                #   in Loop: Header=BB20_5 Depth=1
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s7, %pc_lo12(_ZN9Benchmark5countE)
	blez	$a1, .LBB20_13
...
# %bb.9:                                #   in Loop: Header=BB20_8 Depth=2
	ld.w	$a0, $s7, %pc_lo12(_ZN9Benchmark5countE)
	addi.d	$s5, $s5, 1
	addi.d	$s8, $s8, 8
	blt	$s5, $a0, .LBB20_8
	b	.LBB20_13
	.p2align	4, , 16
.LBB20_10:                              # %_ZN9Benchmark4findEPKc.exit
                                        #   in Loop: Header=BB20_5 Depth=1
	ld.d	$a0, $s8, 0
	beqz	$a0, .LBB20_13
...
.LBB20_12:
	...
	addi.d	$sp, $sp, 224
	ret
.LBB20_13:                              # %_ZN9Benchmark4findEPKc.exit.thread
