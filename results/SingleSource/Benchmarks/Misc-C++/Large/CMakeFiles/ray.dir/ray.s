...
.LBB7_16:                               # %_ZNSt7__cxx114listIP5SceneSaIS2_EEC2ERKS4_.exit
	...
	st.d	$zero, $fp, 64
	beq	$s0, $s3, .LBB7_21
# %bb.17:                               # %.lr.ph.i.i.i30.preheader
	addi.d	$s2, $sp, 48
	.p2align	4, , 16
.LBB7_18:                               # %.lr.ph.i.i.i30
                                        # =>This Inner Loop Header: Depth=1
.Ltmp26:                                # EH_LABEL
	ori	$a0, $zero, 24
	pcaddu18i	$ra, %call36(_Znwm)
...
# %bb.19:                               # %.noexc.i.i
	...
	st.d	$a0, $fp, 64
	bne	$s0, $s2, .LBB7_18
# %bb.20:                               # %_ZN5GroupC2E6SphereNSt7__cxx114listIP5SceneSaIS4_EEE.exit.loopexit
	ld.d	$s0, $sp, 48
...
.Ltmp28:                                # EH_LABEL
	...
	move	$s0, $a0
	beq	$a1, $s1, .LBB7_32
# %bb.30:                               # %.lr.ph.i.i.i.i.preheader
	move	$a0, $a1
	.p2align	4, , 16
.LBB7_31:                               # %.lr.ph.i.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s2, $a0, 0
	ori	$a1, $zero, 24
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB7_39:                               # %.lr.ph.i.i47
	...
	move	$a0, $s1
	bne	$s1, $fp, .LBB7_39
.LBB7_40:                               # %_ZNSt7__cxx1110_List_baseIP5SceneSaIS2_EED2Ev.exit50
	move	$a0, $s0
...
.LCPI9_0:
	...
	.dword	0xbfe9a8365810363f              # double -0.80178372573727319
.LCPI9_1:
...
.LBB9_8:                                # %.preheader
	...
	addi.d	$a1, $sp, 112
	move	$a2, $fp
	pcaddu18i	$ra, %call36(_Z9ray_traceRK3VecRK3RayRK5Scene)
	jirl	$ra, $ra, 0
	fadd.d	$fs5, $fs5, $fa0
...
.LBB11_4:                               # %_ZNK6Sphere10ray_sphereERK3Ray.exit
	fld.d	$fa1, $a2, 0
...
.LBB14_3:                               # %.split
	...
	fsel	$fa0, $fa1, $fa2, $fcc0
.LBB14_4:                               # %_ZNK6Sphere10ray_sphereERK3Ray.exit
	fld.d	$fa1, $a2, 0
	fcmp.cult.d	$fcc0, $fa0, $fa1
	bceqz	$fcc0, .LBB14_9
# %bb.5:
