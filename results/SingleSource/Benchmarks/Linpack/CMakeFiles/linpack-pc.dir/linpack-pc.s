...
# %bb.33:                               # %middle.block750
	...
	move	$t8, $s1
	beq	$a2, $a1, .LBB6_27
.LBB6_34:                               # %scalar.ph693.preheader
                                        #   in Loop: Header=BB6_28 Depth=1
	slli.d	$fp, $a0, 2
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	sub.d	$s0, $a1, $a0
...
.LBB6_42:                               # %vector.memcheck458
	...
	move	$s8, $zero
	bnez	$a4, .LBB6_80
# %bb.43:                               # %vector.memcheck458
	addi.d	$a4, $t5, 4
	sltu	$a4, $s6, $a4
	sltu	$s5, $t5, $s7
	and	$a4, $a4, $s5
	bnez	$a4, .LBB6_80
# %bb.44:                               # %vector.memcheck458
	addi.d	$a4, $t4, 4
	sltu	$a4, $s6, $a4
	sltu	$s5, $t4, $s7
	and	$a4, $a4, $s5
	bnez	$a4, .LBB6_80
# %bb.45:                               # %vector.memcheck458
	addi.d	$a4, $t3, 4
	sltu	$a4, $s6, $a4
	sltu	$s5, $t3, $s7
	and	$a4, $a4, $s5
	bnez	$a4, .LBB6_80
# %bb.46:                               # %vector.memcheck458
	addi.d	$a4, $t2, 4
	sltu	$a4, $s6, $a4
	sltu	$s5, $t2, $s7
	and	$a4, $a4, $s5
	bnez	$a4, .LBB6_80
# %bb.47:                               # %vector.memcheck458
	addi.d	$a4, $t1, 4
	sltu	$a4, $s6, $a4
	sltu	$s5, $t1, $s7
	and	$a4, $a4, $s5
	bnez	$a4, .LBB6_80
# %bb.48:                               # %vector.memcheck458
	addi.d	$a4, $t0, 4
	sltu	$a4, $s6, $a4
	sltu	$s5, $t0, $s7
	and	$a4, $a4, $s5
...
.LBB6_59:                               # %vector.body544
	...
	addi.d	$a0, $a0, 16
	bne	$a1, $a0, .LBB6_59
# %bb.60:                               # %middle.block572
	bne	$s8, $s6, .LBB6_23
	b	.LBB6_25
.LBB6_61:                               # %vector.memcheck393
	alsl.d	$fp, $t1, $s5, 2
	addi.d	$t4, $a6, 4
	sltu	$t4, $s5, $t4
	sltu	$t5, $a6, $fp
	...
	move	$t4, $zero
	bnez	$t5, .LBB6_17
# %bb.62:                               # %vector.memcheck393
	addi.d	$t5, $a4, 4
	sltu	$t5, $s5, $t5
	sltu	$t6, $a4, $fp
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_17
# %bb.63:                               # %vector.memcheck393
	addi.d	$t5, $a1, 4
	sltu	$t5, $s5, $t5
	sltu	$t6, $a1, $fp
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_17
# %bb.64:                               # %vector.memcheck393
	addi.d	$t5, $a0, 4
	sltu	$t5, $s5, $t5
	sltu	$t6, $a0, $fp
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_17
# %bb.65:                               # %vector.memcheck393
	alsl.d	$t5, $t3, $a5, 2
	add.d	$t6, $t3, $t1
	alsl.d	$t6, $t6, $a5, 2
	sltu	$t6, $s5, $t6
...
.LBB6_70:                               # %vector.body439
	...
	addi.d	$fp, $fp, 16
	bnez	$s0, .LBB6_70
# %bb.71:                               # %middle.block455
	bne	$t4, $t1, .LBB6_17
	b	.LBB6_19
.LBB6_72:                               # %vector.memcheck351
	alsl.d	$t0, $s6, $s5, 2
	addi.d	$a7, $a1, 4
	sltu	$a7, $s5, $a7
	sltu	$t1, $a1, $t0
