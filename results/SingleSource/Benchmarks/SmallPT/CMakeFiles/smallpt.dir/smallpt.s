...
# %bb.0:
	...
	fsub.d	$fa1, $fa1, $ft2
	fsub.d	$fa2, $fa2, $fs1
	vreplvei.d	$vr4, $vr7, 1
	fmul.d	$fa3, $fa1, $fa4
	vreplvei.d	$vr5, $vr7, 0
	fmadd.d	$fa3, $fa0, $fa5, $fa3
	fmul.d	$fa1, $fa1, $fa1
	fmadd.d	$fa0, $fa0, $fa0, $fa1
	fld.d	$fa1, $s0, 704
	fmadd.d	$fs2, $fa2, $fs0, $fa3
	fmadd.d	$fa0, $fa2, $fa2, $fa0
	fmsub.d	$fa0, $fs2, $fs2, $fa0
...
.LBB0_6:                                # %_ZNK6Sphere9intersectERK3Ray.exit.i.1.split
	...
	or	$s3, $a5, $a4
	movgr2cf	$fcc0, $a0
	fsel	$ft0, $ft0, $fa0, $fcc0
.LBB0_7:                                # %_ZNK6Sphere9intersectERK3Ray.exit.thread.i.1
	fld.d	$fa0, $s0, 536
	fld.d	$fa1, $s0, 544
	fld.d	$fa2, $s0, 552
	fsub.d	$fa0, $fa0, $ft1
...
.LBB0_9:                                # %_ZNK6Sphere9intersectERK3Ray.exit.i.2.split
	...
	movgr2cf	$fcc0, $a0
	fsel	$ft0, $ft0, $fa0, $fcc0
.LBB0_10:                               # %_ZNK6Sphere9intersectERK3Ray.exit.thread.i.2
	fld.d	$fa0, $s0, 448
	fld.d	$fa1, $s0, 456
	fld.d	$fa2, $s0, 464
	fsub.d	$fa0, $fa0, $ft1
...
.LBB0_12:                               # %_ZNK6Sphere9intersectERK3Ray.exit.i.3.split
	...
	movgr2cf	$fcc0, $a0
	fsel	$ft0, $ft0, $fa0, $fcc0
.LBB0_13:                               # %_ZNK6Sphere9intersectERK3Ray.exit.thread.i.3
	fld.d	$fa0, $s0, 360
	fld.d	$fa1, $s0, 368
	fld.d	$fa2, $s0, 376
	fsub.d	$fa0, $fa0, $ft1
...
.LBB0_15:                               # %_ZNK6Sphere9intersectERK3Ray.exit.i.4.split
	...
	movgr2cf	$fcc0, $a0
	fsel	$ft0, $ft0, $fa0, $fcc0
.LBB0_16:                               # %_ZNK6Sphere9intersectERK3Ray.exit.thread.i.4
	fld.d	$fa0, $s0, 272
	fld.d	$fa1, $s0, 280
	fld.d	$fa2, $s0, 288
	fsub.d	$fa0, $fa0, $ft1
...
.LBB0_18:                               # %_ZNK6Sphere9intersectERK3Ray.exit.i.5.split
	...
	movgr2cf	$fcc0, $a0
	fsel	$ft0, $ft0, $fa0, $fcc0
.LBB0_19:                               # %_ZNK6Sphere9intersectERK3Ray.exit.thread.i.5
	fld.d	$fa0, $s0, 184
	fld.d	$fa1, $s0, 192
	fld.d	$fa2, $s0, 200
	fsub.d	$fa0, $fa0, $ft1
...
.LBB0_21:                               # %_ZNK6Sphere9intersectERK3Ray.exit.i.6.split
	...
	movgr2cf	$fcc0, $a0
	fsel	$ft0, $ft0, $fa0, $fcc0
.LBB0_22:                               # %_ZNK6Sphere9intersectERK3Ray.exit.thread.i.6
	fld.d	$fa0, $s0, 96
	fld.d	$fa1, $s0, 104
	fld.d	$fa2, $s0, 112
	fsub.d	$fa0, $fa0, $ft1
...
.LBB0_24:                               # %_ZNK6Sphere9intersectERK3Ray.exit.i.7.split
	...
	movgr2cf	$fcc0, $a0
	fsel	$ft0, $ft0, $fa0, $fcc0
.LBB0_25:                               # %_ZNK6Sphere9intersectERK3Ray.exit.thread.i.7
	fld.d	$fa0, $s0, 8
	fld.d	$fa1, $s0, 16
	fld.d	$fa2, $s0, 24
	fsub.d	$fa0, $fa0, $ft1
...
.LBB0_35:                               # %.thread
	...
	ld.w	$a0, $s3, 80
	fmul.d	$fs1, $fa1, $fa2
	vreplvei.d	$vr10, $vr0, 0
	ori	$a4, $zero, 1
	addi.w	$s0, $a2, 1
	beq	$a0, $a4, .LBB0_40
# %bb.36:                               # %.thread
	vreplvei.d	$vr11, $vr0, 1
	fmul.d	$fa1, $fa4, $ft3
	fmadd.d	$fa1, $ft2, $fa5, $fa1
	fmadd.d	$fa1, $fs1, $fs0, $fa1
	fneg.d	$fa2, $ft2
	fneg.d	$fa3, $ft3
	fneg.d	$fa4, $fs1
	fcmp.clt.d	$fcc0, $fa1, $fs3
	fsel	$fs7, $fa2, $ft2, $fcc0
	fsel	$fs5, $fa3, $ft3, $fcc0
	fsel	$fs6, $fa4, $fs1, $fcc0
	bnez	$a0, .LBB0_41
# %bb.37:
...
.LBB0_41:
	...
	fmadd.d	$fa6, $ft2, $fa3, $fa6
	fmadd.d	$fa6, $fs1, $fa2, $fa6
	...
	vst	$vr0, $sp, 280
	fmul.d	$fa0, $ft3, $fs5
	fmadd.d	$fa0, $ft2, $fs7, $fa0
	pcalau12i	$a0, %pc_hi20(.LCPI0_4)
	fld.d	$fa5, $a0, %pc_lo12(.LCPI0_4)
	fmadd.d	$fa0, $fs1, $fs6, $fa0
	fcmp.clt.d	$fcc1, $fs3, $fa0
	vldi	$vr0, -904
	fsel	$fs0, $fa0, $fa5, $fcc1
	fmul.d	$fa0, $fs5, $fa1
	fmadd.d	$fa0, $fa3, $fs7, $fa0
	fmadd.d	$fs2, $fa2, $fs6, $fa0
	fnmadd.d	$fs5, $fa2, $fs6, $fa0
	vldi	$vr0, -912
	fmadd.d	$fa5, $fs5, $fs2, $fa0
	fneg.d	$fa6, $fs0
	fmul.d	$fa6, $fs0, $fa6
...
.LBB0_45:
	...
	bceqz	$fcc0, .LBB0_64
.LBB0_46:                               # %.split362
	fmadd.d	$fa0, $fs2, $fs0, $fa1
	fnmadd.d	$fa1, $fs2, $fs0, $fa1
...
.LBB0_61:                               # %call.sqrt359
	...
	move	$a3, $s4
	b	.LBB0_27
.LBB0_62:                               # %call.sqrt360
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fs2, $fa0
	b	.LBB0_38
.LBB0_63:                               # %call.sqrt361
	fmov.d	$fa0, $fa1
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_39
.LBB0_64:                               # %call.sqrt363
	move	$s1, $a3
	move	$s2, $a2
	vst	$vr10, $sp, 80                  # 16-byte Folded Spill
...
.LBB1_7:                                # %.split139.us.us.us
	...
	b	.LBB1_9
	.p2align	4, , 16
.LBB1_8:                                # %._crit_edge.us.us.us.us.1
...
.LBB1_9:                                # %.preheader126.us.us.us
	...
	b	.LBB1_13
	.p2align	4, , 16
.LBB1_10:                               #   in Loop: Header=BB1_13 Depth=4
	fsqrt.d	$fa1, $fa0
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bceqz	$fcc0, .LBB1_21
.LBB1_11:                               # %.split217
...
.LBB1_20:                               # %.split215
	...
	fsub.d	$fa0, $fa2, $fa0
	b	.LBB1_12
.LBB1_21:                               # %call.sqrt218
                                        #   in Loop: Header=BB1_13 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
	b	.LBB1_11
.LBB1_22:                               # %call.sqrt214
                                        #   in Loop: Header=BB1_13 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
...
.LBB1_27:                               # %.split225
	...
	vldi	$vr0, -784
	fadd.d	$fa0, $fa1, $fa0
.LBB1_28:                               #   in Loop: Header=BB1_29 Depth=4
	vldi	$vr1, -904
	fadd.d	$fa1, $fs3, $fa1
	vldi	$vr2, -928
	fmul.d	$fa1, $fa1, $fa2
...
.LBB1_31:                               # %.split221
	...
	b	.LBB1_34
	.p2align	4, , 16
.LBB1_32:                               #   in Loop: Header=BB1_29 Depth=4
	vldi	$vr1, -1024
	fsub.d	$fa1, $fa1, $fa0
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
...
.LBB1_34:                               #   in Loop: Header=BB1_29 Depth=4
	...
	vldi	$vr2, -912
	bcnez	$fcc0, .LBB1_26
# %bb.35:                               #   in Loop: Header=BB1_29 Depth=4
	vldi	$vr1, -1024
	fsub.d	$fa1, $fa1, $fa0
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
...
.LBB1_36:                               # %.split223
	...
	fsub.d	$fa0, $fa2, $fa0
	b	.LBB1_28
.LBB1_37:                               # %call.sqrt226
                                        #   in Loop: Header=BB1_29 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
	b	.LBB1_27
.LBB1_38:                               # %call.sqrt222
                                        #   in Loop: Header=BB1_29 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
